...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor__Vclpkg::__VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi105> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi105> __Vfunc_get__0__Vfuncout;
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor__Vclpkg::__VnoInFunc_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_backdoor"s;
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_get_object_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi105> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_abstract_object_registry__pi105__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_get_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_backdoor"s;
}

Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name)
    : Varchitecture_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_pre_read(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_pre_read\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__4__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__6__Vfuncout;
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95> unnamedblk1__DOT__iter;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk1__DOT__cb;
    this->__VnoInFunc_pre_read(vlSymsp, rw);
    unnamedblk1__DOT__iter = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95, vlSymsp, 
                                    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor>{this});
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_post_read(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_post_read\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_last__8__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_prev__10__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__12__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__14__Vfuncout;
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk2__DOT__cb;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95> unnamedblk3__DOT__iter;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk3__DOT__cb;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95> iter;
    iter = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95, vlSymsp, 
                  VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor>{this});
    ...
    unnamedblk3__DOT__iter = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95, vlSymsp, 
                                    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor>{this});
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_pre_write(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_pre_write\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__19__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__21__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__22__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__24__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95> unnamedblk4__DOT__iter;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk4__DOT__cb;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk5__DOT__cb;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95> iter;
    iter = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95, vlSymsp, 
                  VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor>{this});
    this->__VnoInFunc_pre_write(vlSymsp, rw);
    unnamedblk4__DOT__iter = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95, vlSymsp, 
                                    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor>{this});
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_post_write(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_do_post_write\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__26__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__28__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95> unnamedblk6__DOT__iter;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk6__DOT__cb;
    unnamedblk6__DOT__iter = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_callback_iter__pi95, vlSymsp, 
                                    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor>{this});
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_pre_read(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_pre_read\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_post_read(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_post_read\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_pre_write(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_pre_write\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_post_write(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_post_write\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_is_auto_updated(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_field> field, CData/*0:0*/ &is_auto_updated__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_is_auto_updated\n"); );
    // Body
    is_auto_updated__Vfuncrtn = 0U;
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_wait_for_change(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> element) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_wait_for_change\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_start_update_thread(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> element) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_start_update_thread\n"); );
    // Locals
    VlClassRef<Varchitecture_std__03a__03aprocess> __Vfunc_self__37__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Varchitecture_std__03a__03aprocess> unnamedblk274__DOT____VforkParent;
    VlClassRef<Varchitecture_uvm_pkg__03a__03a__VDynScope_45> __VDynScope_start_update_thread_0;
    __VDynScope_start_update_thread_0 = VL_NEW(Varchitecture_uvm_pkg__03a__03a__VDynScope_45, vlSymsp);
...
VlCoroutine Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_start_update_thread____Vfork_1__0(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03a__VDynScope_45> __VDynScope_start_update_thread_0, VlClassRef<Varchitecture_std__03a__03aprocess> unnamedblk274__DOT____VforkParent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_start_update_thread____Vfork_1__0\n"); );
    // Locals
    VlClassRef<Varchitecture_std__03a__03aprocess> __Vtask___VforkTask_0__38____VforkParent;
    VlClassRef<Varchitecture_uvm_pkg__03a__03a__VDynScope_45> __Vtask___VforkTask_0__38____VDynScope_start_update_thread_0;
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> __Vtask___VforkTask_0__38__unnamedblk276__DOT__r_item;
    ...
    VlQueue<VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_field>> __Vtask___VforkTask_0__38__fields;
    IData/*31:0*/ __Vtask_status__39__Vfuncout;
    __Vtask_status__39__Vfuncout = 0;
    VlClassRef<Varchitecture_std__03a__03aprocess> __Vfunc_self__40__Vfuncout;
    ...
    while (true) {
        __Vtask___VforkTask_0__38__unnamedblk276__DOT__r_item 
            = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_reg_item, vlProcess, vlSymsp, "bd_r_item"s);
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_kill_update_thread(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> element) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_kill_update_thread\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_has_update_threads(Varchitecture__Syms* __restrict vlSymsp, CData/*0:0*/ &has_update_threads__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_has_update_threads\n"); );
    // Body
    has_update_threads__Vfuncrtn = VL_LTS_III(32, 0U, this->__PVT__m_update_thread.size());
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_write(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_write\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_read(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_read\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_read_func(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_read_func\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc_randomize\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc___Vsetup_constraints(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc___Vsetup_constraints\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc___VBasicRand(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__lineno = 0;
}

Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::~Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor::to_string_middle\n"); );
    // Body
    std::string out;
