...
void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg::__VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi182> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi182> __Vfunc_get__0__Vfuncout;
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg::__VnoInFunc_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_mem_access_seq"s;
}

void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_get_object_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi182> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi182__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_create(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq> tmp;
    tmp = ((""s == name) ? VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq, vlProcess, vlSymsp, "uvm_mem_access_seq"s)
            : VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_get_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_mem_access_seq"s;
}

Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name)
    : Varchitecture_uvm_pkg__03a__03auvm_reg_sequence__Tz317(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

VlCoroutine Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_body\n"); );
    // Locals
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_mem_single_access_seq> __Vfunc_create__17__Vfuncout;
    // Body
    VL_KEEP_THIS;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi181__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "single_mem_access_seq"s, VlNull{}, ""s, __Vfunc_create__17__Vfuncout);
        ...
        VL_NULL_CHECK(Varchitecture_uvm_pkg__03a__03auvm_reg_sequence__Tz317::__PVT__model, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_mem_access_seq.svh", 237)->__VnoInFunc_reset(vlSymsp, "HARD"s);
        co_await this->__VnoInFunc_do_block(vlProcess, vlSymsp, Varchitecture_uvm_pkg__03a__03auvm_reg_sequence__Tz317::__PVT__model);
        __Vlabel0: ;
    }
}

VlCoroutine Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_do_block(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_block> blk) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_do_block\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_resource__Tz68> __Vfunc_get_by_name__21__Vfuncout;
    std::string __Vtask_get_full_name__22__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_resource__Tz68> __Vfunc_get_by_name__23__Vfuncout;
    std::string __Vtask_get_full_name__24__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_resource__Tz68> __Vfunc_get_by_name__25__Vfuncout;
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_resource__Tz68> __Vfunc_get_by_name__30__Vfuncout;
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__34__Vfuncout;
    ...
    VlQueue<VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_block>> unnamedblk2__DOT__blks;
        ...
        while (VL_LTS_III(32, unnamedblk1__DOT__i, mems.size())) {
            {
                ...
                co_await VL_NULL_CHECK(this->__PVT__mem_seq, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_mem_access_seq.svh", 279)->__VnoInFunc_start(vlProcess, vlSymsp, VlNull{}, 
                                                                                VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq>{this}, 0xffffffffU, 1U);
                __Vlabel1: ;
            }
...
void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_reset_blk(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_block> blk) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_reset_blk\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_randomize\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_mem_access_seq::to_string_middle\n"); );
    // Body
    std::string out;
