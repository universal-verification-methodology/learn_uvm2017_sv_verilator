...
void Varchitecture_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc_uvm_report_info(Varchitecture__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
...
void Varchitecture_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
