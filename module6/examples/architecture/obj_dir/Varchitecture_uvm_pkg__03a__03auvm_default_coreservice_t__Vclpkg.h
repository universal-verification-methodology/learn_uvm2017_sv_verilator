...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
