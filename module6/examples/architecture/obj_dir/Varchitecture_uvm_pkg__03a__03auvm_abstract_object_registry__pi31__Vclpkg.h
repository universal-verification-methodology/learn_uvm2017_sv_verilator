...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_ABSTRACT_OBJECT_REGISTRY__PI31__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_ABSTRACT_OBJECT_REGISTRY__PI31__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Varchitecture__Syms* const vlSymsp;

    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
    ~Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31__Vclpkg();
    VL_UNCOPYABLE(Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31__Vclpkg);
    ...
    void __VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31> &get__Vfuncrtn);
...
class Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31 : public Varchitecture_uvm_pkg__03a__03auvm_object_wrapper {
  public:
  ...
  public:
    Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31(Varchitecture__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Varchitecture_uvm_pkg__03a__03auvm_abstract_object_registry__pi31() {}
};
