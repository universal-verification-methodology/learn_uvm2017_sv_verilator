...
void Varchitecture___024root__trace_chg_0_sub_0(Varchitecture___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Varchitecture___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Varchitecture___024root__trace_chg_0\n"); );
    // Body
    ...
    Varchitecture___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Varchitecture___024root__trace_chg_0_sub_0(Varchitecture___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Varchitecture___024root__trace_chg_0_sub_0\n"); );
    Varchitecture__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Varchitecture___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Varchitecture___024root__trace_cleanup\n"); );
    // Body
    Varchitecture___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Varchitecture___024root*>(voidSelf);
    Varchitecture__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
