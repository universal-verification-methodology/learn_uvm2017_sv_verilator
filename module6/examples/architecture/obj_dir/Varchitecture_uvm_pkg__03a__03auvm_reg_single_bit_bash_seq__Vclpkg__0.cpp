    ...
    while (VL_LTS_III(32, 0U, unnamedblk1_2__DOT____Vrepeat1)) {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_2 = Varchitecture___024unit::__Venumtab_enum_name71
                    [(3U & status)];
                __Vtemp_3 = ([&]() {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_5 = Varchitecture___024unit::__Venumtab_enum_name71
                    [(3U & status)];
                __Vtemp_6 = ([&]() {
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
