...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ68__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ68__VCLPKG_H_  // guard
...
class Varchitecture_uvm_pkg__03a__03auvm_set_get_dap_base__Tz68;


class Varchitecture__Syms;

class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz68__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz68__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
    ~Varchitecture_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz68__Vclpkg();
    VL_UNCOPYABLE(Varchitecture_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz68__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz125> &get_type__Vfuncrtn);
};
...
class Varchitecture_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz68 : public Varchitecture_uvm_pkg__03a__03auvm_set_get_dap_base__Tz68 {
  public:
  ...
  public:
    Varchitecture_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz68(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Varchitecture_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz68() {}
};
