    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        ...
        if ((unnamedblk1__DOT__cb_base_type == this->__PVT__m_cb_typeid)) {
            if (VL_UNLIKELY(((1U & (~ (0U != ([&]() {
                ...
                VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz187.get.unnamedblk1: '$cast' failed.\n",0,
...
void Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz187::__VnoInFunc___Vsetup_constraints(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz187::__VnoInFunc___Vsetup_constraints\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz187::__VnoInFunc___VBasicRand(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz187::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz187::~Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz187() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz187::~\n"); );
}
