...
VlCoroutine Varchitecture_uvm_pkg__03a__03auvm_queue__Tz43::__VnoInFunc_wait_until_not_empty(Varchitecture__Syms* __restrict vlSymsp) {
    ...
    if (VL_GTES_III(32, 0U, this->__PVT__queue.size())) {
        CData/*0:0*/ __VdynTrigger_hc4e9f3fe__0;
        __VdynTrigger_hc4e9f3fe__0 = 0;
        __VdynTrigger_hc4e9f3fe__0 = 0U;
        while ((1U & (~ (IData)(__VdynTrigger_hc4e9f3fe__0)))) {
            co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                         ...
                                                         196);
            this->__Vtrigprevexpr_hbf05640b__0 = VL_LTS_III(32, 0U, this->__PVT__queue.size());
            __VdynTrigger_hc4e9f3fe__0 = this->__Vtrigprevexpr_hbf05640b__0;
            vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hc4e9f3fe__0);
        }
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz43::__VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_queue__Tz43::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz43::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    ...
    __Vtrigprevexpr_hbf05640b__0 = VL_SCOPED_RAND_RESET_I(1, 6475006282755257126ULL, 3969918472043692799ull);
}
