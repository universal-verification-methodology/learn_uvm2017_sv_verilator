...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_std__03a__03aprocess__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture_std__03a__03aprocess__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
