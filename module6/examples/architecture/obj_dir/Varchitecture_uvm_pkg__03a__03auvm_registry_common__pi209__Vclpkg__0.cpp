...
void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_mem_access_seq"s;
}

void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_create(Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_mem_access_seq> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> __Vfunc_get__3__Vfuncout;
...
void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_set_type_override(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> __Vfunc_get__11__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_set_inst_override(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_set_type_alias(Varchitecture__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> unnamedblk2__DOT__rgtry;
...
void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> rgtry;
...
void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::__VnoInFunc_get_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::__VnoInFunc_initialize(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi185> __Vfunc_get__2__Vfuncout;
    // Body
...
Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi209::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
