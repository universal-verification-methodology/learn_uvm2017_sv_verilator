...
void Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz71_TBz180__Vclpkg::__VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz71_TBz180> &get__Vfuncrtn) {
    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        ...
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
            ...
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz71_TBz180.get.unnamedblk1: 'assert' failed.\n",0,
...
void Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz71_TBz180::__VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_callbacks__Tz71_TBz180::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
