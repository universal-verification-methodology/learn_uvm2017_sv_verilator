...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture___024unit__03a__03aArchMonitor__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture___024unit__03a__03aArchMonitor__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
