...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_PORT_BASE__TZ292__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_PORT_BASE__TZ292__VCLPKG_H_  // guard
...
class Varchitecture_uvm_pkg__03a__03auvm_port_component__Tz295;
...
class Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292 : public Varchitecture_uvm_pkg__03a__03auvm_tlm_if_base__Tz216_TBz216 {
  public:
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292> __PVT__m_if;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_component__Tz295> __PVT__m_comp;
    VlAssocArray<std::string, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292>> __PVT__m_provided_by;
    VlAssocArray<std::string, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292>> __PVT__m_provided_to;
    VlAssocArray<std::string, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292>> __PVT__m_imp_list;
    virtual void __VnoInFunc_connect(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292> provider);
    ...
    void __VnoInFunc_get_connected_to(Varchitecture__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292>> &list);
    ...
    void __VnoInFunc_get_if(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292> &get_if__Vfuncrtn);
    ...
    void __VnoInFunc_get_provided_to(Varchitecture__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292>> &list);
    ...
    void __VnoInFunc_m_add_list(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292> provider);
    void __VnoInFunc_m_check_relationship(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz292> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn);
