...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_config_db__Tz65__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_config_db__Tz65__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
