...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_POOL__TZ76_TBZ76__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_POOL__TZ76_TBZ76__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_pool__Tz76_TBz76__Vclpkg final {
  public:
    ...
    void __VnoInFunc_get_global(Varchitecture__Syms* __restrict vlSymsp, CData/*1:0*/ key, CData/*1:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_pool__Tz76_TBz76> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz132> &get_type__Vfuncrtn);
...
class Varchitecture_uvm_pkg__03a__03auvm_pool__Tz76_TBz76 : public Varchitecture_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_exists(Varchitecture__Syms* __restrict vlSymsp, CData/*1:0*/ key, IData/*31:0*/ &exists__Vfuncrtn);
    virtual void __VnoInFunc_first(Varchitecture__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &first__Vfuncrtn);
    virtual void __VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, CData/*1:0*/ key, CData/*1:0*/ &get__Vfuncrtn);
    virtual void __VnoInFunc_get_object_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn);
    virtual void __VnoInFunc_get_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn);
    virtual void __VnoInFunc_last(Varchitecture__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &last__Vfuncrtn);
    virtual void __VnoInFunc_next(Varchitecture__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &next__Vfuncrtn);
    virtual void __VnoInFunc_num(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &num__Vfuncrtn);
    virtual void __VnoInFunc_prev(Varchitecture__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &prev__Vfuncrtn);
