...
void Varchitecture_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_valid_fifo_size_setup_constraint(Varchitecture__Syms* __restrict vlSymsp) {
    ...
    Varchitecture_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard(VL_SFORMATF_N_NX("(__Vbv (bvule __Vfifo_size %@))",0,
                                                                    ...
                                                                    54, 
                                                                    "      fifo.size() <= m_size;");
    Varchitecture_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard("(__Vbv (bvsge __Vfifo_size #x00000000))"s, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_fifo.svh", 
                                                                    54, 
                                                                    "      fifo.size() <= m_size;");
}
...
void Varchitecture_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___VBasicRand(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Varchitecture_uvm_pkg__03a__03auvm_reg_fifo::~Varchitecture_uvm_pkg__03a__03auvm_reg_fifo() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_reg_fifo::~\n"); );
}
