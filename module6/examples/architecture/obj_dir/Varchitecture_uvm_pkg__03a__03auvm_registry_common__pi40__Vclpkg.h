...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI40__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI40__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi40__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi40> &get__Vfuncrtn);
...
class Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi40 : public virtual VlClass {
  public:
  ...
  public:
    Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi40(Varchitecture__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi40() {}
};
