...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_POOL__TZ43_TBZ178__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_POOL__TZ43_TBZ178__VCLPKG_H_  // guard
...
class Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz234;
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Varchitecture__Syms* const vlSymsp;

    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
    ~Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178__Vclpkg();
    VL_UNCOPYABLE(Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz234> &get_type__Vfuncrtn);
...
class Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178 : public Varchitecture_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_barrier>> __PVT__pool;
    virtual void __VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Varchitecture__Syms* __restrict vlSymsp) {}
    virtual void __VnoInFunc_add(Varchitecture__Syms* __restrict vlSymsp, std::string key, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_barrier> item);
  ...
  public:
    Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Varchitecture_uvm_pkg__03a__03auvm_pool__Tz43_TBz178() {}
};
