    ...
    do {
...
#endif
            VL_FATAL_MT("architecture.sv", 112, "", "NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Varchitecture___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("architecture.sv", 112, "", "Active region did not converge after 100 tries");
            }
