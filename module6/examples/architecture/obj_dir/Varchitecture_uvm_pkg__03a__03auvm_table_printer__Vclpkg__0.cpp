...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi167> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi167> __Vfunc_get__0__Vfuncout;
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_table_printer"s;
}

void Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_set_default(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_table_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    this->__PVT__m_default_table_printer = printer;
}

void Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_default(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_table_printer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Body
    if ((VlNull{} == this->__PVT__m_default_table_printer)) {
        this->__PVT__m_default_table_printer = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_table_printer, vlProcess, vlSymsp, "uvm_default_table_printer"s);
    }
    get_default__Vfuncrtn = this->__PVT__m_default_table_printer;
}

void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_object_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__pi167> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi167__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_create(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_table_printer> tmp;
    tmp = ((""s == name) ? VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_table_printer, vlProcess, vlSymsp, ""s)
            : VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_table_printer, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_table_printer"s;
}

Varchitecture_uvm_pkg__03a__03auvm_table_printer::Varchitecture_uvm_pkg__03a__03auvm_table_printer(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name)
    : Varchitecture_uvm_pkg__03a__03auvm_printer(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::new\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_pop_element(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_pop_element\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_top_element__4__Vfuncout;
    ...
    IData/*31:0*/ level;
    level = 0;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_printer_element> popped;
    std::string name_str;
    ...
    Varchitecture_uvm_pkg__03a__03auvm_printer::__VnoInFunc_pop_element(vlSymsp);
}

void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_emit(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_emit\n"); );
    // Locals
    ...
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_bottom_element__26__Vfuncout;
    ...
    std::string dashes;
    std::string linefeed;
    if (Varchitecture_uvm_pkg__03a__03auvm_printer::__PVT__m_flushed) {
        Varchitecture_uvm_pkg__03a__03auvm_printer::__PVT__m_flushed = 0U;
    } else if ((0U != ([&]() {
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_m_emit_element(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_printer_element> element, IData/*31:0*/ level, std::string &m_emit_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_m_emit_element\n"); );
    // Locals
    ...
    std::string result;
    VlQueue<VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_printer_element>> element_children;
    std::string linefeed;
    linefeed = VL_CONCATN_NNN("\n"s, ([&]() {
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_set_indent(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ indent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_set_indent\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__40__Vfuncout;
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs> _knobs;
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_indent(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &get_indent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_indent\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__41__Vfuncout;
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs> _knobs;
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_flush(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_flush\n"); );
    // Body
    Varchitecture_uvm_pkg__03a__03auvm_printer::__VnoInFunc_flush(vlProcess, vlSymsp);
    this->__PVT__m_max_name = 4U;
    this->__PVT__m_max_type = 4U;
    this->__PVT__m_max_size = 4U;
    this->__PVT__m_max_value = 5U;
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_randomize\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___Vsetup_constraints(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___Vsetup_constraints\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___VBasicRand(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Varchitecture_uvm_pkg__03a__03auvm_table_printer::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::_ctor_var_reset\n"); );
    // Body
...
Varchitecture_uvm_pkg__03a__03auvm_table_printer::~Varchitecture_uvm_pkg__03a__03auvm_table_printer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_table_printer>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_table_printer::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_table_printer::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_table_printer::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Varchitecture_uvm_pkg__03a__03auvm_printer::to_string_middle();
    return (out);
}
