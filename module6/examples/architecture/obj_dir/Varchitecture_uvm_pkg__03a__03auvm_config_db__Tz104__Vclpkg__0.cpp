...
VlCoroutine Varchitecture_uvm_pkg__03a__03auvm_config_db__Tz104__Vclpkg::__VnoInFunc_wait_modified(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    ...
    CData/*0:0*/ __VdynTrigger_h9d8a33da__0;
    __VdynTrigger_h9d8a33da__0 = 0;
    __VdynTrigger_h9d8a33da__0 = 0U;
    while ((1U & (~ (IData)(__VdynTrigger_h9d8a33da__0)))) {
        co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                     ...
                                                     289);
        __VdynTrigger_h9d8a33da__0 = VL_NULL_CHECK(waiter, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_config_db.svh", 289)
            ->__PVT__trigger.isFired();
        vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h9d8a33da__0);
...
Varchitecture_uvm_pkg__03a__03auvm_config_db__Tz104::~Varchitecture_uvm_pkg__03a__03auvm_config_db__Tz104() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_config_db__Tz104::~\n"); );
}
