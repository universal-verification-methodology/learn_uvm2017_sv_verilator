...
void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_create(Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz19> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz19> __Vfunc_create__2__Vfuncout;
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_set_type_override(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_set_inst_override(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_set_type_alias(Varchitecture__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::__VnoInFunc_get_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi159> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi159> common;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi159__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__11__Vfuncout);
...
void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::__VnoInFunc_initialize(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi159> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi159> common;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi159__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__13__Vfuncout);
...
Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149(Varchitecture__Syms* __restrict vlSymsp)
    : Varchitecture_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::~Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Varchitecture_uvm_pkg__03a__03auvm_abstract_component_registry__pi149::to_string_middle\n"); );
    // Body
    std::string out;
