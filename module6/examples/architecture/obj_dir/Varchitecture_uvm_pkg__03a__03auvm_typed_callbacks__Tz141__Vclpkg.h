...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ141__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ141__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz86> __PVT__m_tw_cb_q;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Varchitecture__Syms* const vlSymsp;

    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
    ~Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg();
    VL_UNCOPYABLE(Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141> &m_initialize__Vfuncrtn);
};
...
class Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141 : public Varchitecture_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz141() {}
};
