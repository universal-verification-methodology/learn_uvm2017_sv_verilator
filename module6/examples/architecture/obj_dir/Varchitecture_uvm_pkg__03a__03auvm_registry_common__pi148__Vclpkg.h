...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI148__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI148__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Varchitecture__Syms* const vlSymsp;

    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
    ~Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148__Vclpkg();
    VL_UNCOPYABLE(Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148__Vclpkg);
    ...
    void __VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148> &get__Vfuncrtn);
...
class Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148 : public virtual VlClass {
  public:
  ...
  public:
    Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148(Varchitecture__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Varchitecture_uvm_pkg__03a__03auvm_registry_common__pi148() {}
};
