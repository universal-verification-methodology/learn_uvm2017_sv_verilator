...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43__Vclpkg::__VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz252> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz252> __Vfunc_get__0__Vfuncout;
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_get_object_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz252> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz252__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_create(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43> tmp;
    tmp = ((""s == name) ? VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43, vlProcess, vlSymsp, "unnamed-uvm_simple_lock_dap#(T)"s)
            : VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name)
    : Varchitecture_uvm_pkg__03a__03auvm_set_get_dap_base__Tz43(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::new\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_set(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_set\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_try_set(Varchitecture__Syms* __restrict vlSymsp, std::string value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_try_set\n"); );
    // Body
    if (this->__PVT__m_locked) {
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_get(Varchitecture__Syms* __restrict vlSymsp, std::string &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_get\n"); );
    // Body
    get__Vfuncrtn = this->__PVT__m_value;
}

void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_try_get(Varchitecture__Syms* __restrict vlSymsp, std::string &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_try_get\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_lock(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_lock\n"); );
    // Body
    this->__PVT__m_locked = 1U;
}

void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_unlock(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_unlock\n"); );
    // Body
    this->__PVT__m_locked = 0U;
}

void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_is_locked(Varchitecture__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_is_locked\n"); );
    // Body
    is_locked__Vfuncrtn = this->__PVT__m_locked;
}

void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_copy(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_pack(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_pack\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_unpack(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_convert2string(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_convert2string\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_print(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_do_print\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc_randomize\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc___Vsetup_constraints(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc___Vsetup_constraints\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc___VBasicRand(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_locked = 0;
}

Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::~Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_simple_lock_dap__Tz43::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_locked:" + VL_TO_STRING(__PVT__m_locked);
    out += ", "+ Varchitecture_uvm_pkg__03a__03auvm_set_get_dap_base__Tz43::to_string_middle();
    return (out);
}
