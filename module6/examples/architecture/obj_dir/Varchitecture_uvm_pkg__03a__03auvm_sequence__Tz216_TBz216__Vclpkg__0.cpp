...
VlCoroutine Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216::__VnoInFunc_get_response(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_item> &response, IData/*31:0*/ transaction_id) {
    ...
    if (VL_UNLIKELY(((! VL_CAST_DYNAMIC(rsp, response))))) {
        VL_WRITEF_NX("[%0t] %%Error: uvm_sequence.svh:128: Assertion failed in %Nuvm_pkg.uvm_sequence__Tz216_TBz216.get_response: '$cast' failed.\n",0,
...
void Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216::__VnoInFunc___Vsetup_constraints(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216::__VnoInFunc___Vsetup_constraints\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216::__VnoInFunc___VBasicRand(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216::~Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_sequence__Tz216_TBz216::~\n"); );
}
