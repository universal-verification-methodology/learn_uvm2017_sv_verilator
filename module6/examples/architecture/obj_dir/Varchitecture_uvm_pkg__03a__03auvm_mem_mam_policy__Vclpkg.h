...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_mem_mam_policy__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_mem_mam_policy__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
...
class Varchitecture_uvm_pkg__03a__03auvm_mem_mam_policy : public virtual VlClass {
  public:
    ...
    // INTERNAL VARIABLES
    VlRNG __Vm_rng;
    void __VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn);
