...
void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184, vlProcess, vlSymsp);
...
void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg::__VnoInFunc_m_cb_find_name(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz86> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg::__VnoInFunc_display(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor> me;
    ...
    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_am_i_a(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_am_i_a\n"); );
        // Body
        VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_reg_backdoor> this_type;
        {
            if ((VlNull{} == obj)) {
    ...
    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_get_tw_cb_q(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz86> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Locals
            ...
            if (([&]() {
                ...
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Varchitecture_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    ...
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184>{this}))) {
                ...
                m_get_tw_cb_q__Vfuncrtn = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__PVT__m_tw_cb_q;
            } else {
    ...
    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_add_tw_cbs(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz86> q;
        if ((0xffffffffU == ([&]() {
                        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__2__Vfuncout);
                    }(), __Vfunc_m_cb_find__2__Vfuncout))) {
            warned = (1U & ([&]() {
                        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__VnoInFunc_m_cb_find_name(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__PVT__m_tw_cb_q, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
            ...
            if ((0U == ordering)) {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 256)
                        ->__VnoInFunc_push_back(vlSymsp, cb);
            } else {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 258)
        ...
        if ((0U != ([&]() {
            ...
            do {
                if (VL_CAST_DYNAMIC(obj, me)) {
                    ...
                    if ((0xffffffffU == ([&]() {
                                    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__11__Vfuncout);
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Varchitecture_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            ...
            if ((cb_pair != VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184>{this})) {
    ...
    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_delete_tw_cbs(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
        ...
        IData/*31:0*/ pos;
        pos = 0;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__19__Vfuncout);
        pos = __Vfunc_m_cb_find__19__Vfuncout;
        if ((0xffffffffU != pos)) {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 296)
        ...
        if ((0U != ([&]() {
            ...
            do {
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__25__Vfuncout);
    ...
    Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp)
      : Varchitecture_uvm_pkg__03a__03auvm_callbacks_base(vlProcess, vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::new\n"); );
        // Body
        _ctor_var_reset(vlSymsp);
        ;
    }

    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc___Vbasic_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::__VnoInFunc___Vbasic_randomize\n"); );
        // Body
        __Vbasic_randomize__Vfuncrtn = 1U;
    }

    void Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::_ctor_var_reset\n"); );
        // Body
        (void)vlSymsp;  // Prevent unused variable warning
    }

    std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184::to_string_middle\n"); );
        // Body
        std::string out;
