...
Varchitecture_uvm_pkg__03a__03auvm_heartbeat::Varchitecture_uvm_pkg__03a__03auvm_heartbeat(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> cntxt, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_objection> objection)
    : Varchitecture_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::new\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ mode, IData/*31:0*/ &set_mode__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_event_> e, VlQueue<VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component>> &comps) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add\n"); );
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> c;
    {
        c = comp;
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove\n"); );
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> c;
    c = comp;
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_event_> e) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_enable_cb(Varchitecture__Syms* __restrict vlSymsp) {
    ...
    // Body
    {
        ...
        if ((1U & (~ (IData)(this->__PVT__m_added)))) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz71_TBz180__Vclpkg.__VnoInFunc_add(vlSymsp, this->__PVT__m_objection, this->__PVT__m_cb, 0U);
        }
...
void Varchitecture_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_heartbeat>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_heartbeat::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_heartbeat::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03auvm_heartbeat::to_string_middle\n"); );
    // Body
    std::string out;
