...
void Varchitecture_uvm_pkg__03a__03auvm_report_message_int_element::__VnoInFunc_do_record(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_recorder> recorder) {
    ...
    // Body
    VL_NULL_CHECK(recorder, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_report_message.svh", 150)->__VnoInFunc_record_field(vlProcess, vlSymsp, Varchitecture_uvm_pkg__03a__03auvm_report_message_element_base::__PVT___name, this->__PVT___val, this->__PVT___size, this->__PVT___radix);
}
