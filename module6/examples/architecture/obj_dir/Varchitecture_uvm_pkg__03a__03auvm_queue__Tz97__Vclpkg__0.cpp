...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_get_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz146> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz146> __Vfunc_get__0__Vfuncout;
    // Body
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_queue"s;
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_get_global_queue(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97> &get_global_queue__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_get_global_queue\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((VlNull{} == this->__PVT__m_global_queue)) {
        this->__PVT__m_global_queue = VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97, vlProcess, vlSymsp, "global_queue"s);
    }
    get_global_queue__Vfuncrtn = this->__PVT__m_global_queue;
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_get_global(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> &get_global__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97__Vclpkg::__VnoInFunc_get_global\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97> __Vfunc_get_global_queue__2__Vfuncout;
    VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> __Vtask_get__3__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97> gqueue;
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_get_object_type(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object_registry__Tz146> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz146__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_create(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97> tmp;
    tmp = ((""s == name) ? VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97, vlProcess, vlSymsp, ""s)
            : VL_NEW(Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_get_type_name(Varchitecture__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_queue"s;
}

Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name)
    : Varchitecture_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_get(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_get\n"); );
    // Locals
    ...
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> default_value;
    {
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_size(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_size\n"); );
    // Body
    size__Vfuncrtn = this->__PVT__queue.size();
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_insert(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_insert\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_delete(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_delete\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_pop_front(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> &pop_front__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_pop_front\n"); );
    // Body
    pop_front__Vfuncrtn = this->__PVT__queue.pop_front();
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_pop_back(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> &pop_back__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_pop_back\n"); );
    // Body
    pop_back__Vfuncrtn = this->__PVT__queue.pop_back();
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_push_front(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_push_front\n"); );
    // Body
    this->__PVT__queue.push_front(item);
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_push_back(Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_waiter> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_push_back\n"); );
    // Body
    this->__PVT__queue.push_back(item);
}

VlCoroutine Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_wait_until_not_empty(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_wait_until_not_empty\n"); );
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_hbbdb689a__0;
    __Vtrigprevexpr_hbbdb689a__0 = 0;
    // Body
    VL_KEEP_THIS;
    if (VL_GTES_III(32, 0U, this->__PVT__queue.size())) {
        CData/*0:0*/ __VdynTrigger_hca2412b1__0;
        __VdynTrigger_hca2412b1__0 = 0;
        __VdynTrigger_hca2412b1__0 = 0U;
        while ((1U & (~ (IData)(__VdynTrigger_hca2412b1__0)))) {
            co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                         nullptr, 
                                                         "@([true] (32'sh0 < uvm_pkg::uvm_queue__Tz97.queue.size()))", 
                                                         "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_queue.svh", 
                                                         196);
            __Vtrigprevexpr_hbbdb689a__0 = VL_LTS_III(32, 0U, this->__PVT__queue.size());
            __VdynTrigger_hca2412b1__0 = __Vtrigprevexpr_hbbdb689a__0;
            vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hca2412b1__0);
        }
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_do_copy(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_do_copy\n"); );
    // Body
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97> p;
    {
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_convert2string(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_convert2string\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_randomize(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc_randomize\n"); );
    // Locals
...
void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc___Vsetup_constraints(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc___Vsetup_constraints\n"); );
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc___VBasicRand(Varchitecture__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::~Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Varchitecture_uvm_pkg__03a__03auvm_queue__Tz97::to_string_middle\n"); );
    // Body
    std::string out;
