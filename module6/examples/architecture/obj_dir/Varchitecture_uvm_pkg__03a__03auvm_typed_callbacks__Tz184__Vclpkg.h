...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_typed_callbacks__Tz184__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
