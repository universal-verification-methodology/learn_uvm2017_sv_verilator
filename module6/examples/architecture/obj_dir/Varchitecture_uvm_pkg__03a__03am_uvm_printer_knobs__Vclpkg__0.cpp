...
Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::new\n"); );
    // Body
...
void Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::_ctor_var_reset(Varchitecture__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Varchitecture_uvm_pkg__03a__03am_uvm_printer_knobs::to_string_middle\n"); );
    // Body
    std::string out;
