...
#ifndef VERILATED_VARCHITECTURE___024UNIT_H_
#define VERILATED_VARCHITECTURE___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture___024unit(Varchitecture__Syms* symsp, const char* v__name);
    ~Varchitecture___024unit();
    VL_UNCOPYABLE(Varchitecture___024unit);
