...
#ifndef VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI101__VCLPKG_H_
#define VERILATED_VARCHITECTURE_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI101__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Varchitecture_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi101__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Varchitecture_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi101__Vclpkg(Varchitecture__Syms* symsp, const char* v__name);
    ~Varchitecture_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi101__Vclpkg();
    VL_UNCOPYABLE(Varchitecture_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi101__Vclpkg);
...
class Varchitecture_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi101 : public Varchitecture_uvm_pkg__03a__03auvm_port_base__Tz195 {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_sequencer_> __PVT__m_imp;
  ...
  public:
    Varchitecture_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi101(VlProcessRef vlProcess, Varchitecture__Syms* __restrict vlSymsp, std::string name, VlClassRef<Varchitecture_uvm_pkg__03a__03auvm_sequencer_> imp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Varchitecture_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi101() {}
};
