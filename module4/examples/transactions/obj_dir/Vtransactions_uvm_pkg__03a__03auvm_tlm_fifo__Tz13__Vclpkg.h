...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ13__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ13__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vtransactions_std__03a__03amailbox__Tz13;
class Vtransactions_uvm_pkg__03a__03auvm_analysis_port__Tz13;
class Vtransactions_uvm_pkg__03a__03auvm_component;
class Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz201;
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo__Tz13__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo__Tz13__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo__Tz13__Vclpkg();
    VL_UNCOPYABLE(Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo__Tz13__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz201> &get_type__Vfuncrtn);
...
class Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo__Tz13 : public Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz13 {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_size;
    IData/*31:0*/ __PVT__m_pending_blocked_gets;
    VlClassRef<Vtransactions_std__03a__03amailbox__Tz13> __PVT__m;
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo__Tz13(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ size);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtransactions_uvm_pkg__03a__03auvm_tlm_fifo__Tz13() {}
};
