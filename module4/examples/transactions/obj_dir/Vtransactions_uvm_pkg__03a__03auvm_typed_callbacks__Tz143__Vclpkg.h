...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ143__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ143__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> __PVT__m_tw_cb_q;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vtransactions__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg();
    VL_UNCOPYABLE(Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143> &m_initialize__Vfuncrtn);
};
...
class Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143 : public Vtransactions_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143() {}
};
