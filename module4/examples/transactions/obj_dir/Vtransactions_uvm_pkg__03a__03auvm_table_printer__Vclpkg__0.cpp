...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__pi139> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__pi139> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi139__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_table_printer"s;
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_set_default(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_table_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    this->__PVT__m_default_table_printer = printer;
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_default(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_table_printer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_table_printer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Body
    if ((VlNull{} == this->__PVT__m_default_table_printer)) {
        this->__PVT__m_default_table_printer = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_table_printer, vlProcess, vlSymsp, "uvm_default_table_printer"s);
    }
    get_default__Vfuncrtn = this->__PVT__m_default_table_printer;
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_object_type(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__pi139> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi139__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_create(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_table_printer> tmp;
    tmp = ((""s == name) ? VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_table_printer, vlProcess, vlSymsp, ""s)
            : VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_table_printer, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_table_printer"s;
}

Vtransactions_uvm_pkg__03a__03auvm_table_printer::Vtransactions_uvm_pkg__03a__03auvm_table_printer(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name)
    : Vtransactions_uvm_pkg__03a__03auvm_printer(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::new\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_pop_element(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_pop_element\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_top_element__4__Vfuncout;
    ...
    IData/*31:0*/ level;
    level = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer_element> popped;
    std::string name_str;
    ...
    Vtransactions_uvm_pkg__03a__03auvm_printer::__VnoInFunc_pop_element(vlSymsp);
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_emit(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_emit\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_bottom_element__26__Vfuncout;
    ...
    std::string dashes;
    std::string linefeed;
    if (Vtransactions_uvm_pkg__03a__03auvm_printer::__PVT__m_flushed) {
        Vtransactions_uvm_pkg__03a__03auvm_printer::__PVT__m_flushed = 0U;
    } else if ((0U != ([&]() {
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_m_emit_element(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer_element> element, IData/*31:0*/ level, std::string &m_emit_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_m_emit_element\n"); );
    // Locals
    ...
    std::string result;
    VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer_element>> element_children;
    std::string linefeed;
    linefeed = VL_CONCATN_NNN("\n"s, ([&]() {
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_set_indent(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ indent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_set_indent\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__40__Vfuncout;
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03am_uvm_printer_knobs> _knobs;
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_indent(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &get_indent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_get_indent\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__41__Vfuncout;
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03am_uvm_printer_knobs> _knobs;
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_flush(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_flush\n"); );
    // Body
    Vtransactions_uvm_pkg__03a__03auvm_printer::__VnoInFunc_flush(vlProcess, vlSymsp);
    this->__PVT__m_max_name = 4U;
    this->__PVT__m_max_type = 4U;
    this->__PVT__m_max_size = 4U;
    this->__PVT__m_max_value = 5U;
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtransactions_uvm_pkg__03a__03auvm_table_printer::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::_ctor_var_reset\n"); );
    // Body
...
Vtransactions_uvm_pkg__03a__03auvm_table_printer::~Vtransactions_uvm_pkg__03a__03auvm_table_printer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_table_printer>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_table_printer::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_table_printer::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_table_printer::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vtransactions_uvm_pkg__03a__03auvm_printer::to_string_middle();
    return (out);
}
