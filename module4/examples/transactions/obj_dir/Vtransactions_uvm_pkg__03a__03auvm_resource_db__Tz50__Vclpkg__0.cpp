...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_get_by_type(Vtransactions__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__0__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> __Vfunc_get_type__1__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> rsrc;
    std::string msg;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_base> type_handle;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz50__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __Vfunc_get_type__1__Vfuncout);
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_get_by_name(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> __Vfunc_get_type__13__Vfuncout;
    ...
    std::string msg;
    {
        ...
        VL_NULL_CHECK(rp, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_resource_db.svh", 108)->__VnoInFunc_get_by_name(vlProcess, vlSymsp, scope, name, 
                                                                                ([&]() {
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz50__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __Vfunc_get_type__13__Vfuncout);
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_default(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__22__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> r;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    r = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50, vlProcess, vlSymsp, name);
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> rsrc;
    rsrc = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50, vlProcess, vlSymsp, name);
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_anonymous(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> rsrc;
    rsrc = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50, vlProcess, vlSymsp, ""s);
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_override(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_override\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_override_type(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_override_name(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_read_by_name(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string &val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> __Vfunc_get_by_name__65__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_read_by_type(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string &val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> __Vfunc_get_by_type__69__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_write_by_name(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> __Vfunc_get_by_name__73__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_write_by_type(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string val, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz50> __Vfunc_get_by_type__77__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_dump(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg::__VnoInFunc_dump\n"); );
    // Locals
...
Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_resource_db__Tz50::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
