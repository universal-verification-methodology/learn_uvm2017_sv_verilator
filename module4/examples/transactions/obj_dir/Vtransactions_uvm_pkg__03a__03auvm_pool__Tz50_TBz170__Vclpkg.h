...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_POOL__TZ50_TBZ170__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_POOL__TZ50_TBZ170__VCLPKG_H_  // guard
...
class Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz241;
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vtransactions__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170__Vclpkg();
    VL_UNCOPYABLE(Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz241> &get_type__Vfuncrtn);
...
class Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170 : public Vtransactions_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz50>> __PVT__pool;
    virtual void __VnoInFunc___Vbasic_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {}
    virtual void __VnoInFunc_add(Vtransactions__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz50> item);
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz170() {}
};
