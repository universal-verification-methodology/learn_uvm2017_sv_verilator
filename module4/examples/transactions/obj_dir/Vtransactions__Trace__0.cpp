...
void Vtransactions___024root__trace_chg_0_sub_0(Vtransactions___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vtransactions___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_chg_0\n"); );
    // Body
    ...
    Vtransactions___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vtransactions___024root__trace_chg_0_sub_0(Vtransactions___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_chg_0_sub_0\n"); );
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vtransactions___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_cleanup\n"); );
    // Body
    Vtransactions___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtransactions___024root*>(voidSelf);
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
