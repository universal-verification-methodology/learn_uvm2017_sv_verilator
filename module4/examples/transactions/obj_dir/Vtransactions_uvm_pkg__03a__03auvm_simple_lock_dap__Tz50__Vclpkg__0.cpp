...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50__Vclpkg::__VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz211> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz211> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_get_object_type(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz211> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz211__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_create(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50> tmp;
    tmp = ((""s == name) ? VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50, vlProcess, vlSymsp, "unnamed-uvm_simple_lock_dap#(T)"s)
            : VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name)
    : Vtransactions_uvm_pkg__03a__03auvm_set_get_dap_base__Tz50(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::new\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_set(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_set\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_try_set(Vtransactions__Syms* __restrict vlSymsp, std::string value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_try_set\n"); );
    // Body
    if (this->__PVT__m_locked) {
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, std::string &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_get\n"); );
    // Body
    get__Vfuncrtn = this->__PVT__m_value;
}

void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_try_get(Vtransactions__Syms* __restrict vlSymsp, std::string &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_try_get\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_lock(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_lock\n"); );
    // Body
    this->__PVT__m_locked = 1U;
}

void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_unlock(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_unlock\n"); );
    // Body
    this->__PVT__m_locked = 0U;
}

void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_is_locked(Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_is_locked\n"); );
    // Body
    is_locked__Vfuncrtn = this->__PVT__m_locked;
}

void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_pack(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_pack\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_unpack(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_convert2string\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_print(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_do_print\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_locked = 0;
}

Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::~Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_simple_lock_dap__Tz50::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_locked:" + VL_TO_STRING(__PVT__m_locked);
    out += ", "+ Vtransactions_uvm_pkg__03a__03auvm_set_get_dap_base__Tz50::to_string_middle();
    return (out);
}
