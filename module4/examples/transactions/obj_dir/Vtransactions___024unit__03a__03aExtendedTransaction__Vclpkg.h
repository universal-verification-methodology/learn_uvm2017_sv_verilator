...
#ifndef VERILATED_VTRANSACTIONS___024UNIT__03A__03AEXTENDEDTRANSACTION__VCLPKG_H_
#define VERILATED_VTRANSACTIONS___024UNIT__03A__03AEXTENDEDTRANSACTION__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions___024unit__03a__03aExtendedTransaction__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtransactions___024unit__03a__03aExtendedTransaction__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions___024unit__03a__03aExtendedTransaction__Vclpkg();
    VL_UNCOPYABLE(Vtransactions___024unit__03a__03aExtendedTransaction__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz3_TBz4> &get_type__Vfuncrtn);
...
class Vtransactions___024unit__03a__03aExtendedTransaction : public Vtransactions___024unit__03a__03aBaseTransaction {
  public:

    // DESIGN SPECIFIC STATE
    CData/*7:0*/ __PVT__control;
  ...
  public:
    Vtransactions___024unit__03a__03aExtendedTransaction(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtransactions___024unit__03a__03aExtendedTransaction() {}
};
