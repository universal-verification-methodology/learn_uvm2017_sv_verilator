...
class Vtransactions_uvm_pkg__03a__03a__VDynScope_34;
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_heartbeat__Vclpkg final {
  public:
...
class Vtransactions_uvm_pkg__03a__03auvm_heartbeat : public Vtransactions_uvm_pkg__03a__03auvm_object {
  ...
  private:
    VlCoroutine __VnoInFunc_m_hb_process____Vfork_2__0(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03a__VDynScope_34> __VDynScope_m_hb_process_2, VlForkSync __Vfork_2__sync);
  ...
  private:
    VlCoroutine __VnoInFunc_m_start_hb_process____Vfork_1__0(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_std__03a__03aprocess> unnamedblk2__DOT____VforkParent);
  public:
