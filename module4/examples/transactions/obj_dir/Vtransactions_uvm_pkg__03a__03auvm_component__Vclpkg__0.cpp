...
void Vtransactions_uvm_pkg__03a__03auvm_component__Vclpkg::__VnoInFunc_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_component__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_component"s;
}

void Vtransactions_uvm_pkg__03a__03auvm_component__Vclpkg::__VnoInFunc_set_type_override(Vtransactions__Syms* __restrict vlSymsp, std::string original_type_name, std::string override_type_name, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_component__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> factory;
...
void Vtransactions_uvm_pkg__03a__03auvm_component__Vclpkg::__VnoInFunc_set_type_override_by_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> original_type, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_component__Vclpkg::__VnoInFunc_set_type_override_by_type\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__4__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> cs;
...
std::string VL_TO_STRING(const Vtransactions_m_verbosity_setting__struct__0& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_component__Vclpkg::VL_TO_STRING\n"); );
    // Body
    std::string out;
...
void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_raised(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_objection> objection, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_raised\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_dropped(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_objection> objection, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_dropped\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_all_dropped(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_objection> objection, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_all_dropped\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_abort(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_abort\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_component"s;
}

Vtransactions_uvm_pkg__03a__03auvm_component::Vtransactions_uvm_pkg__03a__03auvm_component(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> parent)
    : Vtransactions_uvm_pkg__03a__03auvm_report_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::new\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_domain> __Vfunc_get_common_domain__4__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> __Vtask_find__5__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_build_phase> __Vfunc_get__6__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> __Vtask_get_child__19__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> unnamedblk181__DOT__bld;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_domain> unnamedblk181__DOT__common;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        if ((parent == VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this})) {
            if ((0U != ([&]() {
        ...
        if (((0U != ([&]() {
             ...
             && (VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this} 
                 != ([&]() {
                            VL_NULL_CHECK(parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_component.svh", 1645)
            ...
            if ((parent == top)) {
                ...
                if ((1U & (~ ([&]() {
                              ...
                              ->__VnoInFunc_m_add_child(vlProcess, vlSymsp, 
                                                        VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, __Vtask_m_add_child__26__Vfuncout);
                                }(), (IData)(__Vtask_m_add_child__26__Vfuncout))))) {
                    this->__PVT__m_parent = VlNull{};
                }
                this->__PVT__event_pool = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_object_string_pool__Tz20, vlProcess, vlSymsp, "event_pool"s);
                ...
                if ((1U & (~ ([&]() {
                                    ...
                                    vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db__Tz21__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, ""s, "recording_detail"s, __Vfunc_get__29__value, __Vfunc_get__29__Vfuncout);
                                    this->__PVT__recording_detail 
                                        = __Vfunc_get__29__value[0U];
                    ...
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db___Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, ""s, "recording_detail"s, __Vtask_get__30__value, __Vtask_get__30__Vfuncout);
                    this->__PVT__recording_detail = __Vtask_get__30__value;
                }
                VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_report_object::__PVT__m_rh, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_component.svh", 1678)
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_add_child(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> child, CData/*0:0*/ &m_add_child__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_add_child\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_children(Vtransactions__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>> &children) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_children\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_first_child(Vtransactions__Syms* __restrict vlSymsp, std::string &name, IData/*31:0*/ &get_first_child__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_first_child\n"); );
            // Body
            get_first_child__Vfuncrtn = this->__PVT__m_children.first(name);
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_next_child(Vtransactions__Syms* __restrict vlSymsp, std::string &name, IData/*31:0*/ &get_next_child__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_next_child\n"); );
            // Body
            get_next_child__Vfuncrtn = this->__PVT__m_children.next(name);
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_child(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> &get_child__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_child\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_has_child(Vtransactions__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ &has_child__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_has_child\n"); );
            // Body
            has_child__Vfuncrtn = this->__PVT__m_children.exists(name);
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_num_children(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_children__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_num_children\n"); );
            // Body
            get_num_children__Vfuncrtn = this->__PVT__m_children.size();
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_full_name\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_parent(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> &get_parent__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_parent\n"); );
            // Body
            get_parent__Vfuncrtn = this->__PVT__m_parent;
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_name(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_name\n"); );
            // Locals
            ...
            // Body
            {
                ...
                Vtransactions_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_name(vlProcess, vlSymsp, name);
                this->__VnoInFunc_m_set_full_name(vlProcess, vlSymsp);
                __Vlabel0: ;
            }
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_full_name(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_full_name\n"); );
            // Locals
            ...
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> unnamedblk183__DOT__unnamedblk184__DOT__tmp;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_root> top;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_lookup(Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> &lookup__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_lookup\n"); );
            // Locals
            ...
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> __Vtask_lookup__67__Vfuncout;
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
            std::string leaf;
            std::string remainder;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> comp;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_root> top;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> cs;
            {
                ...
                comp = VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this};
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_depth(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &get_depth__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_depth\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_extract_name(Vtransactions__Syms* __restrict vlSymsp, std::string name, std::string &leaf, std::string &remainder) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_extract_name\n"); );
            // Body
            IData/*31:0*/ i;
            i = 0;
            IData/*31:0*/ len;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_flush(Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_flush\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_flush(Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_flush\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_create(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_create\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_clone(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_clone\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_print_override_info(Vtransactions__Syms* __restrict vlSymsp, std::string requested_type_name, std::string name) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_print_override_info\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__75__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__76__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_create_component(Vtransactions__Syms* __restrict vlSymsp, std::string requested_type_name, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_create_component\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__79__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__80__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> __Vtask_create_component_by_name__81__Vfuncout;
            ...
            VL_NULL_CHECK(factory, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_component.svh", 1966)
                            ...
                            this->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __Vfunc_get_full_name__82__Vfuncout);
                                                                                ...
                                                                                VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, __Vtask_create_component_by_name__81__Vfuncout);
            create_component__Vfuncrtn = __Vtask_create_component_by_name__81__Vfuncout;
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_create_object(Vtransactions__Syms* __restrict vlSymsp, std::string requested_type_name, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> &create_object__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_create_object\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__83__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__84__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> __Vtask_create_object_by_name__85__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_inst_override(Vtransactions__Syms* __restrict vlSymsp, std::string relative_inst_path, std::string original_type_name, std::string override_type_name) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_inst_override\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__87__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__88__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_inst_override_by_type(Vtransactions__Syms* __restrict vlSymsp, std::string relative_inst_path, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> original_type, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> override_type) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_inst_override_by_type\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__92__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__93__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_id_verbosity_hier(Vtransactions__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ verbosity) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_id_verbosity_hier\n"); );
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_id_verbosity_hier(Vtransactions__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ verbosity) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_id_verbosity_hier\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_action_hier(Vtransactions__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ action) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_action_hier\n"); );
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_id_action_hier(Vtransactions__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ action) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_id_action_hier\n"); );
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_id_action_hier(Vtransactions__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ action) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_id_action_hier\n"); );
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_file_hier(Vtransactions__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ file) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_file_hier\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_default_file_hier(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_default_file_hier\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_id_file_hier(Vtransactions__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ file) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_id_file_hier\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_id_file_hier(Vtransactions__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ file) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_severity_id_file_hier\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_verbosity_level_hier(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ verbosity) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_report_verbosity_level_hier\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_build_phase(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_build_phase\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_connect_phase(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_connect_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_start_of_simulation_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_start_of_simulation_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_end_of_elaboration_phase(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_end_of_elaboration_phase\n"); );
        }

        VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_run_phase(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_run_phase\n"); );
            // Body
            VL_KEEP_THIS;
            co_return;}

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_extract_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_extract_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_check_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_check_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_report_phase(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_report_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_final_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_final_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_reset_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_reset_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_reset_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_reset_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_reset_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_reset_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_configure_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_configure_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_configure_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_configure_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_configure_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_configure_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_main_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_main_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_main_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_main_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_main_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_main_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_shutdown_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_pre_shutdown_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_shutdown_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_shutdown_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_shutdown_phase(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_post_shutdown_phase\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_phase_started(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_phase_started\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_phase_ended(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_phase_ended\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_phase_ready_to_end(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_phase_ready_to_end\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_define_domain(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_domain> domain) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_define_domain\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> __Vtask_find_by_name__119__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_domain> __Vfunc_get_common_domain__123__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> __Vtask_find__124__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_run_phase> __Vfunc_get__126__Vfuncout;
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_domain> unnamedblk197__DOT__common;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> schedule;
            ...
            if ((VlNull{} == schedule)) {
                schedule = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_phase, vlProcess, vlSymsp, "uvm_sched"s, 3U, VlNull{});
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_domain(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_domain> domain, IData/*31:0*/ hier) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_domain\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_domain(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_domain> &get_domain__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_domain\n"); );
            // Body
            get_domain__Vfuncrtn = this->__PVT__m_domain;
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_suspend(Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_suspend\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_resume(Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_resume\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_resolve_bindings(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_resolve_bindings\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_resolve_bindings(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_resolve_bindings\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_accept_tr(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_transaction> tr, QData/*63:0*/ accept_time) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_accept_tr\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> __Vtask_get__137__Vfuncout;
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> e;
            {
                if ((VlNull{} == tr)) {
                    goto __Vlabel0;
                }
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_begin_tr(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_transaction> tr, std::string stream_name, std::string label, std::string desc, QData/*63:0*/ begin_time, IData/*31:0*/ parent_handle, IData/*31:0*/ &begin_tr__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_begin_tr\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_tr_database(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_database> &get_tr_database__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_tr_database\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__140__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_default_tr_database__141__Vfuncout;
            // Body
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk200__DOT__cs;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_tr_database(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_database> db) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_tr_database\n"); );
            // Body
            this->__PVT__tr_database = db;
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_tr_stream(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, std::string stream_type_name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_stream> &get_tr_stream__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_get_tr_stream\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_database> __Vfunc_get_tr_database__142__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_stream> __Vtask_open_stream__143__Vfuncout;
            std::string __Vfunc_get_full_name__144__Vfuncout;
            // Body
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_database> db;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_free_tr_stream(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_stream> stream) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_free_tr_stream\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_begin_tr(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_transaction> tr, IData/*31:0*/ parent_handle, std::string stream_name, std::string label, std::string desc, QData/*63:0*/ begin_time, IData/*31:0*/ &m_begin_tr__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_begin_tr\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_database> __Vfunc_get_tr_database__157__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__158__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_base> __Vtask_get_parent_sequence__159__Vfuncout;
            ...
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__163__Vfuncout;
            ...
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_get_tr_stream__167__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> __Vtask_open_recorder__168__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_parent_child_link> __Vfunc_get_link__172__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_related_link> __Vfunc_get_link__174__Vfuncout;
            IData/*31:0*/ __Vtask_get_handle__175__Vfuncout;
            __Vtask_get_handle__175__Vfuncout = 0;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> __Vtask_get__177__Vfuncout;
            VlWide<6>/*191:0*/ __Vtemp_4;
            // Body
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> unnamedblk201__DOT__seq;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_base> unnamedblk201__DOT__unnamedblk202__DOT__parent_seq;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> e;
            std::string name;
            std::string kind;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_database> db;
            ...
            link_handle = 0;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_stream> stream;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> recorder;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> parent_recorder;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> link_recorder;
            {
                if ((VlNull{} == tr)) {
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_end_tr(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_transaction> tr, QData/*63:0*/ end_time, CData/*0:0*/ free_handle) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_end_tr\n"); );
            // Locals
            IData/*31:0*/ __Vtask_get_handle__181__Vfuncout;
            __Vtask_get_handle__181__Vfuncout = 0;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> __Vtask_get__186__Vfuncout;
            // Body
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> e;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> recorder;
            {
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_record_error_tr(Vtransactions__Syms* __restrict vlSymsp, std::string stream_name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> info, std::string label, std::string desc, QData/*63:0*/ error_time, CData/*0:0*/ keep_active, IData/*31:0*/ &record_error_tr__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_record_error_tr\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_get_tr_stream__188__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> __Vtask_open_recorder__189__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_record_event_tr(Vtransactions__Syms* __restrict vlSymsp, std::string stream_name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> info, std::string label, std::string desc, QData/*63:0*/ event_time, CData/*0:0*/ keep_active, IData/*31:0*/ &record_event_tr__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_record_event_tr\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_get_tr_stream__196__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_recorder> __Vtask_open_recorder__197__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_accept_tr(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_transaction> tr) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_accept_tr\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_begin_tr(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_transaction> tr, std::string stream_name, IData/*31:0*/ tr_handle) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_begin_tr\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_end_tr(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_transaction> tr, IData/*31:0*/ tr_handle) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_end_tr\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_massage_scope(Vtransactions__Syms* __restrict vlSymsp, std::string scope, std::string &massage_scope__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_massage_scope\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_use_automatic_config(Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ &use_automatic_config__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_use_automatic_config\n"); );
            // Body
            use_automatic_config__Vfuncrtn = 1U;
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_apply_config_settings(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ verbose) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_apply_config_settings\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__207__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz22> __Vtask_lookup_scope__208__Vfuncout;
            std::string __Vfunc_get_full_name__209__Vfuncout;
            IData/*31:0*/ __Vtask_size__211__Vfuncout;
            __Vtask_size__211__Vfuncout = 0;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_base> __Vtask_get__212__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_print_config(Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ recurse, CData/*0:0*/ audit) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_print_config\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__216__Vfuncout;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz22> __Vtask_lookup_scope__219__Vfuncout;
            std::string __Vfunc_get_full_name__220__Vfuncout;
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> unnamedblk204__DOT__c;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_print_config_with_audit(Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ recurse) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_print_config_with_audit\n"); );
            // Body
            this->__VnoInFunc_print_config(vlSymsp, recurse, 1U);
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_print(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer> printer) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_print\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_local(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_base> rsrc) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_set_local\n"); );
            // Locals
            ...
            // Body
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz23> unnamedblk206__DOT_____05Ftmp_rsrc___05F;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz21> unnamedblk207__DOT_____05Ftmp_rsrc___05F;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_> unnamedblk208__DOT_____05Ftmp_rsrc___05F;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz24> unnamedblk209__DOT_____05Ftmp_rsrc___05F;
            CData/*0:0*/ success;
            success = 0;
                    ...
                    this->__PVT__recording_detail = (IData)(
                                ...
                                VL_NULL_CHECK(unnamedblk206__DOT_____05Ftmp_rsrc___05F, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_component.svh", 3009)
                                                             ->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, __Vtask_read__230__Vfuncout);
                        ...
                        this->__PVT__recording_detail 
                            = VL_SEL_IWII(4096, ([&]() {
                                    VL_NULL_CHECK(unnamedblk207__DOT_____05Ftmp_rsrc___05F, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_component.svh", 3009)
                                                 ->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, __Vtask_read__231__Vfuncout);
                ...
                if ((1U & (~ (IData)(success)))) {
                    ...
                    if (success) {
                        VL_NULL_CHECK(unnamedblk208__DOT_____05Ftmp_rsrc___05F, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_component.svh", 3009)
                                           ->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                              VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, __Vtask_read__232__Vfuncout);
                        this->__PVT__recording_detail 
                ...
                if ((1U & (~ (IData)(success)))) {
                    ...
                    if (success) {
                        VL_NULL_CHECK(unnamedblk209__DOT_____05Ftmp_rsrc___05F, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_component.svh", 3009)
                                           ->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                              VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this}, __Vtask_read__233__Vfuncout);
                        this->__PVT__recording_detail 
            ...
            if ((1U & (~ (IData)(success)))) {
                Vtransactions_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_local(vlProcess, vlSymsp, rsrc);
            }
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_unsupported_set_local(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource_base> rsrc) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_unsupported_set_local\n"); );
            // Body
            this->__PVT__m_unsupported_resource_base 
                = rsrc;
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_msg_args(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_msg_args\n"); );
            // Locals
            VlClassRef<Vtransactions_std__03a__03aprocess> __Vfunc_self__235__Vfuncout;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_verb(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_verb\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_cmdline_processor> __Vfunc_get_inst__243__Vfuncout;
            ...
            VlClassRef<Vtransactions_std__03a__03aprocess> __Vfunc_self__258__Vfuncout;
            std::string __Vtemp_1;
            // Body
            VlQueue<std::string> unnamedblk210__DOT__t;
            Vtransactions_m_verbosity_setting__struct__0 unnamedblk210__DOT__setting;
            ...
            Vtransactions_m_verbosity_setting__struct__0 unnamedblk212__DOT__unnamedblk213__DOT__setting;
            ...
            VlClassRef<Vtransactions_std__03a__03aprocess> unnamedblk214__DOT____VforkParent;
            ...
            while (VL_LTS_III(32, unnamedblk212__DOT__i, vlSymsp->TOP__uvm_pkg__03a__03auvm_component__Vclpkg.__PVT__m_set_cl_verb__Vstatic__values.size())) {
                ...
                if ((("time"s == unnamedblk212__DOT__unnamedblk213__DOT__setting
                      .__PVT__phase) & (VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this} 
                                        == top))) {
            ...
            if ((VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>{this} 
                 == top)) {
        ...
        VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_verb____Vfork_1__0(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_root> top, VlClassRef<Vtransactions_std__03a__03aprocess> unnamedblk214__DOT____VforkParent) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_verb____Vfork_1__0\n"); );
            // Locals
            VlClassRef<Vtransactions_std__03a__03aprocess> __Vtask___VforkTask_0__259____VforkParent;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_root> __Vtask___VforkTask_0__259__top;
            IData/*31:0*/ __Vtask___VforkTask_0__259__unnamedblk216__DOT__i;
            __Vtask___VforkTask_0__259__unnamedblk216__DOT__i = 0;
            VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>> __Vtask___VforkTask_0__259__unnamedblk216__DOT__unnamedblk217__DOT__comps;
            ...
            if (VL_LTS_III(32, 0U, vlSymsp->TOP__uvm_pkg__03a__03auvm_component__Vclpkg.__PVT__m_time_settings.size())) {
                vlSymsp->TOP__uvm_pkg__03a__03auvm_component__Vclpkg.__PVT__m_time_settings.sort(
                                                                                ...
                                                                                Vtransactions_m_verbosity_setting__struct__0 item) -> 
                                                                                QData/*63:0*/ {
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_action(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_action\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_cmdline_processor> __Vfunc_get_inst__264__Vfuncout;
            ...
            Vtransactions_uvm_cmdline_parsed_arg_t__struct__0 unnamedblk220__DOT__unnamedblk221__DOT__unnamedblk222__DOT__t;
            ...
            IData/*31:0*/ action;
            action = 0;
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_cmdline_processor> uvm_cmdline_proc;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_sev(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_set_cl_sev\n"); );
            // Locals
            VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_cmdline_processor> __Vfunc_get_inst__290__Vfuncout;
            ...
            Vtransactions_uvm_cmdline_parsed_arg_t__struct__0 unnamedblk225__DOT__unnamedblk226__DOT__unnamedblk227__DOT__t;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_apply_verbosity_settings(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_apply_verbosity_settings\n"); );
            // Locals
            std::string __Vtask_get_name__317__Vfuncout;
            VlClassRef<Vtransactions_std__03a__03aprocess> __Vfunc_self__320__Vfuncout;
            std::string __Vtask_get_randstate__321__Vfuncout;
            VlClassRef<Vtransactions_std__03a__03aprocess> __Vfunc_self__322__Vfuncout;
            // Body
            VlClassRef<Vtransactions_std__03a__03aprocess> unnamedblk230__DOT__p;
            std::string unnamedblk230__DOT__p_rand;
            VlClassRef<Vtransactions_std__03a__03aprocess> unnamedblk230__DOT__unnamedblk231__DOT____VforkParent;
            IData/*31:0*/ i;
            i = 0;
        ...
        VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_apply_verbosity_settings____Vfork_2__0(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ i, VlClassRef<Vtransactions_std__03a__03aprocess> unnamedblk230__DOT__unnamedblk231__DOT____VforkParent) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_apply_verbosity_settings____Vfork_2__0\n"); );
            // Locals
            VlClassRef<Vtransactions_std__03a__03aprocess> __Vtask___VforkTask_1__323____VforkParent;
            IData/*31:0*/ __Vtask___VforkTask_1__323__i;
            __Vtask___VforkTask_1__323__i = 0;
            Vtransactions_m_verbosity_setting__struct__0 __Vtask___VforkTask_1__323__setting;
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_do_pre_abort(Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_do_pre_abort\n"); );
            // Body
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc_randomize\n"); );
            // Locals
        ...
        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc___Vsetup_constraints\n"); );
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::__VnoInFunc___VBasicRand\n"); );
            // Body
            __VBasicRand__Vfuncrtn = 1U;
        }

        void Vtransactions_uvm_pkg__03a__03auvm_component::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::_ctor_var_reset\n"); );
            // Body
        ...
        Vtransactions_uvm_pkg__03a__03auvm_component::~Vtransactions_uvm_pkg__03a__03auvm_component() {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::~\n"); );
        }

        std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>& obj) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::VL_TO_STRING\n"); );
            // Body
            return (obj ? obj->to_string() : "null");
        }

        std::string Vtransactions_uvm_pkg__03a__03auvm_component::to_string() const {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::to_string\n"); );
            // Body
            return ("'{"s + to_string_middle() + "}");
        }

        std::string Vtransactions_uvm_pkg__03a__03auvm_component::to_string_middle() const {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_component::to_string_middle\n"); );
            // Body
            std::string out;
