...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_REPORT_MESSAGE_STRING_ELEMENT__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_REPORT_MESSAGE_STRING_ELEMENT__VCLPKG_H_  // guard
...
class Vtransactions_uvm_pkg__03a__03auvm_report_message_string_element : public Vtransactions_uvm_pkg__03a__03auvm_report_message_element_base {
  public:
    ...
    virtual void __VnoInFunc_get_value(Vtransactions__Syms* __restrict vlSymsp, std::string &get_value__Vfuncrtn);
    virtual void __VnoInFunc_set_value(Vtransactions__Syms* __restrict vlSymsp, std::string value);
  private:
