...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_POOL__TZ50_TBZ51__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_POOL__TZ50_TBZ51__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz51__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_global(Vtransactions__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz51> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz97> &get_type__Vfuncrtn);
...
class Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz51 : public Vtransactions_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get__Vfuncrtn);
