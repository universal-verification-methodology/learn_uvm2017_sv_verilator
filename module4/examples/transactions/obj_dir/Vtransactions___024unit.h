...
#ifndef VERILATED_VTRANSACTIONS___024UNIT_H_
#define VERILATED_VTRANSACTIONS___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtransactions___024unit(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions___024unit();
    VL_UNCOPYABLE(Vtransactions___024unit);
