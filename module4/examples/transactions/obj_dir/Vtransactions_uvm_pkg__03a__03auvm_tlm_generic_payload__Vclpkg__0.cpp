...
void Vtransactions_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_print(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer> printer) {
    ...
    VL_NULL_CHECK(printer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/tlm2/uvm_tlm2_generic_payload.svh", 392)->__VnoInFunc_print_generic(vlProcess, vlSymsp, "command"s, "uvm_tlm_command_e"s, 0x00000020U, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                Vtransactions___024unit::__Venumtab_enum_name61
                                                                                [
                                                                                (3U 
    ...
    VL_NULL_CHECK(printer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/tlm2/uvm_tlm2_generic_payload.svh", 393)->__VnoInFunc_print_generic(vlProcess, vlSymsp, "response_status"s, "uvm_tlm_response_status_e"s, 0x00000020U, 
                                                                                VL_CVT_PACK_STR_NN(Vtransactions___024unit::__Venumtab_enum_name63
...
void Vtransactions_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_compare(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    ...
    if ((((1U & (~ (0U != ([&]() {
        ...
        __Vtemp_1 = Vtransactions___024unit::__Venumtab_enum_name61
            [(3U & this->__PVT__m_command)];
        __Vtemp_2 = Vtransactions___024unit::__Venumtab_enum_name61
    ...
    if ((((1U & (~ (0U != ([&]() {
        ...
        __Vtemp_3 = Vtransactions___024unit::__Venumtab_enum_name63
            .at(this->__PVT__m_response_status);
        __Vtemp_4 = Vtransactions___024unit::__Venumtab_enum_name63
                    ...
                    unnamedblk18__DOT__unnamedblk19__DOT__rhs_ext 
                        = (VL_NULL_CHECK(gp, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/tlm2/uvm_tlm2_generic_payload.svh", 510)
                           ...
                           ->__PVT__m_extensions.at(unnamedblk18__DOT__unnamedblk19__DOT__ext)
                            : VlNull{});
                    VL_NULL_CHECK(comparer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/tlm2/uvm_tlm2_generic_payload.svh", 513)->__VnoInFunc_compare_object(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
    ...
    unnamedblk45__DOT__ext__Vfirst = 0;
    {
        ...
        if (((VlNull{} != recorder) && ([&]() {
            ...
            if (([&]() {
                ...
                __Vtemp_2 = Vtransactions___024unit::__Venumtab_enum_name63
                    .at(this->__PVT__m_response_status);
...
void Vtransactions_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc___Vbasic_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc___Vbasic_randomize\n"); );
    // Locals
