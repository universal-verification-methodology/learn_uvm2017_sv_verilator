    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        if ((VlNull{} == blk_parent)) {
            ...
            void Vtransactions_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
                ...
                // Body
                VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz50> unnamedblk392__DOT__hdl_paths;
            ...
            void Vtransactions_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vsetup_constraints\n"); );
            }

            void Vtransactions_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___VBasicRand\n"); );
                // Body
            ...
            Vtransactions_uvm_pkg__03a__03auvm_reg_file::~Vtransactions_uvm_pkg__03a__03auvm_reg_file() {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_reg_file::~\n"); );
            }
