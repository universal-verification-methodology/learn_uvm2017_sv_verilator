...
#include "Vtransactions__Syms.h"


VL_ATTR_COLD void Vtransactions___024root__trace_init_sub__TOP__uvm_pkg__0(Vtransactions___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void Vtransactions___024root__trace_init_sub__TOP__0(Vtransactions___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_init_sub__TOP__0\n"); );
    ...
    Vtransactions___024root__trace_init_sub__TOP__uvm_pkg__0(vlSelf, tracep);
    tracep->popPrefix();
}

VL_ATTR_COLD void Vtransactions___024root__trace_init_sub__TOP__uvm_pkg__0(Vtransactions___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_init_sub__TOP__uvm_pkg__0\n"); );
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const int c = vlSymsp->__Vm_baseCode;
...
VL_ATTR_COLD void Vtransactions___024root__trace_init_top(Vtransactions___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_init_top\n"); );
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vtransactions___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vtransactions___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vtransactions___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vtransactions___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vtransactions___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vtransactions___024root__trace_register(Vtransactions___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_register\n"); );
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vtransactions___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vtransactions___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vtransactions___024root__trace_chg_0, 0, vlSelf);
    tracep->addCleanupCb(&Vtransactions___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vtransactions___024root__trace_const_0_sub_0(Vtransactions___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vtransactions___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_const_0\n"); );
    // Body
    Vtransactions___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtransactions___024root*>(voidSelf);
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vtransactions___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vtransactions___024root__trace_const_0_sub_0(Vtransactions___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_const_0_sub_0\n"); );
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtransactions___024root__trace_full_0_sub_0(Vtransactions___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vtransactions___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_full_0\n"); );
    // Body
    Vtransactions___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtransactions___024root*>(voidSelf);
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vtransactions___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vtransactions___024root__trace_full_0_sub_0(Vtransactions___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtransactions___024root__trace_full_0_sub_0\n"); );
    Vtransactions__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
