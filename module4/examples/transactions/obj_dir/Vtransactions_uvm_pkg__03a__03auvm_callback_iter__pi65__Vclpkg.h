...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_CALLBACK_ITER__PI65__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_CALLBACK_ITER__PI65__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_callback_iter__pi65__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_callback_iter__pi65__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions_uvm_pkg__03a__03auvm_callback_iter__pi65__Vclpkg();
    VL_UNCOPYABLE(Vtransactions_uvm_pkg__03a__03auvm_callback_iter__pi65__Vclpkg);
...
class Vtransactions_uvm_pkg__03a__03auvm_callback_iter__pi65 : public virtual VlClass {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_i;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_reg> __PVT__m_obj;
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_callback_iter__pi65(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_reg> obj);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vtransactions_uvm_pkg__03a__03auvm_callback_iter__pi65() {}
};
