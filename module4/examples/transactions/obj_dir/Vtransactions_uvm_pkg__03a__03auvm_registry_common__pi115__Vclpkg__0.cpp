...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    {
...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_create(Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_pool__Tz50_TBz149> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> __Vfunc_get__3__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_set_type_override(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> __Vfunc_get__11__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_set_inst_override(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_set_type_alias(Vtransactions__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> unnamedblk2__DOT__rgtry;
...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> rgtry;
...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::__VnoInFunc_get_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::__VnoInFunc_initialize(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz190> __Vfunc_get__2__Vfuncout;
    // Body
...
Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi115::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
