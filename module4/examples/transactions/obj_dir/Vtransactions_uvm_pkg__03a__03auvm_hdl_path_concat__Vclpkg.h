...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_hdl_path_concat__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_hdl_path_concat__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
