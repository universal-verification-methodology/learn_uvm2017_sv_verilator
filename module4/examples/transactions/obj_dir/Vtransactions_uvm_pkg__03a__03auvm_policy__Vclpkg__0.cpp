...
void Vtransactions_uvm_pkg__03a__03auvm_policy::__VnoInFunc___Vbasic_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_policy::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
