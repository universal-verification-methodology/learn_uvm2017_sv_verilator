...
void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143, vlProcess, vlSymsp);
...
void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg::__VnoInFunc_m_cb_find_name(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg::__VnoInFunc_display(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_mem> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_mem> me;
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_am_i_a(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_am_i_a\n"); );
        // Body
        VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_mem> this_type;
        {
            if ((VlNull{} == obj)) {
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_get_tw_cb_q(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Locals
            ...
            if (([&]() {
                ...
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Vtransactions_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    ...
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143>{this}))) {
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_add_tw_cbs(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Vtransactions_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            ...
            if ((cb_pair != VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143>{this})) {
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_delete_tw_cbs(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
    ...
    Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp)
      : Vtransactions_uvm_pkg__03a__03auvm_callbacks_base(vlProcess, vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::new\n"); );
        // Body
        _ctor_var_reset(vlSymsp);
        ;
    }

    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc___Vbasic_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::__VnoInFunc___Vbasic_randomize\n"); );
        // Body
        __Vbasic_randomize__Vfuncrtn = 1U;
    }

    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::_ctor_var_reset\n"); );
        // Body
        (void)vlSymsp;  // Prevent unused variable warning
    }

    std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz143::to_string_middle\n"); );
        // Body
        std::string out;
