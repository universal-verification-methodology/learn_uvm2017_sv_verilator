...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_MEM_SHARED_ACCESS_SEQ__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_MEM_SHARED_ACCESS_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_mem_shared_access_seq__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_mem_shared_access_seq__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions_uvm_pkg__03a__03auvm_mem_shared_access_seq__Vclpkg();
    VL_UNCOPYABLE(Vtransactions_uvm_pkg__03a__03auvm_mem_shared_access_seq__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__pi162> &get_type__Vfuncrtn);
...
class Vtransactions_uvm_pkg__03a__03auvm_mem_shared_access_seq : public Vtransactions_uvm_pkg__03a__03auvm_reg_sequence__Tz285 {
  public:
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_mem_shared_access_seq(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtransactions_uvm_pkg__03a__03auvm_mem_shared_access_seq() {}
};
