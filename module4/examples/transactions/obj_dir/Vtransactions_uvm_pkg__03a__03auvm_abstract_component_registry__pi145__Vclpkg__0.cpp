...
void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_create(Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_agent> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_agent> __Vfunc_create__2__Vfuncout;
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_set_type_override(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_set_inst_override(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_set_type_alias(Vtransactions__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::__VnoInFunc_get_type_name(Vtransactions__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi172> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi172> common;
...
void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::__VnoInFunc_initialize(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi172> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi172> common;
...
Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145(Vtransactions__Syms* __restrict vlSymsp)
    : Vtransactions_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::~Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtransactions_uvm_pkg__03a__03auvm_abstract_component_registry__pi145::to_string_middle\n"); );
    // Body
    std::string out;
