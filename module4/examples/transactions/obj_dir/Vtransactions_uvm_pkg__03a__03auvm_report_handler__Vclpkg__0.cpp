...
void Vtransactions_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_do_print(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_printer> printer) {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        ...
                        if ((0U != (Vtransactions___024unit::__Venumtab_enum_valid25
                            ...
                            __Vtemp_2 = Vtransactions___024unit::__Venumtab_enum_name21
                                [l_severity];
                            ...
                            unnamedblk2__DOT__unnamedblk4__DOT__unnamedblk5__DOT__l_str 
                                = VL_SFORMATF_N_NX("%0d",0,
                                                   32,
                                                   l_int) ;
                            __Vtemp_3 = Vtransactions___024unit::__Venumtab_enum_name21
                                [l_severity];
        ...
        if ((0U != this->__PVT__severity_id_actions.first(l_severity))) {
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        __Vtemp_5 = Vtransactions___024unit::__Venumtab_enum_name21
                            [l_severity];
    ...
    if ((0U != ([&]() {
        ...
        do {
            ...
            __Vtemp_6 = Vtransactions___024unit::__Venumtab_enum_name21
                [l_severity];
            ...
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        ...
                        __Vtemp_7 = Vtransactions___024unit::__Venumtab_enum_name21
                            [l_severity];
    ...
    if ((0U != this->__PVT__severity_file_handles.first(l_severity))) {
        ...
        do {
            __Vtemp_10 = Vtransactions___024unit::__Venumtab_enum_name21
                [l_severity];
        ...
        if ((0U != this->__PVT__severity_id_file_handles.first(l_severity))) {
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        __Vtemp_12 = Vtransactions___024unit::__Venumtab_enum_name21
                            [l_severity];
...
void Vtransactions_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vtransactions_uvm_pkg__03a__03auvm_report_handler::~Vtransactions_uvm_pkg__03a__03auvm_report_handler() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_report_handler::~\n"); );
}
