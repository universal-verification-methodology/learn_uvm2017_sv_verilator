...
Vtransactions_uvm_pkg__03a__03auvm_heartbeat::Vtransactions_uvm_pkg__03a__03auvm_heartbeat(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> cntxt, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_objection> objection)
    : Vtransactions_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::new\n"); );
    // Locals
    ...
    this->__PVT__m_cntxt = ((VlNull{} != cntxt) ? cntxt
                             : (VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>)(
                                                                                ([&]() {
    ...
    this->__PVT__m_cb = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_heartbeat_callback, vlProcess, vlSymsp, 
                               VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(name, "_cb"s)), this->__PVT__m_cntxt);
}

void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ mode, IData/*31:0*/ &set_mode__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> e, VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>> &comps) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat\n"); );
    // Body
    IData/*31:0*/ unnamedblk1__DOT__i;
    unnamedblk1__DOT__i = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> c;
    {
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add\n"); );
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> c;
    {
        c = comp;
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove\n"); );
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> c;
    c = comp;
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_event_> e) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop\n"); );
    // Body
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process\n"); );
    // Locals
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process____Vfork_1__0(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_std__03a__03aprocess> unnamedblk2__DOT____VforkParent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process____Vfork_1__0\n"); );
    // Locals
    VlClassRef<Vtransactions_std__03a__03aprocess> __Vtask___VforkTask_0__15____VforkParent;
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_enable_cb(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_enable_cb\n"); );
    // Locals
    ...
    // Body
    {
        ...
        if ((1U & (~ (IData)(this->__PVT__m_added)))) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz46_TBz138__Vclpkg.__VnoInFunc_add(vlSymsp, this->__PVT__m_objection, this->__PVT__m_cb, 0U);
        }
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_disable_cb(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_disable_cb\n"); );
    // Locals
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process\n"); );
    // Body
    VL_KEEP_THIS;
    VlClassRef<Vtransactions_uvm_pkg__03a__03a__VDynScope_34> __VDynScope_m_hb_process_2;
    __VDynScope_m_hb_process_2 = VL_NEW(Vtransactions_uvm_pkg__03a__03a__VDynScope_34, vlSymsp);
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__1(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlForkSync __Vfork_2__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__1\n"); );
    // Body
    VL_KEEP_THIS;
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__0(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03a__VDynScope_34> __VDynScope_m_hb_process_2, VlForkSync __Vfork_2__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__0\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03a__VDynScope_34> __Vtask___VforkTask_1__22____VDynScope_m_hb_process_2;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_1__22__unnamedblk3__DOT__idx;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_1__22__unnamedblk4__DOT__unnamedblk5__DOT__idx;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_1__22__unnamedblk6__DOT__unnamedblk7__DOT__idx;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_1__22__unnamedblk8__DOT__unnamedblk9__DOT__idx;
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtransactions_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset\n"); );
    // Body
...
Vtransactions_uvm_pkg__03a__03auvm_heartbeat::~Vtransactions_uvm_pkg__03a__03auvm_heartbeat() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_heartbeat>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_heartbeat::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_heartbeat::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_heartbeat::to_string_middle\n"); );
    // Body
    std::string out;
