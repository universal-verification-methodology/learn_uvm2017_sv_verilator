...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI189__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI189__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vtransactions__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189__Vclpkg();
    VL_UNCOPYABLE(Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189__Vclpkg);
    ...
    void __VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189> &get__Vfuncrtn);
...
class Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189 : public virtual VlClass {
  public:
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189(Vtransactions__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi189() {}
};
