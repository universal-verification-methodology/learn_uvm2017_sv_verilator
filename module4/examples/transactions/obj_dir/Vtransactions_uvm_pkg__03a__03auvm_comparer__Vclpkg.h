...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_COMPARER__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_COMPARER__VCLPKG_H_  // guard
...
class Vtransactions_uvm_pkg__03a__03auvm_object_registry__pi3;
...
struct Vtransactions_state_info_t__struct__0 {
    IData/*31:0*/ __PVT__state;
    CData/*0:0*/ __PVT__ret_val;

    bool operator==(const Vtransactions_state_info_t__struct__0& rhs) const {
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_comparer__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_default(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_comparer> &get_default__Vfuncrtn);
    void __VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__pi3> &get_type__Vfuncrtn);
    void __VnoInFunc_set_default(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_comparer> comparer);
...
class Vtransactions_uvm_pkg__03a__03auvm_comparer : public Vtransactions_uvm_pkg__03a__03auvm_policy {
  public:
    ...
    VlAssocArray<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object>, VlAssocArray<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object>, VlAssocArray<IData/*27:0*/, Vtransactions_state_info_t__struct__0>>> __PVT__m_recur_states;
    ...
    virtual void __VnoInFunc_compare_object(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> rhs, CData/*0:0*/ &compare_object__Vfuncrtn);
    virtual void __VnoInFunc_compare_string(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string name, std::string lhs, std::string rhs, CData/*0:0*/ &compare_string__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_check_type(Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ &get_check_type__Vfuncrtn);
    virtual void __VnoInFunc_get_miscompares(Vtransactions__Syms* __restrict vlSymsp, std::string &get_miscompares__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_result(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &get_result__Vfuncrtn);
    virtual void __VnoInFunc_get_severity(Vtransactions__Syms* __restrict vlSymsp, CData/*1:0*/ &get_severity__Vfuncrtn);
    virtual void __VnoInFunc_get_show_max(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &get_show_max__Vfuncrtn);
    ...
    virtual void __VnoInFunc_object_compared(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> rhs, IData/*27:0*/ recursion, CData/*0:0*/ &ret_val, IData/*31:0*/ &object_compared__Vfuncrtn);
    void __VnoInFunc_print_msg(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string msg);
    void __VnoInFunc_print_msg_object(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> rhs);
    virtual void __VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn);
    virtual void __VnoInFunc_set_check_type(Vtransactions__Syms* __restrict vlSymsp, CData/*0:0*/ enabled);
    virtual void __VnoInFunc_set_recursion_policy(Vtransactions__Syms* __restrict vlSymsp, IData/*27:0*/ policy);
    virtual void __VnoInFunc_set_result(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ result);
    virtual void __VnoInFunc_set_severity(Vtransactions__Syms* __restrict vlSymsp, CData/*1:0*/ severity);
    virtual void __VnoInFunc_set_show_max(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ show_max);
    virtual void __VnoInFunc_set_threshold(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ threshold);
    virtual void __VnoInFunc_set_verbosity(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ verbosity);
  private:
