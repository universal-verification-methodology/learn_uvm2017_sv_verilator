...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03am_uvm_tr_stream_cfg__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03am_uvm_tr_stream_cfg__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
