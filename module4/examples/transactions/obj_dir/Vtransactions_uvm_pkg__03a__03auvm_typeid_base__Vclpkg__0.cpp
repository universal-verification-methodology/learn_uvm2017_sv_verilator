...
Vtransactions_uvm_pkg__03a__03auvm_typeid_base::~Vtransactions_uvm_pkg__03a__03auvm_typeid_base() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_typeid_base::~\n"); );
}
