...
#ifndef VERILATED_VTRANSACTIONS___024UNIT__03A__03ACONSTRAINEDTRANSACTION__VCLPKG_H_
#define VERILATED_VTRANSACTIONS___024UNIT__03A__03ACONSTRAINEDTRANSACTION__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions___024unit__03a__03aConstrainedTransaction__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_type(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object_registry__Tz5_TBz6> &get_type__Vfuncrtn);
...
class Vtransactions___024unit__03a__03aConstrainedTransaction : public Vtransactions_uvm_pkg__03a__03auvm_sequence_item {
  public:
    ...
    void __VnoInFunc_data_nonzero_setup_constraint(Vtransactions__Syms* __restrict vlSymsp);
