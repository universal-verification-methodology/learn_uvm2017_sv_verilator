...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz78> __Vtask_m_initialize__0__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typeid__Tz62> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typeid__Tz137> __Vfunc_get__2__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typeid__Tz78> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78> __Vfunc_get__5__Vfuncout;
    ...
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typeid_base> unnamedblk1__DOT__cb_base_type;
    if ((VlNull{} == this->__PVT__m_inst)) {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz62__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__1__Vfuncout);
        unnamedblk1__DOT__cb_base_type = __Vfunc_get__1__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz137__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__2__Vfuncout);
        ...
        this->__PVT__m_inst = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137, vlProcess, vlSymsp);
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
                          == this->__PVT__m_cb_typeid)))) {
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz78_TBz137.get.unnamedblk1: '$cast' failed.\n",0,
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_m_register_pair(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_m_register_pair\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vfunc_get__11__Vfuncout;
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> inst;
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_add(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_add\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__12__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> __Vtask_get__35__Vfuncout;
    IData/*31:0*/ __Vtask_size__38__Vfuncout;
    __Vtask_size__38__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78> __Vtask_get__39__Vfuncout;
    IData/*31:0*/ __Vtask_size__40__Vfuncout;
    __Vtask_size__40__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__42__Vfuncout;
    IData/*31:0*/ __Vtask_size__43__Vfuncout;
    __Vtask_size__43__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__45__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> unnamedblk2__DOT__o;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> unnamedblk2__DOT__unnamedblk3__DOT__qr;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> q;
    std::string nm;
    std::string tnm;
    {
        ...
        if ((VlNull{} == obj)) {
            ...
            if ((VlNull{} == q)) {
                q = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62, vlProcess, vlSymsp, ""s);
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_add_by_name(Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> root, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_add_by_name\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__58__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__68__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_root> __Vtask_get_root__69__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    IData/*31:0*/ unnamedblk6__DOT__i;
    unnamedblk6__DOT__i = 0;
    VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component>> cq;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_root> top;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_coreservice_t> cs;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> t;
    {
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_delete(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_delete\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__72__Vfuncout;
    CData/*0:0*/ __Vtask_m_delete_tw_cbs__73__Vfuncout;
    __Vtask_m_delete_tw_cbs__73__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> __Vtask_get__74__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> b_obj;
    b_obj = obj;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> q;
    CData/*0:0*/ found;
    found = 0;
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_delete_by_name(Vtransactions__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component> root) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_delete_by_name\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__83__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_m_get_q(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> &q, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_m_get_q\n"); );
    // Locals
    IData/*31:0*/ __Vtask_exists__93__Vfuncout;
    __Vtask_exists__93__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> __Vtask_get__94__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> __Vtask_m_get_tw_cb_q__97__Vfuncout;
    // Body
    if ((0U != ([&]() {
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_first(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> &get_first__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_first\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__98__Vfuncout;
    IData/*31:0*/ __Vtask_size__100__Vfuncout;
    __Vtask_size__100__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__101__Vfuncout;
    CData/*0:0*/ __Vtask_callback_mode__102__Vfuncout;
    __Vtask_callback_mode__102__Vfuncout = 0;
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> q;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> cb;
    {
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_last(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> &get_last__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_last\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__103__Vfuncout;
    IData/*31:0*/ __Vtask_size__105__Vfuncout;
    __Vtask_size__105__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__106__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_next(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> &get_next__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_next\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__108__Vfuncout;
    IData/*31:0*/ __Vtask_size__110__Vfuncout;
    __Vtask_size__110__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__111__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_prev(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> &get_prev__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_prev\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__113__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__115__Vfuncout;
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_all(Vtransactions__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher>> &all_callbacks, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_get_all\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__117__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__120__Vfuncout;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> __Vtask_get__121__Vfuncout;
    IData/*31:0*/ __Vtask_size__122__Vfuncout;
    __Vtask_size__122__Vfuncout = 0;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> __Vtask_get__123__Vfuncout;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> q;
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> cb;
    VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher>> callbacks_to_append;
    VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher>> unique_callbacks_to_append;
    ...
    unique_callbacks_to_append = callbacks_to_append.unique(
                                                            [&](
                                                                ...
                                                                VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> cb_) -> 
                                                            IData/*31:0*/ {
            return (([&]() {
    ...
    all_callbacks = VlQueue<VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher>>::consCC(unique_callbacks_to_append, 
                                                                                all_callbacks);
}

void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_display(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137__Vclpkg::__VnoInFunc_display\n"); );
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137> __Vtask_get__125__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc_m_is_registered(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_registered__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc_m_is_registered\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc_m_is_for_me(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_for_me__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc_m_is_for_me\n"); );
    // Body
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_report_catcher> this_cb;
    m_is_for_me__Vfuncrtn = (1U & VL_CAST_DYNAMIC(cb, this_cb));
}

Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp)
    : Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz78(vlProcess, vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_registered = 0;
}

Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::~Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_callbacks__Tz78_TBz137::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_registered:" + VL_TO_STRING(__PVT__m_registered);
    out += ", "+ Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz78::to_string_middle();
    return (out);
}
