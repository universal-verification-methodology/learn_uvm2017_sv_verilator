...
void Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_stop_sequences(Vtransactions__Syms* __restrict vlSymsp) {
    ...
    if ((0U != ([&]() {
                    VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 170)
        ...
        VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 172)->__VnoInFunc_flush(vlSymsp);
    }
}
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get_next_item(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> &t) {
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> __Vtask_peek__19__t;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    ...
    co_await VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 222)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__19__t);
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_try_next_item(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> &t) {
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> __Vtask_try_peek__30__t;
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_base> seq;
    {
        ...
        co_await this->__VnoInFunc_wait_for_sequences(vlProcess, vlSymsp);
        if ((1U & (~ ([&]() {
                            VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 264)
...
void Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_item_done(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> item) {
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> __Vtask_try_get__36__t;
    ...
    this->__PVT__get_next_item_called = 0U;
    if (([&]() {
                VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 283)
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> &t) {
    ...
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> __Vtask_peek__44__t;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    if ((1U & (~ (IData)(this->__PVT__sequence_item_requested)))) {
    ...
    this->__PVT__sequence_item_requested = 1U;
    co_await VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 316)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__44__t);
...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_peek(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> &t) {
    ...
    // Locals
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_sequence_item> __Vtask_peek__47__t;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    if ((1U & (~ (IData)(this->__PVT__sequence_item_requested)))) {
    ...
    this->__PVT__sequence_item_requested = 1U;
    co_await VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 333)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__47__t);
...
void Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc___Vbasic_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
