...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__TZ251__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__TZ251__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vtransactions__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251__Vclpkg(Vtransactions__Syms* symsp, const char* v__name);
    ~Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251__Vclpkg();
    VL_UNCOPYABLE(Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251__Vclpkg);
    ...
    void __VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251> &get__Vfuncrtn);
...
class Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251 : public Vtransactions_uvm_pkg__03a__03auvm_object_wrapper {
  public:
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251(Vtransactions__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtransactions_uvm_pkg__03a__03auvm_component_registry__Tz251() {}
};
