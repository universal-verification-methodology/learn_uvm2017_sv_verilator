...
void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46, vlProcess, vlSymsp);
...
void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg::__VnoInFunc_m_cb_find_name(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg::__VnoInFunc_display(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_objection> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_objection> me;
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_am_i_a(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_am_i_a\n"); );
        // Body
        VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_objection> this_type;
        {
            if ((VlNull{} == obj)) {
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_get_tw_cb_q(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Locals
            ...
            if (([&]() {
                ...
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Vtransactions_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    ...
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46>{this}))) {
                ...
                m_get_tw_cb_q__Vfuncrtn = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__PVT__m_tw_cb_q;
            } else {
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_add_tw_cbs(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_queue__Tz62> q;
        if ((0xffffffffU == ([&]() {
                        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__2__Vfuncout);
                    }(), __Vfunc_m_cb_find__2__Vfuncout))) {
            warned = (1U & ([&]() {
                        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__VnoInFunc_m_cb_find_name(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__PVT__m_tw_cb_q, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
            ...
            if ((0U == ordering)) {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 256)
                        ->__VnoInFunc_push_back(vlSymsp, cb);
            } else {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 258)
        ...
        if ((0U != ([&]() {
            ...
            do {
                if (VL_CAST_DYNAMIC(obj, me)) {
                    ...
                    if ((0xffffffffU == ([&]() {
                                    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__11__Vfuncout);
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Vtransactions_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            ...
            if ((cb_pair != VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46>{this})) {
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_delete_tw_cbs(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
        ...
        IData/*31:0*/ pos;
        pos = 0;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__19__Vfuncout);
        pos = __Vfunc_m_cb_find__19__Vfuncout;
        if ((0xffffffffU != pos)) {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 296)
        ...
        if ((0U != ([&]() {
            ...
            do {
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz46__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__25__Vfuncout);
    ...
    Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp)
      : Vtransactions_uvm_pkg__03a__03auvm_callbacks_base(vlProcess, vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::new\n"); );
        // Body
        _ctor_var_reset(vlSymsp);
        ;
    }

    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc___Vbasic_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::__VnoInFunc___Vbasic_randomize\n"); );
        // Body
        __Vbasic_randomize__Vfuncrtn = 1U;
    }

    void Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::_ctor_var_reset(Vtransactions__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::_ctor_var_reset\n"); );
        // Body
        (void)vlSymsp;  // Prevent unused variable warning
    }

    std::string VL_TO_STRING(const VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtransactions_uvm_pkg__03a__03auvm_typed_callbacks__Tz46::to_string_middle\n"); );
        // Body
        std::string out;
