...
void Vtransactions_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc_m_set_p_sequencer(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc_m_set_p_sequencer\n"); );
}
...
void Vtransactions_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc_uvm_report_info(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
...
void Vtransactions_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vtransactions_uvm_pkg__03a__03auvm_sequence_item::~Vtransactions_uvm_pkg__03a__03auvm_sequence_item() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_sequence_item::~\n"); );
}
