...
#ifndef VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI171__VCLPKG_H_
#define VERILATED_VTRANSACTIONS_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI171__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi171__Vclpkg final {
  public:
    ...
    void __VnoInFunc_get(Vtransactions__Syms* __restrict vlSymsp, VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi171> &get__Vfuncrtn);
...
class Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi171 : public virtual VlClass {
  public:
  ...
  public:
    Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi171(Vtransactions__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vtransactions_uvm_pkg__03a__03auvm_registry_common__pi171() {}
};
