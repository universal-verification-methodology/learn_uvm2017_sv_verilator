...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_reg_item> rw;
    {
        if (VL_UNLIKELY(((! VL_CAST_DYNAMIC(([&]() {
                                    VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_indirect.svh", 287)
        ...
        if (VL_UNLIKELY(((! VL_CAST_DYNAMIC(([&]() {
                                    VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_indirect.svh", 300)
        ...
        if ((1U == VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_indirect.svh", 303)
             ->__PVT__kind)) {
            ...
            VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_indirect.svh", 307)->__PVT__value.atWrite(0U) 
        ...
        VL_NULL_CHECK(Vtransactions_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_indirect.svh", 313)->__PVT__status 
...
void Vtransactions_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc___Vbasic_randomize(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
