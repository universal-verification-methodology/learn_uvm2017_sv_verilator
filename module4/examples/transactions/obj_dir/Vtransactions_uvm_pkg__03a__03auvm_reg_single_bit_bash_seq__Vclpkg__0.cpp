...
VlCoroutine Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vtransactions__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vtransactions_uvm_pkg__03a__03auvm_resource__Tz43> __Vfunc_get_by_name__6__Vfuncout;
    ...
    while (VL_LTS_III(32, 0U, unnamedblk1_2__DOT____Vrepeat1)) {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_2 = Vtransactions___024unit::__Venumtab_enum_name83
                    [(3U & status)];
                __Vtemp_3 = ([&]() {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_5 = Vtransactions___024unit::__Venumtab_enum_name83
                    [(3U & status)];
                __Vtemp_6 = ([&]() {
...
void Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vsetup_constraints(Vtransactions__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___VBasicRand(Vtransactions__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::~Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtransactions_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::~\n"); );
}
