...
void Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_accept_tr(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_accept_tr\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_begin_tr(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_begin_tr\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_end_tr(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_end_tr\n"); );
}
...
void Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc___Vsetup_constraints(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc___VBasicRand(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_transaction::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vrecorders_top_uvm_pkg__03a__03auvm_transaction::~Vrecorders_top_uvm_pkg__03a__03auvm_transaction() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_transaction::~\n"); );
}
