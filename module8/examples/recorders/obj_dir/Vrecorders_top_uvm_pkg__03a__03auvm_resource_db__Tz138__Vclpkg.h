...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ138__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ138__VCLPKG_H_  // guard
...
class Vrecorders_top_uvm_pkg__03a__03auvm_resource__Tz138;
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_resource_db__Tz138__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_resource_db__Tz138__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_resource_db__Tz138__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_resource_db__Tz138__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_dump(Vrecorders_top__Syms* __restrict vlSymsp);
    void __VnoInFunc_get_by_name(Vrecorders_top__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_resource__Tz138> &get_by_name__Vfuncrtn);
    void __VnoInFunc_get_by_type(Vrecorders_top__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_resource__Tz138> &get_by_type__Vfuncrtn);
    void __VnoInFunc_m_show_msg(Vrecorders_top__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_resource__Tz138> rsrc);
    ...
    void __VnoInFunc_set_default(Vrecorders_top__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_resource__Tz138> &set_default__Vfuncrtn);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_resource_db__Tz138 : public virtual VlClass {
  public:
  private:
    void _ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp);
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_resource_db__Tz138(Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vrecorders_top_uvm_pkg__03a__03auvm_resource_db__Tz138() {}
};
