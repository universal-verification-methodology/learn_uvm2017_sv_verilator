...
void Vrecorders_top___024unit__03a__03aRecorderTransaction::__VnoInFunc_do_record(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_recorder> recorder) {
    ...
    VL_NULL_CHECK(recorder, "recorders.sv", 36)->__VnoInFunc_record_field(vlProcess, vlSymsp, "data"s, __Vtemp_1, 8U, 0x07000000U);
    ...
    VL_NULL_CHECK(recorder, "recorders.sv", 37)->__VnoInFunc_record_field(vlProcess, vlSymsp, "address"s, __Vtemp_2, 0x00000010U, 0x07000000U);
    VL_EXTENDS_WI(4096,32, __Vtemp_3, this->__PVT__timestamp);
    VL_NULL_CHECK(recorder, "recorders.sv", 38)->__VnoInFunc_record_field(vlProcess, vlSymsp, "timestamp"s, __Vtemp_3, 0x00000020U, 0x02000000U);
}
...
void Vrecorders_top___024unit__03a__03aRecorderTransaction::__VnoInFunc___Vbasic_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrecorders_top___024unit__03a__03aRecorderTransaction::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
