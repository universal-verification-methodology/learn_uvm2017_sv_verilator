...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_ABSTRACT_OBJECT_REGISTRY__PI4__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_ABSTRACT_OBJECT_REGISTRY__PI4__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vrecorders_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4__Vclpkg);
    ...
    void __VnoInFunc_get(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4> &get__Vfuncrtn);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4 : public Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper {
  public:
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4(Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vrecorders_top_uvm_pkg__03a__03auvm_abstract_object_registry__pi4() {}
};
