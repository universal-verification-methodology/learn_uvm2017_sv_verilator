...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ174__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ174__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi137;
class Vrecorders_top_uvm_pkg__03a__03auvm_analysis_port__Tz174;
class Vrecorders_top_uvm_pkg__03a__03auvm_component;
class Vrecorders_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz174_TBz253;
class Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper;
class Vrecorders_top_uvm_pkg__03a__03auvm_put_imp__Tz174_TBz253;
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz174__Vclpkg final {
  public:
    ...
    void __VnoInFunc_get_type(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi137> &get_type__Vfuncrtn);
};
...
class Vrecorders_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz174 : public Vrecorders_top_uvm_pkg__03a__03auvm_component {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_put_imp__Tz174_TBz253> __PVT__put_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz174_TBz253> __PVT__get_peek_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_analysis_port__Tz174> __PVT__put_ap;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_analysis_port__Tz174> __PVT__get_ap;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_put_imp__Tz174_TBz253> __PVT__blocking_put_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_put_imp__Tz174_TBz253> __PVT__nonblocking_put_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz174_TBz253> __PVT__blocking_get_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz174_TBz253> __PVT__nonblocking_get_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz174_TBz253> __PVT__get_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz174_TBz253> __PVT__blocking_peek_export;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz174_TBz253> __PVT__nonblocking_peek_export;
    ...
    virtual VlCoroutine __VnoInFunc_get(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> &t);
    ...
    virtual VlCoroutine __VnoInFunc_peek(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> &t);
    virtual VlCoroutine __VnoInFunc_put(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> t);
    virtual void __VnoInFunc_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn);
    virtual void __VnoInFunc_size(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn);
    virtual void __VnoInFunc_try_get(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> &t, CData/*0:0*/ &try_get__Vfuncrtn);
    virtual void __VnoInFunc_try_peek(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> &t, CData/*0:0*/ &try_peek__Vfuncrtn);
    virtual void __VnoInFunc_try_put(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> t, CData/*0:0*/ &try_put__Vfuncrtn);
