...
Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::Vrecorders_top_uvm_pkg__03a__03auvm_tr_database(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string name)
    : Vrecorders_top_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_db(Vrecorders_top__Syms* __restrict vlSymsp, CData/*0:0*/ &open_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_db\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_close_db(Vrecorders_top__Syms* __restrict vlSymsp, CData/*0:0*/ &close_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_close_db\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_is_open(Vrecorders_top__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_stream(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> &open_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_stream\n"); );
    // Locals
    ...
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_do_open_stream__6__Vfuncout;
    // Body
    VlClassRef<Vrecorders_top_std__03a__03aprocess> unnamedblk1__DOT__p;
    ...
    if (([&]() {
        ...
        if ((VlNull{} != open_stream__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_stream__Vfuncrtn, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_tr_database.svh", 117)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database>{this}, scope, type_name);
        }
        if ((VlNull{} != unnamedblk1__DOT__p)) {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_m_free_stream(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_m_free_stream\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_get_streams(Vrecorders_top__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream>> &q, CData/*0:0*/ &get_streams__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_get_streams\n"); );
    // Body
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> unnamedblk2__DOT__idx;
...
void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_establish_link(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_link_base> link) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_establish_link\n"); );
    // Locals
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> __Vtask_get_lhs__9__Vfuncout;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> __Vtask_get_rhs__10__Vfuncout;
    ...
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> __Vtask_get_stream__45__Vfuncout;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> __Vtask_get_stream__46__Vfuncout;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_db__47__Vfuncout;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_db__48__Vfuncout;
    ...
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_db__59__Vfuncout;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_db__60__Vfuncout;
    ...
    // Body
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> s_lhs;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> s_rhs;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_recorder> r_lhs;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_recorder> r_rhs;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> lhs;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> rhs;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (((VlNull{} != s_lhs) && (([&]() {
                            VL_NULL_CHECK(s_lhs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_tr_database.svh", 189)
                                     ...
                                     != VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database>{this}))) {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_db(Vrecorders_top__Syms* __restrict vlSymsp, CData/*0:0*/ &do_open_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_db\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_close_db(Vrecorders_top__Syms* __restrict vlSymsp, CData/*0:0*/ &do_close_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_close_db\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_stream(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_stream> &do_open_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_stream\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_establish_link(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_link_base> link) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_establish_link\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___Vbasic_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::_ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_tr_database::to_string_middle\n"); );
    // Body
    std::string out;
