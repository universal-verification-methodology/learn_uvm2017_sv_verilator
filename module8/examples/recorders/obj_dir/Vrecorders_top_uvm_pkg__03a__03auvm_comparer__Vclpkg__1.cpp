                ...
                std::string msg;
                {
                    if ((lhs != rhs)) {
                        msg = VL_CONCATN_NNN(VL_CONCATN_NNN(
                            ...
                            void Vrecorders_top_uvm_pkg__03a__03auvm_comparer::__VnoInFunc___Vbasic_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
                                VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_comparer::__VnoInFunc___Vbasic_randomize\n"); );
                                // Body
