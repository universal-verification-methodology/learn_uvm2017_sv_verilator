...
void Vrecorders_top___024root__trace_chg_0_sub_0(Vrecorders_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vrecorders_top___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_chg_0\n"); );
    // Body
    ...
    Vrecorders_top___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vrecorders_top___024root__trace_chg_0_sub_0(Vrecorders_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_chg_0_sub_0\n"); );
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vrecorders_top___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_cleanup\n"); );
    // Body
    Vrecorders_top___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vrecorders_top___024root*>(voidSelf);
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
