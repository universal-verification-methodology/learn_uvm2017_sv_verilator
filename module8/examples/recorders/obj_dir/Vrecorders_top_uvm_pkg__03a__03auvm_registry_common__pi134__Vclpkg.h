...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI134__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI134__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vrecorders_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134__Vclpkg);
    ...
    void __VnoInFunc_get(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134> &get__Vfuncrtn);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134 : public virtual VlClass {
  public:
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134(Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi134() {}
};
