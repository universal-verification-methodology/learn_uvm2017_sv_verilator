...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_CALLBACKS__TZ45__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_CALLBACKS__TZ45__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    std::string __PVT__m_cb_typename;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45> &get__Vfuncrtn);
    void __VnoInFunc_get_all(Vrecorders_top__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callback>> &all_callbacks, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_objection> obj);
    void __VnoInFunc_get_first(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callback> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callback> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callback> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callback> &get_prev__Vfuncrtn);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45 : public Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz45 {
  public:
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vrecorders_top_uvm_pkg__03a__03auvm_callbacks__Tz45() {}
};
