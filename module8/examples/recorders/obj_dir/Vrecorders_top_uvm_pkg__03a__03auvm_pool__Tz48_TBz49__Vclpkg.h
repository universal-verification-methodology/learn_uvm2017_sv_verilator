...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ48_TBZ49__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ48_TBZ49__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz49__Vclpkg final {
  public:
    ...
    void __VnoInFunc_get_global(Vrecorders_top__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz49> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_registry__Tz96> &get_type__Vfuncrtn);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz49 : public Vrecorders_top_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_get(Vrecorders_top__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get__Vfuncrtn);
