...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_type_name(Vrecorders_top__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_get(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_create(Vrecorders_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_test> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_test> __Vfunc_create__2__Vfuncout;
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_set_type_override(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_set_inst_override(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_set_type_alias(Vrecorders_top__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::__VnoInFunc_create_component(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_component> parent, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::__VnoInFunc_create_component\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::__VnoInFunc_get_type_name(Vrecorders_top__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi27> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi27> common;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi27__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__11__Vfuncout);
...
void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::__VnoInFunc_initialize(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi27> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi27> common;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi27__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__13__Vfuncout);
...
Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9(Vrecorders_top__Syms* __restrict vlSymsp)
    : Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::_ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::~Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi9::to_string_middle\n"); );
    // Body
    std::string out;
