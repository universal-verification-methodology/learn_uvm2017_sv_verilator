...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz169__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz169__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
