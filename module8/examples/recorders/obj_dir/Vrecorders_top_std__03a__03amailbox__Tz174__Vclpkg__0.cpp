...
VlCoroutine Vrecorders_top_std__03a__03amailbox__Tz174::__VnoInFunc_put(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> message) {
    ...
    while (((0U != this->__PVT__m_bound) & VL_GTES_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound))) {
        if (VL_GTES_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound)) {
            CData/*0:0*/ __VdynTrigger_hc13c9e6a__0;
            __VdynTrigger_hc13c9e6a__0 = 0;
            __VdynTrigger_hc13c9e6a__0 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_hc13c9e6a__0)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             ...
                                                             49);
                this->__Vtrigprevexpr_hc3330b6f__0 
                    = VL_LTS_III(32, this->__PVT__m_queue.size(), this->__PVT__m_bound);
                __VdynTrigger_hc13c9e6a__0 = this->__Vtrigprevexpr_hc3330b6f__0;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hc13c9e6a__0);
            }
...
VlCoroutine Vrecorders_top_std__03a__03amailbox__Tz174::__VnoInFunc_get(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> &message) {
    ...
    while ((0U == this->__PVT__m_queue.size())) {
        if (VL_GTES_III(32, 0U, this->__PVT__m_queue.size())) {
            CData/*0:0*/ __VdynTrigger_hc1e79765__0;
            __VdynTrigger_hc1e79765__0 = 0;
            __VdynTrigger_hc1e79765__0 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_hc1e79765__0)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             nullptr, 
                                                             "@([true] (32'sh0 < std::mailbox__Tz174.m_queue.size()))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             65);
                this->__Vtrigprevexpr_hc4080484__0 
                    = VL_LTS_III(32, 0U, this->__PVT__m_queue.size());
                __VdynTrigger_hc1e79765__0 = this->__Vtrigprevexpr_hc4080484__0;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hc1e79765__0);
            }
            co_await vlSymsp->TOP.__VdynSched.resumption(
                                                         nullptr, 
                                                         "@([true] (32'sh0 < std::mailbox__Tz174.m_queue.size()))", 
...
VlCoroutine Vrecorders_top_std__03a__03amailbox__Tz174::__VnoInFunc_peek(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_item> &message) {
    ...
    while ((0U == this->__PVT__m_queue.size())) {
        if (VL_GTES_III(32, 0U, this->__PVT__m_queue.size())) {
            CData/*0:0*/ __VdynTrigger_hc1e79765__1;
            __VdynTrigger_hc1e79765__1 = 0;
            __VdynTrigger_hc1e79765__1 = 0U;
            while ((1U & (~ (IData)(__VdynTrigger_hc1e79765__1)))) {
                co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                             vlProcess, 
                                                             "@([true] (32'sh0 < std::mailbox__Tz174.m_queue.size()))", 
                                                             "/usr/local/share/verilator/include/verilated_std.sv", 
                                                             82);
                this->__Vtrigprevexpr_hc4080484__1 
                    = VL_LTS_III(32, 0U, this->__PVT__m_queue.size());
                __VdynTrigger_hc1e79765__1 = this->__Vtrigprevexpr_hc4080484__1;
                vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hc1e79765__1);
            }
            co_await vlSymsp->TOP.__VdynSched.resumption(
                                                         vlProcess, 
                                                         "@([true] (32'sh0 < std::mailbox__Tz174.m_queue.size()))", 
...
void Vrecorders_top_std__03a__03amailbox__Tz174::_ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp) {
    ...
    __PVT__m_bound = 0;
    __Vtrigprevexpr_hc3330b6f__0 = VL_SCOPED_RAND_RESET_I(1, 15489198463053140781ULL, 5618057048934678173ull);
    __Vtrigprevexpr_hc4080484__0 = VL_SCOPED_RAND_RESET_I(1, 15489198463053140781ULL, 14685553207362776633ull);
    __Vtrigprevexpr_hc4080484__1 = VL_SCOPED_RAND_RESET_I(1, 15489198463053140781ULL, 13353694865402177116ull);
}
