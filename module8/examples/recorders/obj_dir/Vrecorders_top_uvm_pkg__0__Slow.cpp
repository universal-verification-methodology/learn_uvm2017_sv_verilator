...
VL_ATTR_COLD void Vrecorders_top_uvm_pkg___eval_static__TOP__uvm_pkg(Vrecorders_top_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrecorders_top_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
...
VL_ATTR_COLD void Vrecorders_top_uvm_pkg___ctor_var_reset(Vrecorders_top_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrecorders_top_uvm_pkg___ctor_var_reset\n"); );
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
