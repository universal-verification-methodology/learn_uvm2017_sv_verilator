...
void Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135::__VnoInFunc_do_print(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_printer> printer) {
    ...
    // Body
    std::string key;
    VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_pool.svh", 323)->__VnoInFunc_print_array_header(vlProcess, vlSymsp, "pool"s, Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz135::__PVT__pool.size(), "aa_object_string"s, 0x2eU);
...
void Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135::__VnoInFunc___Vsetup_constraints(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135::__VnoInFunc___VBasicRand(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135::~Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_object_string_pool__Tz135::~\n"); );
}
