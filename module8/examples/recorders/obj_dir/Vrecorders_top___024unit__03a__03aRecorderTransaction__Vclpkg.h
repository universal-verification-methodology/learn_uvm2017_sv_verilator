...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top___024unit__03a__03aRecorderTransaction__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top___024unit__03a__03aRecorderTransaction__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
