...
class Vrecorders_top_uvm_pkg__03a__03a__VDynScope_33;
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_reg_backdoor__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_reg_backdoor__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_reg_backdoor : public Vrecorders_top_uvm_pkg__03a__03auvm_object {
  ...
  private:
    VlCoroutine __VnoInFunc_start_update_thread____Vfork_1__0(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03a__VDynScope_33> __VDynScope_start_update_thread_0);
  public:
