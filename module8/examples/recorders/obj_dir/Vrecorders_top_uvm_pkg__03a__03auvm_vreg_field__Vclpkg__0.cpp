...
VlCoroutine Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_write(Vrecorders_top__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_block> unnamedblk298__DOT__blk;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk299__DOT__cb;
    ...
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk301__DOT__cb;
    QData/*63:0*/ tmp;
    tmp = 0;
    QData/*63:0*/ segval;
    segval = 0;
...
VlCoroutine Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_read(Vrecorders_top__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_block> unnamedblk302__DOT__blk;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk303__DOT__cb;
    IData/*31:0*/ unnamedblk1_2__DOT____Vrepeat1;
    unnamedblk1_2__DOT____Vrepeat1 = 0;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk304__DOT__cb;
    QData/*63:0*/ tmp;
    tmp = 0;
    QData/*63:0*/ segval;
    segval = 0;
...
void Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___Vsetup_constraints(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___VBasicRand(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::~Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_vreg_field::~\n"); );
}
