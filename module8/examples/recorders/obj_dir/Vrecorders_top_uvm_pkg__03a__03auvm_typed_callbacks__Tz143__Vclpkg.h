...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ143__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ143__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz60> __PVT__m_tw_cb_q;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vrecorders_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143> &m_initialize__Vfuncrtn);
};
...
class Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143 : public Vrecorders_top_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz143() {}
};
