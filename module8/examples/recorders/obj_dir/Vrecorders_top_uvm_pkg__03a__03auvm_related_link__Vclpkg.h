...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_related_link__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_related_link__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
