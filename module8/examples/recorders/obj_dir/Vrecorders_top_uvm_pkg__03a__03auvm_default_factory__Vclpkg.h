...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_  // guard
...
class Vrecorders_top_uvm_pkg__03a__03auvm_factory_queue_class;
...
struct Vrecorders_top_m_inst_typename_alias_t__struct__0 {
    ...
    bool operator==(const Vrecorders_top_m_inst_typename_alias_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vrecorders_top_m_inst_typename_alias_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_default_factory__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_default_factory__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_default_factory__Vclpkg);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_default_factory : public Vrecorders_top_uvm_pkg__03a__03auvm_factory {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper>, CData/*0:0*/> __PVT__m_types;
    VlAssocArray<std::string, CData/*0:0*/> __PVT__m_lookup_strs;
    VlQueue<Vrecorders_top_m_inst_typename_alias_t__struct__0> __PVT__m_inst_aliases;
    ...
    VlAssocArray<std::string, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper>> __PVT__m_type_names;
    VlQueue<VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_type_overrides;
    VlQueue<VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_inst_overrides;
    VlQueue<VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_override_info;
    void __VnoInFunc_check_inst_override_exists(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> original_type, std::string original_type_name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string override_type_name, std::string full_inst_path, CData/*0:0*/ &check_inst_override_exists__Vfuncrtn);
    ...
    void __VnoInFunc_m_debug_create(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string parent_inst_path, std::string name);
    void __VnoInFunc_m_debug_display(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> result, std::string full_inst_path);
    void __VnoInFunc_m_matches_inst_override(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_factory_override> __SYM__override, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, std::string full_inst_path, CData/*0:0*/ &m_matches_inst_override__Vfuncrtn);
    void __VnoInFunc_m_matches_type_override(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_factory_override> __SYM__override, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, std::string full_inst_path, CData/*0:0*/ match_original_type, CData/*0:0*/ resolve_null_type_by_inst, CData/*0:0*/ &m_matches_type_override__Vfuncrtn);
    void __VnoInFunc_m_matches_type_pair(Vrecorders_top__Syms* __restrict vlSymsp, Vrecorders_top_m_uvm_factory_type_pair_t__struct__0 match_type_pair, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, CData/*0:0*/ &m_matches_type_pair__Vfuncrtn);
    void __VnoInFunc_m_resolve_type_name(Vrecorders_top__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> &m_resolve_type_name__Vfuncrtn);
    void __VnoInFunc_m_resolve_type_name_by_inst(Vrecorders_top__Syms* __restrict vlSymsp, std::string requested_type_name, std::string full_inst_path, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_wrapper> &m_resolve_type_name_by_inst__Vfuncrtn);
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_default_factory(Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vrecorders_top_uvm_pkg__03a__03auvm_default_factory() {}
};
