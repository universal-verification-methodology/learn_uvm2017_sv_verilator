...
VL_ATTR_COLD void Vrecorders_top___024root__trace_init_sub__TOP__uvm_pkg__0(Vrecorders_top___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void Vrecorders_top___024root__trace_init_sub__TOP__0(Vrecorders_top___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_init_sub__TOP__0\n"); );
    ...
    Vrecorders_top___024root__trace_init_sub__TOP__uvm_pkg__0(vlSelf, tracep);
    tracep->popPrefix();
}

VL_ATTR_COLD void Vrecorders_top___024root__trace_init_sub__TOP__uvm_pkg__0(Vrecorders_top___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_init_sub__TOP__uvm_pkg__0\n"); );
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const int c = vlSymsp->__Vm_baseCode;
...
VL_ATTR_COLD void Vrecorders_top___024root__trace_init_top(Vrecorders_top___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_init_top\n"); );
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vrecorders_top___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vrecorders_top___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vrecorders_top___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vrecorders_top___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vrecorders_top___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vrecorders_top___024root__trace_register(Vrecorders_top___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_register\n"); );
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vrecorders_top___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vrecorders_top___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vrecorders_top___024root__trace_chg_0, 0, vlSelf);
    tracep->addCleanupCb(&Vrecorders_top___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vrecorders_top___024root__trace_const_0_sub_0(Vrecorders_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vrecorders_top___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_const_0\n"); );
    // Body
    Vrecorders_top___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vrecorders_top___024root*>(voidSelf);
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vrecorders_top___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vrecorders_top___024root__trace_const_0_sub_0(Vrecorders_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_const_0_sub_0\n"); );
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vrecorders_top___024root__trace_full_0_sub_0(Vrecorders_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vrecorders_top___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_full_0\n"); );
    // Body
    Vrecorders_top___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vrecorders_top___024root*>(voidSelf);
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vrecorders_top___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vrecorders_top___024root__trace_full_0_sub_0(Vrecorders_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrecorders_top___024root__trace_full_0_sub_0\n"); );
    Vrecorders_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
