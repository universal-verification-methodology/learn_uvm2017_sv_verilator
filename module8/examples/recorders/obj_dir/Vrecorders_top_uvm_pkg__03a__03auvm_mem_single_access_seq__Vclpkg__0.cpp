...
VlCoroutine Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__12__Vfuncout;
            ...
            while (((QData)((IData)(unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__k)) 
                ...
                if (("RO"s == mode)) {
                    ...
                    if ((0U != unnamedblk1__DOT__unnamedblk2__DOT__status)) {
                        if ((0U != ([&]() {
                            ...
                            __Vtemp_1 = Vrecorders_top___024unit::__Venumtab_enum_name83
                ...
                if ((0U != unnamedblk1__DOT__unnamedblk2__DOT__status)) {
                    if ((0U != ([&]() {
                        ...
                        __Vtemp_11 = Vrecorders_top___024unit::__Venumtab_enum_name83
                            [(3U & unnamedblk1__DOT__unnamedblk2__DOT__status)];
                        __Vtemp_12 = ([&]() {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___Vsetup_constraints(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___VBasicRand(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq::~Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_mem_single_access_seq::~\n"); );
}
