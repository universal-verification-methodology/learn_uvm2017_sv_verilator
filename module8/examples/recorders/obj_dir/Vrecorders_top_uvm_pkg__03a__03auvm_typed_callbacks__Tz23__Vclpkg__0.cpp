...
void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23, vlProcess, vlSymsp);
...
void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg::__VnoInFunc_m_cb_find_name(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz60> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg::__VnoInFunc_display(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> me;
    ...
    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_am_i_a(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_am_i_a\n"); );
        // Body
        VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> this_type;
        {
            if ((VlNull{} == obj)) {
    ...
    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_get_tw_cb_q(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz60> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Locals
            ...
            if (([&]() {
                ...
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Vrecorders_top_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    ...
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23>{this}))) {
    ...
    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_add_tw_cbs(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        if ((0xffffffffU == ([&]() {
            ...
            if ((0U == ordering)) {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 256)
                        ->__VnoInFunc_push_back(vlSymsp, cb);
            } else {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 258)
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Vrecorders_top_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            ...
            if ((cb_pair != VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23>{this})) {
    ...
    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_delete_tw_cbs(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
        ...
        if ((0xffffffffU != pos)) {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz23__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 296)
    ...
    Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp)
      : Vrecorders_top_uvm_pkg__03a__03auvm_callbacks_base(vlProcess, vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::new\n"); );
        // Body
        _ctor_var_reset(vlSymsp);
        ;
    }

    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc___Vbasic_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::__VnoInFunc___Vbasic_randomize\n"); );
        // Body
        __Vbasic_randomize__Vfuncrtn = 1U;
    }

    void Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::_ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::_ctor_var_reset\n"); );
        // Body
        (void)vlSymsp;  // Prevent unused variable warning
    }

    std::string VL_TO_STRING(const VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vrecorders_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz23::to_string_middle\n"); );
        // Body
        std::string out;
