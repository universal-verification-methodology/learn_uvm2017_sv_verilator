...
void Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz20>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53__Vclpkg::__VnoInFunc_levenshtein_distance(Vrecorders_top__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53__Vclpkg::__VnoInFunc_minimum(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = 0;
    min = a;
...
Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::_ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_spell_chkr__Tz53::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
