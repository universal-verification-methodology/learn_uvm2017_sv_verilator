...
void Vrecorders_top___024unit__03a__03aRecorderTest::__VnoInFunc_connect_phase(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> phase) {
    ...
    VL_NULL_CHECK(this->__PVT__transaction_port, "recorders.sv", 260)->__VnoInFunc_connect(vlProcess, vlSymsp, VL_NULL_CHECK(this->__PVT__recorder, "recorders.sv", 260)
                                                                                ->__PVT__analysis_imp);
}
...
VlCoroutine Vrecorders_top___024unit__03a__03aRecorderTest::__VnoInFunc_run_phase(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> phase) {
    ...
    VL_NULL_CHECK(phase, "recorders.sv", 265)->__VnoInFunc_raise_objection(vlProcess, vlSymsp, 
    ...
    while (VL_GTS_III(32, 0x0000000aU, unnamedblk1__DOT__i)) {
        ...
        VL_NULL_CHECK(txn, "recorders.sv", 277)->__VnoInFunc_randomize(vlSymsp, __Vtask_randomize__9__Vfuncout);
        VL_NULL_CHECK(txn, "recorders.sv", 278)->__PVT__timestamp 
            = VL_MULS_III(32, (IData)(0x0000000aU), unnamedblk1__DOT__i);
        VL_NULL_CHECK(this->__PVT__transaction_port, "recorders.sv", 279)->__VnoInFunc_write(vlProcess, vlSymsp, txn);
    ...
    co_await vlSymsp->TOP.__VdlySched.delay(0x0000000000000032ULL, 
                                            ...
                                            "recorders.sv", 
                                            286);
    VL_NULL_CHECK(this->__PVT__recorder, "recorders.sv", 287)->__VnoInFunc_playback_transactions(vlProcess, vlSymsp);
    co_await vlSymsp->TOP.__VdlySched.delay(0x0000000000000032ULL, 
                                            vlProcess, 
                                            "recorders.sv", 
                                            289);
    VL_NULL_CHECK(phase, "recorders.sv", 290)->__VnoInFunc_drop_objection(vlProcess, vlSymsp, 
                                                                          VlClassRef<Vrecorders_top___024unit__03a__03aRecorderTest>{this}, ""s, 1U);
    co_return;}
