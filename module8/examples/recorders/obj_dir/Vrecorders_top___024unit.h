...
#ifndef VERILATED_VRECORDERS_TOP___024UNIT_H_
#define VERILATED_VRECORDERS_TOP___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top___024unit(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top___024unit();
    VL_UNCOPYABLE(Vrecorders_top___024unit);
