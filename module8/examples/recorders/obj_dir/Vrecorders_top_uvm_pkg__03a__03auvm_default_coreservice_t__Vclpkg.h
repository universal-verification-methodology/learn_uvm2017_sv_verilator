...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_  // guard
...
class Vrecorders_top_uvm_pkg__03a__03auvm_component_name_check_visitor;
class Vrecorders_top_uvm_pkg__03a__03auvm_copier;
class Vrecorders_top_uvm_pkg__03a__03auvm_coreservice_t;
class Vrecorders_top_uvm_pkg__03a__03auvm_default_factory;
...
class Vrecorders_top_uvm_pkg__03a__03auvm_table_printer;
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_default_coreservice_t : public Vrecorders_top_uvm_pkg__03a__03auvm_coreservice_t {
  public:
    ...
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_factory> __PVT__factory;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_tr_database> __PVT__tr_database;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_report_server> __PVT__report_server;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_visitor_> __PVT___visitor;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_printer> __PVT__m_printer;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_packer> __PVT__m_packer;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_comparer> __PVT__m_comparer;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_resource_pool> __PVT__m_rp;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_copier> __PVT__m_copier;
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_default_coreservice_t(Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vrecorders_top_uvm_pkg__03a__03auvm_default_coreservice_t() {}
};
