...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ48_TBZ169__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ48_TBZ169__VCLPKG_H_  // guard
...
class Vrecorders_top_uvm_pkg__03a__03auvm_object_registry__Tz240;
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vrecorders_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_registry__Tz240> &get_type__Vfuncrtn);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169 : public Vrecorders_top_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz48>> __PVT__pool;
    ...
    virtual void __VnoInFunc_add(Vrecorders_top__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz48> item);
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vrecorders_top_uvm_pkg__03a__03auvm_pool__Tz48_TBz169() {}
};
