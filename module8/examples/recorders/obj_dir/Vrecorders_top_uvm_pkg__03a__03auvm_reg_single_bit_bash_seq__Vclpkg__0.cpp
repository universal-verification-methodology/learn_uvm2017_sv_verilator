    ...
    while (VL_LTS_III(32, 0U, unnamedblk1_2__DOT____Vrepeat1)) {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_2 = Vrecorders_top___024unit::__Venumtab_enum_name83
                    [(3U & status)];
                __Vtemp_3 = ([&]() {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_5 = Vrecorders_top___024unit::__Venumtab_enum_name83
                    [(3U & status)];
                __Vtemp_6 = ([&]() {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vsetup_constraints(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___VBasicRand(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vrecorders_top_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::~Vrecorders_top_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::~\n"); );
}
