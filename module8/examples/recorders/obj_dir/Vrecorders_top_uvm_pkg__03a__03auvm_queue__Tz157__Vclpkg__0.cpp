...
VlCoroutine Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz157::__VnoInFunc_wait_until_not_empty(Vrecorders_top__Syms* __restrict vlSymsp) {
    ...
    if (VL_GTES_III(32, 0U, this->__PVT__queue.size())) {
        CData/*0:0*/ __VdynTrigger_hc4d4a17a__0;
        __VdynTrigger_hc4d4a17a__0 = 0;
        __VdynTrigger_hc4d4a17a__0 = 0U;
        while ((1U & (~ (IData)(__VdynTrigger_hc4d4a17a__0)))) {
            co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                         ...
                                                         196);
            this->__Vtrigprevexpr_hbeab06bf__0 = VL_LTS_III(32, 0U, this->__PVT__queue.size());
            __VdynTrigger_hc4d4a17a__0 = this->__Vtrigprevexpr_hbeab06bf__0;
            vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hc4d4a17a__0);
        }
...
void Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz157::__VnoInFunc___Vbasic_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz157::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_queue__Tz157::_ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp) {
    ...
    __Vtrigprevexpr_hbeab06bf__0 = VL_SCOPED_RAND_RESET_I(1, 12746392919820194408ULL, 4197511652970773719ull);
}
