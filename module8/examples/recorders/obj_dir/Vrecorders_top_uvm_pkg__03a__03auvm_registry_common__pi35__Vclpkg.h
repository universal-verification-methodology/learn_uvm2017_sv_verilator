...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI35__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI35__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi35__Vclpkg final {
  public:
    ...
    void __VnoInFunc_get(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi35> &get__Vfuncrtn);
...
class Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi35 : public virtual VlClass {
  public:
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi35(Vrecorders_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vrecorders_top_uvm_pkg__03a__03auvm_registry_common__pi35() {}
};
