...
class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_callback_iter__pi67__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_callback_iter__pi67__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
