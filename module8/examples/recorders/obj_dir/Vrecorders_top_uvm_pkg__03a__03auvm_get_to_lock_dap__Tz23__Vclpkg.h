...
#ifndef VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ23__VCLPKG_H_
#define VERILATED_VRECORDERS_TOP_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ23__VCLPKG_H_  // guard
...
class Vrecorders_top_uvm_pkg__03a__03auvm_set_get_dap_base__Tz23;


class Vrecorders_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vrecorders_top_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz23__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrecorders_top_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz23__Vclpkg(Vrecorders_top__Syms* symsp, const char* v__name);
    ~Vrecorders_top_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz23__Vclpkg();
    VL_UNCOPYABLE(Vrecorders_top_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz23__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_object_registry__Tz92> &get_type__Vfuncrtn);
};
...
class Vrecorders_top_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz23 : public Vrecorders_top_uvm_pkg__03a__03auvm_set_get_dap_base__Tz23 {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m_locked;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> __PVT__m_value;
  ...
  public:
    Vrecorders_top_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz23(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vrecorders_top_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz23() {}
};
