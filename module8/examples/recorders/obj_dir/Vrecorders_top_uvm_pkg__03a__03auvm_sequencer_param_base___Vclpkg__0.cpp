...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_current_item(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> &get_current_item__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_current_item\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_peek__0__Vfuncout;
    __Vtask_try_peek__0__Vfuncout = 0;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> __Vtask_try_peek__0__t;
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_req(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> &last_req__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_req\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_rsp(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> &last_rsp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_rsp\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
...
Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_component> parent)
    : Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_base(vlProcess, vlSymsp, name, parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::new\n"); );
    // Body
    ...
    ;
    this->__PVT__rsp_export = VL_NEW(Vrecorders_top_uvm_pkg__03a__03auvm_analysis_export__Tz12, vlProcess, vlSymsp, "rsp_export"s, 
                                     VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_>{this});
    this->__PVT__sqr_rsp_analysis_fifo = VL_NEW(Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_, vlProcess, vlSymsp, "sqr_rsp_analysis_fifo"s, 
                                                VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_>{this});
    ...
    this->__PVT__m_req_fifo = VL_NEW(Vrecorders_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz12, vlProcess, vlSymsp, "req_fifo"s, 
                                     VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_>{this}, 1U);
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_do_print(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_do_print\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_connect_phase(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_connect_phase\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_build_phase(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_build_phase\n"); );
    // Body
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_send_request(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ rerandomize) {
    ...
    __Vincrement1 = 0;
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> param_t;
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_put_response(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_put_response\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_analysis_write(VlProcessRef vlProcess, Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_analysis_write\n"); );
    // Body
    VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> response;
    if ((1U & (~ (0U != ([&]() {
                            response = t;
                        }(), 1U))))) {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_reqs_sent(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_reqs_sent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_reqs_sent\n"); );
    // Body
    get_num_reqs_sent__Vfuncrtn = this->__PVT__m_num_reqs_sent;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_rsps_received(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_rsps_received__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_rsps_received\n"); );
    // Body
    get_num_rsps_received__Vfuncrtn = this->__PVT__m_num_rsps_received;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_reqs(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_reqs\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0x00000400U < max)) {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_reqs(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_reqs__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_reqs\n"); );
    // Body
    get_num_last_reqs__Vfuncrtn = this->__PVT__m_num_last_reqs;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_req_push_front(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_req_push_front\n"); );
    // Body
    {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_rsps(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_rsps\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0x00000400U < max)) {
        this->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, "HSTOB"s, "Invalid last size; 1024 is the maximum and will be used"s, 0x000000c8U, ""s, 0U, ""s, 0U);
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_rsps(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_rsps__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_rsps\n"); );
    // Body
    get_num_last_rsps__Vfuncrtn = this->__PVT__m_num_last_rsps;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_rsp_push_front(Vrecorders_top__Syms* __restrict vlSymsp, VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_rsp_push_front\n"); );
    // Body
    {
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_randomize(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___Vsetup_constraints(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___VBasicRand(Vrecorders_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::_ctor_var_reset(Vrecorders_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::_ctor_var_reset\n"); );
    // Body
...
Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::~Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrecorders_top_uvm_pkg__03a__03auvm_sequencer_param_base_::to_string_middle\n"); );
    // Body
    std::string out;
