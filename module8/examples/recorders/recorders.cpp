/**
 * Module 8 Example 8.3: UVM Recorders - C++ Testbench
 * 
 * LEARNING OBJECTIVES:
 ...
 * recorders example. It instantiates the Verilator-generated model,
...
int main(int argc, char** argv) {
    ...
    auto* top = new Vrecorders_top;
    auto* tfp = new VerilatedVcdC;
    top->trace(tfp, 99);
    tfp->open("recorders.vcd");
