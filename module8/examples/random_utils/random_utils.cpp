/**
 * Module 8 Example 8.8: Random Utilities - C++ Testbench
 * 
 * LEARNING OBJECTIVES:
 ...
 * random utilities example. It instantiates the Verilator-generated model,
 * manages simulation time, and generates VCD waveform files.
 */

#include "Vrandom_utils_top.h"
#include "verilated.h"
...
int main(int argc, char** argv) {
    ...
    auto* top = new Vrandom_utils_top;
    auto* tfp = new VerilatedVcdC;
    top->trace(tfp, 99);
    tfp->open("random_utils.vcd");
