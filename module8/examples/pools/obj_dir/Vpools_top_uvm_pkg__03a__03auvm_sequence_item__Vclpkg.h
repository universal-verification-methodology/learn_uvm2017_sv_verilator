...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_sequence_item__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_sequence_item__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
...
class Vpools_top_uvm_pkg__03a__03auvm_sequence_item : public Vpools_top_uvm_pkg__03a__03auvm_transaction {
  public:
    ...
    virtual void __VnoInFunc_uvm_report_info(Vpools_top__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked);
