...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    {
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_get(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_create(Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_queue__Tz155> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> __Vfunc_get__3__Vfuncout;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_object_creator__Vclpkg.__VnoInFunc_create_by_type(vlProcess, vlSymsp, 
                                                                                ([&]() {
                vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz156__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__3__Vfuncout);
    ...
    if ((! VL_CAST_DYNAMIC(obj, create__Vfuncrtn))) {
        unnamedblk1__DOT__msg = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                            ...
                                                            vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_object_creator__Vclpkg.__VnoInFunc_base_type_name(vlSymsp, __Vfunc_base_type_name__4__Vfuncout);
                                                                                ...
                                                                                ([&]() {
                                                    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz156__Vclpkg.__VnoInFunc_type_name(vlSymsp, __Vfunc_type_name__5__Vfuncout);
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_set_type_override(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> __Vfunc_get__11__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    ...
    VL_NULL_CHECK(factory, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_registry.svh", 577)->__VnoInFunc_set_type_override_by_type(vlSymsp, 
                                                                                ([&]() {
                vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz156__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__11__Vfuncout);
            }(), __Vfunc_get__11__Vfuncout), override_type, replace);
}

void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_set_inst_override(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    ...
    VL_NULL_CHECK(factory, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_registry.svh", 592)->__VnoInFunc_set_inst_override_by_type(vlSymsp, 
                                                                                ([&]() {
                vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz156__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__16__Vfuncout);
            }(), __Vfunc_get__16__Vfuncout), override_type, inst_path);
}

void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_set_type_alias(Vpools_top__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> unnamedblk2__DOT__rgtry;
    ...
    if ((0U != ([&]() {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz156__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__19__Vfuncout);
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> rgtry;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz156__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__22__Vfuncout);
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::__VnoInFunc_get_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::__VnoInFunc_initialize(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> __Vfunc_get__2__Vfuncout;
    // Body
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz156> rgtry;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz156__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__2__Vfuncout);
...
Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi121::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
