...
VlCoroutine Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__12__Vfuncout;
            ...
            while (((QData)((IData)(unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__k)) 
                ...
                if (("RO"s == mode)) {
                    ...
                    if ((0U != unnamedblk1__DOT__unnamedblk2__DOT__status)) {
                        if ((0U != ([&]() {
                            ...
                            __Vtemp_1 = Vpools_top___024unit::__Venumtab_enum_name83
                ...
                if ((0U != unnamedblk1__DOT__unnamedblk2__DOT__status)) {
                    if ((0U != ([&]() {
                        ...
                        __Vtemp_6 = Vpools_top___024unit::__Venumtab_enum_name83
                            [(3U & unnamedblk1__DOT__unnamedblk2__DOT__status)];
                        __Vtemp_7 = ([&]() {
                ...
                if ((0U != unnamedblk1__DOT__unnamedblk2__DOT__status)) {
                    if ((0U != ([&]() {
                        ...
                        __Vtemp_9 = Vpools_top___024unit::__Venumtab_enum_name83
                            [(3U & unnamedblk1__DOT__unnamedblk2__DOT__status)];
                        __Vtemp_10 = ([&]() {
                ...
                if ((0U != unnamedblk1__DOT__unnamedblk2__DOT__status)) {
                    if ((0U != ([&]() {
                        ...
                        __Vtemp_11 = Vpools_top___024unit::__Venumtab_enum_name83
                            [(3U & unnamedblk1__DOT__unnamedblk2__DOT__status)];
                        __Vtemp_12 = ([&]() {
...
void Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___Vsetup_constraints(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___VBasicRand(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq::~Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_single_access_seq::~\n"); );
}
