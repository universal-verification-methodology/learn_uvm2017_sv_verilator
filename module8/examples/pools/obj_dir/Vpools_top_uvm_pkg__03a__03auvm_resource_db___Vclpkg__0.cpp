...
Vpools_top_uvm_pkg__03a__03auvm_resource_db_::~Vpools_top_uvm_pkg__03a__03auvm_resource_db_() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vpools_top_uvm_pkg__03a__03auvm_resource_db_::~\n"); );
}
