...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI168__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI168__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vpools_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168__Vclpkg);
    ...
    void __VnoInFunc_get(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168> &get__Vfuncrtn);
...
class Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168 : public virtual VlClass {
  public:
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168(Vpools_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi168() {}
};
