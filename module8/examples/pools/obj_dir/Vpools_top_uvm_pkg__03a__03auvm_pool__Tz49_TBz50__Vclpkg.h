...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ49_TBZ50__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ49_TBZ50__VCLPKG_H_  // guard
...
class Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz95;
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vpools_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(Vpools_top__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz95> &get_type__Vfuncrtn);
...
class Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50 : public Vpools_top_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_add(Vpools_top__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ item);
    ...
    virtual void __VnoInFunc_get(Vpools_top__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get__Vfuncrtn);
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz50() {}
};
