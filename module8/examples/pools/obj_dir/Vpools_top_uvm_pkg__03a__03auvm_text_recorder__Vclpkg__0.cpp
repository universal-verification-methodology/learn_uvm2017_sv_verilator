...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi140> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi140> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_text_recorder"s;
}

void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_object_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi140> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi140__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_text_recorder> tmp;
    tmp = ((""s == name) ? VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_text_recorder, vlProcess, vlSymsp, "unnamed-uvm_text_recorder"s)
            : VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_text_recorder, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_text_recorder"s;
}

Vpools_top_uvm_pkg__03a__03auvm_text_recorder::Vpools_top_uvm_pkg__03a__03auvm_text_recorder(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name)
    : Vpools_top_uvm_pkg__03a__03auvm_recorder(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_open(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tr_stream> stream, QData/*63:0*/ open_time, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_open\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_db__4__Vfuncout;
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_close(Vpools_top__Syms* __restrict vlSymsp, QData/*63:0*/ close_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_close\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_free(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_free\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field(Vpools_top__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field\n"); );
    // Locals
    std::string __Vfunc_m_current_context__14__Vfuncout;
    // Body
    if ((1U & (~ (0U != radix)))) {
        radix = Vpools_top_uvm_pkg__03a__03auvm_recorder::__PVT__default_radix;
    }
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_int(Vpools_top__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_int\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_real(Vpools_top__Syms* __restrict vlSymsp, std::string name, double value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_real\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_current_context(Vpools_top__Syms* __restrict vlSymsp, std::string name, std::string &m_current_context__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_current_context\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_object(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_object\n"); );
    // Locals
    ...
    v = 0;
    std::string str;
    if (Vpools_top_uvm_pkg__03a__03auvm_recorder::__PVT__identifier) {
        if ((VlNull{} != value)) {
    ...
    Vpools_top_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_object(vlProcess, vlSymsp, name, value);
    if ((1U < ([&]() {
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_string(Vpools_top__Syms* __restrict vlSymsp, std::string name, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_string\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_time(Vpools_top__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_time\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_generic(Vpools_top__Syms* __restrict vlSymsp, std::string name, std::string value, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_generic\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute(Vpools_top__Syms* __restrict vlSymsp, std::string nm, VlWide<128>/*4095:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        __Vtemp_4 = ([&]() {
                ...
                __Vfunc_uvm_bitstream_to_string__34__unnamedblk3__DOT__unnamedblk4__DOT__idx = 0;
                {
                    ...
                    VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vpools_top__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__34__size);
        ...
        __Vtemp_5 = Vpools_top___024unit::__Venumtab_enum_name3
            .at(radix);
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int(Vpools_top__Syms* __restrict vlSymsp, std::string nm, QData/*63:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        __Vtemp_2 = Vpools_top___024unit::__Venumtab_enum_name3
            .at(radix);
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_open_file(Vpools_top__Syms* __restrict vlSymsp, CData/*0:0*/ &open_file__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_open_file\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create_stream(Vpools_top__Syms* __restrict vlSymsp, std::string name, std::string t, std::string scope, IData/*31:0*/ &create_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create_stream\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__40__Vfuncout;
    __Vfunc_open_file__40__Vfuncout = 0;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tr_stream> __Vtask_open_stream__41__Vfuncout;
    IData/*31:0*/ __Vtask_get_handle__42__Vfuncout;
    __Vtask_get_handle__42__Vfuncout = 0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_text_tr_stream> stream;
    {
        if (([&]() {
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_set_attribute(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_set_attribute\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_set_attribute(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, VlWide<32>/*1023:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_set_attribute\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        __Vtemp_4 = ([&]() {
                ...
                __Vfunc_uvm_bitstream_to_string__45__unnamedblk3__DOT__unnamedblk4__DOT__idx = 0;
                {
                    ...
                    VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vpools_top__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__45__size);
                    VL_SUB_W(128, __Vtemp_3, __Vtemp_2, Vpools_top__ConstPool__CONST_h1958c06c_0);
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_check_handle_kind(Vpools_top__Syms* __restrict vlSymsp, std::string htype, IData/*31:0*/ handle, IData/*31:0*/ &check_handle_kind__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_check_handle_kind\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__46__Vfuncout;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_get_stream_from_handle__47__Vfuncout;
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_begin_tr(Vpools_top__Syms* __restrict vlSymsp, std::string txtype, IData/*31:0*/ stream, std::string nm, std::string label, std::string desc, QData/*63:0*/ begin_time, IData/*31:0*/ &begin_tr__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_begin_tr\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__48__Vfuncout;
    __Vfunc_open_file__48__Vfuncout = 0;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_get_stream_from_handle__49__Vfuncout;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_recorder> __Vtask_open_recorder__50__Vfuncout;
    IData/*31:0*/ __Vtask_get_handle__51__Vfuncout;
    __Vtask_get_handle__51__Vfuncout = 0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tr_stream> unnamedblk5__DOT__stream_obj;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_recorder> unnamedblk5__DOT__recorder;
    {
        if (([&]() {
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_end_tr(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ handle, QData/*63:0*/ end_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_end_tr\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__52__Vfuncout;
    __Vfunc_open_file__52__Vfuncout = 0;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__53__Vfuncout;
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_recorder> unnamedblk6__DOT__record;
    if (([&]() {
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_link_tr(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ h1, IData/*31:0*/ h2, std::string relation) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_link_tr\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_free_tr(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ handle) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_free_tr\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__56__Vfuncout;
    __Vfunc_open_file__56__Vfuncout = 0;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__57__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_recorder> unnamedblk7__DOT__record;
    if (([&]() {
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vbasic_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vpools_top_uvm_pkg__03a__03auvm_text_recorder::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_text_recorder>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_text_recorder::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_text_recorder::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_text_recorder::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vpools_top_uvm_pkg__03a__03auvm_recorder::to_string_middle();
    return (out);
}
