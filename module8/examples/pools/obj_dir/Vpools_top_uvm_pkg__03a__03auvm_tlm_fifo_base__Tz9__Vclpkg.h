...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ9__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ9__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi119;
class Vpools_top_uvm_pkg__03a__03auvm_analysis_port__Tz9;
class Vpools_top_uvm_pkg__03a__03auvm_component;
class Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230;
class Vpools_top_uvm_pkg__03a__03auvm_object_wrapper;
class Vpools_top_uvm_pkg__03a__03auvm_put_imp__Tz9_TBz230;
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz9__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz9__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz9__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz9__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi119> &get_type__Vfuncrtn);
};
...
class Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz9 : public Vpools_top_uvm_pkg__03a__03auvm_component {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_put_imp__Tz9_TBz230> __PVT__put_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__get_peek_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_analysis_port__Tz9> __PVT__put_ap;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_analysis_port__Tz9> __PVT__get_ap;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_put_imp__Tz9_TBz230> __PVT__blocking_put_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_put_imp__Tz9_TBz230> __PVT__nonblocking_put_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__blocking_get_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__nonblocking_get_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__get_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__blocking_peek_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__nonblocking_peek_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__peek_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__blocking_get_peek_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_get_peek_imp__Tz9_TBz230> __PVT__nonblocking_get_peek_export;
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz9(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz9() {}
};
