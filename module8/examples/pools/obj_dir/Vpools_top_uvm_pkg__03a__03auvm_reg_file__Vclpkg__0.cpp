    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        if ((VlNull{} == blk_parent)) {
            ...
            void Vpools_top_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
                ...
                // Body
                VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_queue__Tz49> unnamedblk392__DOT__hdl_paths;
            ...
            void Vpools_top_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vsetup_constraints(Vpools_top__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vsetup_constraints\n"); );
            }

            void Vpools_top_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___VBasicRand(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___VBasicRand\n"); );
                // Body
            ...
            Vpools_top_uvm_pkg__03a__03auvm_reg_file::~Vpools_top_uvm_pkg__03a__03auvm_reg_file() {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_reg_file::~\n"); );
            }
