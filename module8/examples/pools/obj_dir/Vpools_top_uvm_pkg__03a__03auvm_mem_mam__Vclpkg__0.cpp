...
Vpools_top_uvm_pkg__03a__03auvm_mem_mam::Vpools_top_uvm_pkg__03a__03auvm_mem_mam(Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem> mem) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    this->__PVT__for_each_idx = 0xffffffffU;
    this->__PVT__cfg = cfg;
    this->__PVT__memory = mem;
    this->__PVT__default_alloc = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_mem_mam_policy, vlSymsp);
}

void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reconfigure(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_mam_cfg> &reconfigure__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reconfigure\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reserve_region(Vpools_top__Syms* __restrict vlSymsp, QData/*63:0*/ start_offset, IData/*31:0*/ n_bytes, std::string fname, IData/*31:0*/ lineno, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_region> &reserve_region__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reserve_region\n"); );
    // Locals
    ...
    end_offset = 0;
    {
        ...
        while (VL_LTS_III(32, unnamedblk397__DOT__i, this->__PVT__in_use.size())) {
            ...
            if ((start_offset > ([&]() {
                ...
                reserve_region__Vfuncrtn = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_mem_region, vlSymsp, start_offset, end_offset, 
                                                  ((IData)(1U) 
                                                   + 
                                                   ((IData)(end_offset) 
                                                    - (IData)(start_offset))), n_bytes, 
                                                  VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_mam>{this});
...
void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_request_region(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ n_bytes, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, std::string fname, IData/*31:0*/ lineno, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_region> &request_region__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_request_region\n"); );
    // Locals
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_region> __Vfunc_reserve_region__64__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        this->__PVT__fname = fname;
...
void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_region(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_region> region) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_region\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_all_regions(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_all_regions\n"); );
    // Body
    this->__PVT__in_use.clear();
}

void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_convert2string(Vpools_top__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_convert2string\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_for_each(Vpools_top__Syms* __restrict vlSymsp, CData/*0:0*/ reset, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_region> &for_each__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_for_each\n"); );
    // Body
    {
        if (reset) {
            this->__PVT__for_each_idx = 0xffffffffU;
...
void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_get_memory(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_get_memory\n"); );
    // Body
    get_memory__Vfuncrtn = this->__PVT__memory;
}

void Vpools_top_uvm_pkg__03a__03auvm_mem_mam::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_mem_mam>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_mem_mam::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_mem_mam::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_mem_mam::to_string_middle\n"); );
    // Body
    std::string out;
