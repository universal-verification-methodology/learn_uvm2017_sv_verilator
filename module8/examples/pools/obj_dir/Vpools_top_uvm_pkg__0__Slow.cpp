...
VL_ATTR_COLD void Vpools_top_uvm_pkg___eval_static__TOP__uvm_pkg(Vpools_top_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vpools_top_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
...
VL_ATTR_COLD void Vpools_top_uvm_pkg___ctor_var_reset(Vpools_top_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vpools_top_uvm_pkg___ctor_var_reset\n"); );
    Vpools_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
