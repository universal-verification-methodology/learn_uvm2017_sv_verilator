...
void Vpools_top___024root__trace_chg_0_sub_0(Vpools_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vpools_top___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpools_top___024root__trace_chg_0\n"); );
    // Body
    ...
    Vpools_top___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vpools_top___024root__trace_chg_0_sub_0(Vpools_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpools_top___024root__trace_chg_0_sub_0\n"); );
    Vpools_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vpools_top___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpools_top___024root__trace_cleanup\n"); );
    // Body
    Vpools_top___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vpools_top___024root*>(voidSelf);
    Vpools_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
