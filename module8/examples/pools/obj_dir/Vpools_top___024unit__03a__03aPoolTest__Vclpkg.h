...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top___024unit__03a__03aPoolTest__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top___024unit__03a__03aPoolTest__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
