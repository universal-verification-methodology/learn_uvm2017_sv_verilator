...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ172__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ172__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vpools_top_std__03a__03amailbox__Tz172;
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component_registry__Tz248> &get_type__Vfuncrtn);
...
class Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172 : public Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz172 {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_size;
    IData/*31:0*/ __PVT__m_pending_blocked_gets;
    VlClassRef<Vpools_top_std__03a__03amailbox__Tz172> __PVT__m;
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ size);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172() {}
};
