...
void Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167::__VnoInFunc_do_print(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_printer> printer) {
    ...
    // Body
    std::string key;
    VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_pool.svh", 323)->__VnoInFunc_print_array_header(vlProcess, vlSymsp, "pool"s, Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz167::__PVT__pool.size(), "aa_object_string"s, 0x2eU);
...
void Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167::__VnoInFunc___Vsetup_constraints(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167::__VnoInFunc___VBasicRand(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167::~Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vpools_top_uvm_pkg__03a__03auvm_object_string_pool__Tz167::~\n"); );
}
