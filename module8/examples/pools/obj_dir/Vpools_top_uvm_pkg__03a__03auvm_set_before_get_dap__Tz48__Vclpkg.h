...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ48__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ48__VCLPKG_H_  // guard
...
class Vpools_top_uvm_pkg__03a__03auvm_set_get_dap_base__Tz48;


class Vpools_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_set_before_get_dap__Tz48__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_set_before_get_dap__Tz48__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_set_before_get_dap__Tz48__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_set_before_get_dap__Tz48__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz94> &get_type__Vfuncrtn);
};
...
class Vpools_top_uvm_pkg__03a__03auvm_set_before_get_dap__Tz48 : public Vpools_top_uvm_pkg__03a__03auvm_set_get_dap_base__Tz48 {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m_set;
    VlClassRef<Vpools_top_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __PVT__m_value;
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_set_before_get_dap__Tz48(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_set_before_get_dap__Tz48() {}
};
