...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI69__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI69__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vpools_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69__Vclpkg);
    ...
    void __VnoInFunc_get(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69> &get__Vfuncrtn);
...
class Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69 : public Vpools_top_uvm_pkg__03a__03auvm_object_wrapper {
  public:
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69(Vpools_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi69() {}
};
