...
VlCoroutine Vpools_top_uvm_pkg__03a__03auvm_queue__Tz57::__VnoInFunc_wait_until_not_empty(Vpools_top__Syms* __restrict vlSymsp) {
    ...
    if (VL_GTES_III(32, 0U, this->__PVT__queue.size())) {
        CData/*0:0*/ __VdynTrigger_hdffbb5ac__0;
        __VdynTrigger_hdffbb5ac__0 = 0;
        __VdynTrigger_hdffbb5ac__0 = 0U;
        while ((1U & (~ (IData)(__VdynTrigger_hdffbb5ac__0)))) {
            co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                         ...
                                                         196);
            this->__Vtrigprevexpr_he5f4213d__0 = VL_LTS_III(32, 0U, this->__PVT__queue.size());
            __VdynTrigger_hdffbb5ac__0 = this->__Vtrigprevexpr_he5f4213d__0;
            vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hdffbb5ac__0);
        }
...
void Vpools_top_uvm_pkg__03a__03auvm_queue__Tz57::__VnoInFunc___Vbasic_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_queue__Tz57::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_queue__Tz57::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    ...
    __Vtrigprevexpr_he5f4213d__0 = VL_SCOPED_RAND_RESET_I(1, 14992577363911994802ULL, 761405212298684490ull);
}
