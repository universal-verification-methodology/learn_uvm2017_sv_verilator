...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE___VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE___VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vpools_top_uvm_pkg__03a__03auvm_analysis_export__Tz9;
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg);
...
class Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base_ : public Vpools_top_uvm_pkg__03a__03auvm_sequencer_base {
  public:
    ...
    VlQueue<VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item>> __PVT__m_last_req_buffer;
    VlQueue<VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item>> __PVT__m_last_rsp_buffer;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_> __PVT__sqr_rsp_analysis_fifo;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_analysis_export__Tz9> __PVT__rsp_export;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz9> __PVT__m_req_fifo;
    ...
    void __VnoInFunc_last_req(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item> &last_req__Vfuncrtn);
    void __VnoInFunc_last_rsp(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item> &last_rsp__Vfuncrtn);
    void __VnoInFunc_m_last_req_push_front(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item> item);
    void __VnoInFunc_m_last_rsp_push_front(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item> item);
    void __VnoInFunc_put_response(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item> t);
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base_(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base_() {}
};
