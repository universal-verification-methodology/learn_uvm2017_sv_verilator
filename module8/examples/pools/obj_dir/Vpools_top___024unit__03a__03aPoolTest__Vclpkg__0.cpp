...
void Vpools_top___024unit__03a__03aPoolTest::__VnoInFunc_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    ...
    // Locals
    IData/*31:0*/ __Vfunc___Vbasic_randomize__15__Vfuncout;
    __Vfunc___Vbasic_randomize__15__Vfuncout = 0;
    // Body
    ...
    randomize__Vfuncrtn = (randomize__Vfuncrtn & ([&]() {
                this->__VnoInFunc___Vbasic_randomize(vlSymsp, __Vfunc___Vbasic_randomize__15__Vfuncout);
            }(), __Vfunc___Vbasic_randomize__15__Vfuncout));
}

void Vpools_top___024unit__03a__03aPoolTest::__VnoInFunc___Vbasic_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vpools_top___024unit__03a__03aPoolTest::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
