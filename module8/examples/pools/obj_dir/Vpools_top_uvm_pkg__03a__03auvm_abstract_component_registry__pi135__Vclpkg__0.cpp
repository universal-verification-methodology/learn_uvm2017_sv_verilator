...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_get(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_create(Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz172> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz172> __Vfunc_create__2__Vfuncout;
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_set_type_override(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_set_inst_override(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_set_type_alias(Vpools_top__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::__VnoInFunc_create_component(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::__VnoInFunc_create_component\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::__VnoInFunc_get_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi136> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi136> common;
...
void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::__VnoInFunc_initialize(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi136> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi136> common;
...
Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135(Vpools_top__Syms* __restrict vlSymsp)
    : Vpools_top_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::~Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vpools_top_uvm_pkg__03a__03auvm_abstract_component_registry__pi135::to_string_middle\n"); );
    // Body
    std::string out;
