    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        ...
        if ((unnamedblk1__DOT__cb_base_type == this->__PVT__m_cb_typeid)) {
            if (VL_UNLIKELY(((1U & (~ (0U != ([&]() {
                ...
                VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz63.get.unnamedblk1: 'assert' failed.\n",0,
...
void Vpools_top_uvm_pkg__03a__03auvm_callbacks__Tz63::__VnoInFunc___Vbasic_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_callbacks__Tz63::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
