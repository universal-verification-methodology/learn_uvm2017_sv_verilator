...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ141__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ141__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_queue__Tz57> __PVT__m_tw_cb_q;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vpools_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141> &m_initialize__Vfuncrtn);
};
...
class Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141 : public Vpools_top_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_typed_callbacks__Tz141() {}
};
