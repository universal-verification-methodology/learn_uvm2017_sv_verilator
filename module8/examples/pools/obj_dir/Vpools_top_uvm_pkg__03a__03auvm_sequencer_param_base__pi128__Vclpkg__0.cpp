...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_current_item(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> &get_current_item__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_current_item\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_peek__0__Vfuncout;
    __Vtask_try_peek__0__Vfuncout = 0;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> __Vtask_try_peek__0__t;
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_last_req(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> &last_req__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_last_req\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_last_rsp(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> &last_rsp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_last_rsp\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
...
Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent)
    : Vpools_top_uvm_pkg__03a__03auvm_sequencer_base(vlProcess, vlSymsp, name, parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::new\n"); );
    // Body
    ...
    ;
    this->__PVT__rsp_export = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_analysis_export__Tz172, vlProcess, vlSymsp, "rsp_export"s, 
                                     VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128>{this});
    this->__PVT__sqr_rsp_analysis_fifo = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_sequencer_analysis_fifo__pi133, vlProcess, vlSymsp, "sqr_rsp_analysis_fifo"s, 
                                                VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128>{this});
    ...
    this->__PVT__m_req_fifo = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_tlm_fifo__Tz172, vlProcess, vlSymsp, "req_fifo"s, 
                                     VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128>{this}, 1U);
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_do_print(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_do_print\n"); );
    // Body
    Vpools_top_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_do_print(vlProcess, vlSymsp, printer);
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_connect_phase(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_connect_phase\n"); );
    // Body
    Vpools_top_uvm_pkg__03a__03auvm_component::__VnoInFunc_connect_phase(vlProcess, vlSymsp, phase);
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_build_phase(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_build_phase\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_send_request(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ rerandomize) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_send_request\n"); );
    // Locals
    ...
    __Vincrement1 = 0;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> param_t;
    ...
    VL_NULL_CHECK(param_t, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_param_base.svh", 302)->__VnoInFunc_set_sequence_id(vlSymsp, 
                ...
                VL_NULL_CHECK(sequence_ptr, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_param_base.svh", 302)
                                                                                ->__VnoInFunc_m_get_sqr_sequence_id(vlSymsp, Vpools_top_uvm_pkg__03a__03auvm_sequencer_base::__PVT__m_sequencer_id, 1U, __Vtask_m_get_sqr_sequence_id__22__Vfuncout);
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_put_response(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_put_response\n"); );
    // Locals
    IData/*31:0*/ __Vtask_get_sequence_id__29__Vfuncout;
    __Vtask_get_sequence_id__29__Vfuncout = 0;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_base> __Vfunc_m_find_sequence__31__Vfuncout;
    ...
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr;
    {
        if ((VlNull{} == t)) {
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_analysis_write(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_analysis_write\n"); );
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> response;
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_reqs_sent(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_reqs_sent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_reqs_sent\n"); );
    // Body
    get_num_reqs_sent__Vfuncrtn = this->__PVT__m_num_reqs_sent;
}

void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_rsps_received(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_rsps_received__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_rsps_received\n"); );
    // Body
    get_num_rsps_received__Vfuncrtn = this->__PVT__m_num_rsps_received;
}

void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_set_num_last_reqs(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_set_num_last_reqs\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0x00000400U < max)) {
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_last_reqs(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_reqs__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_last_reqs\n"); );
    // Body
    get_num_last_reqs__Vfuncrtn = this->__PVT__m_num_last_reqs;
}

void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_m_last_req_push_front(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_m_last_req_push_front\n"); );
    // Body
    {
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_set_num_last_rsps(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_set_num_last_rsps\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0x00000400U < max)) {
        this->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, "HSTOB"s, "Invalid last size; 1024 is the maximum and will be used"s, 0x000000c8U, ""s, 0U, ""s, 0U);
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_last_rsps(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_rsps__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_get_num_last_rsps\n"); );
    // Body
    get_num_last_rsps__Vfuncrtn = this->__PVT__m_num_last_rsps;
}

void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_m_last_rsp_push_front(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_reg_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_m_last_rsp_push_front\n"); );
    // Body
    {
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc___Vsetup_constraints(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc___VBasicRand(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::_ctor_var_reset\n"); );
    // Body
...
Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::~Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vpools_top_uvm_pkg__03a__03auvm_sequencer_param_base__pi128::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vpools_top_uvm_pkg__03a__03auvm_sequencer_base::to_string_middle();
    return (out);
}
