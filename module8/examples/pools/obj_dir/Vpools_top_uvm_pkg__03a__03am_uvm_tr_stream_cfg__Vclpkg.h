...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03am_uvm_tr_stream_cfg__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03am_uvm_tr_stream_cfg__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
