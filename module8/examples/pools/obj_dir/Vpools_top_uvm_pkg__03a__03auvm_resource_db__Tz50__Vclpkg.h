...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ50__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ50__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_resource_db__Tz50__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_dump(Vpools_top__Syms* __restrict vlSymsp);
    void __VnoInFunc_get_by_name(Vpools_top__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_resource_> &get_by_name__Vfuncrtn);
    void __VnoInFunc_get_by_type(Vpools_top__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_resource_> &get_by_type__Vfuncrtn);
    void __VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_resource_> rsrc);
    ...
    void __VnoInFunc_set_default(Vpools_top__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_resource_> &set_default__Vfuncrtn);
...
class Vpools_top_uvm_pkg__03a__03auvm_resource_db__Tz50 : public virtual VlClass {
  public:
  private:
    void _ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp);
  public:
    Vpools_top_uvm_pkg__03a__03auvm_resource_db__Tz50(Vpools_top__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_resource_db__Tz50() {}
};
