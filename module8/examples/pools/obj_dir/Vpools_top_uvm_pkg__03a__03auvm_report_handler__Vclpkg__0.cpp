...
void Vpools_top_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_do_print(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_printer> printer) {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        ...
                        if ((0U != (Vpools_top___024unit::__Venumtab_enum_valid25
                            ...
                            __Vtemp_2 = Vpools_top___024unit::__Venumtab_enum_name21
                                [l_severity];
                            ...
                            unnamedblk2__DOT__unnamedblk4__DOT__unnamedblk5__DOT__l_str 
                                = VL_SFORMATF_N_NX("%0d",0,
                                                   32,
                                                   l_int) ;
                            __Vtemp_3 = Vpools_top___024unit::__Venumtab_enum_name21
                                [l_severity];
        ...
        if ((0U != this->__PVT__severity_id_actions.first(l_severity))) {
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        __Vtemp_5 = Vpools_top___024unit::__Venumtab_enum_name21
                            [l_severity];
    ...
    if ((0U != ([&]() {
        ...
        do {
            ...
            __Vtemp_6 = Vpools_top___024unit::__Venumtab_enum_name21
                [l_severity];
            ...
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        ...
                        __Vtemp_7 = Vpools_top___024unit::__Venumtab_enum_name21
                            [l_severity];
    ...
    if ((0U != this->__PVT__severity_file_handles.first(l_severity))) {
        ...
        do {
            __Vtemp_10 = Vpools_top___024unit::__Venumtab_enum_name21
                [l_severity];
        ...
        if ((0U != this->__PVT__severity_id_file_handles.first(l_severity))) {
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        __Vtemp_12 = Vpools_top___024unit::__Venumtab_enum_name21
                            [l_severity];
...
void Vpools_top_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vsetup_constraints(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vpools_top_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___VBasicRand(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vpools_top_uvm_pkg__03a__03auvm_report_handler::~Vpools_top_uvm_pkg__03a__03auvm_report_handler() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_report_handler::~\n"); );
}
