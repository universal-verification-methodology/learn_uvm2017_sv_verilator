...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_PHASE_STATE_CHANGE__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_PHASE_STATE_CHANGE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_phase_state_change__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi16> &get_type__Vfuncrtn);
...
class Vpools_top_uvm_pkg__03a__03auvm_phase_state_change : public Vpools_top_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_get_state(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &get_state__Vfuncrtn);
    virtual void __VnoInFunc_get_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn);
    void __VnoInFunc_jump_to(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_phase> &jump_to__Vfuncrtn);
