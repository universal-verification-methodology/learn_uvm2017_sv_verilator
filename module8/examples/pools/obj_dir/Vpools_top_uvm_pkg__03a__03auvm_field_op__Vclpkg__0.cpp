...
void Vpools_top_uvm_pkg__03a__03auvm_field_op__Vclpkg::__VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi8> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_field_op__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi8> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vpools_top_uvm_pkg__03a__03auvm_field_op__Vclpkg::__VnoInFunc_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_field_op__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_field_op"s;
}

void Vpools_top_uvm_pkg__03a__03auvm_field_op__Vclpkg::__VnoInFunc_m_get_available_op(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_field_op> &m_get_available_op__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_field_op__Vclpkg::__VnoInFunc_m_get_available_op\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_field_op> __Vfunc_create__1__Vfuncout;
    // Body
    ...
    field_op = (VL_LTS_III(32, 0U, this->__PVT__m_recycled_op.size())
                 ...
                 : ([&]() {
                vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "field_op"s, VlNull{}, ""s, __Vfunc_create__1__Vfuncout);
            }(), __Vfunc_create__1__Vfuncout));
    m_get_available_op__Vfuncrtn = field_op;
}

void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_object_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi8> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_create(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_field_op> tmp;
    tmp = ((""s == name) ? VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_field_op, vlProcess, vlSymsp, ""s)
            : VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_field_op, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_field_op"s;
}

Vpools_top_uvm_pkg__03a__03auvm_field_op::Vpools_top_uvm_pkg__03a__03auvm_field_op(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name)
    : Vpools_top_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::new\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_set(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, IData/*27:0*/ op_type, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_policy> policy, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_set\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_op_name(Vpools_top__Syms* __restrict vlSymsp, std::string &get_op_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_op_name\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_op_type(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, IData/*27:0*/ &get_op_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_op_type\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_policy(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_policy> &get_policy__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_policy\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_rhs(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object> &get_rhs__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_get_rhs\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_user_hook_enabled(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, CData/*0:0*/ &user_hook_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_user_hook_enabled\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_disable_user_hook(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_disable_user_hook\n"); );
    // Body
    this->__PVT__m_user_hook = 0U;
}

void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_flush(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_flush\n"); );
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_m_recycle(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_m_recycle\n"); );
    // Body
    this->__VnoInFunc_flush(vlSymsp);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_field_op__Vclpkg.__PVT__m_recycled_op.push_back(
                                                                                VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_field_op>{this});
}

void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc___Vbasic_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vpools_top_uvm_pkg__03a__03auvm_field_op::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_field_op>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_field_op::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_field_op::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_field_op::to_string_middle\n"); );
    // Body
    std::string out;
