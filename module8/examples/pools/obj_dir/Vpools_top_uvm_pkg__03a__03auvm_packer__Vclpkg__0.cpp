...
void Vpools_top_uvm_pkg__03a__03auvm_packer::__VnoInFunc___Vbasic_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vpools_top_uvm_pkg__03a__03auvm_packer::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
