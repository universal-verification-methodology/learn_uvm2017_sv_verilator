...
#ifndef VERILATED_VPOOLS_TOP___024UNIT_H_
#define VERILATED_VPOOLS_TOP___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top___024unit(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top___024unit();
    VL_UNCOPYABLE(Vpools_top___024unit);
