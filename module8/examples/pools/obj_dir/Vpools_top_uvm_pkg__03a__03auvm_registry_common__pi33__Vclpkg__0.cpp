...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_objection"s;
}

void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_get(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_create(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_objection> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> __Vfunc_get__3__Vfuncout;
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_set_type_override(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> __Vfunc_get__11__Vfuncout;
    // Body
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_set_inst_override(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_set_type_alias(Vpools_top__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> unnamedblk2__DOT__rgtry;
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> rgtry;
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::__VnoInFunc_get_type_name(Vpools_top__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::__VnoInFunc_initialize(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__pi15> __Vfunc_get__2__Vfuncout;
    // Body
...
Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::_ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vpools_top_uvm_pkg__03a__03auvm_registry_common__pi33::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
