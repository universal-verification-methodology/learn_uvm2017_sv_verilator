...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ49__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ49__VCLPKG_H_  // guard
...
class Vpools_top_uvm_pkg__03a__03auvm_set_get_dap_base__Tz49;
class Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49;


class Vpools_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz208> &get_type__Vfuncrtn);
};
...
class Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49 : public Vpools_top_uvm_pkg__03a__03auvm_set_get_dap_base__Tz49 {
  public:
    ...
    void __VnoInFunc_lock(Vpools_top__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_unlock(Vpools_top__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vpools_top__Syms* __restrict vlSymsp);
  public:
    Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_simple_lock_dap__Tz49() {}
};
