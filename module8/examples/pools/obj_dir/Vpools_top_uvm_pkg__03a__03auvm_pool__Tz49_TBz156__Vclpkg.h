...
#ifndef VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ49_TBZ156__VCLPKG_H_
#define VERILATED_VPOOLS_TOP_UVM_PKG__03A__03AUVM_POOL__TZ49_TBZ156__VCLPKG_H_  // guard
...
class Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz234;
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vpools_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156__Vclpkg(Vpools_top__Syms* symsp, const char* v__name);
    ~Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156__Vclpkg();
    VL_UNCOPYABLE(Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_object_registry__Tz234> &get_type__Vfuncrtn);
...
class Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156 : public Vpools_top_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_queue__Tz155>> __PVT__pool;
    virtual void __VnoInFunc___Vbasic_randomize(Vpools_top__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vpools_top__Syms* __restrict vlSymsp) {}
    virtual void __VnoInFunc_add(Vpools_top__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vpools_top_uvm_pkg__03a__03auvm_queue__Tz155> item);
  ...
  public:
    Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vpools_top_uvm_pkg__03a__03auvm_pool__Tz49_TBz156() {}
};
