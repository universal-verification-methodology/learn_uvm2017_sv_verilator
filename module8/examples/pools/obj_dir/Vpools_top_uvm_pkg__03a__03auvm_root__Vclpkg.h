...
class Vpools_top_uvm_pkg__03a__03a__VDynScope_23;
...
class alignas(VL_CACHE_LINE_BYTES) Vpools_top_uvm_pkg__03a__03auvm_root__Vclpkg final {
  public:
...
class Vpools_top_uvm_pkg__03a__03auvm_root : public Vpools_top_uvm_pkg__03a__03auvm_component {
  ...
  private:
    VlCoroutine __VnoInFunc_run_test____Vfork_1__0(VlProcessRef vlProcess, Vpools_top__Syms* __restrict vlSymsp, VlClassRef<Vpools_top_uvm_pkg__03a__03a__VDynScope_23> __VDynScope_run_test_0, VlClassRef<Vpools_top_std__03a__03aprocess> unnamedblk164__DOT____VforkParent);
  public:
