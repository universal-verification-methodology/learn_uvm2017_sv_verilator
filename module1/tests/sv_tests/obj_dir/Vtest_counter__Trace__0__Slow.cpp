...
VL_ATTR_COLD void Vtest_counter___024root__trace_register(Vtest_counter___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vtest_counter___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vtest_counter___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vtest_counter___024root__trace_chg_0, 0, vlSelf);
