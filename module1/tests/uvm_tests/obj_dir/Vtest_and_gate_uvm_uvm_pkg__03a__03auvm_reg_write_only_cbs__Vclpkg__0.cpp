...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_write_only_cbs::__VnoInFunc___Vbasic_randomize(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_write_only_cbs::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
