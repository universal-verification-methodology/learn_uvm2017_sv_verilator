...
#ifndef VERILATED_VTEST_AND_GATE_UVM___024UNIT__03A__03AANDGATEMONITOR__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM___024UNIT__03A__03AANDGATEMONITOR__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm___024unit__03a__03aAndGateMonitor__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_and_gate_uvm___024unit__03a__03aAndGateMonitor__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
    ~Vtest_and_gate_uvm___024unit__03a__03aAndGateMonitor__Vclpkg();
    VL_UNCOPYABLE(Vtest_and_gate_uvm___024unit__03a__03aAndGateMonitor__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component_registry__pi63> &get_type__Vfuncrtn);
    void __VnoInFunc_type_name(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn);
};

#include "Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_monitor__Vclpkg.h"

class Vtest_and_gate_uvm__Syms;

class Vtest_and_gate_uvm___024unit__03a__03aAndGateMonitor : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_monitor {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __Vtrigprevexpr_he5fca228__0;
    Vtest_and_gate_uvm_and_gate_if* __PVT__vif;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz126> __PVT__ap;
  ...
  public:
    Vtest_and_gate_uvm___024unit__03a__03aAndGateMonitor(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_and_gate_uvm___024unit__03a__03aAndGateMonitor() {}
};
