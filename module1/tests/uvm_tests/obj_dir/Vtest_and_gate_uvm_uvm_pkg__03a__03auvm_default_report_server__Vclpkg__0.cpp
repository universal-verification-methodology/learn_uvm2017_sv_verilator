...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_severity_counts(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    ...
    s = 0U;
    {
        while (true) {
            ...
            s = Vtest_and_gate_uvm___024unit::__Venumtab_enum_next9
                [s];
        }
        __Vlabel0: ;
    }
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_report_message(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_report_message> report_message, std::string report_object_name, std::string &compose_report_message__Vfuncrtn) {
    ...
    sev_string = Vtest_and_gate_uvm___024unit::__Venumtab_enum_name9
        [l_severity];
    if ((""s != ([&]() {
    ...
    if (this->__PVT__show_verbosity) {
        if ((0U != (Vtest_and_gate_uvm___024unit::__Venumtab_enum_valid13
            ...
            verbosity_str = Vtest_and_gate_uvm___024unit::__Venumtab_enum_name13
                .at(l_verbosity);
        } else {
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_report_summarize(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    ...
    if ((0U != this->__PVT__m_severity_count.first(unnamedblk11__DOT__s))) {
        ...
        while (((IData)(unnamedblk11__DOT__s__Vfirst) 
            ...
            __Vtemp_1 = Vtest_and_gate_uvm___024unit::__Venumtab_enum_name9
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vbasic_randomize(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
