...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_PORT_BASE__TZ300__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_PORT_BASE__TZ300__VCLPKG_H_  // guard
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_component__Tz303;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_component_base;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_root;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz224_TBz224;
...
#include "Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz224_TBz224__Vclpkg.h"

class Vtest_and_gate_uvm__Syms;

class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300 : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz224_TBz224 {
  public:
    ...
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300> __PVT__m_if;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_component__Tz303> __PVT__m_comp;
    VlAssocArray<std::string, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300>> __PVT__m_provided_by;
    VlAssocArray<std::string, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300>> __PVT__m_provided_to;
    VlAssocArray<std::string, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300>> __PVT__m_imp_list;
    virtual void __VnoInFunc_connect(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300> provider);
    ...
    void __VnoInFunc_get_connected_to(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300>> &list);
    ...
    void __VnoInFunc_get_if(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300> &get_if__Vfuncrtn);
    ...
    void __VnoInFunc_get_provided_to(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300>> &list);
    ...
    void __VnoInFunc_m_add_list(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300> provider);
    void __VnoInFunc_m_check_relationship(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_port_base__Tz300> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn);
