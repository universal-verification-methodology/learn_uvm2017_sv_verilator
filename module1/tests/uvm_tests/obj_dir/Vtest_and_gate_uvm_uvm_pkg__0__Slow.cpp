...
VL_ATTR_COLD void Vtest_and_gate_uvm_uvm_pkg___eval_static__TOP__uvm_pkg(Vtest_and_gate_uvm_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_and_gate_uvm_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
...
VL_ATTR_COLD void Vtest_and_gate_uvm_uvm_pkg___ctor_var_reset(Vtest_and_gate_uvm_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_and_gate_uvm_uvm_pkg___ctor_var_reset\n"); );
    Vtest_and_gate_uvm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
