...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_POOL__TZ23_TBZ23__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_POOL__TZ23_TBZ23__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz23_TBz23__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_global(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ key, CData/*1:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz23_TBz23> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_registry__Tz76> &get_type__Vfuncrtn);
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz23_TBz23 : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_exists(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ key, IData/*31:0*/ &exists__Vfuncrtn);
    virtual void __VnoInFunc_first(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &first__Vfuncrtn);
    virtual void __VnoInFunc_get(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ key, CData/*1:0*/ &get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_last(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &last__Vfuncrtn);
    virtual void __VnoInFunc_next(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &next__Vfuncrtn);
    virtual void __VnoInFunc_num(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &num__Vfuncrtn);
    virtual void __VnoInFunc_prev(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ &key, IData/*31:0*/ &prev__Vfuncrtn);
