...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string nm, VlWide<128>/*4095:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        __Vtemp_5 = Vtest_and_gate_uvm___024unit::__Venumtab_enum_name15
            .at(radix);
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string nm, QData/*63:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        __Vtemp_2 = Vtest_and_gate_uvm___024unit::__Venumtab_enum_name15
            .at(radix);
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vsetup_constraints(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___VBasicRand(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_recorder::~\n"); );
}
