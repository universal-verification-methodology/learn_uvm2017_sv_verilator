...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc_do_open_stream(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream> &do_open_stream__Vfuncrtn) {
    ...
    // Locals
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_tr_stream> __Vfunc_create__9__Vfuncout;
    // Body
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc_do_establish_link(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_link_base> link) {
    ...
    // Locals
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object> __Vtask_get_lhs__10__Vfuncout;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object> __Vtask_get_rhs__11__Vfuncout;
    ...
    // Body
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_parent_child_link> unnamedblk1__DOT__pc_link;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_related_link> unnamedblk1__DOT__re_link;
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc___Vbasic_randomize(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
