...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc_uvm_report_info(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___Vbasic_randomize(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
