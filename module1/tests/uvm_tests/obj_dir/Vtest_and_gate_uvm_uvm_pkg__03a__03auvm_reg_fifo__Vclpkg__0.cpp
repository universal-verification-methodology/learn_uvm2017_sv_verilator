...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_valid_fifo_size_setup_constraint(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    ...
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard(VL_SFORMATF_N_NX("(__Vbv (bvule __Vfifo_size %@))",0,
                                                                                -1,
                                                                                &(__Vtemp_1)) );
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard("(__Vbv (bvsge __Vfifo_size #x00000000))"s);
}
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___Vbasic_randomize(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
