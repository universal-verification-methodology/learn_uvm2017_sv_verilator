...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_HEARTBEAT_CALLBACK__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_HEARTBEAT_CALLBACK__VCLPKG_H_  // guard
...
#include "Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_objection_callback__Vclpkg.h"

class Vtest_and_gate_uvm__Syms;

class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_heartbeat_callback : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_objection_callback {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object>, IData/*31:0*/> __PVT__cnt;
    ...
    void __VnoInFunc_reset_counts(Vtest_and_gate_uvm__Syms* __restrict vlSymsp);
  private:
