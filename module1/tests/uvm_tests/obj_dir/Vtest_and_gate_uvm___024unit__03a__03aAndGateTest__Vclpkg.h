...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm___024unit__03a__03aAndGateTest__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_and_gate_uvm___024unit__03a__03aAndGateTest__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
