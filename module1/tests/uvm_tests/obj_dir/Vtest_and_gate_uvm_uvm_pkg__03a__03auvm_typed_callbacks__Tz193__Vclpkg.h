...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ193__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ193__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_queue__Tz48> __PVT__m_tw_cb_q;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vtest_and_gate_uvm__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
    ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193__Vclpkg();
    VL_UNCOPYABLE(Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193> &m_initialize__Vfuncrtn);
};
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193 : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz193() {}
};
