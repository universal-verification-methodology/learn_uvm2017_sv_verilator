...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ174__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ174__VCLPKG_H_  // guard
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_registry__Tz243;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_wrapper;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174;
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vtest_and_gate_uvm__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
    ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174__Vclpkg();
    VL_UNCOPYABLE(Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource__Tz2> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_registry__Tz243> &get_type__Vfuncrtn);
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174 : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource__Tz2>> __PVT__pool;
    ...
    virtual void __VnoInFunc_add(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource__Tz2> item);
    ...
    virtual void __VnoInFunc_get(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource__Tz2> &get__Vfuncrtn);
  ...
  public:
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz174() {}
};
