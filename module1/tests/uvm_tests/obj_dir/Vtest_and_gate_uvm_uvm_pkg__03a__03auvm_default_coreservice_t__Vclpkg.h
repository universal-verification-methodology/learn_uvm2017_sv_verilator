...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_  // guard
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component_name_check_visitor;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_copier;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_coreservice_t;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_factory;
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
    ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg();
    VL_UNCOPYABLE(Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
};

#include "Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_coreservice_t__Vclpkg.h"

class Vtest_and_gate_uvm__Syms;

class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_coreservice_t : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_coreservice_t {
  public:
    ...
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_factory> __PVT__factory;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_database> __PVT__tr_database;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_report_server> __PVT__report_server;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_visitor_> __PVT___visitor;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_printer> __PVT__m_printer;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_packer> __PVT__m_packer;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_comparer> __PVT__m_comparer;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource_pool> __PVT__m_rp;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_copier> __PVT__m_copier;
  ...
  public:
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_coreservice_t(Vtest_and_gate_uvm__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_default_coreservice_t() {}
};
