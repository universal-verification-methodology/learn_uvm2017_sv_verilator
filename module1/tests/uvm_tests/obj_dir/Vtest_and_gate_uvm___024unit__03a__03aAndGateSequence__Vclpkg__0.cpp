...
void Vtest_and_gate_uvm___024unit__03a__03aAndGateSequence::__VnoInFunc___Vsetup_constraints(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_and_gate_uvm___024unit__03a__03aAndGateSequence::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtest_and_gate_uvm___024unit__03a__03aAndGateSequence::__VnoInFunc___VBasicRand(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_and_gate_uvm___024unit__03a__03aAndGateSequence::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vtest_and_gate_uvm___024unit__03a__03aAndGateSequence::~Vtest_and_gate_uvm___024unit__03a__03aAndGateSequence() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_and_gate_uvm___024unit__03a__03aAndGateSequence::~\n"); );
}
