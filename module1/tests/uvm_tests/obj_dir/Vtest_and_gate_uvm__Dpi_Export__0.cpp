...
void Vtest_and_gate_uvm::m__uvm_report_dpi(int severity, const char* id, const char* message, int verbosity, const char* filename, int line) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_and_gate_uvm___024root::m__uvm_report_dpi\n"); );
    // Locals
    ...
    Vtest_and_gate_uvm__Vcb_m___05Fuvm_report_dpi_t __Vcb = reinterpret_cast<Vtest_and_gate_uvm__Vcb_m___05Fuvm_report_dpi_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    ...
    line__Vcvt = (line);
    (*__Vcb)((Vtest_and_gate_uvm__Syms*)(__Vscopep->symsp()), severity__Vcvt, id__Vcvt, message__Vcvt, verbosity__Vcvt, filename__Vcvt, line__Vcvt);
}
