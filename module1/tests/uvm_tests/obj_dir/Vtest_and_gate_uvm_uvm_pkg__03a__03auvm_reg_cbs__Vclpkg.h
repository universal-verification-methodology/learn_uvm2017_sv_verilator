...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_REG_CBS__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_REG_CBS__VCLPKG_H_  // guard
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_registry__pi108;
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
    ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg();
    VL_UNCOPYABLE(Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_registry__pi108> &get_type__Vfuncrtn);
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_cbs : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_callback {
  public:
    ...
    virtual void __VnoInFunc_decode(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &data);
    virtual void __VnoInFunc_encode(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &data);
    ...
    virtual void __VnoInFunc_post_predict(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_field> fld, QData/*63:0*/ previous, QData/*63:0*/ &value, IData/*31:0*/ kind, IData/*31:0*/ path, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_map> map);
  ...
  public:
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_cbs(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_cbs() {}
};
