...
#ifndef VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ26__VCLPKG_H_
#define VERILATED_VTEST_AND_GATE_UVM_UVM_PKG__03A__03AUVM_TLM_FIFO_BASE__TZ26__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi153;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz26;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_wrapper;
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_put_imp__Tz26_TBz281;
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
    ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26__Vclpkg();
    VL_UNCOPYABLE(Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi153> &get_type__Vfuncrtn);
};
...
class Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26 : public Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_put_imp__Tz26_TBz281> __PVT__put_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__get_peek_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz26> __PVT__put_ap;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz26> __PVT__get_ap;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_put_imp__Tz26_TBz281> __PVT__blocking_put_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_put_imp__Tz26_TBz281> __PVT__nonblocking_put_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__blocking_get_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__nonblocking_get_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__get_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__blocking_peek_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__nonblocking_peek_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__peek_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__blocking_get_peek_export;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_get_peek_imp__Tz26_TBz281> __PVT__nonblocking_get_peek_export;
  ...
  public:
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26() {}
};
