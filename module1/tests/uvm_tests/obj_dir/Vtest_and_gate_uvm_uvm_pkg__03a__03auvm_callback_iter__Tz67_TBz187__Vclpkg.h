...
class alignas(VL_CACHE_LINE_BYTES) Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_callback_iter__Tz67_TBz187__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_callback_iter__Tz67_TBz187__Vclpkg(Vtest_and_gate_uvm__Syms* symsp, const char* v__name);
