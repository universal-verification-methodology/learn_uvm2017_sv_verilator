...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ id, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream> &get_stream_from_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle\n"); );
    // Body
    {
        if ((0U == id)) {
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id\n"); );
    // Body
...
Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name)
    : Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
    this->__PVT__m_cfg_dap = VL_NEW(Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18, vlProcess, vlSymsp, "cfg_dap"s);
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_database> &get_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__2__Vfuncout;
    __Vtask_try_get__2__Vfuncout = 0;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__2__value;
    ...
    // Body
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    {
        if ((1U & (~ ([&]() {
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string &get_scope__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__12__Vfuncout;
    __Vtask_try_get__12__Vfuncout = 0;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__12__value;
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string &get_stream_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__22__Vfuncout;
    __Vtask_try_get__22__Vfuncout = 0;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__22__value;
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close\n"); );
    // Locals
    ...
    // Body
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk1__DOT__idx;
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free\n"); );
    // Locals
    ...
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_database> __Vfunc_get_db__42__Vfuncout;
    ...
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk2__DOT__idx;
    ...
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
                                                                                VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream>{this})) {
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open\n"); );
    // Locals
    ...
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__58__value;
    ...
    // Body
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_database> m_db;
    {
        if ((VlNull{} == db)) {
            if ((0U != ([&]() {
        ...
        if (([&]() {
            ...
            m_cfg = VL_NEW(Vtest_and_gate_uvm_uvm_pkg__03a__03am_uvm_tr_stream_cfg, vlSymsp);
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &is_closed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed\n"); );
    // Body
    is_closed__Vfuncrtn = this->__PVT__m_is_closed;
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder> &open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_is_open__71__Vfuncout;
    __Vfunc_is_open__71__Vfuncout = 0;
    VlClassRef<Vtest_and_gate_uvm_std__03a__03aprocess> __Vfunc_self__72__Vfuncout;
    std::string __Vtask_get_randstate__73__Vfuncout;
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder> __Vfunc_do_open_recorder__74__Vfuncout;
    // Body
    ...
    if (([&]() {
        ...
        if ((VlNull{} != open_recorder__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_recorder__Vfuncrtn, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_tr_stream.svh", 285)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream>{this}, m_time, type_name);
        }
        if ((VlNull{} != unnamedblk3__DOT__p)) {
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder\n"); );
    // Body
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder>> &q, CData/*0:0*/ &get_recorders__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders\n"); );
    // Body
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__idx;
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle\n"); );
    // Locals
    ...
    if ((1U & ((~ ([&]() {
        ...
        if ((vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
             ...
             && (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream
                 .at(VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream>{this}) 
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open\n"); );
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close\n"); );
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free\n"); );
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_recorder> &do_open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder\n"); );
    // Body
    do_open_recorder__Vfuncrtn = VlNull{};
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset\n"); );
    // Body
...
Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_tr_stream::to_string_middle\n"); );
    // Body
    std::string out;
