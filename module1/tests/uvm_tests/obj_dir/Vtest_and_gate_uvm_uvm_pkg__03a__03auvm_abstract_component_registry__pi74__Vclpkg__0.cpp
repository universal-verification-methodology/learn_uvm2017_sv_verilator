...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_type_name(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_get(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_create(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_monitor> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_monitor> __Vfunc_create__2__Vfuncout;
    // Body
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_set_type_override(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_set_inst_override(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_set_type_alias(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::__VnoInFunc_get_type_name(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_registry_common__pi86> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_registry_common__pi86> common;
...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::__VnoInFunc_initialize(VlProcessRef vlProcess, Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_registry_common__pi86> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_registry_common__pi86> common;
...
Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74(Vtest_and_gate_uvm__Syms* __restrict vlSymsp)
    : Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::_ctor_var_reset(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_abstract_component_registry__pi74::to_string_middle\n"); );
    // Body
    std::string out;
