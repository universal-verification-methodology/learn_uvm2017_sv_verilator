...
void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs::__VnoInFunc___Vsetup_constraints(Vtest_and_gate_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs::__VnoInFunc___VBasicRand(Vtest_and_gate_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs::~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs::~\n"); );
}
