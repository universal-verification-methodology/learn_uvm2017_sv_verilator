...
Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::~Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_and_gate_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::~\n"); );
}
