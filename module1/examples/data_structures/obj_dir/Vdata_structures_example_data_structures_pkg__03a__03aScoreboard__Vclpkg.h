...
class alignas(VL_CACHE_LINE_BYTES) Vdata_structures_example_data_structures_pkg__03a__03aScoreboard__Vclpkg final {
  public:
...
class Vdata_structures_example_data_structures_pkg__03a__03aScoreboard : public virtual VlClass {
  public:
