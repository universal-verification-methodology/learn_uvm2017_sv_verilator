/**
 * Module 1 Example 1.3: Package Example - C++ Testbench
 * 
 * This C++ file serves as the testbench wrapper for the SystemVerilog
 * package example. It instantiates the Verilator-generated model,
 ...
 * 
 * Note: This example demonstrates SystemVerilog packages which provide
 * namespaces for types, functions, and tasks used across modules.
 */
...
// The class name is 'Vpackage_example' (V prefix + module name)
...
int main(int argc, char** argv) {
    ...
    // The module was compiled by Verilator from package_example.sv
    // This instance represents the entire SystemVerilog design
    // Package contents are compiled into the module
    Vpackage_example* top = new Vpackage_example;
    ...
    // "package_example.vcd" is the output filename
    // This file will contain all signal transitions during simulation
    tfp->open("package_example.vcd");
    ...
    // Package functions and tasks are available for use at this point
    top->eval();
    ...
    while (!Verilated::gotFinish() && main_time < 1000) {
        ...
        // Package functions and tasks can be called during evaluation
        top->eval();
