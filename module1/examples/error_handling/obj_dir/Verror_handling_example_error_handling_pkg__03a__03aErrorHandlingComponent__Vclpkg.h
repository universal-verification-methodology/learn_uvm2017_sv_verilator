...
class alignas(VL_CACHE_LINE_BYTES) Verror_handling_example_error_handling_pkg__03a__03aErrorHandlingComponent__Vclpkg final {
  public:
...
class Verror_handling_example_error_handling_pkg__03a__03aErrorHandlingComponent : public virtual VlClass {
  public:
