# UVM and SystemVerilog Glossary

A comprehensive glossary of terms used in UVM (Universal Verification Methodology) and SystemVerilog verification.
...
**Clocking Block**
- A SystemVerilog construct that defines synchronous signal access within an interface.
...
**Interface**
- A SystemVerilog construct that groups related signals and provides a communication channel between modules.

## M

**Modport**
- A SystemVerilog construct within an interface that specifies signal directions and access rights.
...
**Package**
- A SystemVerilog construct that groups related declarations (classes, types, functions) into a namespace.
...
**SystemVerilog**
- An extension of Verilog that adds object-oriented programming, interfaces, and other advanced features.

**Verilator**
- An open-source Verilog/SystemVerilog simulator that can be used for UVM verification (with some limitations).

**IEEE 1800.2-2017**
- The IEEE standard that defines the Universal Verification Methodology (UVM) Language Reference Manual.

**UVM 1.2**
- The version of UVM standardized in IEEE 1800.2-2017.
...
- A verification approach that uses random stimulus generation with constraints to achieve coverage goals.

**Assertion-Based Verification**
- A verification approach that uses assertions to specify and check expected design behavior.
