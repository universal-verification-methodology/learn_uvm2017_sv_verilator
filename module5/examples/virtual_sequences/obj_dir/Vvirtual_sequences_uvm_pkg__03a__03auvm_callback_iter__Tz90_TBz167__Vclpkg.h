...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_callback_iter__Tz90_TBz167__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_callback_iter__Tz90_TBz167__Vclpkg(Vvirtual_sequences__Syms* symsp, const char* v__name);
