...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz57> __Vtask_m_initialize__0__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typeid__Tz73> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typeid__Tz58> __Vfunc_get__2__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typeid__Tz57> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57> __Vfunc_get__5__Vfuncout;
    ...
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typeid_base> unnamedblk1__DOT__cb_base_type;
    if ((VlNull{} == this->__PVT__m_inst)) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__VnoInFunc_m_initialize(vlProcess, vlSymsp, __Vtask_m_initialize__0__Vfuncout);
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz73__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__1__Vfuncout);
        unnamedblk1__DOT__cb_base_type = __Vfunc_get__1__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz58__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__2__Vfuncout);
        this->__PVT__m_cb_typeid = __Vfunc_get__2__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz57__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__3__Vfuncout);
        this->__PVT__m_typeid = __Vfunc_get__3__Vfuncout;
        this->__PVT__m_inst = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58, vlProcess, vlSymsp);
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
                          == this->__PVT__m_cb_typeid)))) {
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz57_TBz58.get.unnamedblk1: '$cast' failed.\n",0,
                         64,VL_TIME_UNITED_Q(1),-12,
                         vlSymsp->name());
            VL_STOP_MT("/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 528, "");
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_t_inst 
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz57__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__5__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_m_register_pair(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_m_register_pair\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vfunc_get__11__Vfuncout;
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> inst;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_typename 
        = tname;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_add(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_add\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__12__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> __Vtask_get__35__Vfuncout;
    IData/*31:0*/ __Vtask_size__38__Vfuncout;
    __Vtask_size__38__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz90> __Vtask_get__39__Vfuncout;
    IData/*31:0*/ __Vtask_size__40__Vfuncout;
    __Vtask_size__40__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__42__Vfuncout;
    IData/*31:0*/ __Vtask_size__43__Vfuncout;
    __Vtask_size__43__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__45__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_report_object> unnamedblk2__DOT__o;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> unnamedblk2__DOT__unnamedblk3__DOT__qr;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> q;
    std::string nm;
    std::string tnm;
    {
        ...
        if ((VlNull{} == cb)) {
            ...
            tnm = ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz57__Vclpkg.__PVT__m_typename)
                    ? vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz57__Vclpkg.__PVT__m_typename
                    : ((VlNull{} != obj) ? ([&]() {
        ...
        if ((VlNull{} == obj)) {
            if ((0xffffffffU != ([&]() {
                            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__28__Vfuncout);
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_t_inst, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 658)->__VnoInFunc_m_add_tw_cbs(vlProcess, vlSymsp, cb, ordering);
            }
        } else {
            ...
            if ((VlNull{} == q)) {
                q = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73, vlProcess, vlSymsp, ""s);
            ...
            if ((0U == ([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz90__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vtask_get__39__Vfuncout);
                    unnamedblk2__DOT__unnamedblk3__DOT__qr 
                        = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz90__Vclpkg.__PVT__m_tw_cb_q;
                ...
                while (VL_LTS_III(32, unnamedblk2__DOT__unnamedblk5__DOT__i, 
                                  ([&]() {
                                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 687)
                    ...
                    VL_NULL_CHECK(q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 688)->__VnoInFunc_push_back(vlSymsp, 
                                                                                ([&]() {
                                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 688)
            ...
            if ((0xffffffffU != ([&]() {
                            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__46__Vfuncout);
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__VnoInFunc_m_cb_find_name(vlProcess, vlSymsp, q, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_add_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> root, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_add_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__58__Vfuncout;
    ...
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component>> cq;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> t;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_delete(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_delete\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__71__Vfuncout;
    CData/*0:0*/ __Vtask_m_delete_tw_cbs__72__Vfuncout;
    __Vtask_m_delete_tw_cbs__72__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> __Vtask_get__73__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> b_obj;
    b_obj = obj;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> q;
    CData/*0:0*/ found;
    found = 0;
    ...
    if ((VlNull{} == obj)) {
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_t_inst, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 771)->__VnoInFunc_m_delete_tw_cbs(vlProcess, vlSymsp, cb, __Vtask_m_delete_tw_cbs__72__Vfuncout);
        found = __Vtask_m_delete_tw_cbs__72__Vfuncout;
    } else {
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks_base__Vclpkg.__PVT__m_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 776)->__VnoInFunc_get(vlSymsp, b_obj, __Vtask_get__73__Vfuncout);
        q = __Vtask_get__73__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__74__Vfuncout);
    ...
    if ((1U & (~ (IData)(found)))) {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__80__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
            = __Vtask_get_root__80__Vfuncout;
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 156)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, __Vtask_uvm_report_warning__77__id, __Vtask_uvm_report_warning__77__message, __Vtask_uvm_report_warning__77__verbosity, __Vtask_uvm_report_warning__77__filename, __Vtask_uvm_report_warning__77__line, __Vtask_uvm_report_warning__77__context_name, (IData)(__Vtask_uvm_report_warning__77__report_enabled_checked));
    }
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_delete_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> root) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_delete_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__82__Vfuncout;
    ...
    VL_NULL_CHECK(cs, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 809)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__84__Vfuncout);
    ...
    if ((0U == cq.size())) {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__89__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_m_get_q(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> &q, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_m_get_q\n"); );
    // Locals
    IData/*31:0*/ __Vtask_exists__91__Vfuncout;
    __Vtask_exists__91__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> __Vtask_get__92__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> __Vtask_m_get_tw_cb_q__95__Vfuncout;
    // Body
    if ((0U != ([&]() {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks_base__Vclpkg.__PVT__m_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 838)->__VnoInFunc_get(vlSymsp, obj, __Vtask_get__92__Vfuncout);
        ...
        q = ((VlNull{} == obj) ? vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_tw_cb_q
              : ([&]() {
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_t_inst, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 835)
                 ->__VnoInFunc_m_get_tw_cb_q(vlSymsp, obj, __Vtask_m_get_tw_cb_q__95__Vfuncout);
                }(), __Vtask_m_get_tw_cb_q__95__Vfuncout));
    }
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_first(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> &get_first__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_first\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__96__Vfuncout;
    IData/*31:0*/ __Vtask_size__98__Vfuncout;
    __Vtask_size__98__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__99__Vfuncout;
    CData/*0:0*/ __Vtask_callback_mode__100__Vfuncout;
    __Vtask_callback_mode__100__Vfuncout = 0;
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> q;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> cb;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_last(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> &get_last__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_last\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__101__Vfuncout;
    IData/*31:0*/ __Vtask_size__103__Vfuncout;
    __Vtask_size__103__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__104__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_next(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> &get_next__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_next\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__106__Vfuncout;
    IData/*31:0*/ __Vtask_size__108__Vfuncout;
    __Vtask_size__108__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__109__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_prev(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> &get_prev__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_prev\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__111__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__113__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_all(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback>> &all_callbacks, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_get_all\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__115__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__118__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> __Vtask_get__119__Vfuncout;
    IData/*31:0*/ __Vtask_size__120__Vfuncout;
    __Vtask_size__120__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> __Vtask_get__121__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> q;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> cb;
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback>> callbacks_to_append;
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback>> unique_callbacks_to_append;
    ...
    if (((VlNull{} == obj) || (1U & (~ (0U != ([&]() {
        ...
        while (VL_LTS_III(32, unnamedblk9__DOT__qi, 
                          ([&]() {
                        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 976)
                           ->__VnoInFunc_size(vlSymsp, __Vtask_size__117__Vfuncout);
                    }(), __Vtask_size__117__Vfuncout))) {
            if (VL_CAST_DYNAMIC(([&]() {
                            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 977)
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks_base__Vclpkg.__PVT__m_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 983)->__VnoInFunc_get(vlSymsp, obj, __Vtask_get__119__Vfuncout);
    ...
    unique_callbacks_to_append = callbacks_to_append.unique(
                                                            [&](
                                                                ...
                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> cb_) -> 
                                                            IData/*31:0*/ {
            return (([&]() {
    ...
    all_callbacks = VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback>>::consCC(unique_callbacks_to_append, 
                                                                                all_callbacks);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_display(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58__Vclpkg::__VnoInFunc_display\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58> __Vtask_get__123__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    this->__VnoInFunc_get(vlProcess, vlSymsp, __Vtask_get__123__Vfuncout);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz57__Vclpkg.__VnoInFunc_display(vlSymsp, obj);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc_m_is_registered(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_registered__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc_m_is_registered\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc_m_is_for_me(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_for_me__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc_m_is_for_me\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_objection_callback> this_cb;
    m_is_for_me__Vfuncrtn = (1U & VL_CAST_DYNAMIC(cb, this_cb));
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz57(vlProcess, vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_registered = 0;
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::~Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz57_TBz58::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_registered:" + VL_TO_STRING(__PVT__m_registered);
    out += ", "+ Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz57::to_string_middle();
    return (out);
}
