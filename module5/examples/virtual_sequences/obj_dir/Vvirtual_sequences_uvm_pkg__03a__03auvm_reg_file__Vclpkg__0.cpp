...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi100> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi100> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_file"s;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_object_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi100> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi100__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_create(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file> tmp;
    tmp = ((""s == name) ? VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file, vlProcess, vlSymsp, ""s)
            : VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_file"s;
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::new\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_configure(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> blk_parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file> regfile_parent, std::string hdl_path) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_configure\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__12__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__13__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        if ((VlNull{} == blk_parent)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__9__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_block(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> &get_block__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_block\n"); );
                // Body
                get_block__Vfuncrtn = this->__PVT__parent;
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_regfile(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file> &get_regfile__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_regfile\n"); );
                // Body
                get_regfile__Vfuncrtn = this->__PVT__m_rf;
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clear_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clear_hdl_path\n"); );
                // Locals
                ...
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                {
                    if (("ALL"s == kind)) {
                        this->__PVT__hdl_paths_pool 
                            = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_object_string_pool__Tz198, vlProcess, vlSymsp, "hdl_paths"s);
                        goto __Vlabel0;
                    }
                    if ((""s == kind)) {
                        kind = ((VlNull{} != this->__PVT__m_rf)
                                 ? ([&]() {
                                    VL_NULL_CHECK(this->__PVT__m_rf, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 182)
                                 ...
                                 : ([&]() {
                                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 184)
                    ...
                    if ((1U & (~ (0U != ([&]() {
                                            VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 187)
                        ...
                        if ((0U != ([&]() {
                            ...
                            __Vtask_uvm_report_warning__24__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
                    ...
                    VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 192)
                                                        ->__VnoInFunc_delete(vlSymsp, kind);
                    __Vlabel0: ;
                }
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_add_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string path, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_add_hdl_path\n"); );
                // Locals
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> __Vtask_get__29__Vfuncout;
                // Body
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> paths;
                VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 202)
                                                        ->__VnoInFunc_get(vlProcess, vlSymsp, kind, __Vtask_get__29__Vfuncout);
                paths = __Vtask_get__29__Vfuncout;
                VL_NULL_CHECK(paths, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 204)
                                                        ->__VnoInFunc_push_back(vlSymsp, path);
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_has_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &has_hdl_path__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_has_hdl_path\n"); );
                // Locals
                ...
                if ((""s == kind)) {
                    kind = ((VlNull{} != this->__PVT__m_rf)
                             ? ([&]() {
                                VL_NULL_CHECK(this->__PVT__m_rf, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 214)
                             ...
                             : ([&]() {
                                VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 216)
                ...
                has_hdl_path__Vfuncrtn = (1U & ([&]() {
                            VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 219)
                                                ->__VnoInFunc_exists(vlSymsp, kind, __Vtask_exists__33__Vfuncout);
                        }(), __Vtask_exists__33__Vfuncout));
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_hdl_path\n"); );
                // Locals
                ...
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> __Vtask_get__45__Vfuncout;
                ...
                unnamedblk384__DOT__i = 0;
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> hdl_paths;
                {
                    if ((""s == kind)) {
                        kind = ((VlNull{} != this->__PVT__m_rf)
                                 ? ([&]() {
                                    VL_NULL_CHECK(this->__PVT__m_rf, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 231)
                                 ...
                                 : ([&]() {
                                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 233)
                    ...
                    if ((1U & (~ ([&]() {
                        ...
                        if ((0U != ([&]() {
                            ...
                            __Vtask_uvm_report_error__41__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
                    ...
                    VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 241)
                    ...
                    while (VL_LTS_III(32, unnamedblk384__DOT__i, 
                                      ([&]() {
                                    VL_NULL_CHECK(hdl_paths, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 243)
                                       ->__VnoInFunc_size(vlSymsp, __Vtask_size__46__Vfuncout);
                                }(), __Vtask_size__46__Vfuncout))) {
                        paths.push_back(([&]() {
                                    VL_NULL_CHECK(hdl_paths, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 244)
                                         ->__VnoInFunc_get(vlProcess, vlSymsp, unnamedblk384__DOT__i, __Vtask_get__47__Vfuncout);
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_hdl_path\n"); );
                // Locals
                ...
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> __Vtask_get__58__Vfuncout;
                IData/*31:0*/ __Vtask_size__61__Vfuncout;
                __Vtask_size__61__Vfuncout = 0;
                std::string __Vtask_get__62__Vfuncout;
                // Body
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> unnamedblk385__DOT__hdl_paths;
                VlQueue<std::string> unnamedblk385__DOT__parent_paths;
                IData/*31:0*/ unnamedblk385__DOT__unnamedblk386__DOT__i;
                unnamedblk385__DOT__unnamedblk386__DOT__i = 0;
                ...
                unnamedblk385__DOT__unnamedblk386__DOT__unnamedblk387__DOT__unnamedblk388__DOT__j = 0;
                {
                    ...
                    if ((1U & (~ ([&]() {
                        ...
                        if ((0U != ([&]() {
                            ...
                            __Vtask_uvm_report_error__54__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
                    ...
                    paths.clear();
                    VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 265)
                                                        ->__VnoInFunc_get(vlProcess, vlSymsp, kind, __Vtask_get__58__Vfuncout);
                    unnamedblk385__DOT__hdl_paths = __Vtask_get__58__Vfuncout;
                    if ((VlNull{} != this->__PVT__m_rf)) {
                        VL_NULL_CHECK(this->__PVT__m_rf, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 269)
                        ...
                        VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 271)
                                                        ->__VnoInFunc_get_full_hdl_path(vlProcess, vlSymsp, unnamedblk385__DOT__parent_paths, kind, separator);
                    }
                    unnamedblk385__DOT__unnamedblk386__DOT__i = 0U;
                    while (VL_LTS_III(32, unnamedblk385__DOT__unnamedblk386__DOT__i, 
                                      ([&]() {
                                    VL_NULL_CHECK(unnamedblk385__DOT__hdl_paths, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 273)
                                       ->__VnoInFunc_size(vlSymsp, __Vtask_size__61__Vfuncout);
                                }(), __Vtask_size__61__Vfuncout))) {
                        {
                            VL_NULL_CHECK(unnamedblk385__DOT__hdl_paths, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 274)
                                                        ->__VnoInFunc_get(vlProcess, vlSymsp, unnamedblk385__DOT__unnamedblk386__DOT__i, __Vtask_get__62__Vfuncout);
                            unnamedblk385__DOT__unnamedblk386__DOT__unnamedblk387__DOT__hdl_path 
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_default_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_default_hdl_path__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_default_hdl_path\n"); );
                // Locals
                ...
                // Body
                {
                    if ((""s == this->__PVT__default_hdl_path)) {
                        if ((VlNull{} != this->__PVT__m_rf)) {
                            VL_NULL_CHECK(this->__PVT__m_rf, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 300)
                            ...
                            VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 302)
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_set_default_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_set_default_hdl_path\n"); );
                // Locals
                ...
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                {
                    if ((""s == kind)) {
                        if ((VlNull{} != this->__PVT__m_rf)) {
                            VL_NULL_CHECK(this->__PVT__m_rf, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 314)
                            ...
                            VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 316)
                            ...
                            if ((0U != ([&]() {
                                ...
                                __Vtask_uvm_report_error__71__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_parent(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_parent\n"); );
                // Locals
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> __Vfunc_get_block__75__Vfuncout;
                // Body
                this->__VnoInFunc_get_block(vlSymsp, __Vfunc_get_block__75__Vfuncout);
                get_parent__Vfuncrtn = __Vfunc_get_block__75__Vfuncout;
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_name\n"); );
                // Locals
                ...
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> blk;
                {
                    ...
                    if ((VlNull{} != this->__PVT__m_rf)) {
                        get_full_name__Vfuncrtn = VL_CONCATN_NNN(
                                                                 VL_CONCATN_NNN(
                                                                                ([&]() {
                                        VL_NULL_CHECK(this->__PVT__m_rf, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 345)
                    ...
                    get_full_name__Vfuncrtn = VL_CONCATN_NNN(
                                                             VL_CONCATN_NNN(
                                                                            ([&]() {
                                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh", 350)
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_convert2string\n"); );
                // Locals
                ...
                if ((0U != ([&]() {
                    ...
                    vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, "RegModel register files cannot be converted to strings"s, 0U, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s, 0x00000169U, ""s, 1U);
                }
                convert2string__Vfuncrtn = ""s;
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_print(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_print\n"); );
                // Body
                Vvirtual_sequences_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_print(vlProcess, vlSymsp, printer);
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clone(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clone\n"); );
                // Locals
                ...
                if ((0U != ([&]() {
                    ...
                    vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, "RegModel register files cannot be cloned"s, 0U, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s, 0x00000179U, ""s, 1U);
                }
                clone__Vfuncrtn = VlNull{};
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> rhs) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_copy\n"); );
                // Locals
                ...
                if ((0U != ([&]() {
                    ...
                    vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, "RegModel register files cannot be copied"s, 0U, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s, 0x00000180U, ""s, 1U);
                }
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_compare(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_compare\n"); );
                // Locals
                ...
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__96__Vfuncout;
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__97__Vfuncout;
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__99__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_pack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_pack\n"); );
                // Locals
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__107__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_unpack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_unpack\n"); );
                // Locals
                ...
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__116__Vfuncout;
                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__117__Vfuncout;
                // Body
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__115__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_file.svh"s;
            ...
            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_randomize\n"); );
                // Locals
                IData/*31:0*/ __Vfunc___Vbasic_randomize__120__Vfuncout;
                __Vfunc___Vbasic_randomize__120__Vfuncout = 0;
                // Body
                ...
                randomize__Vfuncrtn = (randomize__Vfuncrtn 
                                       & ([&]() {
                            this->__VnoInFunc___Vbasic_randomize(vlSymsp, __Vfunc___Vbasic_randomize__120__Vfuncout);
                        }(), __Vfunc___Vbasic_randomize__120__Vfuncout));
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vbasic_randomize\n"); );
                // Body
                __Vbasic_randomize__Vfuncrtn = 1U;
            }

            void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::_ctor_var_reset\n"); );
                // Body
                (void)vlSymsp;  // Prevent unused variable warning
            }

            std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file>& obj) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::VL_TO_STRING\n"); );
                // Body
                return (obj ? obj->to_string() : "null");
            }

            std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::to_string() const {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::to_string\n"); );
                // Body
                return ("'{"s + to_string_middle() + "}");
            }

            std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::to_string_middle() const {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_file::to_string_middle\n"); );
                // Body
                std::string out;
