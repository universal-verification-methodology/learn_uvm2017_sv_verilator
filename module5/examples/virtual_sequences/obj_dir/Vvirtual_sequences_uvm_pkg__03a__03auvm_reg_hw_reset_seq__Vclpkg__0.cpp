...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_hw_reset_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    ...
    VL_KEEP_THIS;
    {
        ...
        VL_NULL_CHECK(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__PVT__model, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_hw_reset_seq.svh", 86)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_hw_reset_seq::__VnoInFunc_do_block(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> blk) {
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz54> __Vfunc_get_by_name__29__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz54> __Vfunc_get_by_name__38__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_hw_reset_seq::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_hw_reset_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
