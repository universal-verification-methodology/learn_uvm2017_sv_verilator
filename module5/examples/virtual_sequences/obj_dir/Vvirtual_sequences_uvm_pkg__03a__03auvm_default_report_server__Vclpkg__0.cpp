...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_severity_counts(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    ...
    s = 0U;
    {
        while (true) {
            ...
            s = Vvirtual_sequences___024unit::__Venumtab_enum_next9
                [s];
        }
        __Vlabel0: ;
    }
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_report_message(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_report_message> report_message, std::string report_object_name, std::string &compose_report_message__Vfuncrtn) {
    ...
    sev_string = Vvirtual_sequences___024unit::__Venumtab_enum_name9
        [l_severity];
    if ((""s != ([&]() {
    ...
    if (this->__PVT__show_verbosity) {
        if ((0U != (Vvirtual_sequences___024unit::__Venumtab_enum_valid13
            ...
            verbosity_str = Vvirtual_sequences___024unit::__Venumtab_enum_name13
                .at(l_verbosity);
        } else {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_report_summarize(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    ...
    if ((0U != this->__PVT__m_severity_count.first(unnamedblk11__DOT__s))) {
        ...
        while (((IData)(unnamedblk11__DOT__s__Vfirst) 
            ...
            __Vtemp_1 = Vvirtual_sequences___024unit::__Venumtab_enum_name9
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
