...
VL_ATTR_COLD void Vvirtual_sequences___024unit___ctor_var_reset(Vvirtual_sequences___024unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vvirtual_sequences___024unit___ctor_var_reset\n"); );
