...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_time__Vclpkg::__VnoInFunc_set_time_resolution(Vvirtual_sequences__Syms* __restrict vlSymsp, double res) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_time__Vclpkg::__VnoInFunc_set_time_resolution\n"); );
    // Body
    this->__PVT__m_resolution = res;
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_time::Vvirtual_sequences_uvm_pkg__03a__03auvm_time(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, double res) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::new\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_get_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_get_name\n"); );
    // Body
    get_name__Vfuncrtn = this->__PVT__m_name;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_reset\n"); );
    // Body
    this->__PVT__m_time = 0ULL;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_to_m_res(Vvirtual_sequences__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs, double &to_m_res__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_to_m_res\n"); );
    // Body
    to_m_res__Vfuncrtn = ((t / VL_ITOR_D_Q(64, scaled)) 
                          * (secs / this->__PVT__m_res));
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_get_realtime(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ scaled, double secs, double &get_realtime__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_get_realtime\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_incr(Vvirtual_sequences__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_incr\n"); );
    // Locals
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        if ((t < 0.0)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__5__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/tlm2/uvm_tlm_time.svh"s;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_decr(Vvirtual_sequences__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_decr\n"); );
    // Locals
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        if ((t < 0.0)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__19__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/tlm2/uvm_tlm_time.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__21__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
        ...
        if ((VL_ITOR_D_Q(64, this->__PVT__m_time) < 0.0)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__33__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/tlm2/uvm_tlm_time.svh"s;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_get_abstime(Vvirtual_sequences__Syms* __restrict vlSymsp, double secs, double &get_abstime__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_get_abstime\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_set_abstime(Vvirtual_sequences__Syms* __restrict vlSymsp, double t, double secs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::__VnoInFunc_set_abstime\n"); );
    // Body
    this->__PVT__m_time = VL_RTOIROUND_Q_D(((t * secs) 
                                            / this->__PVT__m_res));
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_time::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_time>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_time::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_time::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_time::to_string_middle\n"); );
    // Body
    std::string out;
