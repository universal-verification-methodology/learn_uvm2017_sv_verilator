...
#ifndef VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI194__VCLPKG_H_
#define VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI194__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi194__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi194> &get__Vfuncrtn);
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi194 : public virtual VlClass {
  public:
  ...
  public:
    Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi194(Vvirtual_sequences__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi194() {}
};
