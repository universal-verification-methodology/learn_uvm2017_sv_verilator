...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field__Vclpkg::__VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi95> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi95> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi95__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field__Vclpkg::__VnoInFunc_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_vreg_field"s;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_object_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi95> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi95__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_create(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field> tmp;
    tmp = ((""s == name) ? VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field, vlProcess, vlSymsp, "uvm_vreg_field"s)
            : VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_vreg_field"s;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_pre_write(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &wdat, IData/*31:0*/ &path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> &map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_pre_write\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_post_write(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ wdat, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ &status) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_post_write\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_pre_read(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> &map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_pre_read\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_post_read(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &rdat, IData/*31:0*/ &path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> &map, IData/*31:0*/ &status) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_post_read\n"); );
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_configure(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> parent, IData/*31:0*/ size, IData/*31:0*/ lsb_pos) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_configure\n"); );
    // Locals
    ...
    if ((0U == size)) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__8__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
    ...
    if ((0x00000040U < size)) {
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_error__17__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
    ...
    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 334)->__VnoInFunc_add_field(vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>{this});
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_full_name\n"); );
    // Locals
    ...
    get_full_name__Vfuncrtn = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                            ([&]() {
                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 340)
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_register(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> &get_register__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_register\n"); );
    // Body
    get_register__Vfuncrtn = this->__PVT__parent;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_parent(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_parent\n"); );
    // Body
    get_parent__Vfuncrtn = this->__PVT__parent;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_lsb_pos_in_register(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_lsb_pos_in_register__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_lsb_pos_in_register\n"); );
    // Body
    get_lsb_pos_in_register__Vfuncrtn = this->__PVT__lsb;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_n_bits(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bits__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_n_bits\n"); );
    // Body
    get_n_bits__Vfuncrtn = this->__PVT__size;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_access(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_get_access\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> __Vtask_get_memory__25__Vfuncout;
    ...
    {
        if ((VlNull{} == ([&]() {
                        VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 366)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__30__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__33__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
        ...
        VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 372)->__VnoInFunc_get_access(vlSymsp, map, __Vtask_get_access__35__Vfuncout);
        get_access__Vfuncrtn = __Vtask_get_access__35__Vfuncout;
        __Vlabel0: ;
    }
}

VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_write(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> __Vtask_get_memory__37__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> __Vtask_get_block__47__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_first__61__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_next__63__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__67__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__84__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__85__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_first__96__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_next__98__Vfuncout;
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk291__DOT__blk;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk292__DOT__cb;
    QData/*63:0*/ unnamedblk293__DOT__segn;
    unnamedblk293__DOT__segn = 0;
    IData/*31:0*/ unnamedblk1_1__DOT____Vrepeat0;
    unnamedblk1_1__DOT____Vrepeat0 = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk294__DOT__cb;
    QData/*63:0*/ tmp;
    tmp = 0;
    QData/*63:0*/ segval;
    segval = 0;
    ...
    IData/*31:0*/ rm_path;
    rm_path = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback_iter__pi87> cbs;
    {
        cbs = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_callback_iter__pi87, vlSymsp, 
                     VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>{this});
        this->__PVT__fname = fname;
        this->__PVT__lineno = lineno;
        this->__PVT__write_in_progress = 1U;
        VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 401)->__VnoInFunc_get_memory(vlSymsp, __Vtask_get_memory__37__Vfuncout);
        ...
        if ((VlNull{} == mem)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__42__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
        ...
        if ((3U == path)) {
            VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 410)->__VnoInFunc_get_block(vlSymsp, __Vtask_get_block__47__Vfuncout);
            unnamedblk291__DOT__blk = __Vtask_get_block__47__Vfuncout;
            VL_NULL_CHECK(unnamedblk291__DOT__blk, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 411)->__VnoInFunc_get_default_door(vlSymsp, __Vtask_get_default_door__48__Vfuncout);
            path = __Vtask_get_default_door__48__Vfuncout;
        }
        status = 0U;
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 416)->__VnoInFunc_XatomicX(vlSymsp, 1U);
        if ((0U != VL_SHIFTR_QQI(64,64,32, value, this->__PVT__size))) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__54__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
        ...
        VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 425)->__VnoInFunc_first(vlSymsp, __Vtask_first__61__Vfuncout);
        unnamedblk292__DOT__cb = __Vtask_first__61__Vfuncout;
        while ((VlNull{} != unnamedblk292__DOT__cb)) {
            VL_NULL_CHECK(unnamedblk292__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 427)->__PVT__fname 
                = this->__PVT__fname;
            VL_NULL_CHECK(unnamedblk292__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 428)->__PVT__lineno 
                = this->__PVT__lineno;
            VL_NULL_CHECK(unnamedblk292__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 429)->__VnoInFunc_pre_write(vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>{this}, idx, value, path, map);
            VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 426)->__VnoInFunc_next(vlSymsp, __Vtask_next__63__Vfuncout);
            unnamedblk292__DOT__cb = __Vtask_next__63__Vfuncout;
        }
        segsiz = VL_SHIFTL_III(32,32,32, ([&]() {
                    VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 432)
        ...
        segoff = (([&]() {
                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 434)
        ...
        rm_path = 3U;
        if ((VlNull{} != ([&]() {
                        VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 438)
        ...
        if (VL_LTS_III(32, 0U, rmwbits)) {
            co_await VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 449)->__VnoInFunc_read(vlProcess, vlSymsp, __Vtask_read__69__status, segoff, __Vtask_read__69__value, rm_path, map, parent, 0xffffffffU, extension, fname, lineno);
            ...
            if (((0U != st) & (2U != st))) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__74__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
                    __Vtask_uvm_report_error__74__verbosity = 0U;
                    __Vtemp_3 = ([&]() {
                            VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 453)
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__78__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
                ...
                status = 1U;
                co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 455)->__VnoInFunc_XatomicX(vlSymsp, 0U);
                goto __Vlabel0;
            }
        ...
        if (VL_LTS_III(32, 0U, rmwbits)) {
            if (VL_LTS_III(32, 0U, segn)) {
                co_await VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 467)->__VnoInFunc_read(vlProcess, vlSymsp, __Vtask_read__82__status, 
                                                                                ((segoff 
                                                                                + (QData)((IData)(segn))) 
                ...
                if (((0U != st) & (2U != st))) {
                    if ((0U != ([&]() {
                        ...
                        __Vtask_uvm_report_error__87__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
                        __Vtask_uvm_report_error__87__verbosity = 0U;
                        __Vtemp_5 = ([&]() {
                                VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 472)
                    ...
                    status = 1U;
                    co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 474)->__VnoInFunc_XatomicX(vlSymsp, 0U);
                    goto __Vlabel0;
                }
            }
        ...
        while (VL_LTS_III(32, 0U, unnamedblk1_1__DOT____Vrepeat0)) {
            co_await VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 484)->__VnoInFunc_write(vlProcess, vlSymsp, __Vtask_write__94__status, segoff, tmp, path, map, parent, 0xffffffffU, extension, fname, lineno);
        ...
        VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 492)->__VnoInFunc_first(vlSymsp, __Vtask_first__96__Vfuncout);
        unnamedblk294__DOT__cb = __Vtask_first__96__Vfuncout;
        while ((VlNull{} != unnamedblk294__DOT__cb)) {
            VL_NULL_CHECK(unnamedblk294__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 494)->__PVT__fname 
                = this->__PVT__fname;
            VL_NULL_CHECK(unnamedblk294__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 495)->__PVT__lineno 
                = this->__PVT__lineno;
            VL_NULL_CHECK(unnamedblk294__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 496)->__VnoInFunc_post_write(vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>{this}, idx, value, path, map, status);
            VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 493)->__VnoInFunc_next(vlSymsp, __Vtask_next__98__Vfuncout);
            unnamedblk294__DOT__cb = __Vtask_next__98__Vfuncout;
        }
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 499)->__VnoInFunc_XatomicX(vlSymsp, 0U);
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_info__104__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_read(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_read\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> __Vtask_get_memory__110__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> __Vtask_get_block__120__Vfuncout;
    IData/*31:0*/ __Vtask_get_default_door__121__Vfuncout;
    __Vtask_get_default_door__121__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_first__124__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_next__126__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_first__134__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> __Vtask_next__136__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__139__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__140__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__144__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__145__Vfuncout;
    std::string __Vtemp_1;
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk295__DOT__blk;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk296__DOT__cb;
    IData/*31:0*/ unnamedblk1_2__DOT____Vrepeat1;
    unnamedblk1_2__DOT____Vrepeat1 = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk297__DOT__cb;
    QData/*63:0*/ tmp;
    tmp = 0;
    QData/*63:0*/ segval;
    segval = 0;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback_iter__pi87> cbs;
    {
        ...
        VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 537)->__VnoInFunc_get_memory(vlSymsp, __Vtask_get_memory__110__Vfuncout);
        ...
        if ((VlNull{} == mem)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__115__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
        ...
        if ((3U == path)) {
            VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 546)->__VnoInFunc_get_block(vlSymsp, __Vtask_get_block__120__Vfuncout);
            unnamedblk295__DOT__blk = __Vtask_get_block__120__Vfuncout;
            VL_NULL_CHECK(unnamedblk295__DOT__blk, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 547)->__VnoInFunc_get_default_door(vlSymsp, __Vtask_get_default_door__121__Vfuncout);
            path = __Vtask_get_default_door__121__Vfuncout;
        }
        status = 0U;
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 552)->__VnoInFunc_XatomicX(vlSymsp, 1U);
        value = 0ULL;
        this->__VnoInFunc_pre_read(vlSymsp, idx, path, map);
        VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 557)->__VnoInFunc_first(vlSymsp, __Vtask_first__124__Vfuncout);
        unnamedblk296__DOT__cb = __Vtask_first__124__Vfuncout;
        while ((VlNull{} != unnamedblk296__DOT__cb)) {
            VL_NULL_CHECK(unnamedblk296__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 559)->__PVT__fname 
                = this->__PVT__fname;
            VL_NULL_CHECK(unnamedblk296__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 560)->__PVT__lineno 
                = this->__PVT__lineno;
            VL_NULL_CHECK(unnamedblk296__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 561)->__VnoInFunc_pre_read(vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>{this}, idx, path, map);
            VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 558)->__VnoInFunc_next(vlSymsp, __Vtask_next__126__Vfuncout);
            unnamedblk296__DOT__cb = __Vtask_next__126__Vfuncout;
        }
        segsiz = VL_SHIFTL_III(32,32,32, ([&]() {
                    VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 564)
        ...
        segoff = (([&]() {
                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 566)
        ...
        while (VL_LTS_III(32, 0U, unnamedblk1_2__DOT____Vrepeat1)) {
            ...
            co_await VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 577)->__VnoInFunc_read(vlProcess, vlSymsp, __Vtask_read__131__status, segoff, __Vtask_read__131__value, path, map, parent, 0xffffffffU, extension, fname, lineno);
        ...
        VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 591)->__VnoInFunc_first(vlSymsp, __Vtask_first__134__Vfuncout);
        unnamedblk297__DOT__cb = __Vtask_first__134__Vfuncout;
        while ((VlNull{} != unnamedblk297__DOT__cb)) {
            VL_NULL_CHECK(unnamedblk297__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 593)->__PVT__fname 
                = this->__PVT__fname;
            VL_NULL_CHECK(unnamedblk297__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 594)->__PVT__lineno 
                = this->__PVT__lineno;
            VL_NULL_CHECK(unnamedblk297__DOT__cb, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 595)->__VnoInFunc_post_read(vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>{this}, idx, value, path, map, status);
            VL_NULL_CHECK(cbs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 592)->__VnoInFunc_next(vlSymsp, __Vtask_next__136__Vfuncout);
            unnamedblk297__DOT__cb = __Vtask_next__136__Vfuncout;
        }
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 598)->__VnoInFunc_XatomicX(vlSymsp, 0U);
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_info__142__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 136)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__145__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top 
                = __Vtask_get_root__145__Vfuncout;
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 137)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, __Vtask_uvm_report_info__142__id, __Vtask_uvm_report_info__142__message, __Vtask_uvm_report_info__142__verbosity, __Vtask_uvm_report_info__142__filename, __Vtask_uvm_report_info__142__line, __Vtask_uvm_report_info__142__context_name, (IData)(__Vtask_uvm_report_info__142__report_enabled_checked));
        }
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_poke(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_poke\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> __Vtask_get_memory__147__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__154__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__155__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__159__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__160__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__174__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__175__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__180__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__181__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__187__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__188__Vfuncout;
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    QData/*63:0*/ unnamedblk298__DOT__segn;
    unnamedblk298__DOT__segn = 0;
    ...
    rm_path = 0;
    {
        this->__PVT__fname = fname;
        this->__PVT__lineno = lineno;
        VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 631)->__VnoInFunc_get_memory(vlSymsp, __Vtask_get_memory__147__Vfuncout);
        ...
        if ((VlNull{} == mem)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__152__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__155__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
        ...
        status = 0U;
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 641)->__VnoInFunc_XatomicX(vlSymsp, 1U);
        if ((0U != VL_SHIFTR_QQI(64,64,32, value, this->__PVT__size))) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__162__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 155)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__166__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
        ...
        tmp = 0ULL;
        segsiz = VL_SHIFTL_III(32,32,32, ([&]() {
                    VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 649)
        ...
        segoff = (([&]() {
                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 651)
        ...
        segn = ((IData)(1U) + VL_DIV_III(32, ((rmwbits 
                                ...
                                this->__VnoInFunc_get_n_bits(vlSymsp, __Vfunc_get_n_bits__171__Vfuncout);
                                              ...
                                              - (IData)(1U)), segsiz));
        if (VL_LTS_III(32, 0U, rmwbits)) {
            VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 662)->__VnoInFunc_peek(vlProcess, vlSymsp, __Vtask_peek__172__status, segoff, __Vtask_peek__172__value, ""s, parent, extension, fname, lineno);
            ...
            if (((0U != st) & (2U != st))) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__177__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
                    __Vtask_uvm_report_error__177__verbosity = 0U;
                    __Vtemp_3 = ([&]() {
                            VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 666)
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__181__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
                ...
                status = 1U;
                co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 668)->__VnoInFunc_XatomicX(vlSymsp, 0U);
                goto __Vlabel0;
            }
            value = (VL_SHIFTL_QQI(64,64,32, value, rmwbits) 
                     | (tmp & (VL_SHIFTL_QQI(64,64,32, 1ULL, rmwbits) 
        ...
        if (VL_LTS_III(32, 0U, rmwbits)) {
            if (VL_LTS_III(32, 0U, segn)) {
                VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 680)->__VnoInFunc_peek(vlProcess, vlSymsp, __Vtask_peek__185__status, 
                                                                                ((segoff 
                                                                                + (QData)((IData)(segn))) 
                ...
                if (((0U != st) & (2U != st))) {
                    if ((0U != ([&]() {
                        ...
                        __Vtask_uvm_report_error__190__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
                        __Vtask_uvm_report_error__190__verbosity = 0U;
                        __Vtemp_5 = ([&]() {
                                VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 685)
                        ...
                        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 174)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__194__Vfuncout);
                        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_error__Vstatic__top 
                    ...
                    status = 1U;
                    co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 687)->__VnoInFunc_XatomicX(vlSymsp, 0U);
                    goto __Vlabel0;
                }
            }
            value = (value | VL_SHIFTL_QQI(64,64,32, 
        ...
        while (VL_LTS_III(32, 0U, unnamedblk1_3__DOT____Vrepeat2)) {
            VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 697)->__VnoInFunc_poke(vlProcess, vlSymsp, __Vtask_poke__197__status, segoff, tmp, ""s, parent, extension, fname, lineno);
        ...
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 704)->__VnoInFunc_XatomicX(vlSymsp, 0U);
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_info__203__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 136)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__206__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top 
                = __Vtask_get_root__206__Vfuncout;
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 137)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, __Vtask_uvm_report_info__203__id, __Vtask_uvm_report_info__203__message, __Vtask_uvm_report_info__203__verbosity, __Vtask_uvm_report_info__203__filename, __Vtask_uvm_report_info__203__line, __Vtask_uvm_report_info__203__context_name, (IData)(__Vtask_uvm_report_info__203__report_enabled_checked));
        }
        this->__PVT__fname = ""s;
        this->__PVT__lineno = 0U;
        __Vlabel0: ;
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_peek(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_peek\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> __Vtask_get_memory__208__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__210__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__211__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> mem;
    {
        this->__PVT__fname = fname;
        this->__PVT__lineno = lineno;
        VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 732)->__VnoInFunc_get_memory(vlSymsp, __Vtask_get_memory__208__Vfuncout);
        ...
        if ((VlNull{} == mem)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_error__213__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
        ...
        status = 0U;
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 742)->__VnoInFunc_XatomicX(vlSymsp, 1U);
        value = 0ULL;
        segsiz = VL_SHIFTL_III(32,32,32, ([&]() {
                    VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 746)
        ...
        segoff = (([&]() {
                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 748)
        ...
        while (VL_LTS_III(32, 0U, unnamedblk1_4__DOT____Vrepeat3)) {
            value = VL_SHIFTL_QQI(64,64,32, value, segsiz);
            VL_NULL_CHECK(mem, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 759)->__VnoInFunc_peek(vlProcess, vlSymsp, __Vtask_peek__223__status, segoff, __Vtask_peek__223__value, ""s, parent, extension, fname, lineno);
        ...
        value = (value & (VL_SHIFTL_QQI(64,64,32, 1ULL, 
                          ...
                          - 1ULL));
        co_await VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 773)->__VnoInFunc_XatomicX(vlSymsp, 0U);
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_info__230__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh"s;
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 136)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__233__Vfuncout);
            vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top 
                = __Vtask_get_root__233__Vfuncout;
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 137)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, __Vtask_uvm_report_info__230__id, __Vtask_uvm_report_info__230__message, __Vtask_uvm_report_info__230__verbosity, __Vtask_uvm_report_info__230__filename, __Vtask_uvm_report_info__230__line, __Vtask_uvm_report_info__230__context_name, (IData)(__Vtask_uvm_report_info__230__report_enabled_checked));
        }
        this->__PVT__fname = ""s;
        this->__PVT__lineno = 0U;
        __Vlabel0: ;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_print(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_print\n"); );
    // Locals
    ...
    VL_NULL_CHECK(printer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 784)->__VnoInFunc_print_generic(vlProcess, vlSymsp, "initiator"s, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
                    VL_NULL_CHECK(this->__PVT__parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_vreg_field.svh", 784)
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_convert2string\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_clone(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_clone\n"); );
    // Body
    clone__Vfuncrtn = VlNull{};
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_copy\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_compare(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_compare\n"); );
    // Body
    do_compare__Vfuncrtn = 0U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_pack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_pack\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_unpack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_do_unpack\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_randomize\n"); );
    // Locals
    IData/*31:0*/ __Vfunc___Vbasic_randomize__244__Vfuncout;
    __Vfunc___Vbasic_randomize__244__Vfuncout = 0;
    // Body
    ...
    randomize__Vfuncrtn = (randomize__Vfuncrtn & ([&]() {
                this->__VnoInFunc___Vbasic_randomize(vlSymsp, __Vfunc___Vbasic_randomize__244__Vfuncout);
            }(), __Vfunc___Vbasic_randomize__244__Vfuncout));
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::to_string_middle\n"); );
    // Body
    std::string out;
