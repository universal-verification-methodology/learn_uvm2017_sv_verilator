...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_write(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk298__DOT__blk;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk299__DOT__cb;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk301__DOT__cb;
    QData/*63:0*/ tmp;
    tmp = 0;
    QData/*63:0*/ segval;
    segval = 0;
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc_read(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk302__DOT__blk;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk303__DOT__cb;
    IData/*31:0*/ unnamedblk1_2__DOT____Vrepeat1;
    unnamedblk1_2__DOT____Vrepeat1 = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field_cbs> unnamedblk304__DOT__cb;
    QData/*63:0*/ tmp;
    tmp = 0;
    QData/*63:0*/ segval;
    segval = 0;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::~Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field::~\n"); );
}
