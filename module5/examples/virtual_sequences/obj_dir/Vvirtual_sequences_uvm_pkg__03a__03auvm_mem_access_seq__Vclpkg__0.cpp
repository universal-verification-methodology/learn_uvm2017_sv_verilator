...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_single_access_seq> __Vfunc_create__8__Vfuncout;
    // Body
    VL_KEEP_THIS;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi169__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "single_mem_access_seq"s, VlNull{}, ""s, __Vfunc_create__8__Vfuncout);
        ...
        VL_NULL_CHECK(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__PVT__model, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_mem_access_seq.svh", 237)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc_do_block(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> blk) {
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__25__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::~Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_access_seq::~\n"); );
}
