...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_get_by_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__0__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> __Vfunc_get_type__1__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> rsrc;
    std::string msg;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_base> type_handle;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz51__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __Vfunc_get_type__1__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_get_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> __Vfunc_get_type__13__Vfuncout;
    ...
    std::string msg;
    {
        ...
        VL_NULL_CHECK(rp, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_resource_db.svh", 108)->__VnoInFunc_get_by_name(vlProcess, vlSymsp, scope, name, 
                                                                                ([&]() {
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz51__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __Vfunc_get_type__13__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_default(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    ...
    r = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51, vlProcess, vlSymsp, name);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_m_show_msg(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
    ...
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> foo;
    std::string msg;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> rsrc;
    rsrc = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51, vlProcess, vlSymsp, name);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_anonymous(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> rsrc;
    rsrc = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51, vlProcess, vlSymsp, ""s);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_override(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_override\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_override_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_override_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_read_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> &val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> __Vfunc_get_by_name__65__Vfuncout;
    CData/*0:0*/ __Vfunc_is_tracing__66__Vfuncout;
    __Vfunc_is_tracing__66__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> __Vtask_read__68__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> rsrc;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_read_by_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> &val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> __Vfunc_get_by_type__69__Vfuncout;
    CData/*0:0*/ __Vfunc_is_tracing__70__Vfuncout;
    __Vfunc_is_tracing__70__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> __Vtask_read__72__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> rsrc;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_write_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> __Vfunc_get_by_name__73__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_write_by_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> __Vfunc_get_by_type__77__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_dump(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51__Vclpkg::__VnoInFunc_dump\n"); );
    // Locals
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz51::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
