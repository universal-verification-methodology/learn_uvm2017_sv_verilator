...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_disable_auto_item_recording(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_disable_auto_item_recording\n"); );
    // Body
    this->__PVT__m_auto_item_recording = 0U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_auto_item_recording_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &is_auto_item_recording_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_auto_item_recording_enabled\n"); );
    // Body
    is_auto_item_recording_enabled__Vfuncrtn = this->__PVT__m_auto_item_recording;
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> parent)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_component(vlProcess, vlSymsp, name, parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::new\n"); );
    // Body
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_sequencer_base__Vclpkg.__PVT__all_sequencer_insts.at(this->__PVT__m_sequencer_id) 
        = VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base>{this};
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_do_print(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_do_print\n"); );
    // Locals
    ...
    Vvirtual_sequences_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_print(vlProcess, vlSymsp, printer);
    ...
    while (VL_LTS_III(32, unnamedblk230__DOT__i, this->__PVT__arb_sequence_q.size())) {
        __Vtemp_1 = Vvirtual_sequences___024unit::__Venumtab_enum_name59
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_update_lists(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_update_lists\n"); );
    // Body
    this->__PVT__m_lock_arb_size = ((IData)(1U) + this->__PVT__m_lock_arb_size);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_convert2string\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_number_driver_connections(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &m_find_number_driver_connections__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_number_driver_connections\n"); );
    // Body
    m_find_number_driver_connections__Vfuncrtn = 0U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_register_sequence(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, IData/*31:0*/ &m_register_sequence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_register_sequence\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_sequence(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ sequence_id, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> &m_find_sequence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_sequence\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> seq_ptr;
    IData/*31:0*/ i;
    i = 0;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unregister_sequence(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ sequence_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unregister_sequence\n"); );
    // Body
    {
        if ((! this->__PVT__reg_sequences.exists(sequence_id))) {
            goto __Vlabel0;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_user_priority_arbitration(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> avail_sequences, IData/*31:0*/ &user_priority_arbitration__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_user_priority_arbitration\n"); );
    // Body
    user_priority_arbitration__Vfuncrtn = avail_sequences.at(0U);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grant_queued_locks(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grant_queued_locks\n"); );
    // Locals
    ...
    std::string __Vtemp_2;
    // Body
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request>> unnamedblk234__DOT__zombies;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request> unnamedblk236__DOT__unnamedblk237__DOT__lock_req;
    unnamedblk234__DOT__zombies = this->__PVT__arb_sequence_q.find(
                                                                   [&](
                                                                       IData/*31:0*/ item__DOT__index, 
                                                                       VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request> item) -> 
                                                                   CData/*31:0*/ {
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_select_sequence(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_select_sequence\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_choose_next_request(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &m_choose_next_request__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_choose_next_request\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_arb_not_equal(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_arb_not_equal\n"); );
    // Body
    VL_KEEP_THIS;
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence\n"); );
    // Locals
    ...
    // Body
    VL_KEEP_THIS;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_25> __VDynScope_m_wait_for_available_sequence_0;
    VlQueue<IData/*31:0*/> is_relevant_entries;
    is_relevant_entries.atDefault() = 0;
    __VDynScope_m_wait_for_available_sequence_0 = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_25, vlSymsp);
    {
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &is_relevant_entries, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_25> &__VDynScope_m_wait_for_available_sequence_0, VlForkSync __Vfork_1__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0\n"); );
    // Body
    VL_KEEP_THIS;
    {
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> is_relevant_entries, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_25> __VDynScope_m_wait_for_available_sequence_0, VlForkSync __Vfork_2__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0\n"); );
    // Body
    VL_KEEP_THIS;
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__1(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlForkSync __Vfork_3__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__1\n"); );
    // Body
    VL_KEEP_THIS;
    co_await this->__VnoInFunc_m_wait_arb_not_equal(vlProcess, vlSymsp);
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlForkSync __Vfork_3__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_25> __Vtask___VforkTask_1__58____VDynScope_m_wait_for_available_sequence_0;
    // Body
    VL_KEEP_THIS;
    ...
    while (VL_LTS_III(32, VL_NULL_CHECK(__Vtask___VforkTask_1__58____VDynScope_m_wait_for_available_sequence_0, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_base.svh", 785)
        ...
        this->__Vtask___VforkTask_1__58___Vwrapped_unnamedblk238_6__DOT____VDynScope_unnamedblk238_6 
            = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_31, vlSymsp);
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0____Vfork_4__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0____Vfork_4__0\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_31> __Vtask___VforkTask_0__60____VDynScope_unnamedblk238_6;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_get_seq_item_priority(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request> seq_q_entry, IData/*31:0*/ &m_get_seq_item_priority__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_get_seq_item_priority\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_arbitration_completed(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ request_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_arbitration_completed\n"); );
    // Body
    VL_KEEP_THIS;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_set_arbitration_completed(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ request_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_set_arbitration_completed\n"); );
    // Body
    this->__PVT__arb_completed.at(request_id) = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_child(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> child, CData/*0:0*/ &is_child__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_child\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> __Vtask_get_parent_sequence__74__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> __Vtask_get_parent_sequence__77__Vfuncout;
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> child_parent;
    {
        if ((VlNull{} == child)) {
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_execute_item(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_execute_item\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03am_uvm_sqr_seq_base> seq;
    seq = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03am_uvm_sqr_seq_base, vlProcess, vlSymsp, "execute_item_seq"s);
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_grant(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, IData/*31:0*/ item_priority, CData/*0:0*/ lock_request) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_grant\n"); );
    // Locals
    IData/*31:0*/ __Vfunc_m_register_sequence__85__Vfuncout;
    __Vfunc_m_register_sequence__85__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_std__03a__03aprocess> __Vfunc_self__87__Vfuncout;
    VlClassRef<Vvirtual_sequences_std__03a__03aprocess> __Vfunc_self__89__Vfuncout;
    // Body
    VL_KEEP_THIS;
    ...
    __Vincrement3 = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request> req_s;
    ...
    if (lock_request) {
        req_s = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request, vlSymsp);
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_item_done(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, IData/*31:0*/ transaction_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_item_done\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_blocked(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, CData/*0:0*/ &is_blocked__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_blocked\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_lock(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, CData/*0:0*/ &has_lock__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_lock\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_lock_req(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, CData/*0:0*/ lock) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_lock_req\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_std__03a__03aprocess> __Vfunc_self__105__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    ...
    IData/*31:0*/ my_seq_id;
    my_seq_id = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request> new_req;
    if ((VlNull{} == sequence_ptr)) {
    ...
    new_req = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_request, vlSymsp);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unlock_req(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unlock_req\n"); );
    // Locals
    ...
    unnamedblk241__DOT__q = this->__PVT__lock_list.find_first_index(
                                                                    [&](
                                                                        IData/*31:0*/ item__DOT__index, 
                                                                        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> item) -> 
                                                                    CData/*31:0*/ {
            return ((([&]() {
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_lock(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_lock\n"); );
    // Body
    VL_KEEP_THIS;
    co_await this->__VnoInFunc_m_lock_req(vlSymsp, sequence_ptr, 1U);
}

VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grab(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grab\n"); );
    // Body
    VL_KEEP_THIS;
    co_await this->__VnoInFunc_m_lock_req(vlSymsp, sequence_ptr, 0U);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_unlock(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_unlock\n"); );
    // Body
    this->__VnoInFunc_m_unlock_req(vlSymsp, sequence_ptr);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_ungrab(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_ungrab\n"); );
    // Body
    this->__VnoInFunc_m_unlock_req(vlSymsp, sequence_ptr);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_remove_sequence_from_queues(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_remove_sequence_from_queues\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_sequences(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_sequences\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> __Vfunc_m_find_sequence__139__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> __Vfunc_m_find_sequence__141__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> seq_ptr;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_sequence_exiting(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_sequence_exiting\n"); );
    // Body
    this->__VnoInFunc_remove_sequence_from_queues(vlProcess, vlSymsp, sequence_ptr);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_kill_sequence(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_kill_sequence\n"); );
    // Body
    this->__VnoInFunc_remove_sequence_from_queues(vlProcess, vlSymsp, sequence_ptr);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_grabbed(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &is_grabbed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_grabbed\n"); );
    // Body
    is_grabbed__Vfuncrtn = (0U != this->__PVT__lock_list.size());
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_current_grabber(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> &current_grabber__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_current_grabber\n"); );
    // Body
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_do_available(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &has_do_available__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_do_available\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_arbitration(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_arbitration\n"); );
    // Body
    this->__PVT__m_arbitration = val;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_arbitration(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_arbitration__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_arbitration\n"); );
    // Body
    get_arbitration__Vfuncrtn = this->__PVT__m_arbitration;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_arbitration_sequence(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> &get_arbitration_sequence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_arbitration_sequence\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_analysis_write(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_analysis_write\n"); );
}

VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences\n"); );
    // Locals
    IData/*31:0*/ __Vtrigprevexpr_heb657ce5__0;
    __Vtrigprevexpr_heb657ce5__0 = 0;
    // Body
    VL_KEEP_THIS;
    ...
    CData/*0:0*/ __VdynTrigger_h198a1890__0;
    __VdynTrigger_h198a1890__0 = 0;
    __VdynTrigger_h198a1890__0 = 0U;
    __Vtrigprevexpr_heb657ce5__0 = VL_NULL_CHECK(this->__Vtask_uvm_wait_for_nba_region__147____VDynScope_uvm_wait_for_nba_region_0, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 430)
        ->__PVT__nba;
    while ((1U & (~ (IData)(__VdynTrigger_h198a1890__0)))) {
        co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                     vlProcess, 
                                                     ...
                                                     430);
        __VdynTrigger_h198a1890__0 = (VL_NULL_CHECK(this->__Vtask_uvm_wait_for_nba_region__147____VDynScope_uvm_wait_for_nba_region_0, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 430)
                                      ->__PVT__nba 
                                      != __Vtrigprevexpr_heb657ce5__0);
        vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h198a1890__0);
        __Vtrigprevexpr_heb657ce5__0 = VL_NULL_CHECK(this->__Vtask_uvm_wait_for_nba_region__147____VDynScope_uvm_wait_for_nba_region_0, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 430)
            ->__PVT__nba;
    }
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0\n"); );
    // Body
    VL_KEEP_THIS;
    this->__Vtask___VforkTask_0__149____VDynScope_uvm_wait_for_nba_region_0 
        = this->__Vtask_uvm_wait_for_nba_region__147____VDynScope_uvm_wait_for_nba_region_0;
    vlSymsp->TOP.__VnbaEventTrigger = 1U;
    IData/*31:0*/ __Vintraval_he5f43940__0;
    __Vintraval_he5f43940__0 = 0;
    __Vintraval_he5f43940__0 = vlSymsp->TOP__uvm_pkg.__PVT__uvm_wait_for_nba_region__Vstatic__next_nba;
    this->__VnoInFunc_wait_for_sequences____Vfork_5__0____Vfork_6__0(vlSymsp, __Vintraval_he5f43940__0);
    vlProcess->state(VlProcess::FINISHED);
    co_return;
    co_return;
}

VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0____Vfork_6__0(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ __Vintraval_he5f43940__0) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0____Vfork_6__0\n"); );
    // Body
    VL_KEEP_THIS;
    ...
    VL_NULL_CHECK(this->__Vtask___VforkTask_0__149____VDynScope_uvm_wait_for_nba_region_0, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 429)->__PVT__nba 
        = __Vintraval_he5f43940__0;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_send_request(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ rerandomize) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_send_request\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_max_zero_time_wait_relevant_count(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ new_val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_max_zero_time_wait_relevant_count\n"); );
    // Body
    this->__PVT__m_max_zero_time_wait_relevant_count 
        = new_val;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__151__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__152__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__153__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz26> __Vtask_lookup_name__154__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_base> __Vtask_get__159__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> __Vtask_read__160__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_read__164__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> __Vtask_create_object_by_type__168__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_base> unnamedblk243__DOT__unnamedblk244__DOT__rsrc;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz51> unnamedblk243__DOT__unnamedblk244__DOT__sbr;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz52> unnamedblk243__DOT__unnamedblk244__DOT__owr;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> unnamedblk243__DOT__unnamedblk244__DOT__unnamedblk245__DOT__wrapper;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_32> __VDynScope_start_phase_sequence_7;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_factory> f;
    __VDynScope_start_phase_sequence_7 = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_32, vlSymsp);
        ...
        while (((VlNull{} == VL_NULL_CHECK(__VDynScope_start_phase_sequence_7, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_base.svh", 1327)
            ...
            if ((VL_CAST_DYNAMIC(unnamedblk243__DOT__unnamedblk244__DOT__rsrc, unnamedblk243__DOT__unnamedblk244__DOT__sbr) 
                ...
                VL_NULL_CHECK(unnamedblk243__DOT__unnamedblk244__DOT__sbr, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_base.svh", 1338)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base>{this}, __Vtask_read__160__Vfuncout);
                ...
                VL_NULL_CHECK(unnamedblk243__DOT__unnamedblk244__DOT__owr, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_base.svh", 1350)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base>{this}, __Vtask_read__164__Vfuncout);
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence____Vfork_7__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_32> __VDynScope_start_phase_sequence_7) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence____Vfork_7__0\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_32> __Vtask___VforkTask_3__190____VDynScope_start_phase_sequence_7;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_process_wrapper> __Vtask___VforkTask_3__190__w;
    VlClassRef<Vvirtual_sequences_std__03a__03aprocess> __Vfunc_self__192__Vfuncout;
    ...
    __Vtask___VforkTask_3__190__w = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_process_wrapper, vlSymsp);
    ...
    co_await VL_NULL_CHECK(VL_NULL_CHECK(__Vtask___VforkTask_3__190____VDynScope_start_phase_sequence_7, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_base.svh", 1395)
                           ->__PVT__seq, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer_base.svh", 1395)->__VnoInFunc_start(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base>{this}, VlNull{}, 0xffffffffU, 1U);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_phase_sequence(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_phase_sequence\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base::to_string_middle\n"); );
    // Body
    std::string out;
