...
#ifndef VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_POOL__TZ61_TBZ198__VCLPKG_H_
#define VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_POOL__TZ61_TBZ198__VCLPKG_H_  // guard
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz261;
...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vvirtual_sequences__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198__Vclpkg(Vvirtual_sequences__Syms* symsp, const char* v__name);
    ~Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198__Vclpkg();
    VL_UNCOPYABLE(Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz261> &get_type__Vfuncrtn);
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198 : public Vvirtual_sequences_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61>> __PVT__pool;
    ...
    virtual void __VnoInFunc_add(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> item);
  ...
  public:
    Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198() {}
};
