...
#ifndef VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_BOTTOMUP_PHASE__VCLPKG_H_
#define VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_BOTTOMUP_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_bottomup_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_bottomup_phase__Vclpkg();
    ~Vvirtual_sequences_uvm_pkg__03a__03auvm_bottomup_phase__Vclpkg();
    void ctor(Vvirtual_sequences__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vvirtual_sequences_uvm_pkg__03a__03auvm_bottomup_phase__Vclpkg);
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_bottomup_phase : public Vvirtual_sequences_uvm_pkg__03a__03auvm_phase {
  public:
  ...
  public:
    Vvirtual_sequences_uvm_pkg__03a__03auvm_bottomup_phase(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vvirtual_sequences_uvm_pkg__03a__03auvm_bottomup_phase();
};
