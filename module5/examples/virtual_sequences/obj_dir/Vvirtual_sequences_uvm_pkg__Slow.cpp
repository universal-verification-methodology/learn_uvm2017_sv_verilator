...
Vvirtual_sequences_uvm_pkg::Vvirtual_sequences_uvm_pkg(Vvirtual_sequences__Syms* symsp, const char* v__name)
...
Vvirtual_sequences_uvm_pkg::~Vvirtual_sequences_uvm_pkg() {
}
