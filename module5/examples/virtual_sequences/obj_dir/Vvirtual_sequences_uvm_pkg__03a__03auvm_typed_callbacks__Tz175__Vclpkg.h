...
#ifndef VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ175__VCLPKG_H_
#define VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ175__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> __PVT__m_tw_cb_q;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vvirtual_sequences__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175__Vclpkg(Vvirtual_sequences__Syms* symsp, const char* v__name);
    ~Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175__Vclpkg();
    VL_UNCOPYABLE(Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175> &m_initialize__Vfuncrtn);
};
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175 : public Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz175() {}
};
