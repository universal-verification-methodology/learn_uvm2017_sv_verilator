...
#ifndef VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI7__VCLPKG_H_
#define VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI7__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vvirtual_sequences___024unit__03a__03aVirtualTransaction;
class Vvirtual_sequences_uvm_pkg__03a__03auvm_analysis_export__Tz1;
...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7__Vclpkg(Vvirtual_sequences__Syms* symsp, const char* v__name);
    ~Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7__Vclpkg();
    VL_UNCOPYABLE(Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7__Vclpkg);
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7 : public Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base {
  public:
    ...
    VlQueue<VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction>> __PVT__m_last_req_buffer;
    VlQueue<VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction>> __PVT__m_last_rsp_buffer;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_analysis_fifo__pi32> __PVT__sqr_rsp_analysis_fifo;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_analysis_export__Tz1> __PVT__rsp_export;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_tlm_fifo__Tz1> __PVT__m_req_fifo;
    ...
    void __VnoInFunc_last_req(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> &last_req__Vfuncrtn);
    void __VnoInFunc_last_rsp(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> &last_rsp__Vfuncrtn);
    void __VnoInFunc_m_last_req_push_front(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> item);
    void __VnoInFunc_m_last_rsp_push_front(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> item);
    void __VnoInFunc_put_response(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> t);
  ...
  public:
    Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7() {}
};
