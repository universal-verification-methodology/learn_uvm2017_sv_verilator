...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_report_message_element_container::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_report_message_element_container::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
