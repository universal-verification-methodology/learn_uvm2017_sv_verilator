...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304__Vclpkg::__VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz348> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz348> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_get_object_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz348> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz348__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_create(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304> tmp;
    tmp = ((""s == name) ? VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304, vlProcess, vlSymsp, "uvm_reg_sequence_inst"s)
            : VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence__Tz203_TBz203(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::new\n"); );
    // Body
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_body(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_body\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_item> __Vtask_peek__27__t;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_item> __Vtask_get__29__t;
    // Body
    VL_KEEP_THIS;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_item> unnamedblk1__DOT__reg_item;
                ...
                = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                    VL_CONCATN_NNN(
                                                                   VL_CONCATN_NNN("Executing RegModel translation sequence on sequencer "s, 
                                                                                ([&]() {
                                    VL_NULL_CHECK(Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item::__PVT__m_sequencer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 133)
    ...
    if ((0U != ([&]() {
        ...
        __Vtask_uvm_report_info__22__message = VL_CVT_PACK_STR_NN(
                                                                  VL_CONCATN_NNN(
                                                                                ...
                                                                                ([&]() {
                            VL_NULL_CHECK(Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item::__PVT__m_sequencer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 138)
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_do_reg_item(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_do_reg_item\n"); );
    // Locals
    ...
    if ((0U == this->__PVT__parent_select)) {
        ...
        VL_NULL_CHECK(rw, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 169)->__PVT__parent 
            = VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304>{this};
    }
    if ((1U == VL_NULL_CHECK(rw, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 172)
        ...
        co_await VL_NULL_CHECK(VL_NULL_CHECK(rw, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 173)
                               ->__PVT__local_map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 173)->__VnoInFunc_do_bus_write(vlProcess, vlSymsp, rw, Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item::__PVT__m_sequencer, this->__PVT__adapter);
    } else {
        co_await VL_NULL_CHECK(VL_NULL_CHECK(rw, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 175)
                               ->__PVT__local_map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 175)->__VnoInFunc_do_bus_read(vlProcess, vlSymsp, rw, Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item::__PVT__m_sequencer, this->__PVT__adapter);
    }
    if ((0U == this->__PVT__parent_select)) {
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_write_reg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg, IData/*31:0*/ &status, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_write_reg\n"); );
    // Locals
    ...
    if ((VlNull{} == rg)) {
        ...
        co_await VL_NULL_CHECK(rg, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 213)->__VnoInFunc_write(vlProcess, vlSymsp, __Vtask_write__59__status, value, path, map, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304>{this}, prior, extension, fname, lineno);
        status = __Vtask_write__59__status;
    }
}

VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_read_reg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg, IData/*31:0*/ &status, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_read_reg\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_poke_reg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg, IData/*31:0*/ &status, QData/*63:0*/ value, std::string kind, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_poke_reg\n"); );
    // Locals
    ...
    if ((VlNull{} == rg)) {
        ...
        co_await VL_NULL_CHECK(rg, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_sequence.svh", 248)->__VnoInFunc_poke(vlSymsp, __Vtask_poke__77__status, value, kind, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304>{this}, extension, fname, lineno);
        status = __Vtask_poke__77__status;
    }
}

VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_peek_reg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg, IData/*31:0*/ &status, QData/*63:0*/ &value, std::string kind, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_peek_reg\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_update_reg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg, IData/*31:0*/ &status, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_update_reg\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_mirror_reg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg, IData/*31:0*/ &status, IData/*31:0*/ check, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_mirror_reg\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_write_mem(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> mem, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_write_mem\n"); );
    // Locals
...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_read_mem(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> mem, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_read_mem\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_poke_mem(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> mem, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ value, std::string kind, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_poke_mem\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_peek_mem(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> mem, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ &value, std::string kind, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_peek_mem\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_put_response(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item> response_item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_put_response\n"); );
    // Body
    this->__VnoInFunc_put_base_response(vlProcess, vlSymsp, response_item);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__parent_select = 0;
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence__Tz203_TBz203::to_string_middle();
    return (out);
}
