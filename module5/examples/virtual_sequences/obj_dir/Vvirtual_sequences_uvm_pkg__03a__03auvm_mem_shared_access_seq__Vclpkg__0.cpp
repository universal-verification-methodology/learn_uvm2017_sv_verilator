...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__26__Vfuncout;
                ...
                while (VL_LTS_III(32, unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__k, maps.size())) {
                    ...
                    if ((0U != unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__status)) {
                        if ((0U != ([&]() {
                            ...
                            __Vtemp_12 = Vvirtual_sequences___024unit::__Venumtab_enum_name83
                                [(3U & unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__status)];
                            __Vtemp_13 = ([&]() {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq::~Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_mem_shared_access_seq::~\n"); );
}
