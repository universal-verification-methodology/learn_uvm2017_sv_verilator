...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_current_item(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> &get_current_item__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_current_item\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_peek__0__Vfuncout;
    __Vtask_try_peek__0__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> __Vtask_try_peek__0__t;
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_last_req(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> &last_req__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_last_req\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_last_rsp(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> &last_rsp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_last_rsp\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> parent)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_base(vlProcess, vlSymsp, name, parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::new\n"); );
    // Body
    ...
    ;
    this->__PVT__rsp_export = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_analysis_export__Tz1, vlProcess, vlSymsp, "rsp_export"s, 
                                     VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7>{this});
    this->__PVT__sqr_rsp_analysis_fifo = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_analysis_fifo__pi32, vlProcess, vlSymsp, "sqr_rsp_analysis_fifo"s, 
                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7>{this});
    ...
    this->__PVT__m_req_fifo = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_tlm_fifo__Tz1, vlProcess, vlSymsp, "req_fifo"s, 
                                     VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7>{this}, 1U);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_do_print(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_do_print\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_connect_phase(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_connect_phase\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_build_phase(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_build_phase\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_send_request(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ rerandomize) {
    ...
    __Vincrement1 = 0;
    VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> param_t;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_put_response(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_put_response\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_analysis_write(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_analysis_write\n"); );
    // Body
    VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> response;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_reqs_sent(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_reqs_sent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_reqs_sent\n"); );
    // Body
    get_num_reqs_sent__Vfuncrtn = this->__PVT__m_num_reqs_sent;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_rsps_received(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_rsps_received__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_rsps_received\n"); );
    // Body
    get_num_rsps_received__Vfuncrtn = this->__PVT__m_num_rsps_received;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_set_num_last_reqs(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_set_num_last_reqs\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0x00000400U < max)) {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_last_reqs(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_reqs__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_last_reqs\n"); );
    // Body
    get_num_last_reqs__Vfuncrtn = this->__PVT__m_num_last_reqs;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_m_last_req_push_front(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_m_last_req_push_front\n"); );
    // Body
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_set_num_last_rsps(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_set_num_last_rsps\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0x00000400U < max)) {
        this->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, "HSTOB"s, "Invalid last size; 1024 is the maximum and will be used"s, 0x000000c8U, ""s, 0U, ""s, 0U);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_last_rsps(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_rsps__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_get_num_last_rsps\n"); );
    // Body
    get_num_last_rsps__Vfuncrtn = this->__PVT__m_num_last_rsps;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_m_last_rsp_push_front(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences___024unit__03a__03aVirtualTransaction> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_m_last_rsp_push_front\n"); );
    // Body
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::_ctor_var_reset\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::~Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_sequencer_param_base__pi7::to_string_middle\n"); );
    // Body
    std::string out;
