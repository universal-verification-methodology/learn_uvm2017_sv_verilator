...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_get(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_create(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource__Tz52> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> __Vfunc_get__3__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_set_type_override(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> __Vfunc_get__11__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_set_inst_override(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_set_type_alias(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> unnamedblk2__DOT__rgtry;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> rgtry;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::__VnoInFunc_get_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::__VnoInFunc_initialize(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz106> __Vfunc_get__2__Vfuncout;
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_registry_common__pi63::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
