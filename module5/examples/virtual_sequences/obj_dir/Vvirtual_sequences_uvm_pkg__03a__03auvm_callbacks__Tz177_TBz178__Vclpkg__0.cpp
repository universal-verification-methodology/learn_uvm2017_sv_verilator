...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz177> __Vtask_m_initialize__0__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typeid__Tz73> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typeid__Tz178> __Vfunc_get__2__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_typeid__Tz177> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177> __Vfunc_get__5__Vfuncout;
    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__VnoInFunc_m_initialize(vlProcess, vlSymsp, __Vtask_m_initialize__0__Vfuncout);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz178__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__2__Vfuncout);
        this->__PVT__m_cb_typeid = __Vfunc_get__2__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz177__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__3__Vfuncout);
        this->__PVT__m_typeid = __Vfunc_get__3__Vfuncout;
        this->__PVT__m_inst = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178, vlProcess, vlSymsp);
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
                          == this->__PVT__m_cb_typeid)))) {
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz177_TBz178.get.unnamedblk1: 'assert' failed.\n",0,
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_t_inst 
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz177__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__5__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_m_register_pair(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_m_register_pair\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vfunc_get__11__Vfuncout;
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> inst;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_typename 
        = tname;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_add(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_add\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__12__Vfuncout;
    ...
    std::string tnm;
    {
        ...
        if ((VlNull{} == cb)) {
            ...
            tnm = ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz177__Vclpkg.__PVT__m_typename)
                    ? vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz177__Vclpkg.__PVT__m_typename
                    : ((VlNull{} != obj) ? ([&]() {
        ...
        if ((VlNull{} == obj)) {
            if ((0xffffffffU != ([&]() {
                            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__28__Vfuncout);
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_t_inst, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 658)->__VnoInFunc_m_add_tw_cbs(vlProcess, vlSymsp, cb, ordering);
            }
        } else {
            ...
            if ((0U == ([&]() {
                ...
                while (VL_LTS_III(32, unnamedblk2__DOT__unnamedblk5__DOT__i, 
                                  ([&]() {
                                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 687)
                    ...
                    VL_NULL_CHECK(q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 688)->__VnoInFunc_push_back(vlSymsp, 
                                                                                ([&]() {
                                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 688)
            ...
            if ((0xffffffffU != ([&]() {
                            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__42__Vfuncout);
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__VnoInFunc_m_cb_find_name(vlProcess, vlSymsp, q, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_add_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> root, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_add_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__54__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> t;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_delete(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_delete\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__67__Vfuncout;
    ...
    if ((VlNull{} == obj)) {
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_t_inst, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 771)->__VnoInFunc_m_delete_tw_cbs(vlProcess, vlSymsp, cb, __Vtask_m_delete_tw_cbs__68__Vfuncout);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__70__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_delete_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> root) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_delete_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__78__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_m_get_q(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> &q, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_m_get_q\n"); );
    // Locals
    ...
    if ((0U != ([&]() {
        ...
        q = ((VlNull{} == obj) ? vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_tw_cb_q
              : ([&]() {
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_t_inst, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 835)
                 ->__VnoInFunc_m_get_tw_cb_q(vlSymsp, obj, __Vtask_m_get_tw_cb_q__91__Vfuncout);
                }(), __Vtask_m_get_tw_cb_q__91__Vfuncout));
    }
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_first(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> &get_first__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_first\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__92__Vfuncout;
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> q;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> cb;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_last(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> &get_last__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_last\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__97__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_next(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> &get_next__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_next\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__102__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_prev(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> &get_prev__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_prev\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__107__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_all(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs>> &all_callbacks, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_get_all\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__111__Vfuncout;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz73> q;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> cb;
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs>> callbacks_to_append;
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs>> unique_callbacks_to_append;
    ...
    if (((VlNull{} == obj) || (1U & (~ (0U != ([&]() {
        ...
        while (VL_LTS_III(32, unnamedblk9__DOT__qi, 
                          ([&]() {
                        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 976)
                           ->__VnoInFunc_size(vlSymsp, __Vtask_size__113__Vfuncout);
                    }(), __Vtask_size__113__Vfuncout))) {
            if (VL_CAST_DYNAMIC(([&]() {
                            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 977)
    ...
    unique_callbacks_to_append = callbacks_to_append.unique(
                                                            [&](
                                                                ...
                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> cb_) -> 
                                                            IData/*31:0*/ {
            return (([&]() {
    ...
    all_callbacks = VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs>>::consCC(unique_callbacks_to_append, 
                                                                                all_callbacks);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_display(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178__Vclpkg::__VnoInFunc_display\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178> __Vtask_get__119__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    this->__VnoInFunc_get(vlProcess, vlSymsp, __Vtask_get__119__Vfuncout);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz177__Vclpkg.__VnoInFunc_display(vlSymsp, obj);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc_m_is_registered(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_registered__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc_m_is_registered\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc_m_is_for_me(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_for_me__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc_m_is_for_me\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_cbs> this_cb;
    m_is_for_me__Vfuncrtn = (1U & VL_CAST_DYNAMIC(cb, this_cb));
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz177(vlProcess, vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_registered = 0;
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz177_TBz178::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_registered:" + VL_TO_STRING(__PVT__m_registered);
    out += ", "+ Vvirtual_sequences_uvm_pkg__03a__03auvm_typed_callbacks__Tz177::to_string_middle();
    return (out);
}
