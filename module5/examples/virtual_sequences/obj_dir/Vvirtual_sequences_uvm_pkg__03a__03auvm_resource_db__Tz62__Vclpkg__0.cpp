...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_get_by_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__0__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> __Vfunc_get_type__1__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_get_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> __Vfunc_get_type__13__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_default(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    ...
    r = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_, vlProcess, vlSymsp, name);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> rsrc;
    rsrc = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_, vlProcess, vlSymsp, name);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_anonymous(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> rsrc;
    rsrc = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_, vlProcess, vlSymsp, ""s);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_override(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_override\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_override_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_override_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_read_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ &val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> __Vfunc_get_by_name__65__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_read_by_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ &val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> __Vfunc_get_by_type__69__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_write_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> __Vfunc_get_by_name__73__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_write_by_type(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ val, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_> __Vfunc_get_by_type__77__Vfuncout;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_dump(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62__Vclpkg::__VnoInFunc_dump\n"); );
    // Locals
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vvirtual_sequences_uvm_pkg__03a__03auvm_resource_db__Tz62::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
