...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_abstract_object_registry__pi17> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_abstract_object_registry__pi17> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_abstract_object_registry__pi17__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_printer"s;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_set_default(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__1__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_default(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_printer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> __Vtask_get_default_printer__4__Vfuncout;
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_object_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_abstract_object_registry__pi17> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_abstract_object_registry__pi17__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_printer"s;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_knobs(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03am_uvm_printer_knobs> &get_knobs__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_knobs\n"); );
    // Body
    get_knobs__Vfuncrtn = this->__PVT__knobs;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_m_get_stack_size(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &m_get_stack_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_m_get_stack_size\n"); );
    // Body
    m_get_stack_size__Vfuncrtn = this->__PVT__m_element_stack.size();
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::Vvirtual_sequences_uvm_pkg__03a__03auvm_printer(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_policy(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
    this->__PVT__knobs = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03am_uvm_printer_knobs, vlSymsp);
    this->__VnoInFunc_flush(vlProcess, vlSymsp);
}

extern const VlWide<128>/*4095:0*/ Vvirtual_sequences__ConstPool__CONST_h1958c06c_0;

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix, CData/*7:0*/ scope_separator, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field\n"); );
    // Locals
    ...
    __Vfunc_uvm_bitstream_to_string__5__unnamedblk3__DOT__unnamedblk4__DOT__idx = 0;
    {
        ...
        VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vvirtual_sequences__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__5__size);
        VL_SUB_W(128, __Vtemp_3, __Vtemp_2, Vvirtual_sequences__ConstPool__CONST_h1958c06c_0);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field_int(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix, CData/*7:0*/ scope_separator, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field_int\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_emit(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_emit\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_flush(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_flush\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_bottom_element__24__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_bottom_element__25__Vfuncout;
    // Body
    IData/*31:0*/ unnamedblk41__DOT__i;
    unnamedblk41__DOT__i = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> element;
    ...
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element>> all_descendent_elements;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_name_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_name_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_name_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &get_name_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_name_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_type_name_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_type_name_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &get_type_name_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_type_name_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_size_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_size_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_size_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &get_size_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_size_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_id_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_id_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_id_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &get_id_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_id_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &get_radix_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_string(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*27:0*/ radix, std::string prefix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_radix_string\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_string(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*27:0*/ radix, std::string &get_radix_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_radix_string\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_default_radix(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*27:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_default_radix\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_default_radix(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*27:0*/ &get_default_radix__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_default_radix\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_root_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ enabled) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_root_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_root_enabled(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &get_root_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_root_enabled\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_recursion_policy(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*27:0*/ policy) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_recursion_policy\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_recursion_policy(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*27:0*/ &get_recursion_policy__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_recursion_policy\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_max_depth(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ depth) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_max_depth\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_max_depth(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_depth__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_max_depth\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_file(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ fl) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_file\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_file(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_file__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_file\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_line_prefix(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string prefix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_line_prefix\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_line_prefix(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_line_prefix__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_line_prefix\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_begin_elements(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ elements) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_begin_elements\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_begin_elements(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_begin_elements__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_begin_elements\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_end_elements(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ elements) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_set_end_elements\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_end_elements(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_end_elements__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_end_elements\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_bottom_element(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> &get_bottom_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_bottom_element\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_top_element(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> &get_top_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_top_element\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_push_element(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, std::string type_name, std::string size, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_push_element\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_unused_element__37__Vfuncout;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_top_element__38__Vfuncout;
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> element;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> parent;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_pop_element(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_pop_element\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_unused_element(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> &get_unused_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_get_unused_element\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element> element;
    element = (VL_LTS_III(32, 0U, this->__PVT__m_recycled_elements.size())
                ? this->__PVT__m_recycled_elements.pop_back()
                : VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_printer_element, vlProcess, vlSymsp, ""s));
    get_unused_element__Vfuncrtn = element;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_header(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ size, std::string arraytype, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_header\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_footer(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_footer\n"); );
    // Body
    this->__VnoInFunc_pop_element(vlSymsp);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_range(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ min, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_range\n"); );
    // Body
    std::string tmpstr;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object_header(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object_header\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> __Vfunc_uvm_object_value_str__48__v;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> __Vtask_get_child__58__Vfuncout;
    IData/*31:0*/ __Vtask_get_next_child__60__Vfuncout;
    __Vtask_get_next_child__60__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_field_op> __Vfunc_m_get_available_op__61__Vfuncout;
    CData/*0:0*/ __Vtask_user_hook_enabled__64__Vfuncout;
    __Vtask_user_hook_enabled__64__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> __Vtask_pop_active_object__68__Vfuncout;
    // Body
    std::string unnamedblk42__DOT__name;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> comp;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> child_comp;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_field_op> field_op;
    ...
    if ((((VlNull{} == value) | (0x00040000U == recursion_policy)) 
        ...
        VL_NULL_CHECK(field_op, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_printer.svh", 1285)->__VnoInFunc_set(vlProcess, vlSymsp, 0x00000010U, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer>{this}, VlNull{});
        ...
        if (([&]() {
            ...
            VL_NULL_CHECK(value, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_printer.svh", 1288)->__VnoInFunc_do_print(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer>{this});
        }
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_istop(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &istop__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_istop\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, std::string type_name, IData/*31:0*/ size, std::string value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic_element(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, std::string type_name, std::string size, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic_element\n"); );
    // Body
    this->__VnoInFunc_push_element(vlProcess, vlSymsp, name, type_name, size, value);
    this->__VnoInFunc_pop_element(vlSymsp);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_time(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_time\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_string(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, std::string value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_string\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_object_printed(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> value, IData/*27:0*/ recursion, IData/*31:0*/ &object_printed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_object_printed\n"); );
    // Body
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_real(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, double value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_real\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_index_string(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string name, std::string &index_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_index_string\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_printer::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vvirtual_sequences_uvm_pkg__03a__03auvm_policy::to_string_middle();
    return (out);
}
