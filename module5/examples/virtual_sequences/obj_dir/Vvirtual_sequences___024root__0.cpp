    ...
    do {
...
#endif
            VL_FATAL_MT("virtual_sequences.sv", 413, "", "DIDNOTCONVERGE: NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vvirtual_sequences___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("virtual_sequences.sv", 413, "", "DIDNOTCONVERGE: Active region did not converge after 100 tries");
            }
