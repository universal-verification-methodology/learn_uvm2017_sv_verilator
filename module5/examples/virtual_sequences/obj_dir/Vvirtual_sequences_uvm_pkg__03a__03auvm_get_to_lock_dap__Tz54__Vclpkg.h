...
#ifndef VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ54__VCLPKG_H_
#define VERILATED_VVIRTUAL_SEQUENCES_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ54__VCLPKG_H_  // guard
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_set_get_dap_base__Tz54;


class Vvirtual_sequences__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54__Vclpkg(Vvirtual_sequences__Syms* symsp, const char* v__name);
    ~Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54__Vclpkg();
    VL_UNCOPYABLE(Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz108> &get_type__Vfuncrtn);
};
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54 : public Vvirtual_sequences_uvm_pkg__03a__03auvm_set_get_dap_base__Tz54 {
  public:
  ...
  public:
    Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54() {}
};
