    ...
    while (VL_LTS_III(32, 0U, unnamedblk1_2__DOT____Vrepeat1)) {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_2 = Vvirtual_sequences___024unit::__Venumtab_enum_name83
                    [(3U & status)];
                __Vtemp_3 = ([&]() {
        ...
        if ((0U != status)) {
            if ((0U != ([&]() {
                ...
                __Vtemp_5 = Vvirtual_sequences___024unit::__Venumtab_enum_name83
                    [(3U & status)];
                __Vtemp_6 = ([&]() {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::~Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq::~\n"); );
}
