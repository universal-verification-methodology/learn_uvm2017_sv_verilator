    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        ...
        if ((unnamedblk1__DOT__cb_base_type == this->__PVT__m_cb_typeid)) {
            if (VL_UNLIKELY(((1U & (~ (0U != ([&]() {
                ...
                VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz172.get.unnamedblk1: '$cast' failed.\n",0,
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz172::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz172::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz172::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz172::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz172::~Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz172() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_callbacks__Tz172::~\n"); );
}
