...
VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_bit_bash_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq> __Vfunc_create__17__Vfuncout;
    // Body
    VL_KEEP_THIS;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi165__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "reg_single_bit_bash_seq"s, VlNull{}, ""s, __Vfunc_create__17__Vfuncout);
        ...
        VL_NULL_CHECK(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_sequence__Tz304::__PVT__model, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_bit_bash_seq.svh", 247)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_bit_bash_seq::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_bit_bash_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
