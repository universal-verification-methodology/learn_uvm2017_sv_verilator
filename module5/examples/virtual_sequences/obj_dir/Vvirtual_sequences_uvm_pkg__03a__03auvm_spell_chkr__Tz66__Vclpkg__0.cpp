...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz26>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66__Vclpkg::__VnoInFunc_levenshtein_distance(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66__Vclpkg::__VnoInFunc_minimum(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = 0;
    min = a;
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_spell_chkr__Tz66::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
