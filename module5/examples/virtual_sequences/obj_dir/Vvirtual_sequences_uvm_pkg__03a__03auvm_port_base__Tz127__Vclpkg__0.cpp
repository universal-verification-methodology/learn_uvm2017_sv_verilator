...
Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ port_type, IData/*31:0*/ min_size, IData/*31:0*/ max_size)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_tlm_if_base__Tz15_TBz15(vlProcess, vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::new\n"); );
    // Locals
    ...
    this->__PVT__m_comp = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_port_component__Tz156, vlProcess, vlSymsp, name, parent, 
                                 VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127>{this});
    if ((1U & (~ ([&]() {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_name\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_full_name\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_parent(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_parent\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_comp(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_component_base> &get_comp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_comp\n"); );
    // Body
    get_comp__Vfuncrtn = this->__PVT__m_comp;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_type_name\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_max_size(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &max_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_max_size\n"); );
    // Body
    max_size__Vfuncrtn = this->__PVT__m_max_size;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_min_size(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &min_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_min_size\n"); );
    // Body
    min_size__Vfuncrtn = this->__PVT__m_min_size;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_unbounded(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &is_unbounded__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_unbounded\n"); );
    // Body
    is_unbounded__Vfuncrtn = (0xffffffffU == this->__PVT__m_max_size);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_port(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &is_port__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_port\n"); );
    // Body
    is_port__Vfuncrtn = (0U == this->__PVT__m_port_type);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_export(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &is_export__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_export\n"); );
    // Body
    is_export__Vfuncrtn = (1U == this->__PVT__m_port_type);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_imp(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &is_imp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_is_imp\n"); );
    // Body
    is_imp__Vfuncrtn = (2U == this->__PVT__m_port_type);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_size(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_size\n"); );
    // Body
    size__Vfuncrtn = this->__PVT__m_imp_list.size();
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_set_if(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_set_if\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> __Vfunc_get_if__7__Vfuncout;
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_m_get_if_mask(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &m_get_if_mask__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_m_get_if_mask\n"); );
    // Body
    m_get_if_mask__Vfuncrtn = this->__PVT__m_if_mask;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_set_default_index(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_set_default_index\n"); );
    // Body
    this->__PVT__m_def_index = index;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_connect(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> provider) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_connect\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        if ((provider == VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127>{this})) {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_debug_connected_to(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ level, IData/*31:0*/ max_level) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_debug_connected_to\n"); );
    // Locals
    ...
    curr_num = 0;
    std::string s_sz;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> port;
    {
                    ...
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__save 
                        = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                        VL_CONCATN_NNN(
                                                                       VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__save, vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__indent), "  |_"s), unnamedblk1__DOT__nm), " ("s), 
                                                        ([&]() {
        ...
        if ((0U == level)) {
            ...
            if ((0U == this->__PVT__m_imp_list.size())) {
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__save 
                    = (((0x00000010U == ([&]() {
                        ...
                        ? VL_CONCATN_NNN(vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__save, "  Connected implementations: none\n"s)
                            ...
                            = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN(
                                                                           VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__save, vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__indent), s_sz), ": "s), unnamedblk3__DOT__nm), " ("s), 
                                                            ([&]() {
            ...
            VL_NULL_CHECK(this->__PVT__m_comp, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_port_base.svh", 591)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, "debug_connected_to"s, vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_connected_to__Vstatic__save, 0x000000c8U, ""s, 0U, ""s, 0U);
        }
        __Vlabel0: ;
    }
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_debug_provided_to(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ level, IData/*31:0*/ max_level) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_debug_provided_to\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> port;
    {
                    ...
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_provided_to__Vstatic__save 
                        = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                        VL_CONCATN_NNN(
                                                                       VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_provided_to__Vstatic__save, vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_provided_to__Vstatic__indent), "  |_"s), unnamedblk4__DOT__nm), " ("s), 
                                                        ([&]() {
        ...
        if ((0U == level)) {
            ...
            VL_NULL_CHECK(this->__PVT__m_comp, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_port_base.svh", 639)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, "debug_provided_to"s, vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz127__Vclpkg.__PVT__debug_provided_to__Vstatic__save, 0x000000c8U, ""s, 0U, ""s, 0U);
        }
        __Vlabel0: ;
    }
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_connected_to(Vvirtual_sequences__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127>> &list) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_connected_to\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_provided_to(Vvirtual_sequences__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127>> &list) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_provided_to\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_m_check_relationship(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_m_check_relationship\n"); );
    // Locals
    ...
    // Body
    std::string s;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> from;
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_component> to_gparent;
    {
        ...
        from = VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127>{this};
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_m_add_list(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> provider) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_m_add_list\n"); );
    // Locals
    IData/*31:0*/ __Vtask_size__68__Vfuncout;
    __Vtask_size__68__Vfuncout = 0;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> __Vtask_get_if__69__Vfuncout;
    ...
    std::string sz;
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> imp;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_resolve_bindings(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_resolve_bindings\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> unnamedblk8__DOT__unnamedblk9__DOT__port;
    {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_if(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127> &get_if__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::__VnoInFunc_get_if\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::_ctor_var_reset\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::~Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vvirtual_sequences_uvm_pkg__03a__03auvm_port_base__Tz127::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vvirtual_sequences_uvm_pkg__03a__03auvm_tlm_if_base__Tz15_TBz15::to_string_middle();
    return (out);
}
