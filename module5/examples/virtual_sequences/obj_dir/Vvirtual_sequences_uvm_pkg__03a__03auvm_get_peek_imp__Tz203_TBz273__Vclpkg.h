...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_get_peek_imp__Tz203_TBz273__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_get_peek_imp__Tz203_TBz273__Vclpkg(Vvirtual_sequences__Syms* symsp, const char* v__name);
