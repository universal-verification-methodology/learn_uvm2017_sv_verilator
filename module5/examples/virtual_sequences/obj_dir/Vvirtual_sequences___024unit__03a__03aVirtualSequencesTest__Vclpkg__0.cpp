...
void Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    ...
    // Locals
    IData/*31:0*/ __Vfunc___VBasicRand__20__Vfuncout;
    __Vfunc___VBasicRand__20__Vfuncout = 0;
    // Body
    ...
    randomize__Vfuncrtn = (randomize__Vfuncrtn & ([&]() {
                this->__VnoInFunc___VBasicRand(vlSymsp, __Vfunc___VBasicRand__20__Vfuncout);
            }(), __Vfunc___VBasicRand__20__Vfuncout));
}

void Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest::~Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vvirtual_sequences___024unit__03a__03aVirtualSequencesTest::~\n"); );
}
