...
class Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_24;
...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences_uvm_pkg__03a__03auvm_heartbeat__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvirtual_sequences_uvm_pkg__03a__03auvm_heartbeat__Vclpkg(Vvirtual_sequences__Syms* symsp, const char* v__name);
...
class Vvirtual_sequences_uvm_pkg__03a__03auvm_heartbeat : public Vvirtual_sequences_uvm_pkg__03a__03auvm_object {
  ...
  private:
    VlCoroutine __VnoInFunc_m_hb_process____Vfork_2__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03a__VDynScope_24> __VDynScope_m_hb_process_1, VlForkSync __Vfork_2__sync);
  ...
  private:
    VlCoroutine __VnoInFunc_m_start_hb_process____Vfork_1__0(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp);
  public:
