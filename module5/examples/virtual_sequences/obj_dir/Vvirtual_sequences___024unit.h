...
class alignas(VL_CACHE_LINE_BYTES) Vvirtual_sequences___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvirtual_sequences___024unit(Vvirtual_sequences__Syms* symsp, const char* v__name);
