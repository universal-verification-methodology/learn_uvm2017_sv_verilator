...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54__Vclpkg::__VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz108> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz108> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_get_object_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__Tz108> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz108__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_create(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54> tmp;
    tmp = ((""s == name) ? VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54, vlProcess, vlSymsp, "unnamed-uvm_get_to_lock_dap#(T)"s)
            : VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name)
    : Vvirtual_sequences_uvm_pkg__03a__03auvm_set_get_dap_base__Tz54(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::new\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_set(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_set\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_try_set(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_try_set\n"); );
    // Body
    if (this->__PVT__m_locked) {
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_get(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_get\n"); );
    // Body
    this->__PVT__m_locked = 1U;
    get__Vfuncrtn = this->__PVT__m_value;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_try_get(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_try_get\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_pack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_pack\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_unpack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_convert2string\n"); );
    // Body
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_print(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_do_print\n"); );
    // Body
    ...
    VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/dap/uvm_get_to_lock_dap.svh", 146)->__VnoInFunc_print_generic(vlProcess, vlSymsp, "value"s, "PARAMTYPEDTYPE 'T'"s, 0U, VL_SFORMATF_N_NX("'h%0x",0,
                                                                                1,
                                                                                this->__PVT__m_value) , 0x2eU);
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::_ctor_var_reset\n"); );
    // Body
...
Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::~Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz54::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_locked:" + VL_TO_STRING(__PVT__m_locked);
    out += ", "+ Vvirtual_sequences_uvm_pkg__03a__03auvm_set_get_dap_base__Tz54::to_string_middle();
    return (out);
}
