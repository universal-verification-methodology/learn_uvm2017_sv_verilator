...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_object_string_pool__Tz198::__VnoInFunc_do_print(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
    ...
    // Body
    std::string key;
    VL_NULL_CHECK(printer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_pool.svh", 323)->__VnoInFunc_print_array_header(vlProcess, vlSymsp, "pool"s, Vvirtual_sequences_uvm_pkg__03a__03auvm_pool__Tz61_TBz198::__PVT__pool.size(), "aa_object_string"s, 0x2eU);
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_object_string_pool__Tz198::__VnoInFunc___Vbasic_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vvirtual_sequences_uvm_pkg__03a__03auvm_object_string_pool__Tz198::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
