...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi99> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi99> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi99__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_block"s;
}

void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_check_data_width(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ width, CData/*0:0*/ &check_data_width__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_check_data_width\n"); );
    // Locals
    ...
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__3__Vfuncout;
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        ...
        if ((0U != ([&]() {
            ...
            vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, VL_SFORMATF_N_NX("Register model requires that UVM_REG_DATA_WIDTH be defined as %0# or greater. Currently defined as 64",0,
                                                                                32,
                                                                                width) , 0U, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s, 0x000003e7U, ""s, 1U);
        }
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_root_blocks(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>> &blks) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_root_blocks\n"); );
    // Body
    VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk631__DOT__blk;
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_blocks(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>> &blks, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, IData/*31:0*/ &find_blocks__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_blocks\n"); );
    // Locals
    ...
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>> r;
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>> b;
    if ((VlNull{} != root)) {
        name = VL_CONCATN_NNN(VL_CONCATN_NNN(([&]() {
                        VL_NULL_CHECK(root, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1307)
                                              ->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __Vtask_get_full_name__6__Vfuncout);
                    }(), __Vtask_get_full_name__6__Vfuncout), "."s), name);
        b = VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>>::consVC(root, 
                                                                                VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>>{});
    } else {
    ...
    while (VL_LTS_III(32, unnamedblk632__DOT__idx, b.size())) {
        ...
        VL_NULL_CHECK(b.at(unnamedblk632__DOT__idx), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1314)->__VnoInFunc_get_blocks(vlSymsp, r, 1U);
    ...
    while (VL_LTS_III(32, unnamedblk633__DOT__idx, r.size())) {
        if (([&]() {
                    __Vfunc_uvm_is_match__9__str = 
                        VL_CVT_PACK_STR_NN(([&]() {
                                VL_NULL_CHECK(r.at(unnamedblk633__DOT__idx), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1320)
...
void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_block(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> &find_block__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_block\n"); );
    // Locals
    ...
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>> blks;
    {
        if ((1U & (~ (0U != ([&]() {
        ...
        if (VL_LTS_III(32, 1U, blks.size())) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__18__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_object_type(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_object_type\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object_registry__pi99> __Vfunc_get__0__Vfuncout;
        // Body
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi99__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> tmp;
        tmp = ((""s == name) ? VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block, vlProcess, vlSymsp, ""s, 0U)
                : VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block, vlProcess, vlSymsp, name, 0U));
        create__Vfuncrtn = tmp;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_type_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_type_name\n"); );
        // Body
        get_type_name__Vfuncrtn = "uvm_reg_block"s;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_unlock_model(Vvirtual_sequences__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_unlock_model\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk1__DOT__blk_;
        CData/*0:0*/ unnamedblk1__DOT__blk___Vfirst;
        unnamedblk1__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk2__DOT__b;
        CData/*0:0*/ unnamedblk2__DOT__b__Vfirst;
        unnamedblk2__DOT__b__Vfirst = 0;
        VlAssocArray<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>, CData/*0:0*/> s;
        s.atDefault() = 0;
        ...
        if ((0U != this->__PVT__blks.first(unnamedblk1__DOT__blk_))) {
            ...
            while (((IData)(unnamedblk1__DOT__blk___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk1__DOT__blk_, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 206)
    ...
    VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_wait_for_lock(Vvirtual_sequences__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_wait_for_lock\n"); );
        // Body
        VL_KEEP_THIS;
        CData/*0:0*/ __VdynTrigger_h05d6c367__0;
        __VdynTrigger_h05d6c367__0 = 0;
        __VdynTrigger_h05d6c367__0 = 0U;
        while ((1U & (~ (IData)(__VdynTrigger_h05d6c367__0)))) {
            co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                         nullptr, 
                                                         "@([event] uvm_pkg::uvm_reg_block.m_uvm_lock_model_complete)", 
                                                         "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 
                                                         216);
            __VdynTrigger_h05d6c367__0 = this->__PVT__m_uvm_lock_model_complete.isFired();
            vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h05d6c367__0);
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ offset, CData/*0:0*/ is_read, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample\n"); );
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_lock(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ v) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_lock\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk3__DOT__idx;
        ...
        if ((0U != this->__PVT__blks.first(unnamedblk3__DOT__idx))) {
            ...
            while (((IData)(unnamedblk3__DOT__idx__Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk3__DOT__idx, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 966)
                    ->__VnoInFunc_set_lock(vlSymsp, v);
            }
        }
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_unregister(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> m) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_unregister\n"); );
        // Locals
        ...
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk4__DOT__idx;
        CData/*0:0*/ unnamedblk4__DOT__idx__Vfirst;
        unnamedblk4__DOT__idx__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk5__DOT__idx;
        CData/*0:0*/ unnamedblk5__DOT__idx__Vfirst;
        unnamedblk5__DOT__idx__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk6__DOT__idx;
        ...
        if ((0U != this->__PVT__regs.first(unnamedblk4__DOT__idx))) {
            ...
            while (((IData)(unnamedblk4__DOT__idx__Vfirst) 
                ...
                if (([&]() {
                            VL_NULL_CHECK(unnamedblk4__DOT__idx, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 972)
        ...
        if ((0U != this->__PVT__mems.first(unnamedblk5__DOT__idx))) {
            ...
            while (((IData)(unnamedblk5__DOT__idx__Vfirst) 
                ...
                if (([&]() {
                            VL_NULL_CHECK(unnamedblk5__DOT__idx, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 976)
        ...
        if ((0U != this->__PVT__vregs.first(unnamedblk6__DOT__idx))) {
            ...
            while (((IData)(unnamedblk6__DOT__idx__Vfirst) 
                ...
                if (([&]() {
                            VL_NULL_CHECK(unnamedblk6__DOT__idx, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 980)
    ...
    Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ has_coverage)
      : Vvirtual_sequences_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::new\n"); );
        // Locals
        ...
        ;
        this->__PVT__hdl_paths_pool = VL_NEW(Vvirtual_sequences_uvm_pkg__03a__03auvm_object_string_pool__Tz198, vlProcess, vlSymsp, "hdl_paths"s);
        this->__PVT__has_cover = has_coverage;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_reg_block__Vclpkg.__PVT__m_roots
                    .at(VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>{this}) = 0U;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_configure(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> parent, std::string hdl_path) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_configure\n"); );
        // Body
        this->__PVT__parent = parent;
        if ((VlNull{} != parent)) {
            VL_NULL_CHECK(this->__PVT__parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1025)
                    ->__VnoInFunc_add_block(vlSymsp, 
                                            VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>{this});
        }
        this->__VnoInFunc_add_hdl_path(vlSymsp, hdl_path, "RTL"s);
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_block(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> blk) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_block\n"); );
        // Locals
        ...
        __Vincrement1 = 0;
        {
            if (([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__17__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            if (this->__PVT__blks.exists(blk)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__25__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                        ...
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN(
                                                                           VL_CONCATN_NNN(
                                                                                ...
                                                                                ([&]() {
                                                VL_NULL_CHECK(blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1039)
            ...
            VL_NULL_CHECK(blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1046)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_reg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_reg\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__42__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__43__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__48__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__49__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        __Vincrement2 = 0;
        {
            if (([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__37__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            if (this->__PVT__regs.exists(rg)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__45__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                        ...
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN(
                                                                           VL_CONCATN_NNN(
                                                                                ...
                                                                                ([&]() {
                                                VL_NULL_CHECK(rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1062)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_vreg(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> vreg) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_vreg\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__53__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__54__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__67__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__68__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        __Vincrement3 = 0;
        {
            if (([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__56__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            if (this->__PVT__vregs.exists(vreg)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__64__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                        ...
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN(
                                                                           VL_CONCATN_NNN(
                                                                                ...
                                                                                ([&]() {
                                                VL_NULL_CHECK(vreg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1080)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_mem(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> mem) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_mem\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__72__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__73__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__76__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__77__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__80__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__81__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__86__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__87__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        __Vincrement4 = 0;
        {
            if (([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__75__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            if (this->__PVT__mems.exists(mem)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__83__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                        ...
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN(
                                                                           VL_CONCATN_NNN(
                                                                                ...
                                                                                ([&]() {
                                                VL_NULL_CHECK(mem, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1097)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_parent(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> parent) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_parent\n"); );
        // Body
        if ((VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>{this} 
             != parent)) {
            this->__PVT__parent = parent;
        }
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_locked(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_locked\n"); );
        // Body
        is_locked__Vfuncrtn = this->__PVT__locked;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_lock_model(Vvirtual_sequences__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_lock_model\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__99__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__100__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__106__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__107__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__112__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__113__Vfuncout;
        std::string __Vtemp_1;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__rg_;
        CData/*0:0*/ unnamedblk604__DOT__rg___Vfirst;
        unnamedblk604__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__unnamedblk605__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk606__DOT__mem_;
        CData/*0:0*/ unnamedblk606__DOT__mem___Vfirst;
        unnamedblk606__DOT__mem___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk606__DOT__unnamedblk607__DOT__mem;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk608__DOT__blk_;
        CData/*0:0*/ unnamedblk608__DOT__blk___Vfirst;
        unnamedblk608__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk608__DOT__unnamedblk609__DOT__blk;
        ...
        unnamedblk610__DOT__max_size = 0;
        {
            ...
            if ((0U != this->__PVT__regs.first(unnamedblk604__DOT__rg_))) {
                ...
                while (((IData)(unnamedblk604__DOT__rg___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk604__DOT__unnamedblk605__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1130)
            ...
            if ((0U != this->__PVT__mems.first(unnamedblk606__DOT__mem_))) {
                ...
                while (((IData)(unnamedblk606__DOT__mem___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk606__DOT__unnamedblk607__DOT__mem, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1135)
                    ->__VnoInFunc_Xlock_modelX(vlSymsp);
                }
            }
            if ((0U != this->__PVT__blks.first(unnamedblk608__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk608__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk608__DOT__unnamedblk609__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1140)
            ...
            if ((VlNull{} == this->__PVT__parent)) {
                ...
                if (VL_LTS_III(32, 0x00000040U, unnamedblk610__DOT__max_size)) {
                    if ((0U != ([&]() {
                        ...
                        vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, VL_SFORMATF_N_NX("Register model requires that UVM_REG_DATA_WIDTH be defined as %0d or greater. Currently defined as 64",0,
                                                                                32,
                                                                                unnamedblk610__DOT__max_size) , 0U, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s, 0x00000481U, ""s, 1U);
                    }
                }
                ...
                if ((1U < vlSymsp->TOP__uvm_pkg__03a__03auvm_reg_block__Vclpkg.__PVT__m_root_names
                    ...
                    if ((0U != ([&]() {
                        ...
                        __Vtask_uvm_report_error__109__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_name\n"); );
        // Locals
        ...
        // Body
        {
            ...
            get_full_name__Vfuncrtn = VL_CONCATN_NNN(
                                                     VL_CONCATN_NNN(
                                                                    ([&]() {
                            VL_NULL_CHECK(this->__PVT__parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1179)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_fields(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_field>> &fields, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_fields\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk611__DOT__rg_;
        CData/*0:0*/ unnamedblk611__DOT__rg___Vfirst;
        unnamedblk611__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk611__DOT__unnamedblk612__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__blk_;
        CData/*0:0*/ unnamedblk613__DOT__blk___Vfirst;
        unnamedblk613__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__unnamedblk614__DOT__blk;
        if ((0U != this->__PVT__regs.first(unnamedblk611__DOT__rg_))) {
            ...
            while (((IData)(unnamedblk611__DOT__rg___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk611__DOT__unnamedblk612__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1191)
        ...
        if ((1U == hier)) {
            if ((0U != this->__PVT__blks.first(unnamedblk613__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk613__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk613__DOT__unnamedblk614__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1198)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_fields(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>> &fields, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_fields\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk615__DOT__vreg_;
        CData/*0:0*/ unnamedblk615__DOT__vreg___Vfirst;
        unnamedblk615__DOT__vreg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk615__DOT__unnamedblk616__DOT__vreg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk617__DOT__blk_;
        CData/*0:0*/ unnamedblk617__DOT__blk___Vfirst;
        unnamedblk617__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk617__DOT__unnamedblk618__DOT__blk;
        if ((0U != this->__PVT__vregs.first(unnamedblk615__DOT__vreg_))) {
            ...
            while (((IData)(unnamedblk615__DOT__vreg___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk615__DOT__unnamedblk616__DOT__vreg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1211)
                    ->__VnoInFunc_get_fields(vlSymsp, fields);
            }
        }
        if ((1U == hier)) {
            if ((0U != this->__PVT__blks.first(unnamedblk617__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk617__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk617__DOT__unnamedblk618__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1217)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_registers(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg>> &regs, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_registers\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk619__DOT__rg;
        CData/*0:0*/ unnamedblk619__DOT__rg__Vfirst;
        unnamedblk619__DOT__rg__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__blk_;
        CData/*0:0*/ unnamedblk620__DOT__blk___Vfirst;
        unnamedblk620__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__unnamedblk621__DOT__blk;
        ...
        if ((1U == hier)) {
            if ((0U != this->__PVT__blks.first(unnamedblk620__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk620__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk620__DOT__unnamedblk621__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1232)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_registers(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg>> &regs, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_registers\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk622__DOT__rg;
        CData/*0:0*/ unnamedblk622__DOT__rg__Vfirst;
        unnamedblk622__DOT__rg__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk623__DOT__blk_;
        CData/*0:0*/ unnamedblk623__DOT__blk___Vfirst;
        unnamedblk623__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk623__DOT__unnamedblk624__DOT__blk;
        ...
        if ((1U == hier)) {
            if ((0U != this->__PVT__blks.first(unnamedblk623__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk623__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk623__DOT__unnamedblk624__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1248)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_memories(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem>> &mems, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_memories\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk625__DOT__mem_;
        CData/*0:0*/ unnamedblk625__DOT__mem___Vfirst;
        unnamedblk625__DOT__mem___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk625__DOT__unnamedblk626__DOT__mem;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk627__DOT__blk_;
        CData/*0:0*/ unnamedblk627__DOT__blk___Vfirst;
        unnamedblk627__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk627__DOT__unnamedblk628__DOT__blk;
        ...
        if ((1U == hier)) {
            if ((0U != this->__PVT__blks.first(unnamedblk627__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk627__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk627__DOT__unnamedblk628__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1266)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_blocks(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>> &blks, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_blocks\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk629__DOT__blk_;
        CData/*0:0*/ unnamedblk629__DOT__blk___Vfirst;
        unnamedblk629__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk629__DOT__unnamedblk630__DOT__blk;
        if ((0U != this->__PVT__blks.first(unnamedblk629__DOT__blk_))) {
            ...
            while (((IData)(unnamedblk629__DOT__blk___Vfirst) 
                ...
                if ((1U == hier)) {
                    VL_NULL_CHECK(unnamedblk629__DOT__unnamedblk630__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1281)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_maps(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map>> &maps) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_maps\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> unnamedblk634__DOT__map;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_parent(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_parent\n"); );
        // Body
        get_parent__Vfuncrtn = this->__PVT__parent;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_block_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> &get_block_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_block_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__131__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__132__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__136__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__137__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk635__DOT__blk_;
        CData/*0:0*/ unnamedblk635__DOT__blk___Vfirst;
        unnamedblk635__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk635__DOT__unnamedblk636__DOT__blk;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk637__DOT__blk_;
        CData/*0:0*/ unnamedblk637__DOT__blk___Vfirst;
        unnamedblk637__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk637__DOT__unnamedblk638__DOT__blk;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>> unnamedblk637__DOT__unnamedblk638__DOT__subblks;
        ...
        unnamedblk637__DOT__unnamedblk638__DOT__unnamedblk639__DOT__j = 0;
        {
            if ((([&]() {
                 ...
                 == name)) {
                get_block_by_name__Vfuncrtn = VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>{this};
                goto __Vlabel0;
            }
            if ((0U != this->__PVT__blks.first(unnamedblk635__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk635__DOT__blk___Vfirst) 
                    ...
                    if ((([&]() {
                                    VL_NULL_CHECK(unnamedblk635__DOT__unnamedblk636__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1380)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk637__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk637__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk637__DOT__blk_, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1387)
                    ...
                    while (VL_LTS_III(32, unnamedblk637__DOT__unnamedblk638__DOT__unnamedblk639__DOT__j, unnamedblk637__DOT__unnamedblk638__DOT__subblks.size())) {
                        if ((([&]() {
                                        VL_NULL_CHECK(unnamedblk637__DOT__unnamedblk638__DOT__subblks.at(unnamedblk637__DOT__unnamedblk638__DOT__unnamedblk639__DOT__j), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1390)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__134__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_reg_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> &get_reg_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_reg_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__143__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__144__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__148__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__149__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk640__DOT__rg_;
        CData/*0:0*/ unnamedblk640__DOT__rg___Vfirst;
        unnamedblk640__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk640__DOT__unnamedblk641__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk642__DOT__blk_;
        CData/*0:0*/ unnamedblk642__DOT__blk___Vfirst;
        unnamedblk642__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk642__DOT__unnamedblk643__DOT__blk;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg>> unnamedblk642__DOT__unnamedblk643__DOT__subregs;
        ...
        unnamedblk642__DOT__unnamedblk643__DOT__unnamedblk644__DOT__j = 0;
        {
            if ((0U != this->__PVT__regs.first(unnamedblk640__DOT__rg_))) {
                ...
                while (((IData)(unnamedblk640__DOT__rg___Vfirst) 
                    ...
                    if ((([&]() {
                                    VL_NULL_CHECK(unnamedblk640__DOT__unnamedblk641__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1407)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk642__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk642__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk642__DOT__blk_, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1414)
                    ...
                    while (VL_LTS_III(32, unnamedblk642__DOT__unnamedblk643__DOT__unnamedblk644__DOT__j, unnamedblk642__DOT__unnamedblk643__DOT__subregs.size())) {
                        if ((([&]() {
                                        VL_NULL_CHECK(unnamedblk642__DOT__unnamedblk643__DOT__subregs.at(unnamedblk642__DOT__unnamedblk643__DOT__unnamedblk644__DOT__j), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1417)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__146__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vreg_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vreg_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__155__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__156__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__160__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__161__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk645__DOT__rg_;
        CData/*0:0*/ unnamedblk645__DOT__rg___Vfirst;
        unnamedblk645__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk645__DOT__unnamedblk646__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk647__DOT__blk_;
        CData/*0:0*/ unnamedblk647__DOT__blk___Vfirst;
        unnamedblk647__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk647__DOT__unnamedblk648__DOT__blk;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg>> unnamedblk647__DOT__unnamedblk648__DOT__subvregs;
        ...
        unnamedblk647__DOT__unnamedblk648__DOT__unnamedblk649__DOT__j = 0;
        {
            if ((0U != this->__PVT__vregs.first(unnamedblk645__DOT__rg_))) {
                ...
                while (((IData)(unnamedblk645__DOT__rg___Vfirst) 
                    ...
                    if ((([&]() {
                                    VL_NULL_CHECK(unnamedblk645__DOT__unnamedblk646__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1434)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk647__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk647__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk647__DOT__blk_, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1441)
                    ...
                    while (VL_LTS_III(32, unnamedblk647__DOT__unnamedblk648__DOT__unnamedblk649__DOT__j, unnamedblk647__DOT__unnamedblk648__DOT__subvregs.size())) {
                        if ((([&]() {
                                        VL_NULL_CHECK(unnamedblk647__DOT__unnamedblk648__DOT__subvregs.at(unnamedblk647__DOT__unnamedblk648__DOT__unnamedblk649__DOT__j), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1444)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__158__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_mem_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> &get_mem_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_mem_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__167__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__168__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__172__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__173__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk650__DOT__mem_;
        CData/*0:0*/ unnamedblk650__DOT__mem___Vfirst;
        unnamedblk650__DOT__mem___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk650__DOT__unnamedblk651__DOT__mem;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk652__DOT__blk_;
        CData/*0:0*/ unnamedblk652__DOT__blk___Vfirst;
        unnamedblk652__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk652__DOT__unnamedblk653__DOT__blk;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem>> unnamedblk652__DOT__unnamedblk653__DOT__submems;
        ...
        unnamedblk652__DOT__unnamedblk653__DOT__unnamedblk654__DOT__j = 0;
        {
            if ((0U != this->__PVT__mems.first(unnamedblk650__DOT__mem_))) {
                ...
                while (((IData)(unnamedblk650__DOT__mem___Vfirst) 
                    ...
                    if ((([&]() {
                                    VL_NULL_CHECK(unnamedblk650__DOT__unnamedblk651__DOT__mem, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1461)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk652__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk652__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk652__DOT__blk_, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1468)
                    ...
                    while (VL_LTS_III(32, unnamedblk652__DOT__unnamedblk653__DOT__unnamedblk654__DOT__j, unnamedblk652__DOT__unnamedblk653__DOT__submems.size())) {
                        if ((([&]() {
                                        VL_NULL_CHECK(unnamedblk652__DOT__unnamedblk653__DOT__submems.at(unnamedblk652__DOT__unnamedblk653__DOT__unnamedblk654__DOT__j), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1471)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__170__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_field_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_field> &get_field_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_field_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__181__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__182__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__186__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__187__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk655__DOT__rg_;
        CData/*0:0*/ unnamedblk655__DOT__rg___Vfirst;
        unnamedblk655__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk655__DOT__unnamedblk656__DOT__rg;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_field>> unnamedblk655__DOT__unnamedblk656__DOT__fields;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk658__DOT__blk_;
        CData/*0:0*/ unnamedblk658__DOT__blk___Vfirst;
        unnamedblk658__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk658__DOT__unnamedblk659__DOT__blk;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg>> unnamedblk658__DOT__unnamedblk659__DOT__subregs;
        ...
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_field>> unnamedblk658__DOT__unnamedblk659__DOT__unnamedblk660__DOT__unnamedblk661__DOT__fields;
        ...
        unnamedblk658__DOT__unnamedblk659__DOT__unnamedblk660__DOT__unnamedblk661__DOT__unnamedblk662__DOT__i = 0;
        {
            if ((0U != this->__PVT__regs.first(unnamedblk655__DOT__rg_))) {
                ...
                while (((IData)(unnamedblk655__DOT__rg___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk655__DOT__unnamedblk656__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1490)
                    ...
                    while (VL_LTS_III(32, unnamedblk655__DOT__unnamedblk656__DOT__unnamedblk657__DOT__i, unnamedblk655__DOT__unnamedblk656__DOT__fields.size())) {
                        if ((([&]() {
                                        VL_NULL_CHECK(unnamedblk655__DOT__unnamedblk656__DOT__fields.at(unnamedblk655__DOT__unnamedblk656__DOT__unnamedblk657__DOT__i), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1492)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk658__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk658__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk658__DOT__blk_, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1499)
                    ...
                    while (VL_LTS_III(32, unnamedblk658__DOT__unnamedblk659__DOT__unnamedblk660__DOT__j, unnamedblk658__DOT__unnamedblk659__DOT__subregs.size())) {
                        VL_NULL_CHECK(unnamedblk658__DOT__unnamedblk659__DOT__subregs.at(unnamedblk658__DOT__unnamedblk659__DOT__unnamedblk660__DOT__j), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1503)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__184__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vfield_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field> &get_vfield_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vfield_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__195__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__196__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__200__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__201__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk663__DOT__rg_;
        CData/*0:0*/ unnamedblk663__DOT__rg___Vfirst;
        unnamedblk663__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk663__DOT__unnamedblk664__DOT__rg;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>> unnamedblk663__DOT__unnamedblk664__DOT__fields;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk666__DOT__blk_;
        CData/*0:0*/ unnamedblk666__DOT__blk___Vfirst;
        unnamedblk666__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk666__DOT__unnamedblk667__DOT__blk;
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg>> unnamedblk666__DOT__unnamedblk667__DOT__subvregs;
        ...
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg_field>> unnamedblk666__DOT__unnamedblk667__DOT__unnamedblk668__DOT__unnamedblk669__DOT__fields;
        ...
        unnamedblk666__DOT__unnamedblk667__DOT__unnamedblk668__DOT__unnamedblk669__DOT__unnamedblk670__DOT__i = 0;
        {
            if ((0U != this->__PVT__vregs.first(unnamedblk663__DOT__rg_))) {
                ...
                while (((IData)(unnamedblk663__DOT__rg___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk663__DOT__unnamedblk664__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1526)
                    ...
                    while (VL_LTS_III(32, unnamedblk663__DOT__unnamedblk664__DOT__unnamedblk665__DOT__i, unnamedblk663__DOT__unnamedblk664__DOT__fields.size())) {
                        if ((([&]() {
                                        VL_NULL_CHECK(unnamedblk663__DOT__unnamedblk664__DOT__fields.at(unnamedblk663__DOT__unnamedblk664__DOT__unnamedblk665__DOT__i), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1528)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk666__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk666__DOT__blk___Vfirst) 
                    ...
                    VL_NULL_CHECK(unnamedblk666__DOT__blk_, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1535)
                    ...
                    while (VL_LTS_III(32, unnamedblk666__DOT__unnamedblk667__DOT__unnamedblk668__DOT__j, unnamedblk666__DOT__unnamedblk667__DOT__subvregs.size())) {
                        VL_NULL_CHECK(unnamedblk666__DOT__unnamedblk667__DOT__subvregs.at(unnamedblk666__DOT__unnamedblk667__DOT__unnamedblk668__DOT__j), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1539)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__198__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_coverage(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, IData/*31:0*/ &set_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_coverage\n"); );
        // Locals
        ...
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk671__DOT__rg_;
        CData/*0:0*/ unnamedblk671__DOT__rg___Vfirst;
        unnamedblk671__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk671__DOT__unnamedblk672__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk673__DOT__mem_;
        CData/*0:0*/ unnamedblk673__DOT__mem___Vfirst;
        unnamedblk673__DOT__mem___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk673__DOT__unnamedblk674__DOT__mem;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk675__DOT__blk_;
        CData/*0:0*/ unnamedblk675__DOT__blk___Vfirst;
        unnamedblk675__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk675__DOT__unnamedblk676__DOT__blk;
        ...
        if ((0U != this->__PVT__regs.first(unnamedblk671__DOT__rg_))) {
            ...
            while (((IData)(unnamedblk671__DOT__rg___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk671__DOT__unnamedblk672__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1566)
        ...
        if ((0U != this->__PVT__mems.first(unnamedblk673__DOT__mem_))) {
            ...
            while (((IData)(unnamedblk673__DOT__mem___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk673__DOT__unnamedblk674__DOT__mem, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1571)
        ...
        if ((0U != this->__PVT__blks.first(unnamedblk675__DOT__blk_))) {
            ...
            while (((IData)(unnamedblk675__DOT__blk___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk675__DOT__unnamedblk676__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1576)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample_values(Vvirtual_sequences__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample_values\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk677__DOT__rg_;
        CData/*0:0*/ unnamedblk677__DOT__rg___Vfirst;
        unnamedblk677__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk677__DOT__unnamedblk678__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk679__DOT__blk_;
        CData/*0:0*/ unnamedblk679__DOT__blk___Vfirst;
        unnamedblk679__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk679__DOT__unnamedblk680__DOT__blk;
        if ((0U != this->__PVT__regs.first(unnamedblk677__DOT__rg_))) {
            ...
            while (((IData)(unnamedblk677__DOT__rg___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk677__DOT__unnamedblk678__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1588)
        ...
        if ((0U != this->__PVT__blks.first(unnamedblk679__DOT__blk_))) {
            ...
            while (((IData)(unnamedblk679__DOT__blk___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk679__DOT__unnamedblk680__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1593)
                    ->__VnoInFunc_sample_values(vlSymsp);
            }
        }
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_XsampleX(Vvirtual_sequences__Syms* __restrict vlSymsp, QData/*63:0*/ addr, CData/*0:0*/ is_read, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_XsampleX\n"); );
        // Body
        this->__VnoInFunc_sample(vlSymsp, addr, (IData)(is_read), map);
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_build_coverage(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ models, IData/*31:0*/ &build_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_build_coverage\n"); );
        // Locals
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz169__Vclpkg.__VnoInFunc_read_by_name(vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
                            ...
                            this->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __Vfunc_get_full_name__210__Vfuncout);
                                                                                ...
                                                                                VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>{this}, __Vtask_read_by_name__209__Vfuncout);
        build_coverage__Vfuncrtn = __Vtask_read_by_name__209__val;
        build_coverage__Vfuncrtn = (build_coverage__Vfuncrtn 
                                    & models);
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_coverage(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ models) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_coverage\n"); );
        // Body
        this->__PVT__has_cover = (this->__PVT__has_cover 
                                  | models);
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_coverage(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ models, CData/*0:0*/ &has_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_coverage\n"); );
        // Body
        has_coverage__Vfuncrtn = ((this->__PVT__has_cover 
                                   & models) == models);
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_coverage(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, CData/*0:0*/ &get_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_coverage\n"); );
        // Locals
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_reset(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_reset\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk681__DOT__rg_;
        CData/*0:0*/ unnamedblk681__DOT__rg___Vfirst;
        unnamedblk681__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk681__DOT__unnamedblk682__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk683__DOT__blk_;
        CData/*0:0*/ unnamedblk683__DOT__blk___Vfirst;
        unnamedblk683__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk683__DOT__unnamedblk684__DOT__blk;
        if ((0U != this->__PVT__regs.first(unnamedblk681__DOT__rg_))) {
            ...
            while (((IData)(unnamedblk681__DOT__rg___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk681__DOT__unnamedblk682__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1653)
        ...
        if ((0U != this->__PVT__blks.first(unnamedblk683__DOT__blk_))) {
            ...
            while (((IData)(unnamedblk683__DOT__blk___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk683__DOT__unnamedblk684__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1658)
                    ->__VnoInFunc_reset(vlSymsp, kind);
            }
        }
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_needs_update(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ &needs_update__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_needs_update\n"); );
        // Locals
        ...
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk685__DOT__rg_;
        CData/*0:0*/ unnamedblk685__DOT__rg___Vfirst;
        unnamedblk685__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk685__DOT__unnamedblk686__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk687__DOT__blk_;
        CData/*0:0*/ unnamedblk687__DOT__blk___Vfirst;
        unnamedblk687__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk687__DOT__unnamedblk688__DOT__blk;
        {
            ...
            if ((0U != this->__PVT__regs.first(unnamedblk685__DOT__rg_))) {
                ...
                while (((IData)(unnamedblk685__DOT__rg___Vfirst) 
                    ...
                    if (([&]() {
                                VL_NULL_CHECK(unnamedblk685__DOT__unnamedblk686__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1670)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk687__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk687__DOT__blk___Vfirst) 
                    ...
                    if (([&]() {
                                VL_NULL_CHECK(unnamedblk687__DOT__unnamedblk688__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1675)
    ...
    VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_update(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_update\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__218__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__219__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__223__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__224__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__227__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__228__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__232__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__233__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__238__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__239__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__243__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__244__Vfuncout;
        ...
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VL_KEEP_THIS;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk689__DOT__rg_;
        CData/*0:0*/ unnamedblk689__DOT__rg___Vfirst;
        unnamedblk689__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk689__DOT__unnamedblk690__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk691__DOT__blk_;
        CData/*0:0*/ unnamedblk691__DOT__blk___Vfirst;
        unnamedblk691__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk691__DOT__unnamedblk692__DOT__blk;
        {
            status = 0U;
            if ((1U & (~ ([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_info__221__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_info__230__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                ...
                __Vtemp_3 = Vvirtual_sequences___024unit::__Venumtab_enum_name85
                    [(3U & path)];
            ...
            if ((0U != this->__PVT__regs.first(unnamedblk689__DOT__rg_))) {
                ...
                while (((IData)(unnamedblk689__DOT__rg___Vfirst) 
                    ...
                    if (([&]() {
                                VL_NULL_CHECK(unnamedblk689__DOT__unnamedblk690__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1703)
                         ->__VnoInFunc_needs_update(vlSymsp, __Vtask_needs_update__235__Vfuncout);
                            }(), (IData)(__Vtask_needs_update__235__Vfuncout))) {
                        co_await VL_NULL_CHECK(unnamedblk689__DOT__unnamedblk690__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1704)
                    ->__VnoInFunc_update(vlSymsp, __Vtask_update__236__status, path, VlNull{}, parent, prior, extension, ""s, 0U);
                        ...
                        if (((0U != status) & (2U != status))) {
                            if ((0U != ([&]() {
                                ...
                                __Vtask_uvm_report_error__241__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                                __Vtask_uvm_report_error__241__verbosity = 0U;
                                __Vtemp_4 = ([&]() {
                                        VL_NULL_CHECK(unnamedblk689__DOT__unnamedblk690__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1707)
            ...
            if ((0U != this->__PVT__blks.first(unnamedblk691__DOT__blk_))) {
                ...
                while (((IData)(unnamedblk691__DOT__blk___Vfirst) 
                    ...
                    co_await VL_NULL_CHECK(unnamedblk691__DOT__unnamedblk692__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1715)
    ...
    VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_mirror(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ check, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_mirror\n"); );
        // Locals
        ...
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VL_KEEP_THIS;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk693__DOT__rg_;
        CData/*0:0*/ unnamedblk693__DOT__rg___Vfirst;
        unnamedblk693__DOT__rg___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk693__DOT__unnamedblk694__DOT__rg;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk695__DOT__blk_;
        CData/*0:0*/ unnamedblk695__DOT__blk___Vfirst;
        unnamedblk695__DOT__blk___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk695__DOT__unnamedblk696__DOT__blk;
        ...
        if ((0U != this->__PVT__regs.first(unnamedblk693__DOT__rg_))) {
            ...
            while (((IData)(unnamedblk693__DOT__rg___Vfirst) 
                ...
                co_await VL_NULL_CHECK(unnamedblk693__DOT__unnamedblk694__DOT__rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1734)
        ...
        if ((0U != this->__PVT__blks.first(unnamedblk695__DOT__blk_))) {
            ...
            while (((IData)(unnamedblk695__DOT__blk___Vfirst) 
                ...
                co_await VL_NULL_CHECK(unnamedblk695__DOT__unnamedblk696__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1744)
    ...
    VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_reg_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_reg_by_name\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> __Vfunc_get_reg_by_name__249__Vfuncout;
        IData/*31:0*/ __Vtask_write__250__status;
        __Vtask_write__250__status = 0;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VL_KEEP_THIS;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> rg;
        ...
        if ((VlNull{} != rg)) {
            co_await VL_NULL_CHECK(rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1772)
    ...
    VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_reg_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ &data, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_reg_by_name\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> __Vfunc_get_reg_by_name__251__Vfuncout;
        ...
        if ((VlNull{} != rg)) {
            co_await VL_NULL_CHECK(rg, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1796)
    ...
    VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_mem_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ offset, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_mem_by_name\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> __Vfunc_get_mem_by_name__253__Vfuncout;
        IData/*31:0*/ __Vtask_write__254__status;
        __Vtask_write__254__status = 0;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VL_KEEP_THIS;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> mem;
        this->__PVT__fname = fname;
        this->__PVT__lineno = lineno;
        status = 1U;
        ...
        if ((VlNull{} != mem)) {
            co_await VL_NULL_CHECK(mem, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1820)
    ...
    VlCoroutine Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_mem_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ offset, QData/*63:0*/ &data, IData/*31:0*/ path, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_mem_by_name\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> __Vfunc_get_mem_by_name__255__Vfuncout;
        ...
        if ((VlNull{} != mem)) {
            co_await VL_NULL_CHECK(mem, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1844)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_readmemh(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string filename) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_readmemh\n"); );
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_writememh(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string filename) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_writememh\n"); );
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create_map(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ base_addr, IData/*31:0*/ n_bytes, IData/*31:0*/ endian, CData/*0:0*/ byte_addressing, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> &create_map__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create_map\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> __Vfunc_create__257__Vfuncout;
        std::string __Vfunc_get_full_name__258__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi101__Vclpkg.__VnoInFunc_create(vlSymsp, name, VlNull{}, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
        ...
        VL_NULL_CHECK(map, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1877)
                    ->__VnoInFunc_configure(vlSymsp, 
                                            VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>{this}, base_addr, n_bytes, endian, (IData)(byte_addressing));
        this->__VnoInFunc_add_map(vlSymsp, map);
        create_map__Vfuncrtn = map;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_map(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_map\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__262__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__263__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__266__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__267__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__270__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__271__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__276__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__277__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        {
            if (this->__PVT__locked) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__265__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            if (this->__PVT__maps.exists(map)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__273__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                        ...
                        = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                            VL_CONCATN_NNN(
                                                                           VL_CONCATN_NNN(
                                                                                ...
                                                                                ([&]() {
                                                VL_NULL_CHECK(map, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1896)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_map_by_name(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> &get_map_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_map_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__284__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__285__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__288__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__289__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        ...
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map>> unnamedblk698__DOT__unnamedblk699__DOT__submaps;
        ...
        VlQueue<VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map>> maps;
        {
            ...
            while (VL_LTS_III(32, unnamedblk697__DOT__i, maps.size())) {
                if ((([&]() {
                                VL_NULL_CHECK(maps.at(unnamedblk697__DOT__i), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1915)
            ...
            while (VL_LTS_III(32, unnamedblk698__DOT__i, maps.size())) {
                VL_NULL_CHECK(maps.at(unnamedblk698__DOT__i), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1920)
                ...
                while (VL_LTS_III(32, unnamedblk698__DOT__unnamedblk699__DOT__unnamedblk700__DOT__j, unnamedblk698__DOT__unnamedblk699__DOT__submaps.size())) {
                    if ((([&]() {
                                    VL_NULL_CHECK(unnamedblk698__DOT__unnamedblk699__DOT__submaps.at(unnamedblk698__DOT__unnamedblk699__DOT__unnamedblk700__DOT__j), "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1923)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__287__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_map(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_map\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__292__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__293__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__297__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__298__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        if ((! this->__PVT__maps.exists(map))) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__295__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
                __Vtask_uvm_report_warning__295__verbosity = 0U;
                __Vtask_uvm_report_warning__295__message 
                    = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                                        VL_CONCATN_NNN("Map '"s, 
                                                                       ([&]() {
                                    VL_NULL_CHECK(map, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1937)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_map(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_map\n"); );
        // Body
        get_default_map__Vfuncrtn = this->__PVT__default_map;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_door(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &get_default_door__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_door\n"); );
        // Locals
        ...
        // Body
        {
            ...
            if ((VlNull{} != this->__PVT__parent)) {
                VL_NULL_CHECK(this->__PVT__parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1962)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_door(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ door) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_door\n"); );
        // Body
        this->__PVT__default_path = door;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_Xinit_address_mapsX(Vvirtual_sequences__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_Xinit_address_mapsX\n"); );
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> unnamedblk701__DOT__map_;
        CData/*0:0*/ unnamedblk701__DOT__map___Vfirst;
        unnamedblk701__DOT__map___Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> unnamedblk701__DOT__unnamedblk702__DOT__map;
        if ((0U != this->__PVT__maps.first(unnamedblk701__DOT__map_))) {
            ...
            while (((IData)(unnamedblk701__DOT__map___Vfirst) 
                ...
                VL_NULL_CHECK(unnamedblk701__DOT__unnamedblk702__DOT__map, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1981)
                    ->__VnoInFunc_Xinit_address_mapX(vlSymsp);
            }
        }
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_backdoor(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_backdoor> bkdr, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_backdoor\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__304__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__305__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__308__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__309__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VL_NULL_CHECK(bkdr, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1996)
                    ->__PVT__fname = fname;
        VL_NULL_CHECK(bkdr, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1997)
                    ->__PVT__lineno = lineno;
        if (((VlNull{} != this->__PVT__backdoor) && 
             ([&]() {
                        VL_NULL_CHECK(this->__PVT__backdoor, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 1999)
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_warning__307__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_backdoor(Vvirtual_sequences__Syms* __restrict vlSymsp, CData/*0:0*/ inherited, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_backdoor> &get_backdoor__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_backdoor\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> __Vfunc_get_parent__311__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__312__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> __Vtask_get_parent__313__Vfuncout;
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk703__DOT__blk;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk703__DOT__unnamedblk704__DOT__bkdr;
        {
            if (inherited) {
                ...
                while ((VlNull{} != unnamedblk703__DOT__blk)) {
                    VL_NULL_CHECK(unnamedblk703__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2012)
                    ...
                    VL_NULL_CHECK(unnamedblk703__DOT__blk, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2015)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clear_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clear_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__318__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__319__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__322__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__323__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        {
            if (("ALL"s == kind)) {
            ...
            if ((1U & (~ (0U != ([&]() {
                                    VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2035)
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_warning__321__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2040)
                    ->__VnoInFunc_delete(vlSymsp, kind);
            __Vlabel0: ;
        }
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string path, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_hdl_path\n"); );
        // Locals
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> __Vtask_get__326__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> paths;
        VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2050)
                    ->__VnoInFunc_get(vlProcess, vlSymsp, kind, __Vtask_get__326__Vfuncout);
        paths = __Vtask_get__326__Vfuncout;
        VL_NULL_CHECK(paths, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2052)
                    ->__VnoInFunc_push_back(vlSymsp, path);
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &has_hdl_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_hdl_path\n"); );
        // Locals
        ...
        has_hdl_path__Vfuncrtn = (1U & ([&]() {
                    VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2063)
                                        ->__VnoInFunc_exists(vlSymsp, kind, __Vtask_exists__329__Vfuncout);
                }(), __Vtask_exists__329__Vfuncout));
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__333__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__334__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__337__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__338__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> __Vtask_get__340__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> hdl_paths;
        {
            if ((""s == kind)) {
            ...
            if ((1U & (~ ([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__336__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2081)
            ...
            while (VL_LTS_III(32, unnamedblk705__DOT__i, 
                              ([&]() {
                            VL_NULL_CHECK(hdl_paths, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2083)
                               ->__VnoInFunc_size(vlSymsp, __Vtask_size__341__Vfuncout);
                        }(), __Vtask_size__341__Vfuncout))) {
                paths.push_back(([&]() {
                            VL_NULL_CHECK(hdl_paths, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2084)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__347__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__348__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__351__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__352__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> __Vtask_get__354__Vfuncout;
        IData/*31:0*/ __Vtask_size__356__Vfuncout;
        __Vtask_size__356__Vfuncout = 0;
        std::string __Vtask_get__357__Vfuncout;
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_queue__Tz61> unnamedblk706__DOT__hdl_paths;
        ...
        unnamedblk706__DOT__unnamedblk707__DOT__unnamedblk708__DOT__unnamedblk709__DOT__j = 0;
        {
            ...
            if ((1U & (~ ([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__350__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            VL_NULL_CHECK(this->__PVT__hdl_paths_pool, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2111)
            ...
            if ((VlNull{} != this->__PVT__parent)) {
                VL_NULL_CHECK(this->__PVT__parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2115)
            ...
            while (VL_LTS_III(32, unnamedblk706__DOT__unnamedblk707__DOT__i, 
                              ([&]() {
                            VL_NULL_CHECK(unnamedblk706__DOT__hdl_paths, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2117)
                               ->__VnoInFunc_size(vlSymsp, __Vtask_size__356__Vfuncout);
                        }(), __Vtask_size__356__Vfuncout))) {
                {
                    VL_NULL_CHECK(unnamedblk706__DOT__hdl_paths, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2118)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &get_default_hdl_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_hdl_path\n"); );
        // Locals
        ...
        // Body
        {
            if (((""s == this->__PVT__default_hdl_path) 
                ...
                VL_NULL_CHECK(this->__PVT__parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2143)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_hdl_path(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__360__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__361__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__364__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__365__Vfuncout;
        ...
        if ((""s == kind)) {
            if ((VlNull{} == this->__PVT__parent)) {
                if ((0U != ([&]() {
                    ...
                    __Vtask_uvm_report_error__363__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
            ...
            VL_NULL_CHECK(this->__PVT__parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2157)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_hdl_path_root(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string path, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_hdl_path_root\n"); );
        // Locals
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_hdl_path_root(Vvirtual_sequences__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &is_hdl_path_root__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_hdl_path_root\n"); );
        // Locals
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_print(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_printer> printer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_print\n"); );
        // Locals
        ...
        // Body
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk710__DOT__i;
        CData/*0:0*/ unnamedblk710__DOT__i__Vfirst;
        unnamedblk710__DOT__i__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block> unnamedblk710__DOT__unnamedblk711__DOT__b;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> unnamedblk710__DOT__unnamedblk711__DOT__obj;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk712__DOT__i;
        CData/*0:0*/ unnamedblk712__DOT__i__Vfirst;
        unnamedblk712__DOT__i__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg> unnamedblk712__DOT__unnamedblk713__DOT__r;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> unnamedblk712__DOT__unnamedblk713__DOT__obj;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk714__DOT__i;
        CData/*0:0*/ unnamedblk714__DOT__i__Vfirst;
        unnamedblk714__DOT__i__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_vreg> unnamedblk714__DOT__unnamedblk715__DOT__r;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> unnamedblk714__DOT__unnamedblk715__DOT__obj;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk716__DOT__i;
        CData/*0:0*/ unnamedblk716__DOT__i__Vfirst;
        unnamedblk716__DOT__i__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_mem> unnamedblk716__DOT__unnamedblk717__DOT__m;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> unnamedblk716__DOT__unnamedblk717__DOT__obj;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> unnamedblk718__DOT__i;
        CData/*0:0*/ unnamedblk718__DOT__i__Vfirst;
        unnamedblk718__DOT__i__Vfirst = 0;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_map> unnamedblk718__DOT__unnamedblk719__DOT__m;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> unnamedblk718__DOT__unnamedblk719__DOT__obj;
        ...
        if ((0U != this->__PVT__blks.first(unnamedblk710__DOT__i))) {
            ...
            while (((IData)(unnamedblk710__DOT__i__Vfirst) 
                ...
                unnamedblk710__DOT__unnamedblk711__DOT__obj 
                    = unnamedblk710__DOT__unnamedblk711__DOT__b;
                VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2195)
                    ->__VnoInFunc_print_object(vlProcess, vlSymsp, 
                                               VL_CVT_PACK_STR_NN(
                                                                  ([&]() {
                                VL_NULL_CHECK(unnamedblk710__DOT__unnamedblk711__DOT__obj, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2195)
        ...
        if ((0U != this->__PVT__regs.first(unnamedblk712__DOT__i))) {
            ...
            while (((IData)(unnamedblk712__DOT__i__Vfirst) 
                ...
                unnamedblk712__DOT__unnamedblk713__DOT__obj 
                    = unnamedblk712__DOT__unnamedblk713__DOT__r;
                VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2201)
                    ->__VnoInFunc_print_object(vlProcess, vlSymsp, 
                                               VL_CVT_PACK_STR_NN(
                                                                  ([&]() {
                                VL_NULL_CHECK(unnamedblk712__DOT__unnamedblk713__DOT__obj, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2201)
        ...
        if ((0U != this->__PVT__vregs.first(unnamedblk714__DOT__i))) {
            ...
            while (((IData)(unnamedblk714__DOT__i__Vfirst) 
                ...
                unnamedblk714__DOT__unnamedblk715__DOT__obj 
                    = unnamedblk714__DOT__unnamedblk715__DOT__r;
                VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2207)
                    ->__VnoInFunc_print_object(vlProcess, vlSymsp, 
                                               VL_CVT_PACK_STR_NN(
                                                                  ([&]() {
                                VL_NULL_CHECK(unnamedblk714__DOT__unnamedblk715__DOT__obj, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2207)
        ...
        if ((0U != this->__PVT__mems.first(unnamedblk716__DOT__i))) {
            ...
            while (((IData)(unnamedblk716__DOT__i__Vfirst) 
                ...
                unnamedblk716__DOT__unnamedblk717__DOT__obj 
                    = unnamedblk716__DOT__unnamedblk717__DOT__m;
                VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2213)
                    ->__VnoInFunc_print_object(vlProcess, vlSymsp, 
                                               VL_CVT_PACK_STR_NN(
                                                                  ([&]() {
                                VL_NULL_CHECK(unnamedblk716__DOT__unnamedblk717__DOT__obj, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2213)
        ...
        if ((0U != this->__PVT__maps.first(unnamedblk718__DOT__i))) {
            ...
            while (((IData)(unnamedblk718__DOT__i__Vfirst) 
                ...
                unnamedblk718__DOT__unnamedblk719__DOT__obj 
                    = unnamedblk718__DOT__unnamedblk719__DOT__m;
                VL_NULL_CHECK(printer, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2219)
                    ->__VnoInFunc_print_object(vlProcess, vlSymsp, 
                                               VL_CVT_PACK_STR_NN(
                                                                  ([&]() {
                                VL_NULL_CHECK(unnamedblk718__DOT__unnamedblk719__DOT__obj, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh", 2219)
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clone(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clone\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__382__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__383__Vfuncout;
        ...
        if ((0U != ([&]() {
            ...
            vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, "RegModel blocks cannot be cloned"s, 0U, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s, 0x000008b5U, ""s, 1U);
        }
        clone__Vfuncrtn = VlNull{};
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> rhs) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_copy\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__387__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__388__Vfuncout;
        ...
        if ((0U != ([&]() {
            ...
            vlSymsp->TOP__uvm_pkg.__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(vlProcess, vlSymsp, "RegModel"s, "RegModel blocks cannot be copied"s, 0U, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s, 0x000008bcU, ""s, 1U);
        }
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_compare(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_compare\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__392__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__393__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__396__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__397__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_warning__395__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_pack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_pack\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__400__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__401__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__404__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__405__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_warning__403__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_unpack(Vvirtual_sequences__Syms* __restrict vlSymsp, VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_packer> packer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_unpack\n"); );
        // Locals
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__408__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__409__Vfuncout;
        ...
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__412__Vfuncout;
        VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_root> __Vtask_get_root__413__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_warning__411__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_block.svh"s;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vvirtual_sequences__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_convert2string\n"); );
        // Body
        std::string image;
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_randomize(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___Vsetup_constraints(Vvirtual_sequences__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___Vsetup_constraints\n"); );
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___VBasicRand(Vvirtual_sequences__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___VBasicRand\n"); );
        // Body
        __VBasicRand__Vfuncrtn = 1U;
    }

    void Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::_ctor_var_reset(Vvirtual_sequences__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::_ctor_var_reset\n"); );
        // Body
    ...
    Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::~Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block() {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::~\n"); );
    }

    std::string VL_TO_STRING(const VlClassRef<Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vvirtual_sequences_uvm_pkg__03a__03auvm_reg_block::to_string_middle\n"); );
        // Body
        std::string out;
