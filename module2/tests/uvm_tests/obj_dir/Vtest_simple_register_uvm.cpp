...
Vtest_simple_register_uvm::Vtest_simple_register_uvm(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new Vtest_simple_register_uvm__Syms(contextp(), _vcname__, this)}
    , __PVT____024unit{vlSymsp->TOP.__PVT____024unit}
    , __PVT__std{vlSymsp->TOP.__PVT__std}
    , __PVT__uvm_pkg{vlSymsp->TOP.__PVT__uvm_pkg}
    , __PVT__test_simple_register_uvm__DOT__reg_if{vlSymsp->TOP.__PVT__test_simple_register_uvm__DOT__reg_if}
    , __024unit__03a__03aRegisterTransaction__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterTransaction__Vclpkg}
    , __024unit__03a__03aRegisterSequence__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterSequence__Vclpkg}
    , __024unit__03a__03aRegisterDriver__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterDriver__Vclpkg}
    , __024unit__03a__03aRegisterMonitor__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterMonitor__Vclpkg}
    , __024unit__03a__03aRegisterScoreboard__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterScoreboard__Vclpkg}
    , __024unit__03a__03aRegisterAgent__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterAgent__Vclpkg}
    , __024unit__03a__03aRegisterEnv__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterEnv__Vclpkg}
    , __024unit__03a__03aRegisterTest__Vclpkg{vlSymsp->TOP.__024unit__03a__03aRegisterTest__Vclpkg}
...
Vtest_simple_register_uvm::Vtest_simple_register_uvm(const char* _vcname__)
    : Vtest_simple_register_uvm(Verilated::threadContextp(), _vcname__)
{
}
...
Vtest_simple_register_uvm::~Vtest_simple_register_uvm() {
    delete vlSymsp;
}
...
#endif  // VL_DEBUG
void Vtest_simple_register_uvm___024root___eval_static(Vtest_simple_register_uvm___024root* vlSelf);
void Vtest_simple_register_uvm___024root___eval_initial(Vtest_simple_register_uvm___024root* vlSelf);
void Vtest_simple_register_uvm___024root___eval_settle(Vtest_simple_register_uvm___024root* vlSelf);
void Vtest_simple_register_uvm___024root___eval(Vtest_simple_register_uvm___024root* vlSelf);

void Vtest_simple_register_uvm::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vtest_simple_register_uvm::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
    Vtest_simple_register_uvm___024root___eval_debug_assertions(&(vlSymsp->TOP));
#endif  // VL_DEBUG
    ...
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) {
        ...
        Vtest_simple_register_uvm___024root___eval_static(&(vlSymsp->TOP));
        Vtest_simple_register_uvm___024root___eval_initial(&(vlSymsp->TOP));
        Vtest_simple_register_uvm___024root___eval_settle(&(vlSymsp->TOP));
    }
    VL_DEBUG_IF(VL_DBG_MSGF("+ Eval\n"););
    Vtest_simple_register_uvm___024root___eval(&(vlSymsp->TOP));
    // Evaluate cleanup
...
//============================================================
// Events and timing
bool Vtest_simple_register_uvm::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty(); }

uint64_t Vtest_simple_register_uvm::nextTimeSlot() { return vlSymsp->TOP.__VdlySched.nextTimeSlot(); }

//============================================================
// Utilities

const char* Vtest_simple_register_uvm::name() const {
    return vlSymsp->name();
}
...
void Vtest_simple_register_uvm___024root___eval_final(Vtest_simple_register_uvm___024root* vlSelf);

VL_ATTR_COLD void Vtest_simple_register_uvm::final() {
    Vtest_simple_register_uvm___024root___eval_final(&(vlSymsp->TOP));
}

//============================================================
// Implementations of abstract methods from VerilatedModel

const char* Vtest_simple_register_uvm::hierName() const { return vlSymsp->name(); }
const char* Vtest_simple_register_uvm::modelName() const { return "Vtest_simple_register_uvm"; }
unsigned Vtest_simple_register_uvm::threads() const { return 1; }
void Vtest_simple_register_uvm::prepareClone() const { contextp()->prepareClone(); }
void Vtest_simple_register_uvm::atClone() const {
    contextp()->threadPoolpOnClone();
}
std::unique_ptr<VerilatedTraceConfig> Vtest_simple_register_uvm::traceConfig() const {
...
void Vtest_simple_register_uvm___024root__trace_decl_types(VerilatedVcd* tracep);

void Vtest_simple_register_uvm___024root__trace_init_top(Vtest_simple_register_uvm___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD void Vtest_simple_register_uvm::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    (void)levels; (void)options;
    VerilatedVcdC* const stfp = dynamic_cast<VerilatedVcdC*>(tfp);
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vtest_simple_register_uvm::trace()' called on non-VerilatedVcdC object;"
            " use --trace-fst with VerilatedFst object, and --trace-vcd with VerilatedVcd object");
    }
    stfp->spTrace()->addModel(this);
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP));
    Vtest_simple_register_uvm___024root__trace_register(&(vlSymsp->TOP), stfp->spTrace());
}
