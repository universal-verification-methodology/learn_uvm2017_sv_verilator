...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ90__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ90__VCLPKG_H_  // guard
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz244;
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper;
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90;
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vtest_simple_register_uvm__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90__Vclpkg(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
    ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90__Vclpkg();
    VL_UNCOPYABLE(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz28> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz244> &get_type__Vfuncrtn);
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90 : public Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz28>> __PVT__pool;
    ...
    virtual void __VnoInFunc_add(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz28> item);
    ...
    virtual void __VnoInFunc_get(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz28> &get__Vfuncrtn);
  ...
  public:
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_pool__Tz2_TBz90() {}
};
