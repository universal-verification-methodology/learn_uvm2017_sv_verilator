...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI70__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI70__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction;
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_analysis_export__Tz126;
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_param_base__pi70__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_param_base__pi70__Vclpkg(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
    ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_param_base__pi70__Vclpkg();
    VL_UNCOPYABLE(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_param_base__pi70__Vclpkg);
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_param_base__pi70 : public Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_base {
  public:
    ...
    VlQueue<VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction>> __PVT__m_last_req_buffer;
    VlQueue<VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction>> __PVT__m_last_rsp_buffer;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_analysis_fifo__pi84> __PVT__sqr_rsp_analysis_fifo;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_analysis_export__Tz126> __PVT__rsp_export;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tlm_fifo__Tz126> __PVT__m_req_fifo;
    ...
    void __VnoInFunc_last_req(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction> &last_req__Vfuncrtn);
    void __VnoInFunc_last_rsp(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction> &last_rsp__Vfuncrtn);
    void __VnoInFunc_m_last_req_push_front(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction> item);
    void __VnoInFunc_m_last_rsp_push_front(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction> item);
  ...
  public:
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_param_base__pi70(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequencer_param_base__pi70() {}
};
