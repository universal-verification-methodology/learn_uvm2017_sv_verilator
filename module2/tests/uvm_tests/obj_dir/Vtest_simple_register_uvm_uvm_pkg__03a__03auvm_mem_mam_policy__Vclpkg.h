...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem_mam_policy__Vclpkg final {
  public:
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem_mam_policy : public virtual VlClass {
  public:
    ...
    // INTERNAL VARIABLES
    VlRNG __Vm_rng;
    void __VnoInFunc___VBasicRand(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
