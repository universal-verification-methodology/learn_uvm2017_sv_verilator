...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_get_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__pi174> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__pi174> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi174__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_type_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_text_recorder"s;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_object_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__pi174> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi174__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder> tmp;
    tmp = ((""s == name) ? VL_NEW(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder, vlProcess, vlSymsp, "unnamed-uvm_text_recorder"s)
            : VL_NEW(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_type_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_text_recorder"s;
}

Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name)
    : Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_open(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tr_stream> stream, QData/*63:0*/ open_time, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_open\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_db__4__Vfuncout;
    ...
    if (VL_UNLIKELY(((! VL_CAST_DYNAMIC(([&]() {
                                VL_NULL_CHECK(stream, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 672)
                                         ->__VnoInFunc_get_db(vlProcess, vlSymsp, __Vtask_get_db__4__Vfuncout);
                            }(), __Vtask_get_db__4__Vfuncout), this->__PVT__m_text_db))))) {
        VL_WRITEF_NX("[%0t] %%Error: uvm_recorder.svh:672: Assertion failed in %Nuvm_pkg.uvm_text_recorder.do_open: 'assert' failed.\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 672, "");
    }
    if (VL_UNLIKELY((([&]() {
                        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 673)
        ...
        VL_FWRITEF_NX(VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 674)
                      ...
                      32,([&]() {
                        VL_NULL_CHECK(stream, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 678)
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_close(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ close_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_close\n"); );
    // Locals
    ...
    // Body
    if (VL_UNLIKELY((([&]() {
                        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 689)
                      ->__VnoInFunc_open_db(vlSymsp, __Vtask_open_db__9__Vfuncout);
                    }(), (IData)(__Vtask_open_db__9__Vfuncout))))) {
        VL_FWRITEF_NX(VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 690)
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_free(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_free\n"); );
    // Locals
    ...
    // Body
    if (VL_UNLIKELY((([&]() {
                        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 704)
                      ->__VnoInFunc_open_db(vlSymsp, __Vtask_open_db__11__Vfuncout);
                    }(), (IData)(__Vtask_open_db__11__Vfuncout))))) {
        VL_FWRITEF_NX(VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 705)
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field\n"); );
    // Locals
    std::string __Vfunc_m_current_context__14__Vfuncout;
    // Body
    if ((1U & (~ (0U != radix)))) {
        radix = Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder::__PVT__default_radix;
    }
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_int(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*27:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_int\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_real(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, double value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_real\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_current_context(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, std::string &m_current_context__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_current_context\n"); );
    // Body
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_object(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_object\n"); );
    // Locals
    ...
    v = 0;
    std::string str;
    if (Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder::__PVT__identifier) {
        if ((VlNull{} != value)) {
            VL_NULL_CHECK(value, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 803)->__VnoInFunc_get_inst_id(vlSymsp, __Vtask_get_inst_id__19__Vfuncout);
    ...
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_object(vlProcess, vlSymsp, name, value);
    if ((1U < ([&]() {
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_string(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_string\n"); );
    // Locals
    ...
    // Body
    if (VL_UNLIKELY((([&]() {
                        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 824)
        ...
        VL_FWRITEF_NX(VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 825)
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_time(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_time\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_generic(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, std::string value, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_generic\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string nm, VlWide<128>/*4095:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute\n"); );
    // Locals
    ...
    // Body
    if (VL_UNLIKELY((([&]() {
                        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 877)
        ...
        __Vtemp_4 = ([&]() {
                ...
                __Vfunc_uvm_bitstream_to_string__34__unnamedblk3__DOT__unnamedblk4__DOT__idx = 0;
                {
                    ...
                    VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vtest_simple_register_uvm__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__34__size);
        ...
        __Vtemp_5 = Vtest_simple_register_uvm___024unit::__Venumtab_enum_name3
            .at(radix);
        VL_FWRITEF_NX(VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 878)
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string nm, QData/*63:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int\n"); );
    // Locals
    ...
    // Body
    if (VL_UNLIKELY((([&]() {
                        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 903)
        ...
        __Vtemp_2 = Vtest_simple_register_uvm___024unit::__Venumtab_enum_name3
            .at(radix);
        VL_FWRITEF_NX(VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 904)
                      ->__PVT__m_file,"      SET_ATTR @%0^ {TXH:%0d NAME:%@ VALUE:%@   RADIX:%@ BITS=%0d}\n",0,
                      64,VL_TIME_UNITED_D(1000),-9,
                      32,([&]() {
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_open_file(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &open_file__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_open_file\n"); );
    // Locals
    CData/*0:0*/ __Vtask_open_db__39__Vfuncout;
    __Vtask_open_db__39__Vfuncout = 0;
    // Body
    if ((1U & (~ (IData)(this->__PVT__filename_set)))) {
        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 936)->__VnoInFunc_set_file_name(vlSymsp, this->__PVT__filename);
    }
    VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 938)->__VnoInFunc_open_db(vlSymsp, __Vtask_open_db__39__Vfuncout);
    open_file__Vfuncrtn = __Vtask_open_db__39__Vfuncout;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create_stream(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, std::string t, std::string scope, IData/*31:0*/ &create_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create_stream\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__40__Vfuncout;
    __Vfunc_open_file__40__Vfuncout = 0;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tr_stream> __Vtask_open_stream__41__Vfuncout;
    IData/*31:0*/ __Vtask_get_handle__42__Vfuncout;
    __Vtask_get_handle__42__Vfuncout = 0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_tr_stream> stream;
    {
        if (([&]() {
                    this->__VnoInFunc_open_file(vlSymsp, __Vfunc_open_file__40__Vfuncout);
                }(), (IData)(__Vfunc_open_file__40__Vfuncout))) {
            if (VL_UNLIKELY(((! VL_CAST_DYNAMIC(([&]() {
                                        VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 950)
                ...
                VL_WRITEF_NX("[%0t] %%Error: uvm_recorder.svh:950: Assertion failed in %Nuvm_pkg.uvm_text_recorder.create_stream: 'assert' failed.\n",0,
                             64,VL_TIME_UNITED_Q(1000),
                             -9,vlSymsp->name());
                VL_STOP_MT("/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 950, "");
            }
            VL_NULL_CHECK(stream, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 951)->__VnoInFunc_get_handle(vlSymsp, __Vtask_get_handle__42__Vfuncout);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_set_attribute(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_set_attribute\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        unnamedblk3__DOT__file = VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 964)
            ->__PVT__m_file;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_set_attribute(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, VlWide<32>/*1023:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_set_attribute\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        unnamedblk4__DOT__file = VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 979)
            ->__PVT__m_file;
        __Vtemp_4 = ([&]() {
                ...
                __Vfunc_uvm_bitstream_to_string__45__unnamedblk3__DOT__unnamedblk4__DOT__idx = 0;
                {
                    ...
                    VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vtest_simple_register_uvm__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__45__size);
                    VL_SUB_W(128, __Vtemp_3, __Vtemp_2, Vtest_simple_register_uvm__ConstPool__CONST_h1958c06c_0);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_check_handle_kind(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string htype, IData/*31:0*/ handle, IData/*31:0*/ &check_handle_kind__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_check_handle_kind\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__46__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_get_stream_from_handle__47__Vfuncout;
    // Body
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_begin_tr(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string txtype, IData/*31:0*/ stream, std::string nm, std::string label, std::string desc, QData/*63:0*/ begin_time, IData/*31:0*/ &begin_tr__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_begin_tr\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__48__Vfuncout;
    __Vfunc_open_file__48__Vfuncout = 0;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tr_stream> __Vfunc_get_stream_from_handle__49__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder> __Vtask_open_recorder__50__Vfuncout;
    IData/*31:0*/ __Vtask_get_handle__51__Vfuncout;
    __Vtask_get_handle__51__Vfuncout = 0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tr_stream> unnamedblk5__DOT__stream_obj;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk5__DOT__recorder;
    {
        if (([&]() {
            ...
            VL_NULL_CHECK(unnamedblk5__DOT__stream_obj, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 1018)->__VnoInFunc_open_recorder(vlProcess, vlSymsp, nm, begin_time, txtype, __Vtask_open_recorder__50__Vfuncout);
            unnamedblk5__DOT__recorder = __Vtask_open_recorder__50__Vfuncout;
            VL_NULL_CHECK(unnamedblk5__DOT__recorder, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 1020)->__VnoInFunc_get_handle(vlSymsp, __Vtask_get_handle__51__Vfuncout);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_end_tr(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ handle, QData/*63:0*/ end_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_end_tr\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__52__Vfuncout;
    __Vfunc_open_file__52__Vfuncout = 0;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__53__Vfuncout;
    // Body
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk6__DOT__record;
    if (([&]() {
        ...
        if ((VlNull{} != unnamedblk6__DOT__record)) {
            VL_NULL_CHECK(unnamedblk6__DOT__record, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 1033)->__VnoInFunc_close(vlSymsp, end_time);
        }
    }
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_link_tr(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ h1, IData/*31:0*/ h2, std::string relation) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_link_tr\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        VL_FWRITEF_NX(VL_NULL_CHECK(this->__PVT__m_text_db, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 1046)
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_free_tr(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ handle) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_free_tr\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_open_file__56__Vfuncout;
    __Vfunc_open_file__56__Vfuncout = 0;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder> __Vfunc_get_recorder_from_handle__57__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk7__DOT__record;
    if (([&]() {
        ...
        if ((VlNull{} != unnamedblk7__DOT__record)) {
            VL_NULL_CHECK(unnamedblk7__DOT__record, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_recorder.svh", 1058)->__VnoInFunc_free(vlProcess, vlSymsp, 0ULL);
        }
    }
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_randomize\n"); );
    // Locals
    IData/*31:0*/ __Vfunc___Vbasic_randomize__60__Vfuncout;
    __Vfunc___Vbasic_randomize__60__Vfuncout = 0;
    // Body
    ...
    randomize__Vfuncrtn = (randomize__Vfuncrtn & ([&]() {
                this->__VnoInFunc___Vbasic_randomize(vlSymsp, __Vfunc___Vbasic_randomize__60__Vfuncout);
            }(), __Vfunc___Vbasic_randomize__60__Vfuncout));
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vbasic_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__filename_set = 0;
    VL_SCOPED_RAND_RESET_W(115200, __Vfunc_uvm_string_to_bits__31__Vfuncout, 7006767861087420341ULL, 9251762423289343843ull);
}

std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_recorder::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_recorder::to_string_middle();
    return (out);
}
