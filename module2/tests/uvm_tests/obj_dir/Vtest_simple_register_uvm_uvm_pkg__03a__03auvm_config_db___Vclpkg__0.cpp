...
Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_config_db_::~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_config_db_() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_config_db_::~\n"); );
}
