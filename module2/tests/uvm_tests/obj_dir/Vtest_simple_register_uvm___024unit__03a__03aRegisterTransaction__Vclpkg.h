...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM___024UNIT__03A__03AREGISTERTRANSACTION__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM___024UNIT__03A__03AREGISTERTRANSACTION__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction__Vclpkg();
    ~Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction__Vclpkg();
    void ctor(Vtest_simple_register_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__pi60> &get_type__Vfuncrtn);
...
class Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction : public Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequence_item {
  public:

    // DESIGN SPECIFIC STATE
    CData/*7:0*/ __PVT__data;
    CData/*7:0*/ __PVT__expected_q;
  ...
  public:
    Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction();
};
