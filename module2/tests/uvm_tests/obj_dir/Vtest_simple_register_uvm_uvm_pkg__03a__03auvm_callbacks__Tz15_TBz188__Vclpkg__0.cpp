...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz188__Vclpkg::__VnoInFunc_get(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz188> &get__Vfuncrtn) {
    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        ...
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
            ...
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz15_TBz188.get.unnamedblk1: 'assert' failed.\n",0,
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz188::__VnoInFunc___Vbasic_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz188::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
