    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        if ((VlNull{} == blk_parent)) {
            ...
            void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
                ...
                // Body
                VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_queue__Tz2> unnamedblk392__DOT__hdl_paths;
            ...
            void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vsetup_constraints(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vsetup_constraints\n"); );
            }

            void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___VBasicRand(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___VBasicRand\n"); );
                // Body
            ...
            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file::~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file() {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_file::~\n"); );
            }
