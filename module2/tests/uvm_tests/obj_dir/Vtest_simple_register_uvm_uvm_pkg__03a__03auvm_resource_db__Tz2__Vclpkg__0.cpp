...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__0__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> __Vfunc_get_type__1__Vfuncout;
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
    std::string msg;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> __Vfunc_get_type__13__Vfuncout;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_default(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__22__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> r;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    r = VL_NEW(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2, vlProcess, vlSymsp, name);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
    rsrc = VL_NEW(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2, vlProcess, vlSymsp, name);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_anonymous(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Locals
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
    rsrc = VL_NEW(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2, vlProcess, vlSymsp, ""s);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string &val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> __Vfunc_get_by_name__65__Vfuncout;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string &val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> __Vfunc_get_by_type__69__Vfuncout;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> __Vfunc_get_by_name__73__Vfuncout;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string val, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz2> __Vfunc_get_by_type__77__Vfuncout;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_dump(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_dump\n"); );
    // Locals
...
Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
