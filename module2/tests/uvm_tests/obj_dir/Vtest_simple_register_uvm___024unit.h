...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_simple_register_uvm___024unit(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
