...
Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ min_size, IData/*31:0*/ max_size)
    : Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_port_base__Tz154(vlProcess, vlSymsp, name, parent, 0U, min_size, max_size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::new\n"); );
    // Body
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_get_type_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_get_type_name\n"); );
    // Body
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_is_auto_item_recording_enabled(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &is_auto_item_recording_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_is_auto_item_recording_enabled\n"); );
    // Locals
...
VlCoroutine Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_get_next_item(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_get_next_item\n"); );
    // Locals
...
VlCoroutine Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_get(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm___024unit__03a__03aRegisterTransaction> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::__VnoInFunc_get\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_seq_item_pull_port__pi72::to_string_middle\n"); );
    // Body
    std::string out;
