...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_comparer__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_comparer__Vclpkg(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
