            ...
            while (VL_LTS_III(32, unnamedblk7__DOT__unnamedblk8__DOT__unnamedblk9__DOT__k, maps.size())) {
                ...
                if ((0U != unnamedblk7__DOT__unnamedblk8__DOT__status)) {
                    if ((0U != ([&]() {
                        ...
                        __Vtemp_8 = Vtest_simple_register_uvm___024unit::__Venumtab_enum_name83
                            [(3U & unnamedblk7__DOT__unnamedblk8__DOT__status)];
                        __Vtemp_9 = ([&]() {
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___Vsetup_constraints(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___VBasicRand(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_shared_access_seq::~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_shared_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_shared_access_seq::~\n"); );
}
