...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc_do_open_stream(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_tr_stream> &do_open_stream__Vfuncrtn) {
    ...
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_tr_stream> __Vfunc_create__9__Vfuncout;
    // Body
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_tr_stream> m_stream;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi121__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, name, VlNull{}, ""s, __Vfunc_create__9__Vfuncout);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc_do_establish_link(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_link_base> link) {
    ...
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> __Vtask_get_lhs__10__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> __Vtask_get_rhs__11__Vfuncout;
    ...
    // Body
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_parent_child_link> unnamedblk1__DOT__pc_link;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_related_link> unnamedblk1__DOT__re_link;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc___Vbasic_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_text_tr_database::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
