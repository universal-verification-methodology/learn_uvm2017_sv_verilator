...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm___024unit__03a__03aRegisterScoreboard__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_simple_register_uvm___024unit__03a__03aRegisterScoreboard__Vclpkg(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
