...
Vtest_simple_register_uvm_std::Vtest_simple_register_uvm_std(Vtest_simple_register_uvm__Syms* symsp, const char* v__name)
...
Vtest_simple_register_uvm_std::~Vtest_simple_register_uvm_std() {
}
