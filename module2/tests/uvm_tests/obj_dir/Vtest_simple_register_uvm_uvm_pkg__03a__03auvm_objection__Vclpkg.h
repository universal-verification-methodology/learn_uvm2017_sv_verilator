...
class Vtest_simple_register_uvm_uvm_pkg__03a__03a__VDynScope_25;
class Vtest_simple_register_uvm_uvm_pkg__03a__03a__VDynScope_26;
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_objection__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_objection__Vclpkg(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
  ...
  private:
    VlCoroutine __VnoInFunc_m_execute_scheduled_forks____Vfork_1__0(VlProcessRef vlProcess, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03a__VDynScope_26> unnamedblk5__DOT___Vwrapped_guard_3__DOT____VDynScope_guard_3);
  public:
