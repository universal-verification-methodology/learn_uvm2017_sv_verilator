...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ189__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ189__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz189__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz189__Vclpkg(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
    ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz189__Vclpkg();
    VL_UNCOPYABLE(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz189__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_dump(Vtest_simple_register_uvm__Syms* __restrict vlSymsp);
    void __VnoInFunc_get_by_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz189> &get_by_name__Vfuncrtn);
    void __VnoInFunc_get_by_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz189> &get_by_type__Vfuncrtn);
    void __VnoInFunc_m_show_msg(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz189> rsrc);
    ...
    void __VnoInFunc_set_default(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz189> &set_default__Vfuncrtn);
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz189 : public virtual VlClass {
  public:
  private:
    void _ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp);
  public:
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz189(Vtest_simple_register_uvm__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource_db__Tz189() {}
};
