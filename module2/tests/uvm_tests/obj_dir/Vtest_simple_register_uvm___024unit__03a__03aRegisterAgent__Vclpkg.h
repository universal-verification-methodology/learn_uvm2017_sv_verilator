...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM___024UNIT__03A__03AREGISTERAGENT__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM___024UNIT__03A__03AREGISTERAGENT__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm___024unit__03a__03aRegisterAgent__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_type(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_component_registry__pi65> &get_type__Vfuncrtn);
    void __VnoInFunc_type_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn);
};

#include "Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_agent__Vclpkg.h"

class Vtest_simple_register_uvm__Syms;

class Vtest_simple_register_uvm___024unit__03a__03aRegisterAgent : public Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_agent {
  public:
