...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_  // guard
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callback_iter__pi103;
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem_mam_policy;
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_vreg : public Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlQueue<VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_vreg_field>> __PVT__fields;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem> __PVT__mem;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem_region> __PVT__region;
    ...
    void __VnoInFunc_configure(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_block> parent, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ size, QData/*63:0*/ offset, IData/*31:0*/ incr);
    ...
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_field_by_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_vreg_field> &get_field_by_name__Vfuncrtn);
    virtual void __VnoInFunc_get_fields(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_vreg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_incr(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_incr__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_memory(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_n_memlocs(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_memlocs__Vfuncrtn);
    virtual void __VnoInFunc_get_offset_in_memory(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &get_offset_in_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_region(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem_region> &get_region__Vfuncrtn);
    virtual void __VnoInFunc_get_rights(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_rights__Vfuncrtn);
    virtual void __VnoInFunc_get_size(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_size__Vfuncrtn);
    virtual void __VnoInFunc_implement(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ offset, IData/*31:0*/ incr, CData/*0:0*/ &implement__Vfuncrtn);
    ...
    virtual void __VnoInFunc_peek(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_poke(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    ...
    virtual void __VnoInFunc_release_region(Vtest_simple_register_uvm__Syms* __restrict vlSymsp);
    void __VnoInFunc_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string kind);
