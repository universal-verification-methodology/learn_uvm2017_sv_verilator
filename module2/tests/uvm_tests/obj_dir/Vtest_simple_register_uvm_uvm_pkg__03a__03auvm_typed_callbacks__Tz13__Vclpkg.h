...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ13__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ13__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_queue__Tz48> __PVT__m_tw_cb_q;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vtest_simple_register_uvm__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg(Vtest_simple_register_uvm__Syms* symsp, const char* v__name);
    ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg();
    VL_UNCOPYABLE(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13> &m_initialize__Vfuncrtn);
};
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13 : public Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz13() {}
};
