...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_queue__Tz5>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
    ...
    VlQueue<std::string> min_key;
    {
        ...
        if ((0xffffffffU == min)) {
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_info__5__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_spell_chkr.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 136)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__7__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top 
                    = __Vtask_get_root__7__Vfuncout;
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 137)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, __Vtask_uvm_report_info__5__id, __Vtask_uvm_report_info__5__message, __Vtask_uvm_report_info__5__verbosity, __Vtask_uvm_report_info__5__filename, __Vtask_uvm_report_info__5__line, __Vtask_uvm_report_info__5__context_name, (IData)(__Vtask_uvm_report_info__5__report_enabled_checked));
            }
        } else {
            ...
            if ((0U != ([&]() {
                ...
                __Vtask_uvm_report_info__13__filename = "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_spell_chkr.svh"s;
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__cs, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 136)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__16__Vfuncout);
                vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top 
                    = __Vtask_get_root__16__Vfuncout;
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_info__Vstatic__top, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_globals.svh", 137)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, __Vtask_uvm_report_info__13__id, __Vtask_uvm_report_info__13__message, __Vtask_uvm_report_info__13__verbosity, __Vtask_uvm_report_info__13__filename, __Vtask_uvm_report_info__13__line, __Vtask_uvm_report_info__13__context_name, (IData)(__Vtask_uvm_report_info__13__report_enabled_checked));
            }
        }
        check__Vfuncrtn = 0U;
        __Vlabel0: ;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11__Vclpkg::__VnoInFunc_levenshtein_distance(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11__Vclpkg::__VnoInFunc_minimum(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = 0;
    min = a;
...
Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz11::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
