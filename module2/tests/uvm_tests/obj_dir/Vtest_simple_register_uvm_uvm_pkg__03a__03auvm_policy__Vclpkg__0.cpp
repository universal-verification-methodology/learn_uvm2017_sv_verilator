...
Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name)
    : Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_flush(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_flush\n"); );
    // Body
    this->__PVT__m_policy_stack.clear();
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_extension_exists(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> ext_type, CData/*0:0*/ &extension_exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_extension_exists\n"); );
    // Body
    extension_exists__Vfuncrtn = (this->__PVT__m_extensions.exists(ext_type)
                                   ? 1U : 0U);
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_set_extension(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> extension, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> &set_extension__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_set_extension\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__2__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__3__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__4__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__5__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> m_set_extension;
    if ((VlNull{} == extension)) {
    ...
    if (this->__PVT__m_extensions.exists(([&]() {
                    VL_NULL_CHECK(extension, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_policy.svh", 96)
        ...
        m_set_extension = this->__PVT__m_extensions
            .at(([&]() {
                    VL_NULL_CHECK(extension, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_policy.svh", 97)
        ...
        this->__PVT__m_extensions.at(([&]() {
                    VL_NULL_CHECK(extension, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_policy.svh", 98)
        ...
        this->__PVT__m_extensions.at(([&]() {
                    VL_NULL_CHECK(extension, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_policy.svh", 103)
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_extension(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> ext_type, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> &get_extension__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_extension\n"); );
    // Body
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extension(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> ext_type) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extension\n"); );
    // Body
    this->__PVT__m_extensions.erase(ext_type);
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extensions(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extensions\n"); );
    // Body
    this->__PVT__m_extensions.clear();
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_push_active_object(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_push_active_object\n"); );
    // Locals
    ...
    if ((VlNull{} != obj)) {
        ...
        __Vtask_uvm_report_error__10__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_policy.svh"s;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_pop_active_object(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> &pop_active_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_pop_active_object\n"); );
    // Locals
    ...
    // Body
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> m_tmp;
    if ((0U != this->__PVT__m_policy_stack.size())) {
        ...
        __Vtask_uvm_report_info__18__filename = "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_policy.svh"s;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> &get_active_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object\n"); );
    // Body
    if ((0U != this->__PVT__m_policy_stack.size())) {
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object_depth(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_active_object_depth__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object_depth\n"); );
    // Body
    get_active_object_depth__Vfuncrtn = this->__PVT__m_policy_stack.size();
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc___Vsetup_constraints(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc___VBasicRand(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_policy::to_string_middle\n"); );
    // Body
    std::string out;
