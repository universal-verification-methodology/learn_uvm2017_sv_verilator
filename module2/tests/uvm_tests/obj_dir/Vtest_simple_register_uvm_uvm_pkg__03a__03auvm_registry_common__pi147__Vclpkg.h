...
#ifndef VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI147__VCLPKG_H_
#define VERILATED_VTEST_SIMPLE_REGISTER_UVM_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI147__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi147__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi147> &get__Vfuncrtn);
...
class Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi147 : public virtual VlClass {
  public:
  ...
  public:
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi147(Vtest_simple_register_uvm__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi147() {}
};
