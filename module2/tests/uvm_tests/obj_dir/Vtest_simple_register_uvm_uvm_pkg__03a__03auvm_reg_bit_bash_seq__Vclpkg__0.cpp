...
VlCoroutine Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_bit_bash_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_single_bit_bash_seq> __Vfunc_create__17__Vfuncout;
    // Body
    VL_KEEP_THIS;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi180__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "reg_single_bit_bash_seq"s, VlNull{}, ""s, __Vfunc_create__17__Vfuncout);
        ...
        VL_NULL_CHECK(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_sequence__Tz323::__PVT__model, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_bit_bash_seq.svh", 247)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_bit_bash_seq::__VnoInFunc___Vbasic_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_reg_bit_bash_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
