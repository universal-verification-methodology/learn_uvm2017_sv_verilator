...
void Vtest_simple_register_uvm_std__03a__03aprocess__Vclpkg::__VnoInFunc_self(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_std__03a__03aprocess> &self__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_std__03a__03aprocess__Vclpkg::__VnoInFunc_self\n"); );
    // Body
...
void Vtest_simple_register_uvm_std__03a__03aprocess__Vclpkg::__VnoInFunc_killQueue(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vtest_simple_register_uvm_std__03a__03aprocess>> &processQueue) {
...
void Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_set_status(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ s) {
...
void Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_status(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &status__Vfuncrtn) {
...
void Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_kill(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_kill\n"); );
    // Body
...
void Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_resume(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_resume\n"); );
    // Body
...
void Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_set_randstate(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string s) {
...
Vtest_simple_register_uvm_std__03a__03aprocess::Vtest_simple_register_uvm_std__03a__03aprocess(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_std__03a__03aprocess::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_srandom(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ seed) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_std__03a__03aprocess::__VnoInFunc_srandom\n"); );
    // Body
    __Vm_rng.srandom(seed);
}

void Vtest_simple_register_uvm_std__03a__03aprocess::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
...
std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_std__03a__03aprocess>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_std__03a__03aprocess::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_simple_register_uvm_std__03a__03aprocess::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_std__03a__03aprocess::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_simple_register_uvm_std__03a__03aprocess::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtest_simple_register_uvm_std__03a__03aprocess::to_string_middle\n"); );
    // Body
    std::string out;
