...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_type_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    {
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_get(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_create(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_resource__Tz28> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> __Vfunc_get__3__Vfuncout;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_set_type_override(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> __Vfunc_get__11__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_set_inst_override(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_set_type_alias(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> unnamedblk2__DOT__rgtry;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> rgtry;
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::__VnoInFunc_get_type_name(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::__VnoInFunc_initialize(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object_registry__Tz90> __Vfunc_get__2__Vfuncout;
    // Body
...
Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_registry_common__pi51::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
