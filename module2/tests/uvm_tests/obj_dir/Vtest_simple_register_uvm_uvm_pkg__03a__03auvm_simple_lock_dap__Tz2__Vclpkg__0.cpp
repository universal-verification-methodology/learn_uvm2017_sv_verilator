...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___Vbasic_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
