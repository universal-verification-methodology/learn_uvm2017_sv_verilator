...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15, vlProcess, vlSymsp);
...
void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg::__VnoInFunc_m_cb_find_name(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_queue__Tz48> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg::__VnoInFunc_display(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_objection> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_objection> me;
    ...
    void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_m_am_i_a(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_m_am_i_a\n"); );
        // Body
        VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_objection> this_type;
        {
            if ((VlNull{} == obj)) {
            ...
            if (([&]() {
                ...
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    ...
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15>{this}))) {
    ...
    void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_m_add_tw_cbs(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        if ((0xffffffffU == ([&]() {
            ...
            if ((0U == ordering)) {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 256)
                        ->__VnoInFunc_push_back(vlSymsp, cb);
            } else {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 258)
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            ...
            if ((cb_pair != VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15>{this})) {
    ...
    void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_m_delete_tw_cbs(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp, VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
        ...
        if ((0xffffffffU != pos)) {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 296)
    ...
    Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15(VlProcessRef vlProcess, Vtest_simple_register_uvm__Syms* __restrict vlSymsp)
      : Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_callbacks_base(vlProcess, vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::new\n"); );
        // Body
        _ctor_var_reset(vlSymsp);
        ;
    }

    void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc___Vbasic_randomize(Vtest_simple_register_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::__VnoInFunc___Vbasic_randomize\n"); );
        // Body
        __Vbasic_randomize__Vfuncrtn = 1U;
    }

    void Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::_ctor_var_reset(Vtest_simple_register_uvm__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::_ctor_var_reset\n"); );
        // Body
        (void)vlSymsp;  // Prevent unused variable warning
    }

    std::string VL_TO_STRING(const VlClassRef<Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+                Vtest_simple_register_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz15::to_string_middle\n"); );
        // Body
        std::string out;
