/**
 * Module 3 Example 3.4: UVM ConfigDB - C++ Testbench
 * 
 * LEARNING OBJECTIVES:
...
// INCLUDES
// ============================================================================
#include "Vconfigdb.h"      // Verilator-generated header for configdb module
...
int main(int argc, char** argv) {
    ...
    Vconfigdb* top = new Vconfigdb;
    
    // Setup VCD tracing
    VerilatedVcdC* tfp = new VerilatedVcdC;
    top->trace(tfp, 99);  // Register all signals for tracing (depth=99)
    tfp->open("configdb.vcd");  // Open VCD file for waveform output
