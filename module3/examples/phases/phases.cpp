/**
 * Module 3 Example 3.2: UVM Phases - C++ Testbench
 * 
 * LEARNING OBJECTIVES:
...
// INCLUDES
// ============================================================================
#include "Vphases.h"        // Verilator-generated header for phases module
...
int main(int argc, char** argv) {
    ...
    Vphases* top = new Vphases;
    
    // Setup VCD tracing
    VerilatedVcdC* tfp = new VerilatedVcdC;
    top->trace(tfp, 99);  // Register all signals for tracing (depth=99)
    tfp->open("phases.vcd");  // Open VCD file for waveform output
