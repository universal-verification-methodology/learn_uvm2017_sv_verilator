/**
 * Module 3 Example 3.5: UVM Factory Pattern - C++ Testbench
 * 
 * LEARNING OBJECTIVES:
...
// INCLUDES
// ============================================================================
#include "Vfactory.h"       // Verilator-generated header for factory module
...
int main(int argc, char** argv) {
    ...
    Vfactory* top = new Vfactory;
    
    // Setup VCD tracing
    VerilatedVcdC* tfp = new VerilatedVcdC;
    top->trace(tfp, 99);  // Register all signals for tracing (depth=99)
    tfp->open("factory.vcd");  // Open VCD file for waveform output
