/**
 * Module 3 Example 3.6: UVM Objections - C++ Testbench
 * 
 * LEARNING OBJECTIVES:
...
// INCLUDES
// ============================================================================
#include "Vobjections.h"    // Verilator-generated header for objections module
...
int main(int argc, char** argv) {
    ...
    Vobjections* top = new Vobjections;
    
    // Setup VCD tracing
    VerilatedVcdC* tfp = new VerilatedVcdC;
    top->trace(tfp, 99);  // Register all signals for tracing (depth=99)
    tfp->open("objections.vcd");  // Open VCD file for waveform output
