...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_execute(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> comp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_phase> phase) {
    ...
    // Locals
    VlClassRef<Vclass_hierarchy_std__03a__03aprocess> __Vfunc_self__34__Vfuncout;
    // Body
    VlClassRef<Vclass_hierarchy_std__03a__03aprocess> unnamedblk2__DOT____VforkParent;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03a__VDynScope_13> __VDynScope_execute_0;
    __VDynScope_execute_0 = VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03a__VDynScope_13, vlSymsp);
...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_execute____Vfork_1__0(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03a__VDynScope_13> __VDynScope_execute_0, VlClassRef<Vclass_hierarchy_std__03a__03aprocess> unnamedblk2__DOT____VforkParent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_execute____Vfork_1__0\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_std__03a__03aprocess> __Vtask___VforkTask_0__35____VforkParent;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03a__VDynScope_13> __Vtask___VforkTask_0__35____VDynScope_execute_0;
    VlClassRef<Vclass_hierarchy_std__03a__03aprocess> __Vtask___VforkTask_0__35__proc;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::~Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_task_phase::~\n"); );
}
