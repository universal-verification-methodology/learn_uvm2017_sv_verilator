...
Vclass_hierarchy_uvm_pkg__03a__03auvm_config_db_::~Vclass_hierarchy_uvm_pkg__03a__03auvm_config_db_() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_config_db_::~\n"); );
}
