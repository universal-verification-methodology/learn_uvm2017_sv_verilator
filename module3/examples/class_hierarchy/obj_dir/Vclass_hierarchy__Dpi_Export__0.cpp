...
void Vclass_hierarchy::m__uvm_report_dpi(int severity, const char* id, const char* message, int verbosity, const char* filename, int line) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root::m__uvm_report_dpi\n"); );
    // Locals
    ...
    Vclass_hierarchy__Vcb_m___05Fuvm_report_dpi_t __Vcb = reinterpret_cast<Vclass_hierarchy__Vcb_m___05Fuvm_report_dpi_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    ...
    line__Vcvt = (line);
    (*__Vcb)((Vclass_hierarchy__Syms*)(__Vscopep->symsp()), severity__Vcvt, id__Vcvt, message__Vcvt, verbosity__Vcvt, filename__Vcvt, line__Vcvt);
}
