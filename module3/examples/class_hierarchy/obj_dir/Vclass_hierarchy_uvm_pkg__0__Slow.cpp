...
VL_ATTR_COLD void Vclass_hierarchy_uvm_pkg___eval_static__TOP__uvm_pkg(Vclass_hierarchy_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vclass_hierarchy_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
...
VL_ATTR_COLD void Vclass_hierarchy_uvm_pkg___ctor_var_reset(Vclass_hierarchy_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vclass_hierarchy_uvm_pkg___ctor_var_reset\n"); );
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
