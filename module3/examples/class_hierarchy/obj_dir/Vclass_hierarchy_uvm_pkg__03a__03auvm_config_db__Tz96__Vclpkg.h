...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_CONFIG_DB__TZ96__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_CONFIG_DB__TZ96__VCLPKG_H_  // guard
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db_;
...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_config_db__Tz96__Vclpkg final {
  public:
    ...
    VlAssocArray<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component>, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_pool__Tz38_TBz185>> __PVT__m_rsc;
    ...
    void __VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> &value, CData/*0:0*/ &get__Vfuncrtn);
    void __VnoInFunc_set(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> value);
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_config_db__Tz96 : public Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db_ {
  public:
  private:
