...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy___024unit__03a__03aMyEnv__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy___024unit__03a__03aMyEnv__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
