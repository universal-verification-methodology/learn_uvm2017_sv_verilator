...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_analysis_fifo___Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_analysis_fifo___Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
