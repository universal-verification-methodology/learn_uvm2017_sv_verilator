...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI205__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI205__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vclass_hierarchy__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205__Vclpkg);
    ...
    void __VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205> &get__Vfuncrtn);
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205 : public virtual VlClass {
  public:
  ...
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205(Vclass_hierarchy__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi205() {}
};
