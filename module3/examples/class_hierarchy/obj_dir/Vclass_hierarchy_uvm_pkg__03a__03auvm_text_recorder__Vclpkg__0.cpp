...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string nm, VlWide<128>/*4095:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        __Vtemp_5 = Vclass_hierarchy___024unit::__Venumtab_enum_name15
            .at(radix);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string nm, QData/*63:0*/ value, IData/*27:0*/ radix, IData/*31:0*/ numbits) {
    ...
    if (VL_UNLIKELY((([&]() {
        ...
        __Vtemp_2 = Vclass_hierarchy___024unit::__Venumtab_enum_name15
            .at(radix);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::~Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_text_recorder::~\n"); );
}
