...
VL_ATTR_COLD void Vclass_hierarchy___024root__trace_init_sub__TOP__uvm_pkg__0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_init_sub__TOP__0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_init_sub__TOP__0\n"); );
    ...
    Vclass_hierarchy___024root__trace_init_sub__TOP__uvm_pkg__0(vlSelf, tracep);
    tracep->popPrefix();
}

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_init_sub__TOP__uvm_pkg__0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_init_sub__TOP__uvm_pkg__0\n"); );
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const int c = vlSymsp->__Vm_baseCode;
...
VL_ATTR_COLD void Vclass_hierarchy___024root__trace_init_top(Vclass_hierarchy___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_init_top\n"); );
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vclass_hierarchy___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vclass_hierarchy___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vclass_hierarchy___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vclass_hierarchy___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_register(Vclass_hierarchy___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_register\n"); );
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vclass_hierarchy___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vclass_hierarchy___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vclass_hierarchy___024root__trace_chg_0, 0, vlSelf);
    tracep->addCleanupCb(&Vclass_hierarchy___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_const_0_sub_0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_const_0\n"); );
    // Body
    Vclass_hierarchy___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vclass_hierarchy___024root*>(voidSelf);
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vclass_hierarchy___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_const_0_sub_0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_const_0_sub_0\n"); );
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vclass_hierarchy___024root__trace_full_0_sub_0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_full_0\n"); );
    // Body
    Vclass_hierarchy___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vclass_hierarchy___024root*>(voidSelf);
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    Vclass_hierarchy___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vclass_hierarchy___024root__trace_full_0_sub_0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_full_0_sub_0\n"); );
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
