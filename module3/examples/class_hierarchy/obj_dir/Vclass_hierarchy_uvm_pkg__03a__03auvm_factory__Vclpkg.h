...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_factory__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_factory__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
