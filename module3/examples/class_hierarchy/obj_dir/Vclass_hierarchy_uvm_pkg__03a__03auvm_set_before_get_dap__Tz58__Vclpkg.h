...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ58__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ58__VCLPKG_H_  // guard
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_set_get_dap_base__Tz58;
class Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream;


class Vclass_hierarchy__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz58__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz58__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz58__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz58__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz115> &get_type__Vfuncrtn);
};
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz58 : public Vclass_hierarchy_uvm_pkg__03a__03auvm_set_get_dap_base__Tz58 {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m_set;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream> __PVT__m_value;
  ...
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz58(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz58() {}
};
