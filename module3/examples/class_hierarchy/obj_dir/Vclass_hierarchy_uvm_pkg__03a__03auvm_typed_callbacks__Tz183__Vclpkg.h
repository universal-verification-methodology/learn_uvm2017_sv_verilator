...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ183__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ183__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> __PVT__m_tw_cb_q;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vclass_hierarchy__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183> &m_initialize__Vfuncrtn);
};
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183 : public Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz183() {}
};
