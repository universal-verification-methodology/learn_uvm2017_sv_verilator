...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ69__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ69__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db__Tz69__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db__Tz69__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db__Tz69__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db__Tz69__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_dump(Vclass_hierarchy__Syms* __restrict vlSymsp);
    void __VnoInFunc_get_by_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_> &get_by_name__Vfuncrtn);
    void __VnoInFunc_get_by_type(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_> &get_by_type__Vfuncrtn);
    void __VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_> rsrc);
    ...
    void __VnoInFunc_set_default(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_> &set_default__Vfuncrtn);
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db__Tz69 : public virtual VlClass {
  public:
  private:
    void _ctor_var_reset(Vclass_hierarchy__Syms* __restrict vlSymsp);
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db__Tz69(Vclass_hierarchy__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vclass_hierarchy_uvm_pkg__03a__03auvm_resource_db__Tz69() {}
};
