...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy___024unit(Vclass_hierarchy__Syms* symsp, const char* v__name);
