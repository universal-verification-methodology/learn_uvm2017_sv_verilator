    ...
    do {
...
#endif
            VL_FATAL_MT("class_hierarchy.sv", 182, "", "NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vclass_hierarchy___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("class_hierarchy.sv", 182, "", "Active region did not converge after 100 tries");
            }
