...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer___Vclpkg::__VnoInFunc_get_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component_registry__Tz188> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer___Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component_registry__Tz188> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_component_registry__Tz188__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get_object_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component_registry__Tz188> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_component_registry__Tz188__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_item_done_get_trigger_data(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> &item_done_get_trigger_data__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_item_done_get_trigger_data\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> __Vfunc_last_rsp__1__Vfuncout;
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> parent)
    : Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_(vlProcess, vlSymsp, name, parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
    this->__PVT__seq_item_export = VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi96, vlProcess, vlSymsp, "seq_item_export"s, 
                                          VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_>{this});
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_stop_sequences(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_stop_sequences\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> t;
    ...
    if ((0U != ([&]() {
                    VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 170)
        ...
        VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 172)->__VnoInFunc_flush(vlSymsp);
    }
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_sequencer"s;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_m_find_number_driver_connections(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &m_find_number_driver_connections__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_m_find_number_driver_connections\n"); );
    // Body
    VlAssocArray<std::string, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_port_base__Tz189>> provided_to_port_list;
...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get_next_item(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get_next_item\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> __Vtask_peek__19__t;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> req_item;
    ...
    co_await VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 222)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__19__t);
    t = __Vtask_peek__19__t;
}

VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_try_next_item(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_try_next_item\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> __Vtask_try_peek__30__t;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_base> seq;
    {
        ...
        co_await this->__VnoInFunc_wait_for_sequences(vlProcess, vlSymsp);
        if ((1U & (~ ([&]() {
                            VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 264)
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_item_done(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_item_done\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__36__Vfuncout;
    __Vtask_try_get__36__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> __Vtask_try_get__36__t;
    ...
    this->__PVT__get_next_item_called = 0U;
    if (([&]() {
                VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 283)
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_put(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_put\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    this->__VnoInFunc_put_response(vlProcess, vlSymsp, t);
}

VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> __Vtask_peek__44__t;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    if ((1U & (~ (IData)(this->__PVT__sequence_item_requested)))) {
    ...
    this->__PVT__sequence_item_requested = 1U;
    co_await VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 316)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__44__t);
    t = __Vtask_peek__44__t;
    this->__VnoInFunc_item_done(vlSymsp, VlNull{});
}

VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_peek(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_peek\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> __Vtask_peek__47__t;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    if ((1U & (~ (IData)(this->__PVT__sequence_item_requested)))) {
    ...
    this->__PVT__sequence_item_requested = 1U;
    co_await VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::__PVT__m_req_fifo, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/seq/uvm_sequencer.svh", 333)->__VnoInFunc_peek(vlSymsp, __Vtask_peek__47__t);
    t = __Vtask_peek__47__t;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_item_done_trigger(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_item_done_trigger\n"); );
    // Body
    this->__VnoInFunc_item_done(vlSymsp, item);
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_randomize(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc___Vbasic_randomize(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::_ctor_var_reset(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base_::to_string_middle();
    return (out);
}
