...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_POOL__TZ38_TBZ69__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_POOL__TZ38_TBZ69__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_pool__Tz38_TBz69__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_global(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_pool__Tz38_TBz69> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz125> &get_type__Vfuncrtn);
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_pool__Tz38_TBz69 : public Vclass_hierarchy_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get__Vfuncrtn);
