...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz95> __Vtask_m_initialize__0__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_typeid__Tz80> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_typeid__Tz173> __Vfunc_get__2__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_typeid__Tz95> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95> __Vfunc_get__5__Vfuncout;
    ...
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_typeid_base> unnamedblk1__DOT__cb_base_type;
    if ((VlNull{} == this->__PVT__m_inst)) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__VnoInFunc_m_initialize(vlProcess, vlSymsp, __Vtask_m_initialize__0__Vfuncout);
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz80__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__1__Vfuncout);
        unnamedblk1__DOT__cb_base_type = __Vfunc_get__1__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz173__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__2__Vfuncout);
        ...
        this->__PVT__m_inst = VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173, vlProcess, vlSymsp);
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
                          == this->__PVT__m_cb_typeid)))) {
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz95_TBz173.get.unnamedblk1: '$cast' failed.\n",0,
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz95__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__5__Vfuncout);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_m_register_pair(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_m_register_pair\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vfunc_get__11__Vfuncout;
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> inst;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_add(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_add\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__12__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> __Vtask_get__35__Vfuncout;
    IData/*31:0*/ __Vtask_size__38__Vfuncout;
    __Vtask_size__38__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95> __Vtask_get__39__Vfuncout;
    IData/*31:0*/ __Vtask_size__40__Vfuncout;
    __Vtask_size__40__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__42__Vfuncout;
    IData/*31:0*/ __Vtask_size__43__Vfuncout;
    __Vtask_size__43__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__45__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> unnamedblk2__DOT__o;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> unnamedblk2__DOT__unnamedblk3__DOT__qr;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> q;
    std::string nm;
    std::string tnm;
    {
        ...
        if ((VlNull{} == obj)) {
            if ((0xffffffffU != ([&]() {
                            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__28__Vfuncout);
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_t_inst, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 658)->__VnoInFunc_m_add_tw_cbs(vlProcess, vlSymsp, cb, ordering);
            }
        } else {
            ...
            if ((VlNull{} == q)) {
                q = VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80, vlProcess, vlSymsp, ""s);
            ...
            if ((0U == ([&]() {
                ...
                if ((0U != ([&]() {
                    ...
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz95__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vtask_get__39__Vfuncout);
                    unnamedblk2__DOT__unnamedblk3__DOT__qr 
                        = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_tw_cb_q;
                ...
                while (VL_LTS_III(32, unnamedblk2__DOT__unnamedblk5__DOT__i, 
                                  ([&]() {
                                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 687)
                    ...
                    VL_NULL_CHECK(q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 688)->__VnoInFunc_push_back(vlSymsp, 
                                                                                ([&]() {
                                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 688)
            ...
            if ((0xffffffffU != ([&]() {
                            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__46__Vfuncout);
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__VnoInFunc_m_cb_find_name(vlProcess, vlSymsp, q, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_add_by_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> root, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_add_by_name\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__58__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__68__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_root> __Vtask_get_root__69__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    IData/*31:0*/ unnamedblk6__DOT__i;
    unnamedblk6__DOT__i = 0;
    VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component>> cq;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> t;
    {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_delete(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> cb) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_delete\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__72__Vfuncout;
    CData/*0:0*/ __Vtask_m_delete_tw_cbs__73__Vfuncout;
    __Vtask_m_delete_tw_cbs__73__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> __Vtask_get__74__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> b_obj;
    b_obj = obj;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> q;
    CData/*0:0*/ found;
    found = 0;
    ...
    if ((VlNull{} == obj)) {
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_t_inst, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 771)->__VnoInFunc_m_delete_tw_cbs(vlProcess, vlSymsp, cb, __Vtask_m_delete_tw_cbs__73__Vfuncout);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__75__Vfuncout);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_delete_by_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> root) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_delete_by_name\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__83__Vfuncout;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_m_get_q(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> &q, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_m_get_q\n"); );
    // Locals
    IData/*31:0*/ __Vtask_exists__93__Vfuncout;
    __Vtask_exists__93__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> __Vtask_get__94__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> __Vtask_m_get_tw_cb_q__97__Vfuncout;
    // Body
    if ((0U != ([&]() {
        ...
        q = ((VlNull{} == obj) ? vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_tw_cb_q
              : ([&]() {
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_t_inst, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 835)
                 ->__VnoInFunc_m_get_tw_cb_q(vlSymsp, obj, __Vtask_m_get_tw_cb_q__97__Vfuncout);
                }(), __Vtask_m_get_tw_cb_q__97__Vfuncout));
    }
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_first(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> &get_first__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_first\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__98__Vfuncout;
    IData/*31:0*/ __Vtask_size__100__Vfuncout;
    __Vtask_size__100__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__101__Vfuncout;
    CData/*0:0*/ __Vtask_callback_mode__102__Vfuncout;
    __Vtask_callback_mode__102__Vfuncout = 0;
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> q;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> cb;
    {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_last(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> &get_last__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_last\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__103__Vfuncout;
    IData/*31:0*/ __Vtask_size__105__Vfuncout;
    __Vtask_size__105__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__106__Vfuncout;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_next(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> &get_next__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_next\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__108__Vfuncout;
    IData/*31:0*/ __Vtask_size__110__Vfuncout;
    __Vtask_size__110__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__111__Vfuncout;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_prev(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> &get_prev__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_prev\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__113__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__115__Vfuncout;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_all(Vclass_hierarchy__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher>> &all_callbacks, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_get_all\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__117__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__120__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> __Vtask_get__121__Vfuncout;
    IData/*31:0*/ __Vtask_size__122__Vfuncout;
    __Vtask_size__122__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> __Vtask_get__123__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_queue__Tz80> q;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> cb;
    VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher>> callbacks_to_append;
    VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher>> unique_callbacks_to_append;
    ...
    if (((VlNull{} == obj) || (1U & (~ (0U != ([&]() {
        ...
        while (VL_LTS_III(32, unnamedblk9__DOT__qi, 
                          ([&]() {
                        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 976)
                           ->__VnoInFunc_size(vlSymsp, __Vtask_size__119__Vfuncout);
                    }(), __Vtask_size__119__Vfuncout))) {
            if (VL_CAST_DYNAMIC(([&]() {
                            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg.__PVT__m_tw_cb_q, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 977)
    ...
    unique_callbacks_to_append = callbacks_to_append.unique(
                                                            [&](
                                                                ...
                                                                VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> cb_) -> 
                                                            IData/*31:0*/ {
            return (([&]() {
    ...
    all_callbacks = VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher>>::consCC(unique_callbacks_to_append, 
                                                                                all_callbacks);
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_display(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173__Vclpkg::__VnoInFunc_display\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173> __Vtask_get__125__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc_m_is_registered(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_registered__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc_m_is_registered\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc_m_is_for_me(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_for_me__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc_m_is_for_me\n"); );
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_report_catcher> this_cb;
    m_is_for_me__Vfuncrtn = (1U & VL_CAST_DYNAMIC(cb, this_cb));
}

Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp)
    : Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz95(vlProcess, vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc_randomize(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::_ctor_var_reset(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_registered = 0;
}

Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::~Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz173::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_registered:" + VL_TO_STRING(__PVT__m_registered);
    out += ", "+ Vclass_hierarchy_uvm_pkg__03a__03auvm_typed_callbacks__Tz95::to_string_middle();
    return (out);
}
