...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_create(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_pool__Tz38_TBz92> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> __Vfunc_get__3__Vfuncout;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_set_type_override(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> __Vfunc_get__11__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_set_inst_override(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_set_type_alias(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> unnamedblk2__DOT__rgtry;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> rgtry;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::__VnoInFunc_get_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::__VnoInFunc_initialize(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz141> __Vfunc_get__2__Vfuncout;
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::_ctor_var_reset(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vclass_hierarchy_uvm_pkg__03a__03auvm_registry_common__pi83::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
