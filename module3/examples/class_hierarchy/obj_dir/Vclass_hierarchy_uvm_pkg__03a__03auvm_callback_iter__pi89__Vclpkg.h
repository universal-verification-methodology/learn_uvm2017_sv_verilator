...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_CALLBACK_ITER__PI89__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_CALLBACK_ITER__PI89__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_callback_iter__pi89__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_callback_iter__pi89__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_callback_iter__pi89__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_callback_iter__pi89__Vclpkg);
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_callback_iter__pi89 : public virtual VlClass {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_i;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg> __PVT__m_obj;
  ...
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_callback_iter__pi89(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg> obj);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_callback_iter__pi89() {}
};
