...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq__Vclpkg::__VnoInFunc_get_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__pi183> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__pi183> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq__Vclpkg::__VnoInFunc_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_mem_shared_access_seq"s;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_get_object_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__pi183> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi183__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_create(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq> tmp;
    tmp = ((""s == name) ? VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq, vlProcess, vlSymsp, "uvm_reg_mem_shared_access_seq"s)
            : VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_get_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_mem_shared_access_seq"s;
}

Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name)
    : Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_sequence__Tz311(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_body\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_shared_access_seq> __Vfunc_create__8__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq> __Vfunc_create__9__Vfuncout;
    // Body
    VL_KEEP_THIS;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi181__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "reg_shared_access_seq"s, VlNull{}, ""s, __Vfunc_create__8__Vfuncout);
        this->__PVT__reg_seq = __Vfunc_create__8__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi182__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "reg_shared_access_seq"s, VlNull{}, ""s, __Vfunc_create__9__Vfuncout);
        ...
        VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_sequence__Tz311::__PVT__model, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_shared_access_seq.svh", 407)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_do_block(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_block> blk) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_do_block\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource__Tz62> __Vfunc_get_by_name__13__Vfuncout;
    std::string __Vtask_get_full_name__14__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource__Tz62> __Vfunc_get_by_name__15__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource__Tz62> __Vfunc_get_by_name__24__Vfuncout;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_base> __Vfunc_get_sequencer__29__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource__Tz62> __Vfunc_get_by_name__31__Vfuncout;
    std::string __Vtask_get_full_name__32__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource__Tz62> __Vfunc_get_by_name__33__Vfuncout;
    std::string __Vtask_get_full_name__34__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource__Tz62> __Vfunc_get_by_name__35__Vfuncout;
    std::string __Vtask_get_full_name__36__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_resource__Tz62> __Vfunc_get_by_name__37__Vfuncout;
    std::string __Vtask_get_full_name__38__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_base> __Vfunc_get_sequencer__40__Vfuncout;
    // Body
    VL_KEEP_THIS;
    ...
    VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_block>> unnamedblk3__DOT__blks;
    ...
    VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_mem>> mems;
    {
        ...
        this->__VnoInFunc_reset_blk(vlSymsp, Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_sequence__Tz311::__PVT__model);
        VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_sequence__Tz311::__PVT__model, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_shared_access_seq.svh", 432)->__VnoInFunc_reset(vlSymsp, "HARD"s);
        ...
        while (VL_LTS_III(32, unnamedblk1__DOT__i, regs.size())) {
            {
                ...
                co_await VL_NULL_CHECK(this->__PVT__reg_seq, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_shared_access_seq.svh", 444)->__VnoInFunc_start(vlProcess, vlSymsp, 
                            ...
                            this->__VnoInFunc_get_sequencer(vlSymsp, __Vfunc_get_sequencer__29__Vfuncout);
                                                                                ...
                                                                                VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq>{this}, 0xffffffffU, 1U);
                __Vlabel1: ;
            }
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_reset_blk(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_block> blk) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_reset_blk\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_randomize(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::_ctor_var_reset(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::~Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::to_string_middle\n"); );
    // Body
    std::string out;
