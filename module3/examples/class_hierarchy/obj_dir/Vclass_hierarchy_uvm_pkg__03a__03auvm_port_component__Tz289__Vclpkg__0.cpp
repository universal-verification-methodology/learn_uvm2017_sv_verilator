...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_get_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_get_port(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_port_base__Tz286> &get_port__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_get_port\n"); );
    // Body
    get_port__Vfuncrtn = this->__PVT__m_port;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_get_connected_to(Vclass_hierarchy__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component_base>> &list) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_get_connected_to\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_is_port(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &is_port__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_is_port\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_is_export(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &is_export__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_is_export\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_is_imp(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &is_imp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::__VnoInFunc_is_imp\n"); );
    // Locals
...
std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        Vclass_hierarchy_uvm_pkg__03a__03auvm_port_component__Tz289::to_string_middle\n"); );
    // Body
    std::string out;
