...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI10__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI10__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_port__pi10__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_port__pi10__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_port__pi10__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_port__pi10__Vclpkg);
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_port__pi10 : public Vclass_hierarchy_uvm_pkg__03a__03auvm_port_base__Tz33 {
  public:
  ...
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_port__pi10(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ min_size, IData/*31:0*/ max_size);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_port__pi10() {}
};
