...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ id, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream> &get_stream_from_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle\n"); );
    // Body
    {
        if ((0U == id)) {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id\n"); );
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name)
    : Vclass_hierarchy_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
    this->__PVT__m_cfg_dap = VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_set_before_get_dap__Tz68, vlProcess, vlSymsp, "cfg_dap"s);
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_database> &get_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__2__Vfuncout;
    __Vtask_try_get__2__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__2__value;
    ...
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    {
        if ((1U & (~ ([&]() {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &get_scope__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__12__Vfuncout;
    __Vtask_try_get__12__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__12__value;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &get_stream_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__22__Vfuncout;
    __Vtask_try_get__22__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__22__value;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close\n"); );
    // Locals
    ...
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder> unnamedblk1__DOT__idx;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_database> __Vfunc_get_db__42__Vfuncout;
    ...
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder> unnamedblk2__DOT__idx;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
                                                                                VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream>{this})) {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open\n"); );
    // Locals
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__58__value;
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__65__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_root> __Vtask_get_root__66__Vfuncout;
    std::string __Vtemp_1;
    std::string __Vtemp_2;
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_database> m_db;
    {
        if ((VlNull{} == db)) {
            if ((0U != ([&]() {
        ...
        if (([&]() {
            ...
            m_cfg = VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03am_uvm_tr_stream_cfg, vlSymsp);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &is_closed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed\n"); );
    // Body
    is_closed__Vfuncrtn = this->__PVT__m_is_closed;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder> &open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_is_open__71__Vfuncout;
    __Vfunc_is_open__71__Vfuncout = 0;
    VlClassRef<Vclass_hierarchy_std__03a__03aprocess> __Vfunc_self__72__Vfuncout;
    std::string __Vtask_get_randstate__73__Vfuncout;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder> __Vfunc_do_open_recorder__74__Vfuncout;
    // Body
    ...
    if (([&]() {
        ...
        if ((VlNull{} != open_recorder__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_recorder__Vfuncrtn, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_tr_stream.svh", 285)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream>{this}, m_time, type_name);
        }
        if ((VlNull{} != unnamedblk3__DOT__p)) {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder\n"); );
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders(Vclass_hierarchy__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder>> &q, CData/*0:0*/ &get_recorders__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders\n"); );
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__idx;
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle\n"); );
    // Locals
    ...
    if ((1U & ((~ ([&]() {
        ...
        if ((vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
             ...
             && (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream
                 .at(VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream>{this}) 
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_recorder> &do_open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder\n"); );
    // Body
    do_open_recorder__Vfuncrtn = VlNull{};
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset\n"); );
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::~Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_tr_stream::to_string_middle\n"); );
    // Body
    std::string out;
