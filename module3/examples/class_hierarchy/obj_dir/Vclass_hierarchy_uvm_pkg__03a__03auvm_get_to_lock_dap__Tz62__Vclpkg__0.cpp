...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62__Vclpkg::__VnoInFunc_get_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz119> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz119> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_get_object_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz119> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz119__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_create(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62> tmp;
    tmp = ((""s == name) ? VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62, vlProcess, vlSymsp, "unnamed-uvm_get_to_lock_dap#(T)"s)
            : VL_NEW(Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name)
    : Vclass_hierarchy_uvm_pkg__03a__03auvm_set_get_dap_base__Tz62(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::new\n"); );
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_set(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_set\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_try_set(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_try_set\n"); );
    // Body
    if (this->__PVT__m_locked) {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_get\n"); );
    // Body
    this->__PVT__m_locked = 1U;
    get__Vfuncrtn = this->__PVT__m_value;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_try_get(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_try_get\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_pack(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_pack\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_unpack(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_convert2string\n"); );
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_print(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_do_print\n"); );
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_randomize(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::_ctor_var_reset(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::_ctor_var_reset\n"); );
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::~Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz62::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_locked:" + VL_TO_STRING(__PVT__m_locked);
    out += ", "+ Vclass_hierarchy_uvm_pkg__03a__03auvm_set_get_dap_base__Tz62::to_string_middle();
    return (out);
}
