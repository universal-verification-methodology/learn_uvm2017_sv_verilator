...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ25__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ25__VCLPKG_H_  // guard
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_set_get_dap_base__Tz25;


class Vclass_hierarchy__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz25__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz25__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz25__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz25__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_object_registry__Tz120> &get_type__Vfuncrtn);
};
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz25 : public Vclass_hierarchy_uvm_pkg__03a__03auvm_set_get_dap_base__Tz25 {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m_locked;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_phase> __PVT__m_value;
  ...
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz25(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vclass_hierarchy_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz25() {}
};
