...
Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer__Tz1_TBz1> imp)
    : Vclass_hierarchy_uvm_pkg__03a__03auvm_port_base__Tz33(vlProcess, vlSymsp, name, imp, 2U, 1U, 1U) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::new\n"); );
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_get_type_name(Vclass_hierarchy__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_get_type_name\n"); );
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_is_auto_item_recording_enabled(Vclass_hierarchy__Syms* __restrict vlSymsp, CData/*0:0*/ &is_auto_item_recording_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_is_auto_item_recording_enabled\n"); );
    // Locals
...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_get_next_item(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy___024unit__03a__03aMyTransaction> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_get_next_item\n"); );
    // Locals
...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_wait_for_sequences(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_wait_for_sequences\n"); );
    // Body
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_put_response(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy___024unit__03a__03aMyTransaction> t) {
...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy___024unit__03a__03aMyTransaction> &t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::__VnoInFunc_get\n"); );
    // Locals
...
std::string VL_TO_STRING(const VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vclass_hierarchy_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi13::to_string_middle\n"); );
    // Body
    std::string out;
