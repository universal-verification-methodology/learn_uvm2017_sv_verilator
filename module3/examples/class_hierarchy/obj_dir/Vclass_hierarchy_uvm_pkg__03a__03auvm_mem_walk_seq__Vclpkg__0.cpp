...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_single_walk_seq> __Vfunc_create__8__Vfuncout;
    // Body
    VL_KEEP_THIS;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi174__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "single_mem_walk_seq"s, VlNull{}, ""s, __Vfunc_create__8__Vfuncout);
        ...
        VL_NULL_CHECK(Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_sequence__Tz311::__PVT__model, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_mem_walk_seq.svh", 240)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq::~Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_walk_seq::~\n"); );
}
