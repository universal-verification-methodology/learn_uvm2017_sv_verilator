...
void Vclass_hierarchy___024root__trace_chg_0_sub_0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vclass_hierarchy___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_chg_0\n"); );
    // Body
    ...
    Vclass_hierarchy___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vclass_hierarchy___024root__trace_chg_0_sub_0(Vclass_hierarchy___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_chg_0_sub_0\n"); );
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vclass_hierarchy___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vclass_hierarchy___024root__trace_cleanup\n"); );
    // Body
    Vclass_hierarchy___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vclass_hierarchy___024root*>(voidSelf);
    Vclass_hierarchy__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
