...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz65_TBz174__Vclpkg::__VnoInFunc_get(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz65_TBz174> &get__Vfuncrtn) {
    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        ...
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
            ...
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:528: Assertion failed in %Nuvm_pkg.uvm_callbacks__Tz65_TBz174.get.unnamedblk1: 'assert' failed.\n",0,
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz65_TBz174::__VnoInFunc___Vbasic_randomize(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_callbacks__Tz65_TBz174::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
