...
#ifndef VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI153__VCLPKG_H_
#define VERILATED_VCLASS_HIERARCHY_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI153__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vclass_hierarchy_uvm_pkg__03a__03auvm_analysis_export__Tz210;
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153;
class Vclass_hierarchy_uvm_pkg__03a__03auvm_tlm_fifo__Tz210;


class Vclass_hierarchy__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153__Vclpkg(Vclass_hierarchy__Syms* symsp, const char* v__name);
    ~Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153__Vclpkg();
    VL_UNCOPYABLE(Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153__Vclpkg);
...
class Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153 : public Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_base {
  public:
    ...
    VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_item>> __PVT__m_last_req_buffer;
    VlQueue<VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_item>> __PVT__m_last_rsp_buffer;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_analysis_fifo__pi158> __PVT__sqr_rsp_analysis_fifo;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_analysis_export__Tz210> __PVT__rsp_export;
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_tlm_fifo__Tz210> __PVT__m_req_fifo;
    ...
    void __VnoInFunc_get_current_item(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_item> &get_current_item__Vfuncrtn);
    ...
    void __VnoInFunc_last_req(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_item> &last_req__Vfuncrtn);
    void __VnoInFunc_last_rsp(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_item> &last_rsp__Vfuncrtn);
    void __VnoInFunc_m_last_req_push_front(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_item> item);
    void __VnoInFunc_m_last_rsp_push_front(Vclass_hierarchy__Syms* __restrict vlSymsp, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_item> item);
  ...
  public:
    Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vclass_hierarchy_uvm_pkg__03a__03auvm_sequencer_param_base__pi153() {}
};
