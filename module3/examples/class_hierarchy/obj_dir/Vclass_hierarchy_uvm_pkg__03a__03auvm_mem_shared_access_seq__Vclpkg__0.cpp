...
VlCoroutine Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vclass_hierarchy__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vclass_hierarchy_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__26__Vfuncout;
                ...
                while (VL_LTS_III(32, unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__k, maps.size())) {
                    ...
                    if ((0U != unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__status)) {
                        if ((0U != ([&]() {
                            ...
                            __Vtemp_12 = Vclass_hierarchy___024unit::__Venumtab_enum_name83
                                [(3U & unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__status)];
                            __Vtemp_13 = ([&]() {
...
void Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___Vsetup_constraints(Vclass_hierarchy__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___VBasicRand(Vclass_hierarchy__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq::~Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vclass_hierarchy_uvm_pkg__03a__03auvm_mem_shared_access_seq::~\n"); );
}
