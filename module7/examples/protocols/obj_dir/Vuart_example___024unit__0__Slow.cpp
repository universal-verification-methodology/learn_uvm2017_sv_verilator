...
VL_ATTR_COLD void Vuart_example___024unit___ctor_var_reset(Vuart_example___024unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vuart_example___024unit___ctor_var_reset\n"); );
