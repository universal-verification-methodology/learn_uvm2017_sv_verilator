...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_  // guard
...
class Vuart_example_uvm_pkg__03a__03auvm_callback_iter__pi88;
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_vreg__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_vreg__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_vreg__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_vreg__Vclpkg);
...
class Vuart_example_uvm_pkg__03a__03auvm_vreg : public Vuart_example_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlQueue<VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field>> __PVT__fields;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem> __PVT__mem;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem_region> __PVT__region;
    VlClassRef<Vuart_example_std__03a__03asemaphore> __PVT__atomic;
    VlCoroutine __VnoInFunc_XatomicX(Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ on);
    void __VnoInFunc_Xlock_modelX(Vuart_example__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vuart_example__Syms* __restrict vlSymsp) {}
    void __VnoInFunc_add_field(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field> field);
    virtual void __VnoInFunc_allocate(Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem_mam> mam, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem_region> &allocate__Vfuncrtn);
    ...
    void __VnoInFunc_configure(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block> parent, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ size, QData/*63:0*/ offset, IData/*31:0*/ incr);
    ...
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ idx, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_field_by_name(Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field> &get_field_by_name__Vfuncrtn);
    virtual void __VnoInFunc_get_fields(Vuart_example__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_incr(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_incr__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_memory(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_n_memlocs(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_memlocs__Vfuncrtn);
    virtual void __VnoInFunc_get_offset_in_memory(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &get_offset_in_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_region(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem_region> &get_region__Vfuncrtn);
    virtual void __VnoInFunc_get_rights(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_rights__Vfuncrtn);
    virtual void __VnoInFunc_get_size(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_size__Vfuncrtn);
    virtual void __VnoInFunc_implement(Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ offset, IData/*31:0*/ incr, CData/*0:0*/ &implement__Vfuncrtn);
    ...
    virtual void __VnoInFunc_peek(Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_poke(Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    ...
    virtual void __VnoInFunc_release_region(Vuart_example__Syms* __restrict vlSymsp);
    void __VnoInFunc_reset(Vuart_example__Syms* __restrict vlSymsp, std::string kind);
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_vreg(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_vreg() {}
};
