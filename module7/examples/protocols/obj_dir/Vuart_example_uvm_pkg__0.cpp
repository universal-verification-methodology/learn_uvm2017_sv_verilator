...
void Vuart_example_uvm_pkg____Vdpiexp_m___05Fuvm_report_dpi_TOP__uvm_pkg(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ severity, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vuart_example_uvm_pkg____Vdpiexp_m___05Fuvm_report_dpi_TOP__uvm_pkg\n"); );
    // Locals
...
void Vuart_example_uvm_pkg::__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vuart_example_uvm_pkg::__VnoInFunc_uvm_report_fatal_TOP__uvm_pkg\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_fatal__Vstatic__top;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_fatal__Vstatic__cs;
...
std::string VL_TO_STRING(const Vuart_example_m_uvm_factory_type_pair_t__struct__0& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vuart_example_uvm_pkg::VL_TO_STRING\n"); );
    // Body
    std::string out;
