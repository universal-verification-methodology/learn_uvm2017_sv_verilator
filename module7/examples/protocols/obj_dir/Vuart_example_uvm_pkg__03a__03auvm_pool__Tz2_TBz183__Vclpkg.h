...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ183__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ183__VCLPKG_H_  // guard
...
class Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz261;
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vuart_example__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz261> &get_type__Vfuncrtn);
...
class Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183 : public Vuart_example_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz182>> __PVT__pool;
    virtual void __VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vuart_example__Syms* __restrict vlSymsp) {}
    virtual void __VnoInFunc_add(Vuart_example__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz182> item);
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz183() {}
};
