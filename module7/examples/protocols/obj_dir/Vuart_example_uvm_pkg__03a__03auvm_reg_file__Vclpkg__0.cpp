...
void Vuart_example_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi101> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi101> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_reg_file__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_file"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_object_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi101> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi101__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_create(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_file> tmp;
    tmp = ((""s == name) ? VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_reg_file, vlProcess, vlSymsp, ""s)
            : VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_reg_file, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_file"s;
}

Vuart_example_uvm_pkg__03a__03auvm_reg_file::Vuart_example_uvm_pkg__03a__03auvm_reg_file(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::new\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_configure(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block> blk_parent, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_file> regfile_parent, std::string hdl_path) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_configure\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__12__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__13__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    {
        if ((VlNull{} == blk_parent)) {
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_block(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block> &get_block__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_block\n"); );
                // Body
                get_block__Vfuncrtn = this->__PVT__parent;
            }

            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_regfile(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_file> &get_regfile__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_regfile\n"); );
                // Body
                get_regfile__Vfuncrtn = this->__PVT__m_rf;
            }

            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clear_hdl_path(Vuart_example__Syms* __restrict vlSymsp, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clear_hdl_path\n"); );
                // Locals
                ...
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                {
                    if (("ALL"s == kind)) {
                        this->__PVT__hdl_paths_pool 
                            = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_object_string_pool__Tz194, vlProcess, vlSymsp, "hdl_paths"s);
                        goto __Vlabel0;
                    }
                    if ((""s == kind)) {
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_add_hdl_path(Vuart_example__Syms* __restrict vlSymsp, std::string path, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_add_hdl_path\n"); );
                // Locals
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz2> __Vtask_get__29__Vfuncout;
                // Body
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_has_hdl_path(Vuart_example__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &has_hdl_path__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_has_hdl_path\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_hdl_path(Vuart_example__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_hdl_path\n"); );
                // Locals
                ...
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz2> __Vtask_get__45__Vfuncout;
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_hdl_path\n"); );
                // Locals
                ...
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz2> __Vtask_get__58__Vfuncout;
                IData/*31:0*/ __Vtask_size__61__Vfuncout;
                __Vtask_size__61__Vfuncout = 0;
                std::string __Vtask_get__62__Vfuncout;
                // Body
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz2> unnamedblk385__DOT__hdl_paths;
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_default_hdl_path(Vuart_example__Syms* __restrict vlSymsp, std::string &get_default_hdl_path__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_default_hdl_path\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_set_default_hdl_path(Vuart_example__Syms* __restrict vlSymsp, std::string kind) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_set_default_hdl_path\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_parent(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_parent\n"); );
                // Locals
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block> __Vfunc_get_block__75__Vfuncout;
                // Body
                this->__VnoInFunc_get_block(vlSymsp, __Vfunc_get_block__75__Vfuncout);
                get_parent__Vfuncrtn = __Vfunc_get_block__75__Vfuncout;
            }

            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_get_full_name\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_convert2string\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_print(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> printer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_print\n"); );
                // Body
                Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_print(vlProcess, vlSymsp, printer);
            }

            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clone(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_clone\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> rhs) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_copy\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_compare(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_compare\n"); );
                // Locals
                ...
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__96__Vfuncout;
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__97__Vfuncout;
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_pack(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_pack\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_unpack(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_do_unpack\n"); );
                // Locals
                ...
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__116__Vfuncout;
                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__117__Vfuncout;
                // Body
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                if ((0U != ([&]() {
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc_randomize\n"); );
                // Locals
            ...
            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::__VnoInFunc___Vbasic_randomize\n"); );
                // Body
                __Vbasic_randomize__Vfuncrtn = 1U;
            }

            void Vuart_example_uvm_pkg__03a__03auvm_reg_file::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::_ctor_var_reset\n"); );
                // Body
                (void)vlSymsp;  // Prevent unused variable warning
            }

            std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_file>& obj) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::VL_TO_STRING\n"); );
                // Body
                return (obj ? obj->to_string() : "null");
            }

            std::string Vuart_example_uvm_pkg__03a__03auvm_reg_file::to_string() const {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::to_string\n"); );
                // Body
                return ("'{"s + to_string_middle() + "}");
            }

            std::string Vuart_example_uvm_pkg__03a__03auvm_reg_file::to_string_middle() const {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_file::to_string_middle\n"); );
                // Body
                std::string out;
