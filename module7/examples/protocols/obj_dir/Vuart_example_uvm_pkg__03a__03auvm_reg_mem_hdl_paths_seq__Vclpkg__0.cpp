...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq__Vclpkg::__VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi182> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi182> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq__Vclpkg::__VnoInFunc_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_mem_hdl_paths_seq"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_get_object_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi182> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi182__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_create(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq> tmp;
    tmp = ((""s == name) ? VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq, vlProcess, vlSymsp, "uvm_reg_mem_hdl_paths_seq"s)
            : VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_get_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_mem_hdl_paths_seq"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_do_execute_op(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> op) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_do_execute_op\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc____05Fm_uvm_execute_field_op(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> ___05Flocal_op___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc____05Fm_uvm_execute_field_op\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__69__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__70__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource__Tz9> unnamedblk17__DOT_____05Ftmp_rsrc___05F;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource__Tz8> unnamedblk18__DOT_____05Ftmp_rsrc___05F;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource_> unnamedblk19__DOT_____05Ftmp_rsrc___05F;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource__Tz10> unnamedblk20__DOT_____05Ftmp_rsrc___05F;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource__Tz2> unnamedblk21__DOT__unnamedblk22__DOT__unnamedblk23__DOT__unnamedblk24__DOT_____05Ftmp_rsrc___05F;
    IData/*27:0*/ local_op_type___05F;
    local_op_type___05F = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq> local_rhs___05F;
                    ...
                    local_size___05F = (IData)(([&]() {
                                VL_NULL_CHECK(unnamedblk17__DOT_____05Ftmp_rsrc___05F, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_hdl_paths_seq.svh", 59)
                                                ->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                   VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq>{this}, __Vtask_read__59__Vfuncout);
                    ...
                    if (local_success___05F) {
                        local_size___05F = VL_SEL_IWII(4096, 
                                    ...
                                    VL_NULL_CHECK(unnamedblk18__DOT_____05Ftmp_rsrc___05F, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_hdl_paths_seq.svh", 59)
                                                        ->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                           VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq>{this}, __Vtask_read__60__Vfuncout);
                ...
                if ((1U & (~ (IData)(local_success___05F)))) {
                    ...
                    if (local_success___05F) {
                        VL_NULL_CHECK(unnamedblk19__DOT_____05Ftmp_rsrc___05F, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_hdl_paths_seq.svh", 59)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq>{this}, __Vtask_read__61__Vfuncout);
                ...
                if ((1U & (~ (IData)(local_success___05F)))) {
                    ...
                    if (local_success___05F) {
                        VL_NULL_CHECK(unnamedblk20__DOT_____05Ftmp_rsrc___05F, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_hdl_paths_seq.svh", 59)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq>{this}, __Vtask_read__62__Vfuncout);
                        ...
                        if (VL_GTS_III(32, 0U, unnamedblk21__DOT__unnamedblk22__DOT__local_index___05F)) {
                            ...
                            if (local_success___05F) {
                                VL_NULL_CHECK(unnamedblk21__DOT__unnamedblk22__DOT__unnamedblk23__DOT__unnamedblk24__DOT_____05Ftmp_rsrc___05F, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_hdl_paths_seq.svh", 59)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq>{this}, __Vtask_read__72__Vfuncout);
...
Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

VlCoroutine Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_body\n"); );
    // Locals
    ...
    unnamedblk25__DOT__i = 0;
    {
        ...
        if ((0U != ([&]() {
            ...
            __Vtask_uvm_report_info__82__message = 
                VL_CVT_PACK_STR_NN(VL_CONCATN_NNN("checking HDL paths for all registers/memories in "s, 
                                                  ([&]() {
                            VL_NULL_CHECK(Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307::__PVT__model, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_hdl_paths_seq.svh", 76)
        ...
        if ((0U == this->__PVT__abstractions.size())) {
            this->__VnoInFunc_do_block(vlProcess, vlSymsp, Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307::__PVT__model, ""s);
        } else {
            unnamedblk25__DOT__i = 0U;
            while (VL_LTS_III(32, unnamedblk25__DOT__i, this->__PVT__abstractions.size())) {
                this->__VnoInFunc_do_block(vlProcess, vlSymsp, Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307::__PVT__model, 
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_reset_blk(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block> blk) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_reset_blk\n"); );
}

void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_do_block(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block> blk, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_do_block\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__103__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__104__Vfuncout;
    // Body
    IData/*31:0*/ unnamedblk26__DOT__i;
    unnamedblk26__DOT__i = 0;
    IData/*31:0*/ unnamedblk27__DOT__i;
    unnamedblk27__DOT__i = 0;
    VlQueue<VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_block>> unnamedblk28__DOT__blks;
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_check_reg(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg> r, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_check_reg\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk30__DOT__unnamedblk31__DOT__path;
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_check_mem(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_mem> m, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_check_mem\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk34__DOT__unnamedblk35__DOT__path;
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_reg_mem_hdl_paths_seq::to_string_middle\n"); );
    // Body
    std::string out;
