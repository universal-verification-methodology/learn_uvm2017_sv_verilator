...
void Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi9> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi9> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi9__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_packer"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_set_default(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_default(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_packer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_get_default_packer__4__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_object_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi9> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi9__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_create(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> tmp;
    tmp = ((""s == name) ? VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_packer, vlProcess, vlSymsp, ""s)
            : VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_packer, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_packer"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_index_error(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string id, IData/*31:0*/ sz) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_index_error\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__4__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__5__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_enough_bits(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ needed, std::string id, CData/*0:0*/ &enough_bits__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_enough_bits\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_size(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_packed_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_size\n"); );
    // Body
    get_packed_size__Vfuncrtn = (this->__PVT__m_pack_iter 
                                 - this->__PVT__m_unpack_iter);
}

extern const VlWide<1024>/*32767:0*/ Vuart_example__ConstPool__CONST_hbc03216d_0;

void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_flush(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_flush\n"); );
    // Body
    this->__PVT__m_pack_iter = 0x00000040U;
    this->__PVT__m_unpack_iter = 0x00000040U;
    VL_ASSIGN_W(32768, this->__PVT__m_bits, Vuart_example__ConstPool__CONST_hbc03216d_0);
    this->__PVT__m_object_references.clear();
    this->__PVT__m_object_references.at(0U) = VlNull{};
    this->__PVT__m_factory = VlNull{};
    Vuart_example_uvm_pkg__03a__03auvm_policy::__VnoInFunc_flush(vlProcess, vlSymsp);
}

void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bits(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bits\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bytes(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_bytes\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_ints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_ints\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_longints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_get_packed_longints\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bits(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bits\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bytes(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_bytes\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_ints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_ints\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_longints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_set_packed_longints\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> __Vfunc_m_get_available_op__13__Vfuncout;
    CData/*0:0*/ __Vtask_user_hook_enabled__16__Vfuncout;
    __Vtask_user_hook_enabled__16__Vfuncout = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> __Vtask_pop_active_object__19__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> field_op;
    {
        ...
        VL_NULL_CHECK(field_op, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_packer.svh", 688)->__VnoInFunc_set(vlProcess, vlSymsp, 0x00000100U, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer>{this}, value);
        ...
        if (([&]() {
            ...
            VL_NULL_CHECK(value, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_packer.svh", 691)->__VnoInFunc_do_pack(vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer>{this});
        }
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_with_meta(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_with_meta\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__23__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_wrapper(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_object_wrapper\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_real(Vuart_example__Syms* __restrict vlSymsp, double value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_real\n"); );
    // Body
    this->__VnoInFunc_pack_field_int(vlSymsp, VL_CVT_Q_D(value), 0x00000040U);
}

void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_time(Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_time\n"); );
    // Body
    this->__VnoInFunc_pack_field_int(vlSymsp, value, 0x00000040U);
}

void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field(Vuart_example__Syms* __restrict vlSymsp, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field_int(Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_field_int\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bits(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bits\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bytes(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_bytes\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_ints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_ints\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_string(Vuart_example__Syms* __restrict vlSymsp, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_pack_string\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_null(Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ &is_null__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_null\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_object_wrapper(Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ &is_object_wrapper__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_is_object_wrapper\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__55__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__56__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__59__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__60__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> __Vfunc_m_get_available_op__71__Vfuncout;
    CData/*0:0*/ __Vtask_user_hook_enabled__74__Vfuncout;
    __Vtask_user_hook_enabled__74__Vfuncout = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> __Vtask_pop_active_object__77__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> field_op;
    {
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_with_meta(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_with_meta\n"); );
    // Locals
    QData/*63:0*/ __Vfunc_unpack_field_int__78__Vfuncout;
    __Vfunc_unpack_field_int__78__Vfuncout = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> __Vfunc_unpack_object_wrapper__79__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__80__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> __Vtask_create_object__81__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> __Vtask_create_component__82__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> unnamedblk67__DOT_____05Fwrapper;
    IData/*31:0*/ reference_id;
    reference_id = 0;
    {
        reference_id = (IData)(([&]() {
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_wrapper(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> &unpack_object_wrapper__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_object_wrapper\n"); );
    // Locals
    std::string __Vfunc_unpack_string__84__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_factory> __Vfunc_get__85__Vfuncout;
    CData/*0:0*/ __Vtask_is_type_name_registered__86__Vfuncout;
    __Vtask_is_type_name_registered__86__Vfuncout = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_find_wrapper_by_name__87__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    std::string type_name;
    {
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_real(Vuart_example__Syms* __restrict vlSymsp, double &unpack_real__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_real\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_time(Vuart_example__Syms* __restrict vlSymsp, QData/*63:0*/ &unpack_time__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_time\n"); );
    // Locals
...
extern const VlWide<128>/*4095:0*/ Vuart_example__ConstPool__CONST_h6e0f3f36_0;

void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ size, VlWide<128>/*4095:0*/ &unpack_field__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field\n"); );
    // Locals
    ...
    while ((__Vilp1 <= 0x0000007fU)) {
        unpack_field__Vfuncrtn[__Vilp1] = Vuart_example__ConstPool__CONST_h6e0f3f36_0[__Vilp1];
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field_int(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ size, QData/*63:0*/ &unpack_field_int__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_field_int\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bits(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bits\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bytes(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_bytes\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__108__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__109__Vfuncout;
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_ints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &value, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_ints\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_string(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string &unpack_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_unpack_string\n"); );
    // Locals
...
Vuart_example_uvm_pkg__03a__03auvm_packer::Vuart_example_uvm_pkg__03a__03auvm_packer(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_policy(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::new\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_packer::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_packer::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_packer::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_packer::to_string_middle\n"); );
    // Body
    std::string out;
