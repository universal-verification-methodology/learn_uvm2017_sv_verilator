...
void Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_uvm_seeding(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ &get_uvm_seeding__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_uvm_seeding\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_set_uvm_seeding(Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ enable) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_set_uvm_seeding\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_inst_count(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_inst_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_inst_count\n"); );
    // Body
    get_inst_count__Vfuncrtn = this->__PVT__m_inst_count;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "<unknown>"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_create(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_create\n"); );
    // Body
    create__Vfuncrtn = VlNull{};
}

Vuart_example_uvm_pkg__03a__03auvm_object::Vuart_example_uvm_pkg__03a__03auvm_object(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_void(vlProcess, vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::new\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_reseed(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_reseed\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_inst_id(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_inst_id__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_inst_id\n"); );
    // Body
    get_inst_id__Vfuncrtn = this->__PVT__m_inst_id;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_object_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__13__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__14__Vfuncout;
    std::string __Vfunc_get_type_name__15__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_find_wrapper_by_name__16__Vfuncout;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_name\n"); );
    // Body
    get_name__Vfuncrtn = this->__PVT__m_leaf_name;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_full_name\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_name(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_name\n"); );
    // Body
    this->__PVT__m_leaf_name = name;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_print(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_print\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> __Vfunc_get_default__19__Vfuncout;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_sprint(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> printer, std::string &sprint__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_sprint\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> __Vfunc_get_default__22__Vfuncout;
    ...
    VL_NULL_CHECK(printer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_object.svh", 968)->__VnoInFunc_print_object(vlProcess, vlSymsp, name, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object>{this}, 0x2eU);
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_convert2string\n"); );
    // Body
    convert2string__Vfuncrtn = ""s;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_local(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource_base> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_local\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> __Vfunc_m_get_available_op__31__Vfuncout;
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> unnamedblk12__DOT__op;
    if ((VlNull{} != rsrc)) {
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unsupported_set_local(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource_base> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unsupported_set_local\n"); );
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_clone(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_clone\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> __Vfunc_create__35__Vfuncout;
    ...
    std::string __Vtemp_1;
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> tmp;
    ...
    if ((VlNull{} == tmp)) {
        ...
        VL_NULL_CHECK(tmp, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_object.svh", 1125)->__VnoInFunc_copy(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object>{this}, VlNull{});
    }
    clone__Vfuncrtn = tmp;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_copy(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_copier> copier) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_copy\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_copier> __Vtask_get_default_copier__52__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_copier> m_copier;
    {
        if ((VlNull{} == rhs)) {
            if ((0U != ([&]() {
        ...
        VL_NULL_CHECK(m_copier, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_object.svh", 1152)->__VnoInFunc_copy_object(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object>{this}, rhs);
        __Vlabel0: ;
    }
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_copy\n"); );
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_compare(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_compare\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_comparer> __Vfunc_get_default__56__Vfuncout;
    ...
    VL_NULL_CHECK(comparer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_object.svh", 1172)->__VnoInFunc_compare_object(vlSymsp, 
                    ...
                    this->__VnoInFunc_get_name(vlSymsp, __Vfunc_get_name__60__Vfuncout);
                                                                                ...
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object>{this}, rhs, __Vtask_compare_object__59__Vfuncout);
    compare__Vfuncrtn = __Vtask_compare_object__59__Vfuncout;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_compare(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_compare\n"); );
    // Body
    do_compare__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc____05Fm_uvm_field_automation(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*27:0*/ what___05F, std::string str___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc____05Fm_uvm_field_automation\n"); );
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_print(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_print\n"); );
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_pack(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> &packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_pack\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vfunc_get_default__61__Vfuncout;
    ...
    VL_NULL_CHECK(packer, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_object.svh", 1213)->__VnoInFunc_pack_object(vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object>{this});
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &bitstream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &pack__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_pack__65__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_bytes(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &bytestream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &pack_bytes__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_bytes\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_pack__68__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_ints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &intstream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &pack_ints__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_ints\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_pack__71__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_longints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &longintstream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &pack_longints__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_longints\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_pack__74__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_pack(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_pack\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__78__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__79__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__82__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> __Vtask_get_root__83__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((VlNull{} == packer)) {
        if ((0U != ([&]() {
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_pre(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> &packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_pre\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vfunc_get_default__85__Vfuncout;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_post(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &m_unpack_post__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_post\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &bitstream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &unpack__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_unpack_pre__91__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_bytes(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &bytestream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &unpack_bytes__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_bytes\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_unpack_pre__94__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_ints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &intstream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &unpack_ints__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_ints\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_unpack_pre__97__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_longints(Vuart_example__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &longintstream, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &unpack_longints__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_longints\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __Vtask_m_unpack_pre__100__packer;
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_execute_op(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_field_op> op) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_execute_op\n"); );
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_unpack(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_record(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_record\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_record(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_record\n"); );
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_get_report_object(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_object> &m_get_report_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_get_report_object\n"); );
    // Body
    m_get_report_object__Vfuncrtn = VlNull{};
}

void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_object::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_object::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_object::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_object::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_leaf_name:" + VL_TO_STRING(__PVT__m_leaf_name);
    out += ", m_inst_id:" + VL_TO_STRING(__PVT__m_inst_id);
    out += ", "+ Vuart_example_uvm_pkg__03a__03auvm_void::to_string_middle();
    return (out);
}
