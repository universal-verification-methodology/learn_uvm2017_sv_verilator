...
void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_objection"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_get(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_create(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_objection> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> __Vfunc_get__3__Vfuncout;
...
void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_set_type_override(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_factory> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> __Vfunc_get__11__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_set_inst_override(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> __Vfunc_get__16__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_set_type_alias(Vuart_example__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> __Vfunc_get__19__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> unnamedblk2__DOT__rgtry;
...
void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> __Vfunc_get__22__Vfuncout;
    IData/*31:0*/ __Vfunc_get_core_state__23__Vfuncout;
    __Vfunc_get_core_state__23__Vfuncout = 0;
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> rgtry;
...
void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::__VnoInFunc_get_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::__VnoInFunc_get_type_name\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::__VnoInFunc_initialize(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_factory> __Vfunc_get__1__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__pi2> __Vfunc_get__2__Vfuncout;
    // Body
...
Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi19::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
