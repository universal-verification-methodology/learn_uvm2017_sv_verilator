...
void Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_domains(Vuart_example__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain>> &domains) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_domains\n"); );
    // Body
    domains = this->__PVT__m_domains;
}

void Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_schedule(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> &get_uvm_schedule__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_schedule\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain> __Vtask_get_uvm_domain__0__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_common_domain(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain> &get_common_domain__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_common_domain\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_build_phase> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_connect_phase> __Vfunc_get__5__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_end_of_elaboration_phase> __Vfunc_get__7__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_start_of_simulation_phase> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_run_phase> __Vfunc_get__11__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_extract_phase> __Vfunc_get__13__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_check_phase> __Vfunc_get__15__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_phase> __Vfunc_get__17__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_final_phase> __Vfunc_get__19__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__20__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_build_phase> __Vfunc_get__21__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__22__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_connect_phase> __Vfunc_get__23__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__24__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_end_of_elaboration_phase> __Vfunc_get__25__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__26__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_start_of_simulation_phase> __Vfunc_get__27__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__28__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_run_phase> __Vfunc_get__29__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__30__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_extract_phase> __Vfunc_get__31__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__32__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_check_phase> __Vfunc_get__33__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__34__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_phase> __Vfunc_get__35__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain> __Vfunc_get_uvm_domain__36__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> __Vtask_find__38__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_run_phase> __Vfunc_get__39__Vfuncout;
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain> domain;
    {
        ...
        domain = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_domain, vlProcess, vlSymsp, "common"s);
...
void Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_add_uvm_phases(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> schedule) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_add_uvm_phases\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pre_reset_phase> __Vfunc_get__41__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reset_phase> __Vfunc_get__43__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_post_reset_phase> __Vfunc_get__45__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pre_configure_phase> __Vfunc_get__47__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_configure_phase> __Vfunc_get__49__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_post_configure_phase> __Vfunc_get__51__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pre_main_phase> __Vfunc_get__53__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_main_phase> __Vfunc_get__55__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_post_main_phase> __Vfunc_get__57__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pre_shutdown_phase> __Vfunc_get__59__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_shutdown_phase> __Vfunc_get__61__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_post_shutdown_phase> __Vfunc_get__63__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_domain(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain> &get_uvm_domain__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_domain\n"); );
    // Body
    if ((VlNull{} == this->__PVT__m_uvm_domain)) {
        this->__PVT__m_uvm_domain = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_domain, vlProcess, vlSymsp, "uvm"s);
        this->__PVT__m_uvm_schedule = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_phase, vlProcess, vlSymsp, "uvm_sched"s, 3U, VlNull{});
...
void Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_jump_all(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_jump_all\n"); );
    // Locals
    VlAssocArray<std::string, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain>> __Vtask_get_domains__68__domains;
    // Body
    std::string unnamedblk2__DOT__idx;
    CData/*0:0*/ unnamedblk2__DOT__idx__Vfirst;
    unnamedblk2__DOT__idx__Vfirst = 0;
    VlAssocArray<std::string, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain>> domains;
...
Vuart_example_uvm_pkg__03a__03auvm_domain::Vuart_example_uvm_pkg__03a__03auvm_domain(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_phase(vlProcess, vlSymsp, name, 4U, VlNull{}) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::new\n"); );
    // Locals
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_domain__Vclpkg.__PVT__m_domains.at(name) 
        = VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain>{this};
}

void Vuart_example_uvm_pkg__03a__03auvm_domain::__VnoInFunc_jump(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::__VnoInFunc_jump\n"); );
    // Locals
    ...
    VlQueue<VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase>> phases;
    this->__VnoInFunc_m_get_transitive_children(vlSymsp, phases);
    phases = phases.find([&](IData/*31:0*/ item__DOT__index, 
                             VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_phase> item) -> 
                         CData/*31:0*/ {
...
void Vuart_example_uvm_pkg__03a__03auvm_domain::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_domain::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_domain::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_domain>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_domain::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_domain::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_domain::to_string_middle\n"); );
    // Body
    std::string out;
    out += Vuart_example_uvm_pkg__03a__03auvm_phase::to_string_middle();
    return (out);
}
