...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_get(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_create(Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_env> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_env> __Vfunc_create__2__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_override(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_inst_override(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_alias(Vuart_example__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_create_component(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_create_component\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_get_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi78> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi78> common;
...
void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_initialize(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi78> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi78> common;
...
Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72(Vuart_example__Syms* __restrict vlSymsp)
    : Vuart_example_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string_middle\n"); );
    // Body
    std::string out;
