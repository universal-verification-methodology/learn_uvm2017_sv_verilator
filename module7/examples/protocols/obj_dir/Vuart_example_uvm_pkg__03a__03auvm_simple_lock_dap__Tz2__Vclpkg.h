...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_  // guard
...
class Vuart_example_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2;
class Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2;


class Vuart_example__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz235> &get_type__Vfuncrtn);
};
...
class Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2 : public Vuart_example_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2 {
  public:
    ...
    void __VnoInFunc_lock(Vuart_example__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_unlock(Vuart_example__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp);
  public:
    Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2() {}
};
