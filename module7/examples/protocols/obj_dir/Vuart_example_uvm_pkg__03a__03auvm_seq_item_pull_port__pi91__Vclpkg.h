...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI91__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI91__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg);
...
class Vuart_example_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91 : public Vuart_example_uvm_pkg__03a__03auvm_port_base__Tz178 {
  public:
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ min_size, IData/*31:0*/ max_size);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91() {}
};
