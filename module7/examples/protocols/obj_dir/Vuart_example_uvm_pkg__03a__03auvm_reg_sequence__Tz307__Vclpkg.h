...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_REG_SEQUENCE__TZ307__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_REG_SEQUENCE__TZ307__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350> &get_type__Vfuncrtn);
};
...
class Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307 : public Vuart_example_uvm_pkg__03a__03auvm_sequence__Tz199_TBz199 {
  public:
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_reg_sequence__Tz307() {}
};
