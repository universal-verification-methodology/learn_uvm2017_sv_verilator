...
Vuart_example_uvm_pkg__03a__03auvm_factory_override::Vuart_example_uvm_pkg__03a__03auvm_factory_override(Vuart_example__Syms* __restrict vlSymsp, std::string full_inst_path, std::string orig_type_name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> orig_type, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> ovrd_type, std::string ovrd_type_name, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_factory_override::new\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_factory_override::__VnoInFunc_m_has_wildcard(Vuart_example__Syms* __restrict vlSymsp, std::string nm, CData/*0:0*/ &m_has_wildcard__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_factory_override::__VnoInFunc_m_has_wildcard\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_factory_override::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_factory_override::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_factory_override>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_factory_override::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_factory_override::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_factory_override::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_factory_override::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_factory_override::to_string_middle\n"); );
    // Body
    std::string out;
