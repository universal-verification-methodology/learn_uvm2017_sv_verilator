...
#ifndef VERILATED_VUART_EXAMPLE___024UNIT_H_
#define VERILATED_VUART_EXAMPLE___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example___024unit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example___024unit(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example___024unit();
    VL_UNCOPYABLE(Vuart_example___024unit);
