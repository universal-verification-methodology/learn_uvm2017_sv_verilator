...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg::__VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz235> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz235> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get_object_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz235> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz235__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_create(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2> tmp;
    tmp = ((""s == name) ? VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2, vlProcess, vlSymsp, "unnamed-uvm_simple_lock_dap#(T)"s)
            : VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::new\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_set(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_set\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_set(Vuart_example__Syms* __restrict vlSymsp, std::string value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_set\n"); );
    // Body
    if (this->__PVT__m_locked) {
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get(Vuart_example__Syms* __restrict vlSymsp, std::string &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get\n"); );
    // Body
    get__Vfuncrtn = this->__PVT__m_value;
}

void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_get(Vuart_example__Syms* __restrict vlSymsp, std::string &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_get\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_lock(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_lock\n"); );
    // Body
    this->__PVT__m_locked = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_unlock(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_unlock\n"); );
    // Body
    this->__PVT__m_locked = 0U;
}

void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_is_locked(Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_is_locked\n"); );
    // Body
    is_locked__Vfuncrtn = this->__PVT__m_locked;
}

void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_pack(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_pack\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_unpack(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_convert2string\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_print(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_print\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_locked = 0;
}

std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_locked:" + VL_TO_STRING(__PVT__m_locked);
    out += ", "+ Vuart_example_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2::to_string_middle();
    return (out);
}
