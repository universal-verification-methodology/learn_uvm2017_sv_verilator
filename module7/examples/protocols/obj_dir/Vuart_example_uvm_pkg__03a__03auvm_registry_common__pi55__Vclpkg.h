...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI55__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI55__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vuart_example__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55__Vclpkg);
    ...
    void __VnoInFunc_get(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55> &get__Vfuncrtn);
...
class Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55 : public virtual VlClass {
  public:
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55(Vuart_example__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vuart_example_uvm_pkg__03a__03auvm_registry_common__pi55() {}
};
