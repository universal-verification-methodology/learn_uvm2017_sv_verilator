...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ100__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ100__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> __PVT__m_tw_cb_q;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vuart_example__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100> &m_initialize__Vfuncrtn);
};
...
class Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100 : public Vuart_example_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz100() {}
};
