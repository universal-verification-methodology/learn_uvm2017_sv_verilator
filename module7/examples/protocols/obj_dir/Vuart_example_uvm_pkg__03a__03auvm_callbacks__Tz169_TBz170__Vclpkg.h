...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_CALLBACKS__TZ169_TBZ170__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_CALLBACKS__TZ169_TBZ170__VCLPKG_H_  // guard
...
class Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170;
...
class Vuart_example_uvm_pkg__03a__03auvm_typeid__Tz170;
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    std::string __PVT__m_cb_typename;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170> &get__Vfuncrtn);
    void __VnoInFunc_get_all(Vuart_example__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field_cbs>> &all_callbacks, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field> obj);
    void __VnoInFunc_get_first(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_prev__Vfuncrtn);
...
class Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170 : public Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz169 {
  public:
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_callbacks__Tz169_TBz170() {}
};
