...
void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor__Vclpkg::__VnoInFunc_get_inst(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor> &get_inst__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor__Vclpkg::__VnoInFunc_get_inst\n"); );
    // Body
    if ((VlNull{} == this->__PVT__m_inst)) {
        this->__PVT__m_inst = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor, vlProcess, vlSymsp, "uvm_cmdline_proc"s);
    }
    get_inst__Vfuncrtn = this->__PVT__m_inst;
}

void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_args(Vuart_example__Syms* __restrict vlSymsp, VlQueue<std::string> &args) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_args\n"); );
    // Body
    args = this->__PVT__m_argv;
}

void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_plusargs(Vuart_example__Syms* __restrict vlSymsp, VlQueue<std::string> &args) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_plusargs\n"); );
    // Body
    args = this->__PVT__m_plus_argv;
}

void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_uvm_args(Vuart_example__Syms* __restrict vlSymsp, VlQueue<std::string> &args) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_uvm_args\n"); );
    // Body
    args = this->__PVT__m_uvm_argv;
}

void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_arg_matches(Vuart_example__Syms* __restrict vlSymsp, std::string match, VlQueue<std::string> &args, IData/*31:0*/ &get_arg_matches__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_arg_matches\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_arg_value(Vuart_example__Syms* __restrict vlSymsp, std::string match, std::string &value, IData/*31:0*/ &get_arg_value__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_arg_value\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_arg_values(Vuart_example__Syms* __restrict vlSymsp, std::string match, VlQueue<std::string> &values, IData/*31:0*/ &get_arg_values__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_arg_values\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_tool_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_tool_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_tool_name\n"); );
    // Body
    get_tool_name__Vfuncrtn = "?"s;
}

void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_tool_version(Vuart_example__Syms* __restrict vlSymsp, std::string &get_tool_version__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_get_tool_version\n"); );
    // Body
    get_tool_version__Vfuncrtn = "?"s;
}

Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_report_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::new\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_m_convert_verb(Vuart_example__Syms* __restrict vlSymsp, std::string verb_str, IData/*31:0*/ &verb_enum, CData/*0:0*/ &m_convert_verb__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_m_convert_verb\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_cmdline_processor::to_string_middle\n"); );
    // Body
    std::string out;
