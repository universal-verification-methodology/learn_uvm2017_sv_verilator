...
void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callbacks_base> __Vtask_m_initialize__0__Vfuncout;
    // Body
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166, vlProcess, vlSymsp);
        this->__PVT__m_tw_cb_q = VL_NEW(Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48, vlProcess, vlSymsp, "typewide_queue"s);
    }
    m_initialize__Vfuncrtn = this->__PVT__m_t_inst;
}

void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_m_cb_find(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> q, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ &m_cb_find__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_m_cb_find\n"); );
    // Locals
    IData/*31:0*/ __Vtask_size__3__Vfuncout;
    __Vtask_size__3__Vfuncout = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> __Vtask_get__4__Vfuncout;
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_m_cb_find_name(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    IData/*31:0*/ __Vtask_size__5__Vfuncout;
    __Vtask_size__5__Vfuncout = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> __Vtask_get__6__Vfuncout;
    ...
    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_display(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_backdoor> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        std::string __Vtask_get_type_name__16__Vfuncout;
        IData/*31:0*/ __Vtask_size__17__Vfuncout;
        __Vtask_size__17__Vfuncout = 0;
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> __Vtask_get__18__Vfuncout;
        ...
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> __Vtask_get__25__Vfuncout;
        IData/*31:0*/ __Vtask_size__28__Vfuncout;
        __Vtask_size__28__Vfuncout = 0;
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> __Vtask_get__29__Vfuncout;
        ...
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> __Vtask_get__40__Vfuncout;
        IData/*31:0*/ __Vtask_size__43__Vfuncout;
        __Vtask_size__43__Vfuncout = 0;
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> __Vtask_get__44__Vfuncout;
        ...
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_backdoor> me;
        ...
        std::string blanks;
        blanks = "                             "s;
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> bobj;
        bobj = obj;
    ...
    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_am_i_a(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_am_i_a\n"); );
        // Body
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_reg_backdoor> this_type;
        {
            if ((VlNull{} == obj)) {
    ...
    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_get_tw_cb_q(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Locals
        CData/*0:0*/ __Vfunc_m_am_i_a__0__Vfuncout;
        __Vfunc_m_am_i_a__0__Vfuncout = 0;
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> __Vtask_m_get_tw_cb_q__1__Vfuncout;
        // Body
        IData/*31:0*/ unnamedblk1__DOT__i;
        unnamedblk1__DOT__i = 0;
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callbacks_base> unnamedblk1__DOT__unnamedblk2__DOT__dt;
        {
            if (([&]() {
                        this->__VnoInFunc_m_am_i_a(vlSymsp, obj, __Vfunc_m_am_i_a__0__Vfuncout);
                    }(), (IData)(__Vfunc_m_am_i_a__0__Vfuncout))) {
                unnamedblk1__DOT__i = 0U;
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Vuart_example_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    unnamedblk1__DOT__unnamedblk2__DOT__dt 
                        = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                        .at(Vuart_example_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk1__DOT__i));
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166>{this}))) {
                ...
                m_get_tw_cb_q__Vfuncrtn = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__PVT__m_tw_cb_q;
            } else {
    ...
    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_add_tw_cbs(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> __Vtask_get__8__Vfuncout;
        ...
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callbacks_base> cb_pair;
        ...
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> q;
        if ((0xffffffffU == ([&]() {
                        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__2__Vfuncout);
                    }(), __Vfunc_m_cb_find__2__Vfuncout))) {
            warned = (1U & ([&]() {
                        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__VnoInFunc_m_cb_find_name(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__PVT__m_tw_cb_q, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                ([&]() {
            ...
            if ((0U == ordering)) {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 256)
                        ->__VnoInFunc_push_back(vlSymsp, cb);
            } else {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 258)
        ...
        if ((0U != ([&]() {
            ...
            do {
                if (VL_CAST_DYNAMIC(obj, me)) {
                    ...
                    if ((0xffffffffU == ([&]() {
                                    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__11__Vfuncout);
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Vuart_example_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            cb_pair = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                .at(Vuart_example_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk5__DOT__i));
            if ((cb_pair != VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166>{this})) {
    ...
    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_delete_tw_cbs(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
        ...
        VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_queue__Tz48> __Vtask_get__22__Vfuncout;
        ...
        IData/*31:0*/ pos;
        pos = 0;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__PVT__m_tw_cb_q, cb, __Vfunc_m_cb_find__19__Vfuncout);
        pos = __Vfunc_m_cb_find__19__Vfuncout;
        if ((0xffffffffU != pos)) {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__PVT__m_tw_cb_q, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_callback.svh", 296)
        ...
        if ((0U != ([&]() {
            ...
            do {
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz166__Vclpkg.__VnoInFunc_m_cb_find(vlProcess, vlSymsp, q, cb, __Vfunc_m_cb_find__25__Vfuncout);
        ...
        while (VL_LTS_III(32, unnamedblk6__DOT__i, Vuart_example_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            cb_pair = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                .at(Vuart_example_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk6__DOT__i));
            if ((cb_pair != VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166>{this})) {
    ...
    Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp)
      : Vuart_example_uvm_pkg__03a__03auvm_callbacks_base(vlProcess, vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::new\n"); );
        // Body
        _ctor_var_reset(vlSymsp);
        ;
    }

    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::__VnoInFunc___Vbasic_randomize\n"); );
        // Body
        __Vbasic_randomize__Vfuncrtn = 1U;
    }

    void Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::_ctor_var_reset\n"); );
        // Body
        (void)vlSymsp;  // Prevent unused variable warning
    }

    std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vuart_example_uvm_pkg__03a__03auvm_typed_callbacks__Tz166::to_string_middle\n"); );
        // Body
        std::string out;
        out += Vuart_example_uvm_pkg__03a__03auvm_callbacks_base::to_string_middle();
        return (out);
    }
