...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_  // guard
...
class Vuart_example_uvm_pkg__03a__03auvm_component_name_check_visitor;
class Vuart_example_uvm_pkg__03a__03auvm_copier;
class Vuart_example_uvm_pkg__03a__03auvm_coreservice_t;
class Vuart_example_uvm_pkg__03a__03auvm_default_factory;
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg);
...
class Vuart_example_uvm_pkg__03a__03auvm_default_coreservice_t : public Vuart_example_uvm_pkg__03a__03auvm_coreservice_t {
  public:
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_factory> __PVT__factory;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_database> __PVT__tr_database;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_server> __PVT__report_server;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_visitor_> __PVT___visitor;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> __PVT__m_printer;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_packer> __PVT__m_packer;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_comparer> __PVT__m_comparer;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_resource_pool> __PVT__m_rp;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_copier> __PVT__m_copier;
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_default_coreservice_t(Vuart_example__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_default_coreservice_t() {}
};
