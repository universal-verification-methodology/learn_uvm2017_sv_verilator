...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI67__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI67__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vuart_example___024unit__03a__03aUartTxn;
class Vuart_example_uvm_pkg__03a__03auvm_analysis_export__Tz126;
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg);
...
class Vuart_example_uvm_pkg__03a__03auvm_sequencer_param_base__pi67 : public Vuart_example_uvm_pkg__03a__03auvm_sequencer_base {
  public:
    ...
    VlQueue<VlClassRef<Vuart_example___024unit__03a__03aUartTxn>> __PVT__m_last_req_buffer;
    VlQueue<VlClassRef<Vuart_example___024unit__03a__03aUartTxn>> __PVT__m_last_rsp_buffer;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_sequencer_analysis_fifo__pi75> __PVT__sqr_rsp_analysis_fifo;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_analysis_export__Tz126> __PVT__rsp_export;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz126> __PVT__m_req_fifo;
    ...
    void __VnoInFunc_get_current_item(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example___024unit__03a__03aUartTxn> &get_current_item__Vfuncrtn);
    ...
    void __VnoInFunc_last_req(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vuart_example___024unit__03a__03aUartTxn> &last_req__Vfuncrtn);
    void __VnoInFunc_last_rsp(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vuart_example___024unit__03a__03aUartTxn> &last_rsp__Vfuncrtn);
    void __VnoInFunc_m_last_req_push_front(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example___024unit__03a__03aUartTxn> item);
    void __VnoInFunc_m_last_rsp_push_front(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example___024unit__03a__03aUartTxn> item);
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_sequencer_param_base__pi67(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_sequencer_param_base__pi67() {}
};
