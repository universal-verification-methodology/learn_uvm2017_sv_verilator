...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ350__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ350__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vuart_example__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350__Vclpkg);
    ...
    void __VnoInFunc_get(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350> &get__Vfuncrtn);
...
class Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350 : public Vuart_example_uvm_pkg__03a__03auvm_object_wrapper {
  public:
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350(Vuart_example__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz350() {}
};
