...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_type_name(Vuart_example__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_default_report_server"s;
}

Vuart_example_uvm_pkg__03a__03auvm_default_report_server::Vuart_example_uvm_pkg__03a__03auvm_default_report_server(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name)
    : Vuart_example_uvm_pkg__03a__03auvm_report_server(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::new\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_do_print(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_do_print\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_max_quit_count(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_quit_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_max_quit_count\n"); );
    // Body
    get_max_quit_count__Vfuncrtn = this->__PVT__m_max_quit_count;
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_max_quit_count(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ count, CData/*0:0*/ overridable) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_max_quit_count\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_quit_count(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &get_quit_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_quit_count\n"); );
    // Body
    get_quit_count__Vfuncrtn = this->__PVT__m_quit_count;
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_quit_count(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ quit_count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_quit_count\n"); );
    // Body
    this->__PVT__m_quit_count = (VL_GTS_III(32, 0U, quit_count)
                                  ? 0U : quit_count);
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_quit_count(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_quit_count\n"); );
    // Body
    this->__PVT__m_quit_count = ((IData)(1U) + this->__PVT__m_quit_count);
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_quit_count(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_quit_count\n"); );
    // Body
    this->__PVT__m_quit_count = 0U;
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_is_quit_count_reached(Vuart_example__Syms* __restrict vlSymsp, CData/*0:0*/ &is_quit_count_reached__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_is_quit_count_reached\n"); );
    // Body
    is_quit_count_reached__Vfuncrtn = VL_GTES_III(32, this->__PVT__m_quit_count, this->__PVT__m_max_quit_count);
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_count(Vuart_example__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ &get_severity_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_count\n"); );
    // Body
    get_severity_count__Vfuncrtn = this->__PVT__m_severity_count
        .at((IData)(severity));
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_severity_count(Vuart_example__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_severity_count\n"); );
    // Body
    this->__PVT__m_severity_count.at((IData)(severity)) 
        = (VL_GTS_III(32, 0U, count) ? 0U : count);
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_severity_count(Vuart_example__Syms* __restrict vlSymsp, CData/*1:0*/ severity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_severity_count\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_severity_counts(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_severity_counts\n"); );
    // Body
    CData/*1:0*/ s;
    s = 0;
    s = 0U;
    {
        while (true) {
            ...
            s = Vuart_example___024unit::__Venumtab_enum_next9
                [s];
        }
        __Vlabel0: ;
    }
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_count(Vuart_example__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ &get_id_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_count\n"); );
    // Body
    {
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_id_count(Vuart_example__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_id_count\n"); );
    // Body
    this->__PVT__m_id_count.at(id) = (VL_GTS_III(32, 0U, count)
                                       ? 0U : count);
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_id_count(Vuart_example__Syms* __restrict vlSymsp, std::string id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_id_count\n"); );
    // Locals
    IData/*31:0*/ __Vtemp_1;
    // Body
    if (this->__PVT__m_id_count.exists(id)) {
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_message_database(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_database> database) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_message_database\n"); );
    // Body
    this->__PVT__m_message_db = database;
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_message_database(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_database> &get_message_database__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_message_database\n"); );
    // Body
    get_message_database__Vfuncrtn = this->__PVT__m_message_db;
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_set(Vuart_example__Syms* __restrict vlSymsp, VlQueue<CData/*1:0*/> &q) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_set\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_set(Vuart_example__Syms* __restrict vlSymsp, VlQueue<std::string> &q) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_set\n"); );
    // Body
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_f_display(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ file, std::string str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_f_display\n"); );
    // Body
    if ((0U == file)) {
        VL_WRITEF_NX("%@\n",0,-1,&(str));
    } else {
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_process_report_message(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_message> report_message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_process_report_message\n"); );
    // Locals
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_handler> __Vtask_get_report_handler__21__Vfuncout;
    VlClassRef<Vuart_example_std__03a__03aprocess> __Vfunc_self__22__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_server> __Vtask_get_report_server__27__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk3__DOT__cs;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_server> unnamedblk3__DOT__svr;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_handler> l_report_handler;
    ...
    VL_NULL_CHECK(report_message, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_report_server.svh", 569)->__VnoInFunc_set_report_server(vlSymsp, 
                                                                                VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_default_report_server>{this});
    if (report_ok) {
        report_ok = (1U & ([&]() {
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_execute_report_message(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_message> report_message, std::string composed_message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_execute_report_message\n"); );
    // Locals
    VlClassRef<Vuart_example_std__03a__03aprocess> __Vfunc_self__31__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_object> __Vtask_get_report_object__39__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_database> __Vfunc_get_message_database__46__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__47__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_database> __Vtask_get_default_tr_database__48__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_stream> __Vtask_open_stream__49__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_recorder> __Vtask_open_recorder__54__Vfuncout;
    ...
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_stream> unnamedblk4__DOT__stream;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_object> unnamedblk4__DOT__ro;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_handler> unnamedblk4__DOT__rh;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_tr_database> unnamedblk4__DOT__unnamedblk5__DOT__db;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__cs;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__unnamedblk7__DOT__recorder;
    IData/*31:0*/ unnamedblk8__DOT__tmp_file;
    unnamedblk8__DOT__tmp_file = 0;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_root> unnamedblk9__DOT__l_root;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk9__DOT__cs;
    VlClassRef<Vuart_example_std__03a__03aprocess> p;
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_report_message(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_message> report_message, std::string report_object_name, std::string &compose_report_message__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_report_message\n"); );
    // Locals
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_message_element_container> __Vtask_get_element_container__87__Vfuncout;
    IData/*31:0*/ __Vtask_size__88__Vfuncout;
    __Vtask_size__88__Vfuncout = 0;
    std::string __Vtask_get_message__89__Vfuncout;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> __Vfunc_get_default__90__Vfuncout;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_handler> __Vtask_get_report_handler__96__Vfuncout;
    std::string __Vtask_get_full_name__97__Vfuncout;
    std::string __Vtask_get_id__98__Vfuncout;
    // Body
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_printer> unnamedblk10__DOT__uvm_default_printer;
    ...
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_message_element_container> el_container;
    std::string prefix;
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_report_handler> l_report_handler;
    ...
    sev_string = Vuart_example___024unit::__Venumtab_enum_name9
        [l_severity];
    if ((""s != ([&]() {
    ...
    if (this->__PVT__show_verbosity) {
        if ((0U != (Vuart_example___024unit::__Venumtab_enum_valid13
            ...
            verbosity_str = Vuart_example___024unit::__Venumtab_enum_name13
                .at(l_verbosity);
        } else {
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_report_summarize(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_report_summarize\n"); );
    // Locals
    ...
    if ((0U != this->__PVT__m_severity_count.first(unnamedblk11__DOT__s))) {
        ...
        while (((IData)(unnamedblk11__DOT__s__Vfirst) 
            ...
            __Vtemp_1 = Vuart_example___024unit::__Venumtab_enum_name9
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vbasic_randomize(Vuart_example__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vuart_example_uvm_pkg__03a__03auvm_default_report_server::_ctor_var_reset(Vuart_example__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_default_report_server>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_default_report_server::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vuart_example_uvm_pkg__03a__03auvm_default_report_server::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuart_example_uvm_pkg__03a__03auvm_default_report_server::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vuart_example_uvm_pkg__03a__03auvm_report_server::to_string_middle();
    return (out);
}
