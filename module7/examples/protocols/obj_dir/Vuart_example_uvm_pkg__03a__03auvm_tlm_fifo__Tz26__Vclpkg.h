...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ26__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ26__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vuart_example_std__03a__03amailbox__Tz26;
class Vuart_example_uvm_pkg__03a__03auvm_analysis_port__Tz26;
class Vuart_example_uvm_pkg__03a__03auvm_component;
class Vuart_example_uvm_pkg__03a__03auvm_component_registry__Tz225;
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz26__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz26__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz26__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz26__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component_registry__Tz225> &get_type__Vfuncrtn);
...
class Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz26 : public Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz26 {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_size;
    IData/*31:0*/ __PVT__m_pending_blocked_gets;
    VlClassRef<Vuart_example_std__03a__03amailbox__Tz26> __PVT__m;
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz26(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ size);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_tlm_fifo__Tz26() {}
};
