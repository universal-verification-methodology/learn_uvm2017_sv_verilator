...
#ifndef VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ22__VCLPKG_H_
#define VERILATED_VUART_EXAMPLE_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ22__VCLPKG_H_  // guard
...
class Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz75;
...
class alignas(VL_CACHE_LINE_BYTES) Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vuart_example__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22__Vclpkg(Vuart_example__Syms* symsp, const char* v__name);
    ~Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22__Vclpkg();
    VL_UNCOPYABLE(Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(Vuart_example__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vuart_example__Syms* __restrict vlSymsp, VlClassRef<Vuart_example_uvm_pkg__03a__03auvm_object_registry__Tz75> &get_type__Vfuncrtn);
...
class Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22 : public Vuart_example_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_add(Vuart_example__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ item);
    ...
    virtual void __VnoInFunc_get(Vuart_example__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get__Vfuncrtn);
  ...
  public:
    Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22(VlProcessRef vlProcess, Vuart_example__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vuart_example_uvm_pkg__03a__03auvm_pool__Tz2_TBz22() {}
};
