...
VL_ATTR_COLD void Vuart_example_uvm_pkg___eval_static__TOP__uvm_pkg(Vuart_example_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vuart_example_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
...
VL_ATTR_COLD void Vuart_example_uvm_pkg___ctor_var_reset(Vuart_example_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vuart_example_uvm_pkg___ctor_var_reset\n"); );
    Vuart_example__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
