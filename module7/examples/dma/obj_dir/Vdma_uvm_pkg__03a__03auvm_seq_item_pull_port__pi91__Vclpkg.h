...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI91__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI91__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91__Vclpkg);
...
class Vdma_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91 : public Vdma_uvm_pkg__03a__03auvm_port_base__Tz178 {
  public:
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ min_size, IData/*31:0*/ max_size);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_seq_item_pull_port__pi91() {}
};
