...
class Vdma_uvm_pkg__03a__03a__VDynScope_55;
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_reg_backdoor__Vclpkg final {
  public:
...
class Vdma_uvm_pkg__03a__03auvm_reg_backdoor : public Vdma_uvm_pkg__03a__03auvm_object {
  ...
  private:
    VlCoroutine __VnoInFunc_start_update_thread____Vfork_1__0(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03a__VDynScope_55> __VDynScope_start_update_thread_0, VlClassRef<Vdma_std__03a__03aprocess> unnamedblk274__DOT____VforkParent);
  public:
