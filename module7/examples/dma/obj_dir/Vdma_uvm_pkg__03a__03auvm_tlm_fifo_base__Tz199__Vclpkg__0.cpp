...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199__Vclpkg::__VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi155> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi155> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_get_object_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi155> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_abstract_component_registry__pi155__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent)
    : Vdma_uvm_pkg__03a__03auvm_component(vlProcess, vlSymsp, name, parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
    this->__PVT__put_export = VL_NEW(Vdma_uvm_pkg__03a__03auvm_put_imp__Tz199_TBz278, vlProcess, vlSymsp, "put_export"s, 
                                     VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199>{this});
    this->__PVT__blocking_put_export = this->__PVT__put_export;
    this->__PVT__nonblocking_put_export = this->__PVT__put_export;
    this->__PVT__get_peek_export = VL_NEW(Vdma_uvm_pkg__03a__03auvm_get_peek_imp__Tz199_TBz278, vlProcess, vlSymsp, "get_peek_export"s, 
                                          VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199>{this});
    ...
    this->__PVT__put_ap = VL_NEW(Vdma_uvm_pkg__03a__03auvm_analysis_port__Tz199, vlProcess, vlSymsp, "put_ap"s, 
                                 VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199>{this});
    this->__PVT__get_ap = VL_NEW(Vdma_uvm_pkg__03a__03auvm_analysis_port__Tz199, vlProcess, vlSymsp, "get_ap"s, 
                                 VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199>{this});
}

void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_use_automatic_config(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &use_automatic_config__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_use_automatic_config\n"); );
    // Body
    use_automatic_config__Vfuncrtn = 0U;
}

void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_flush(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_flush\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_size(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_size\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_put(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_put\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_try_get(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> &t, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_try_get\n"); );
    // Body
    this->__VnoInFunc_uvm_report_error(vlProcess, vlSymsp, "try_get"s, "fifo channel function not implemented"s, 0U, ""s, 0U, ""s, 0U);
    try_get__Vfuncrtn = 0U;
}

void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_try_peek(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> &t, CData/*0:0*/ &try_peek__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_try_peek\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_can_put(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &can_put__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_can_put\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_can_get(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &can_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_can_get\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_can_peek(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &can_peek__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_can_peek\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_ok_to_put(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_event> &ok_to_put__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_ok_to_put\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_ok_to_get(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_event> &ok_to_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_ok_to_get\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_ok_to_peek(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_event> &ok_to_peek__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_ok_to_peek\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_is_empty(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_empty__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_is_empty\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_is_full(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_full__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_is_full\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_used(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &used__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::__VnoInFunc_used\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vdma_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz199::to_string_middle\n"); );
    // Body
    std::string out;
