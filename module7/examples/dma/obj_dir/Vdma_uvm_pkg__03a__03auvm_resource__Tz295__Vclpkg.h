...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_RESOURCE__TZ295__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_RESOURCE__TZ295__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_resource__Tz295__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz295> __PVT__my_type;

    // INTERNAL VARIABLES
    Vdma__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_resource__Tz295__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_resource__Tz295__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_resource__Tz295__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_highest_precedence(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz5> &q, VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz295> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz295> &get_type__Vfuncrtn);
...
class Vdma_uvm_pkg__03a__03auvm_resource__Tz295 : public Vdma_uvm_pkg__03a__03auvm_resource_base {
  public:
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_resource__Tz295(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_resource__Tz295() {}
};
