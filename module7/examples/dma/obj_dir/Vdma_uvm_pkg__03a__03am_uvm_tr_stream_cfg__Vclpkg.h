...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg__Vclpkg(Vdma__Syms* symsp, const char* v__name);
