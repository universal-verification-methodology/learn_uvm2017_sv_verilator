...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_type_name(Vdma__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_type_name\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_get(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__get__Vstatic__m_inst;
}

void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_create(Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vdma_uvm_pkg__03a__03auvm_env> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_env> __Vfunc_create__2__Vfuncout;
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_override(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_inst_override(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_alias(Vdma__Syms* __restrict vlSymsp, std::string alias_name, CData/*0:0*/ &set_type_alias__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_create_component(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_create_component\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_get_type_name(Vdma__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_get_type_name\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_registry_common__pi78> __Vfunc_get__11__Vfuncout;
    std::string __Vtask_get_type_name__12__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_registry_common__pi78> common;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi78__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__11__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_initialize(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::__VnoInFunc_initialize\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_registry_common__pi78> __Vfunc_get__13__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_registry_common__pi78> common;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi78__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__13__Vfuncout);
...
Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72(Vdma__Syms* __restrict vlSymsp)
    : Vdma_uvm_pkg__03a__03auvm_object_wrapper(vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::~Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_abstract_component_registry__pi72::to_string_middle\n"); );
    // Body
    std::string out;
