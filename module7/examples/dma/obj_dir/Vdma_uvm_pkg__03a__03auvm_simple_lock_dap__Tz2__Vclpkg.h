...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_  // guard
...
class Vdma_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2;
class Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2;


class Vdma__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz235> &get_type__Vfuncrtn);
};
...
class Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2 : public Vdma_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2 {
  public:
    ...
    void __VnoInFunc_lock(Vdma__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_unlock(Vdma__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vdma__Syms* __restrict vlSymsp);
  public:
    Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2() {}
};
