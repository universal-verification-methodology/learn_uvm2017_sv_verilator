...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30__Vclpkg::__VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz80> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz80> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz80__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_get_object_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz80> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz80__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_create(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30> tmp;
    tmp = ((""s == name) ? VL_NEW(Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30, vlProcess, vlSymsp, "unnamed-uvm_get_to_lock_dap#(T)"s)
            : VL_NEW(Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name)
    : Vdma_uvm_pkg__03a__03auvm_set_get_dap_base__Tz30(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::new\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_set(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_set\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_try_set(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_try_set\n"); );
    // Body
    if (this->__PVT__m_locked) {
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_get(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_get\n"); );
    // Body
    this->__PVT__m_locked = 1U;
    get__Vfuncrtn = this->__PVT__m_value;
}

void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_try_get(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_try_get\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_pack(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_pack\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_unpack(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_convert2string\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_print(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_do_print\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::_ctor_var_reset\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::~Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_locked:" + VL_TO_STRING(__PVT__m_locked);
    out += ", "+ Vdma_uvm_pkg__03a__03auvm_set_get_dap_base__Tz30::to_string_middle();
    return (out);
}
