...
VL_ATTR_COLD void Vdma_uvm_pkg___eval_static__TOP__uvm_pkg(Vdma_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdma_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
...
VL_ATTR_COLD void Vdma_uvm_pkg___ctor_var_reset(Vdma_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdma_uvm_pkg___ctor_var_reset\n"); );
    Vdma__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
