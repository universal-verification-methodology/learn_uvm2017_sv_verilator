...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_REG_HW_RESET_SEQ__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_REG_HW_RESET_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__pi168> &get_type__Vfuncrtn);
...
class Vdma_uvm_pkg__03a__03auvm_reg_hw_reset_seq : public Vdma_uvm_pkg__03a__03auvm_reg_sequence__Tz307 {
  public:
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_reg_hw_reset_seq(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_reg_hw_reset_seq() {}
};
