...
Vdma_uvm_pkg__03a__03auvm_policy::Vdma_uvm_pkg__03a__03auvm_policy(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name)
    : Vdma_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
}

void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_flush(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_flush\n"); );
    // Body
    this->__PVT__m_policy_stack.clear();
}

void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_extension_exists(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> ext_type, CData/*0:0*/ &extension_exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_extension_exists\n"); );
    // Body
    extension_exists__Vfuncrtn = (this->__PVT__m_extensions.exists(ext_type)
                                   ? 1U : 0U);
}

void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_set_extension(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &set_extension__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_set_extension\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__2__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__3__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__4__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_get_object_type__5__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> m_set_extension;
    if ((VlNull{} == extension)) {
...
void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_extension(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> ext_type, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &get_extension__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_extension\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extension(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> ext_type) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extension\n"); );
    // Body
    this->__PVT__m_extensions.erase(ext_type);
}

void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extensions(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_clear_extensions\n"); );
    // Body
    this->__PVT__m_extensions.clear();
}

void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_push_active_object(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_push_active_object\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_pop_active_object(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &pop_active_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_pop_active_object\n"); );
    // Locals
    ...
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> m_tmp;
...
void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &get_active_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object\n"); );
    // Body
    if ((0U != this->__PVT__m_policy_stack.size())) {
...
void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object_depth(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_active_object_depth__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_get_active_object_depth\n"); );
    // Body
    get_active_object_depth__Vfuncrtn = this->__PVT__m_policy_stack.size();
}

void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_policy::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vdma_uvm_pkg__03a__03auvm_policy::~Vdma_uvm_pkg__03a__03auvm_policy() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_policy>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_policy::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_policy::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_policy::to_string_middle\n"); );
    // Body
    std::string out;
