...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_event_base__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_event_base__Vclpkg(Vdma__Syms* symsp, const char* v__name);
