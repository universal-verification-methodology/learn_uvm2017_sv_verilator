...
void Vdma_uvm_pkg__03a__03auvm_tlm_extension_base::__VnoInFunc___Vbasic_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tlm_extension_base::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
