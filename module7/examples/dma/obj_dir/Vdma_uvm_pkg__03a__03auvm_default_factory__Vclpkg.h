...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_  // guard
...
class Vdma_uvm_pkg__03a__03auvm_factory_queue_class;
...
class Vdma__Syms;
struct Vdma_m_inst_typename_alias_t__struct__0 {
    Vdma_m_uvm_factory_type_pair_t__struct__0 __PVT__orig;
    std::string __PVT__alias_type_name;
    std::string __PVT__full_inst_path;

    bool operator==(const Vdma_m_inst_typename_alias_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vdma_m_inst_typename_alias_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_default_factory__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_default_factory__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_default_factory__Vclpkg);
...
class Vdma_uvm_pkg__03a__03auvm_default_factory : public Vdma_uvm_pkg__03a__03auvm_factory {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper>, CData/*0:0*/> __PVT__m_types;
    VlAssocArray<std::string, CData/*0:0*/> __PVT__m_lookup_strs;
    VlQueue<Vdma_m_inst_typename_alias_t__struct__0> __PVT__m_inst_aliases;
    ...
    VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper>> __PVT__m_type_names;
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_type_overrides;
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_inst_overrides;
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_override_info;
    ...
    void __VnoInFunc_m_debug_create(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string parent_inst_path, std::string name);
    void __VnoInFunc_m_debug_display(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> result, std::string full_inst_path);
    void __VnoInFunc_m_matches_inst_override(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory_override> __SYM__override, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, std::string full_inst_path, CData/*0:0*/ &m_matches_inst_override__Vfuncrtn);
    void __VnoInFunc_m_matches_type_override(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory_override> __SYM__override, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, std::string full_inst_path, CData/*0:0*/ match_original_type, CData/*0:0*/ resolve_null_type_by_inst, CData/*0:0*/ &m_matches_type_override__Vfuncrtn);
    void __VnoInFunc_m_matches_type_pair(Vdma__Syms* __restrict vlSymsp, Vdma_m_uvm_factory_type_pair_t__struct__0 match_type_pair, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string requested_type_name, CData/*0:0*/ &m_matches_type_pair__Vfuncrtn);
    void __VnoInFunc_m_resolve_type_name(Vdma__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> &m_resolve_type_name__Vfuncrtn);
    void __VnoInFunc_m_resolve_type_name_by_inst(Vdma__Syms* __restrict vlSymsp, std::string requested_type_name, std::string full_inst_path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> &m_resolve_type_name_by_inst__Vfuncrtn);
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_default_factory(Vdma__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_default_factory() {}
};
