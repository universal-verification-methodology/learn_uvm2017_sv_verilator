...
void Vdma_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_do_print(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer> printer) {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        ...
                        if ((0U != (Vdma___024unit::__Venumtab_enum_valid13
                            ...
                            __Vtemp_2 = Vdma___024unit::__Venumtab_enum_name9
                                [l_severity];
                            ...
                            unnamedblk2__DOT__unnamedblk4__DOT__unnamedblk5__DOT__l_str 
                                = VL_SFORMATF_N_NX("%0d",0,
                                                   32,
                                                   l_int) ;
                            __Vtemp_3 = Vdma___024unit::__Venumtab_enum_name9
                                [l_severity];
        ...
        if ((0U != this->__PVT__severity_id_actions.first(l_severity))) {
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        __Vtemp_5 = Vdma___024unit::__Venumtab_enum_name9
                            [l_severity];
    ...
    if ((0U != ([&]() {
        ...
        do {
            ...
            __Vtemp_6 = Vdma___024unit::__Venumtab_enum_name9
                [l_severity];
            ...
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        ...
                        __Vtemp_7 = Vdma___024unit::__Venumtab_enum_name9
                            [l_severity];
    ...
    if ((0U != this->__PVT__severity_file_handles.first(l_severity))) {
        ...
        do {
            __Vtemp_10 = Vdma___024unit::__Venumtab_enum_name9
                [l_severity];
        ...
        if ((0U != this->__PVT__severity_id_file_handles.first(l_severity))) {
            do {
                ...
                if ((0U != ([&]() {
                    ...
                    do {
                        __Vtemp_12 = Vdma___024unit::__Venumtab_enum_name9
                            [l_severity];
...
void Vdma_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vbasic_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
