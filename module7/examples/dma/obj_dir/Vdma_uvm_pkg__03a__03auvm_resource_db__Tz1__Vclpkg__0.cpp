...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_get_by_type(Vdma__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__0__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> __Vfunc_get_type__1__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> rsrc;
    std::string msg;
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_get_by_name(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> __Vfunc_get_type__13__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_default(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_default\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__22__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> r;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    r = VL_NEW(Vdma_uvm_pkg__03a__03auvm_resource__Tz1, vlProcess, vlSymsp, name);
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, Vdma_dma_if* val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> rsrc;
    rsrc = VL_NEW(Vdma_uvm_pkg__03a__03auvm_resource__Tz1, vlProcess, vlSymsp, name);
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_anonymous(Vdma__Syms* __restrict vlSymsp, std::string scope, Vdma_dma_if* val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> rsrc;
    rsrc = VL_NEW(Vdma_uvm_pkg__03a__03auvm_resource__Tz1, vlProcess, vlSymsp, ""s);
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_override(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, Vdma_dma_if* val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_override\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_override_type(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, Vdma_dma_if* val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_override_name(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, Vdma_dma_if* val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_read_by_name(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, Vdma_dma_if* &val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> __Vfunc_get_by_name__65__Vfuncout;
    CData/*0:0*/ __Vfunc_is_tracing__66__Vfuncout;
    __Vfunc_is_tracing__66__Vfuncout = 0;
    Vdma_dma_if* __Vtask_read__68__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_read_by_type(Vdma__Syms* __restrict vlSymsp, std::string scope, Vdma_dma_if* &val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> __Vfunc_get_by_type__69__Vfuncout;
    CData/*0:0*/ __Vfunc_is_tracing__70__Vfuncout;
    __Vfunc_is_tracing__70__Vfuncout = 0;
    Vdma_dma_if* __Vtask_read__72__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_write_by_name(Vdma__Syms* __restrict vlSymsp, std::string scope, std::string name, Vdma_dma_if* val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> __Vfunc_get_by_name__73__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_write_by_type(Vdma__Syms* __restrict vlSymsp, std::string scope, Vdma_dma_if* val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz1> __Vfunc_get_by_type__77__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_dump(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg::__VnoInFunc_dump\n"); );
    // Locals
...
Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_resource_db__Tz1::to_string_middle\n"); );
    // Body
    std::string out;
    return (out);
}
