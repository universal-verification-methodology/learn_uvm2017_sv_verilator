...
void Vdma_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ id, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_stream> &get_stream_from_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle\n"); );
    // Body
    {
        if ((0U == id)) {
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_tr_stream::Vdma_uvm_pkg__03a__03auvm_tr_stream(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name)
    : Vdma_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ;
    this->__PVT__m_cfg_dap = VL_NEW(Vdma_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18, vlProcess, vlSymsp, "cfg_dap"s);
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_database> &get_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__2__Vfuncout;
    __Vtask_try_get__2__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__2__value;
    ...
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    {
        if ((1U & (~ ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope(Vdma__Syms* __restrict vlSymsp, std::string &get_scope__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__12__Vfuncout;
    __Vtask_try_get__12__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__12__value;
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name(Vdma__Syms* __restrict vlSymsp, std::string &get_stream_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name\n"); );
    // Locals
    CData/*0:0*/ __Vtask_try_get__22__Vfuncout;
    __Vtask_try_get__22__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__22__value;
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close\n"); );
    // Locals
    ...
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder> unnamedblk1__DOT__idx;
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_database> __Vfunc_get_db__42__Vfuncout;
    VlClassRef<Vdma_std__03a__03aprocess> __Vfunc_self__43__Vfuncout;
    std::string __Vtask_get_randstate__44__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder> unnamedblk2__DOT__idx;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_stream>{this})) {
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__58__value;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__65__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__66__Vfuncout;
    std::string __Vtemp_1;
    std::string __Vtemp_2;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_database> m_db;
    {
        if ((VlNull{} == db)) {
            if ((0U != ([&]() {
        ...
        if (([&]() {
            ...
            m_cfg = VL_NEW(Vdma_uvm_pkg__03a__03am_uvm_tr_stream_cfg, vlSymsp);
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_closed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed\n"); );
    // Body
    is_closed__Vfuncrtn = this->__PVT__m_is_closed;
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder> &open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_is_open__71__Vfuncout;
    __Vfunc_is_open__71__Vfuncout = 0;
    VlClassRef<Vdma_std__03a__03aprocess> __Vfunc_self__72__Vfuncout;
    std::string __Vtask_get_randstate__73__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder> __Vfunc_do_open_recorder__74__Vfuncout;
    // Body
    ...
    if (([&]() {
        ...
        if ((VlNull{} != open_recorder__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_recorder__Vfuncrtn, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_tr_stream.svh", 285)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_stream>{this}, m_time, type_name);
        }
        if ((VlNull{} != unnamedblk3__DOT__p)) {
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders(Vdma__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder>> &q, CData/*0:0*/ &get_recorders__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders\n"); );
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__idx;
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle\n"); );
    // Locals
    ...
    if ((1U & ((~ ([&]() {
        ...
        if ((vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
             ...
             && (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream
                 .at(VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_stream>{this}) 
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_recorder> &do_open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder\n"); );
    // Body
    do_open_recorder__Vfuncrtn = VlNull{};
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_tr_stream::~Vdma_uvm_pkg__03a__03auvm_tr_stream() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_tr_stream>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_tr_stream::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_tr_stream::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tr_stream::to_string_middle\n"); );
    // Body
    std::string out;
