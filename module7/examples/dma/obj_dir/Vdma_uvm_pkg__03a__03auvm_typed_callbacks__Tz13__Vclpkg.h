...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ13__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ13__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__m_typename;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz48> __PVT__m_tw_cb_q;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13> __PVT__m_t_inst;

    // INTERNAL VARIABLES
    Vdma__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13> &m_initialize__Vfuncrtn);
};
...
class Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13 : public Vdma_uvm_pkg__03a__03auvm_callbacks_base {
  public:
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz13() {}
};
