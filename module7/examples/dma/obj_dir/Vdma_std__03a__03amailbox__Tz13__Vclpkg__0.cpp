...
Vdma_std__03a__03amailbox__Tz13::Vdma_std__03a__03amailbox__Tz13(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ bound) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_std__03a__03amailbox__Tz13::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    this->__PVT__m_bound = bound;
}

void Vdma_std__03a__03amailbox__Tz13::__VnoInFunc_num(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &num__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_std__03a__03amailbox__Tz13::__VnoInFunc_num\n"); );
    // Body
...
void Vdma_std__03a__03amailbox__Tz13::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_std__03a__03amailbox__Tz13::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vdma_std__03a__03amailbox__Tz13>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_std__03a__03amailbox__Tz13::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_std__03a__03amailbox__Tz13::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_std__03a__03amailbox__Tz13::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_std__03a__03amailbox__Tz13::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_std__03a__03amailbox__Tz13::to_string_middle\n"); );
    // Body
    std::string out;
