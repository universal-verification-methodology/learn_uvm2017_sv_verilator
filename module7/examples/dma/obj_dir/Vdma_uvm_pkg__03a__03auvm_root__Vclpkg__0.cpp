...
void Vdma_uvm_pkg__03a__03auvm_root__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_root__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__0__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__1__Vfuncout;
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_root__Vclpkg::__VnoInFunc_m_uvm_get_root(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> &m_uvm_get_root__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_root__Vclpkg::__VnoInFunc_m_uvm_get_root\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_domain> __Vfunc_get_uvm_domain__3__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> unnamedblk163__DOT__top;
    {
        if ((VlNull{} == this->__PVT__m_inst)) {
            unnamedblk163__DOT__top = VL_NEW(Vdma_uvm_pkg__03a__03auvm_root, vlProcess, vlSymsp);
...
void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_get_type_name(Vdma__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_root"s;
}

void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_die(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_die\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> __Vfunc_get_server__0__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> l_rs;
...
void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_get_finish_on_completion(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &get_finish_on_completion__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_get_finish_on_completion\n"); );
    // Body
    get_finish_on_completion__Vfuncrtn = this->__PVT__finish_on_completion;
}

void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_set_finish_on_completion(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ f) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_set_finish_on_completion\n"); );
    // Body
    this->__PVT__finish_on_completion = f;
}

void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_phase_started(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_phase_started\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> __Vfunc_get_server__6__Vfuncout;
    IData/*31:0*/ __Vtask_get_severity_count__7__Vfuncout;
    __Vtask_get_severity_count__7__Vfuncout = 0;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> unnamedblk1__DOT__srvr;
...
void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_end_of_elaboration_phase(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_end_of_elaboration_phase\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__11__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_visitor_> __Vtask_get_component_visitor__12__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_component_proxy> p;
    p = VL_NEW(Vdma_uvm_pkg__03a__03auvm_component_proxy, vlProcess, vlSymsp, "proxy"s);
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_top_down_visitor_adapter_> adapter;
    adapter = VL_NEW(Vdma_uvm_pkg__03a__03auvm_top_down_visitor_adapter_, vlProcess, vlSymsp, "adapter"s);
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_visitor_> v;
    ...
    VL_NULL_CHECK(adapter, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_root.svh", 340)->__VnoInFunc_accept(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_root>{this}, v, p, 1U);
}

Vdma_uvm_pkg__03a__03auvm_root::Vdma_uvm_pkg__03a__03auvm_root(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp)
    : Vdma_uvm_pkg__03a__03auvm_component(vlProcess, vlSymsp, "__top__"s, VlNull{}) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::new\n"); );
    // Locals
    IData/*31:0*/ __Vtask_uvm_report_enabled__17__Vfuncout;
    __Vtask_uvm_report_enabled__17__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_cmdline_processor> __Vfunc_get_inst__19__Vfuncout;
    // Body
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_handler> rh;
    {
        ;
        rh = VL_NEW(Vdma_uvm_pkg__03a__03auvm_report_handler, vlProcess, vlSymsp, "reporter"s);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_root__Vclpkg.__PVT__m_inst 
            = VlClassRef<Vdma_uvm_pkg__03a__03auvm_root>{this};
...
void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_report_header(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_report_header\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> __Vfunc_get_server__20__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_cmdline_processor> __Vfunc_get_inst__21__Vfuncout;
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_run_test(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string test_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_run_test\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory> __Vfunc_get__29__Vfuncout;
    IData/*31:0*/ __Vfunc_uvm_report_enabled__32__Vfuncout;
    __Vfunc_uvm_report_enabled__32__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> __Vtask_create_component_by_name__35__Vfuncout;
    std::string __Vtask_get_type_name__39__Vfuncout;
    std::string __Vtask_get_type_name__42__Vfuncout;
    VlClassRef<Vdma_std__03a__03aprocess> __Vfunc_self__43__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> __Vfunc_get_server__49__Vfuncout;
    CData/*0:0*/ __Vfunc_get_finish_on_completion__52__Vfuncout;
    __Vfunc_get_finish_on_completion__52__Vfuncout = 0;
    // Body
    VL_KEEP_THIS;
    VlClassRef<Vdma_std__03a__03aprocess> unnamedblk164__DOT____VforkParent;
    VlClassRef<Vdma_uvm_pkg__03a__03a__VDynScope_33> __VDynScope_run_test_0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> l_rs;
    ...
    std::string msg;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> uvm_test_top;
    __VDynScope_run_test_0 = VL_NEW(Vdma_uvm_pkg__03a__03a__VDynScope_33, vlSymsp);
    {
        ...
        if ((""s != test_name)) {
            if (Vdma_uvm_pkg__03a__03auvm_component::__PVT__m_children.exists("uvm_test_top"s)) {
        ...
        if ((0U == Vdma_uvm_pkg__03a__03auvm_component::__PVT__m_children.size())) {
        ...
        VlCoroutine Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_run_test____Vfork_1__0(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03a__VDynScope_33> __VDynScope_run_test_0, VlClassRef<Vdma_std__03a__03aprocess> unnamedblk164__DOT____VforkParent) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_run_test____Vfork_1__0\n"); );
            // Locals
            VlClassRef<Vdma_std__03a__03aprocess> __Vtask___VforkTask_0__44____VforkParent;
            VlClassRef<Vdma_uvm_pkg__03a__03a__VDynScope_33> __Vtask___VforkTask_0__44____VDynScope_run_test_0;
            IData/*31:0*/ __Vtask_status__45__Vfuncout;
            __Vtask_status__45__Vfuncout = 0;
            VlClassRef<Vdma_std__03a__03aprocess> __Vfunc_self__46__Vfuncout;
            // Body
            VL_KEEP_THIS;
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_find_all(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string comp_match, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_component>> &comps, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> comp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_find_all\n"); );
            // Body
            if ((VlNull{} == comp)) {
                comp = VlClassRef<Vdma_uvm_pkg__03a__03auvm_root>{this};
            }
            this->__VnoInFunc_m_find_all_recurse(vlProcess, vlSymsp, comp_match, comps, comp);
        }

        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_find(Vdma__Syms* __restrict vlSymsp, std::string comp_match, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> &find__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_find\n"); );
            // Locals
            std::string __Vtask_get_full_name__56__Vfuncout;
            std::string __Vtemp_1;
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
            VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_component>> comp_list;
            {
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_print_topology(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer> printer) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_print_topology\n"); );
            // Locals
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer> __Vfunc_get_default__59__Vfuncout;
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_set_timeout(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ timeout, CData/*0:0*/ overridable) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_set_timeout\n"); );
            // Body
            {
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_find_all_recurse(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string comp_match, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_component>> &comps, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> comp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_find_all_recurse\n"); );
            // Locals
            IData/*31:0*/ __Vtask_get_first_child__64__Vfuncout;
            __Vtask_get_first_child__64__Vfuncout = 0;
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> __Vtask_get_child__66__Vfuncout;
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_add_child(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> child, CData/*0:0*/ &m_add_child__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_add_child\n"); );
            // Locals
            CData/*0:0*/ __Vfunc_m_add_child__73__Vfuncout;
            __Vfunc_m_add_child__73__Vfuncout = 0;
            // Body
            Vdma_uvm_pkg__03a__03auvm_component::__VnoInFunc_m_add_child(vlProcess, vlSymsp, child, __Vfunc_m_add_child__73__Vfuncout);
            m_add_child__Vfuncrtn = __Vfunc_m_add_child__73__Vfuncout;
        }

        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_build_phase(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_phase> phase) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_build_phase\n"); );
            // Body
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_verbosity_settings(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_verbosity_settings\n"); );
            // Locals
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_timeout_settings(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_timeout_settings\n"); );
            // Locals
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_factory_settings(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_factory_settings\n"); );
            // Locals
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_inst_override(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string ovr) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_inst_override\n"); );
            // Locals
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__96__Vfuncout;
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__97__Vfuncout;
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_type_override(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string ovr) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_type_override\n"); );
            // Locals
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__102__Vfuncout;
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__103__Vfuncout;
        ...
        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_config(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string cfg, CData/*0:0*/ is_int) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_config\n"); );
            // Locals
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__109__Vfuncout;
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__110__Vfuncout;
            ...
            VL_ZERO_W(4096, v);
            VlQueue<std::string> split_val;
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> m_uvm_top;
            VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> cs;
            {
                    ...
                    this->__VnoInFunc_uvm_report_error(vlProcess, vlSymsp, "UVM_CMDLINE_PROC"s, 
                            ...
                            if ((2U == split_val.size())) {
                                this->__VnoInFunc_uvm_report_error(vlProcess, vlSymsp, "UVM_CMDLINE_PROC"s, 
                                        ...
                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_default_sequence(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string cfg) {
                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_process_default_sequence\n"); );
                                            // Locals
                                            ...
                                            VlClassRef<Vdma_uvm_pkg__03a__03auvm_factory> __Vtask_get_factory__121__Vfuncout;
                                            ...
                                            VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> __Vtask_find_wrapper_by_name__126__Vfuncout;
                                            std::string __Vtemp_1;
                                            // Body
                                            VlQueue<std::string> split_val;
                                            VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> cs;
                                            ...
                                            VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> w;
                                            {
                                                    ...
                                                    this->__VnoInFunc_uvm_report_error(vlProcess, vlSymsp, "UVM_CMDLINE_PROC"s, 
                                                            ...
                                                            if (
                                                                ...
                                                                this->__VnoInFunc_uvm_report_error(vlProcess, vlSymsp, "UVM_CMDLINE_PROC"s, 
                                                                        ...
                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_config_settings(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_config_settings\n"); );
                                                                            // Locals
                                                                        ...
                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_max_quit_settings(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_max_quit_settings\n"); );
                                                                            // Locals
                                                                            VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_server> __Vfunc_get_server__136__Vfuncout;
                                                                        ...
                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_dump_args(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_do_dump_args\n"); );
                                                                            // Locals
                                                                        ...
                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_check_verbosity(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_m_check_verbosity\n"); );
                                                                            // Body
                                                                        ...
                                                                        VlCoroutine Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_run_phase(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_phase> phase) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_run_phase\n"); );
                                                                            // Locals
                                                                        ...
                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_set_enable_print_topology(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ enable) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_set_enable_print_topology\n"); );
                                                                            // Body
                                                                            this->__PVT__enable_print_topology 
                                                                                = enable;
                                                                        }

                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_get_enable_print_topology(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &get_enable_print_topology__Vfuncrtn) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_get_enable_print_topology\n"); );
                                                                            // Body
                                                                            get_enable_print_topology__Vfuncrtn 
                                                                                = this->__PVT__enable_print_topology;
                                                                        }

                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc_randomize\n"); );
                                                                            // Locals
                                                                            ...
                                                                            randomize__Vfuncrtn 
                                                                                = 
                                                                                Vdma_uvm_pkg__03a__03auvm_void::__PVT__constraint.next(__Vm_rng);
                                                                            randomize__Vfuncrtn 
                                                                                = 
                                                                                (randomize__Vfuncrtn 
                                                                                & ([&]() {
                                                                        ...
                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc___Vsetup_constraints\n"); );
                                                                        }

                                                                        void Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::__VnoInFunc___VBasicRand\n"); );
                                                                            // Body
                                                                            __VBasicRand__Vfuncrtn = 1U;
                                                                        }

                                                                        void Vdma_uvm_pkg__03a__03auvm_root::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::_ctor_var_reset\n"); );
                                                                            // Body
                                                                        ...
                                                                        Vdma_uvm_pkg__03a__03auvm_root::~Vdma_uvm_pkg__03a__03auvm_root() {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::~\n"); );
                                                                        }

                                                                        std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_root>& obj) {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::VL_TO_STRING\n"); );
                                                                            // Body
                                                                            return (
                                                                                obj ? obj->to_string() : "null");
                                                                        }

                                                                        std::string Vdma_uvm_pkg__03a__03auvm_root::to_string() const {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::to_string\n"); );
                                                                            // Body
                                                                            return (
                                                                                "'{"s + to_string_middle() + "}");
                                                                        }

                                                                        std::string Vdma_uvm_pkg__03a__03auvm_root::to_string_middle() const {
                                                                            VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_root::to_string_middle\n"); );
                                                                            // Body
                                                                            std::string out;
