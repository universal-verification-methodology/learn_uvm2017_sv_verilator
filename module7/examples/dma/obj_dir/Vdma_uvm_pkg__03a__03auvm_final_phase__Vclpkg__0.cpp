...
void Vdma_uvm_pkg__03a__03auvm_final_phase::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_final_phase::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_final_phase::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_final_phase::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_final_phase::~Vdma_uvm_pkg__03a__03auvm_final_phase() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_final_phase::~\n"); );
}
