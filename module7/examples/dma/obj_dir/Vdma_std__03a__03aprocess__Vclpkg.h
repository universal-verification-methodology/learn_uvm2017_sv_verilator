...
class alignas(VL_CACHE_LINE_BYTES) Vdma_std__03a__03aprocess__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_std__03a__03aprocess__Vclpkg(Vdma__Syms* symsp, const char* v__name);
