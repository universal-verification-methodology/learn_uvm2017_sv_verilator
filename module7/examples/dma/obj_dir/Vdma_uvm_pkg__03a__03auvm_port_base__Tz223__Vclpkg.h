...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_PORT_BASE__TZ223__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_PORT_BASE__TZ223__VCLPKG_H_  // guard
...
class Vdma_uvm_pkg__03a__03auvm_port_component__Tz255;
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_port_base__Tz223__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_port_base__Tz223__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_port_base__Tz223__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_port_base__Tz223__Vclpkg);
...
class Vdma_uvm_pkg__03a__03auvm_port_base__Tz223 : public Vdma_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26 {
  public:
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223> __PVT__m_if;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_component__Tz255> __PVT__m_comp;
    VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223>> __PVT__m_provided_by;
    VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223>> __PVT__m_provided_to;
    VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223>> __PVT__m_imp_list;
    virtual void __VnoInFunc_connect(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223> provider);
    ...
    void __VnoInFunc_get_connected_to(Vdma__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223>> &list);
    ...
    void __VnoInFunc_get_if(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223> &get_if__Vfuncrtn);
    ...
    void __VnoInFunc_get_provided_to(Vdma__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223>> &list);
    ...
    void __VnoInFunc_m_add_list(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223> provider);
    void __VnoInFunc_m_check_relationship(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz223> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn);
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_port_base__Tz223(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ port_type, IData/*31:0*/ min_size, IData/*31:0*/ max_size);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_port_base__Tz223() {}
};
