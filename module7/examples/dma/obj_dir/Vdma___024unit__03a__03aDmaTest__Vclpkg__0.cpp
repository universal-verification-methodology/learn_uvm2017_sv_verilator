...
VlCoroutine Vdma___024unit__03a__03aDmaTest::__VnoInFunc_run_phase(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_phase> phase) {
    ...
    VL_NULL_CHECK(phase, "dma.sv", 95)->__VnoInFunc_raise_objection(vlProcess, vlSymsp, 
    ...
    co_await VL_NULL_CHECK(seq, "dma.sv", 97)->__VnoInFunc_start(vlProcess, vlSymsp, VL_NULL_CHECK(this->__PVT__env, "dma.sv", 97)
                                                                 ->__PVT__seqr, VlNull{}, 0xffffffffU, 1U);
    co_await vlSymsp->TOP.__VdlySched.delay(0x00000000001e8480ULL, 
                                            vlProcess, 
                                            "dma.sv", 
                                            98);
    VL_NULL_CHECK(phase, "dma.sv", 99)->__VnoInFunc_drop_objection(vlProcess, vlSymsp, 
                                                                   VlClassRef<Vdma___024unit__03a__03aDmaTest>{this}, ""s, 1U);
}
...
void Vdma___024unit__03a__03aDmaTest::__VnoInFunc___Vbasic_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vdma___024unit__03a__03aDmaTest::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
