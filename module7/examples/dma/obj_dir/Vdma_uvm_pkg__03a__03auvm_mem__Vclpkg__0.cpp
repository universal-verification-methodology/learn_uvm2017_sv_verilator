...
void Vdma_uvm_pkg__03a__03auvm_mem__Vclpkg::__VnoInFunc_get_max_size(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_mem__Vclpkg::__VnoInFunc_get_max_size\n"); );
    // Body
    get_max_size__Vfuncrtn = this->__PVT__m_max_size;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_write(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_write\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_write(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_write\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_read(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_read\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_read(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_read\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_sample(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ offset, CData/*0:0*/ is_read, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_sample\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_XsampleX(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ addr, CData/*0:0*/ is_read, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_XsampleX\n"); );
    // Body
    this->__VnoInFunc_sample(vlSymsp, addr, (IData)(is_read), map);
}

Vdma_uvm_pkg__03a__03auvm_mem::Vdma_uvm_pkg__03a__03auvm_mem(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ size, IData/*31:0*/ n_bits, std::string access, IData/*31:0*/ has_coverage)
    : Vdma_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::new\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_configure(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> parent, std::string hdl_path) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_configure\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem_mam_cfg> unnamedblk427__DOT__cfg;
    if ((VlNull{} == parent)) {
        if ((0U != ([&]() {
    ...
    unnamedblk427__DOT__cfg = VL_NEW(Vdma_uvm_pkg__03a__03auvm_mem_mam_cfg, vlSymsp);
    ...
    this->__PVT__mam = VL_NEW(Vdma_uvm_pkg__03a__03auvm_mem_mam, vlSymsp, 
                              VL_CVT_PACK_STR_NN(([&]() {
                ...
                }())), unnamedblk427__DOT__cfg, VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this});
    VL_NULL_CHECK(this->__PVT__m_parent, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 581)->__VnoInFunc_add_mem(vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this});
    if ((""s != hdl_path)) {
        this->__VnoInFunc_add_hdl_path_slice(vlSymsp, hdl_path, 0xffffffffU, 0xffffffffU, 0U, "RTL"s);
    }
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_offset(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ offset, CData/*0:0*/ unmapped) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_offset\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__32__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__33__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__37__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__40__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> orig_map;
    {
        ...
        VL_NULL_CHECK(map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 606)->__VnoInFunc_m_set_mem_offset(vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, offset, (IData)(unmapped));
        __Vlabel0: ;
    }
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_map(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_map\n"); );
    // Body
    this->__PVT__m_maps.at(map) = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xlock_modelX(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xlock_modelX\n"); );
    // Body
    this->__PVT__m_locked = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_name\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_block(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> &get_block__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_block\n"); );
    // Body
    get_block__Vfuncrtn = this->__PVT__m_parent;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_maps(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_maps__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_maps\n"); );
    // Body
    get_n_maps__Vfuncrtn = this->__PVT__m_maps.size();
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_maps(Vdma__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map>> &maps) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_maps\n"); );
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk428__DOT__map;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_is_in_map(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, CData/*0:0*/ &is_in_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_is_in_map\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_parent_map__45__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_parent_map__46__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk429__DOT__l;
    CData/*0:0*/ unnamedblk429__DOT__l__Vfirst;
    unnamedblk429__DOT__l__Vfirst = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk429__DOT__unnamedblk430__DOT__local_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk429__DOT__unnamedblk430__DOT__parent_map;
    {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_local_map(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> &get_local_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_local_map\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_default_map__47__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_parent_map__48__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_parent_map__49__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__51__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__52__Vfuncout;
    ...
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk431__DOT__l;
    CData/*0:0*/ unnamedblk431__DOT__l__Vfirst;
    unnamedblk431__DOT__l__Vfirst = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk431__DOT__unnamedblk432__DOT__local_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk431__DOT__unnamedblk432__DOT__parent_map;
    {
        if ((VlNull{} == map)) {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_default_map(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_default_map\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> __Vtask_get_parent__69__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_default_map__70__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__71__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__l;
    CData/*0:0*/ unnamedblk433__DOT__l__Vfirst;
    unnamedblk433__DOT__l__Vfirst = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__unnamedblk434__DOT__map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> unnamedblk433__DOT__unnamedblk434__DOT__blk;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__unnamedblk434__DOT__default_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__unnamedblk434__DOT__unnamedblk435__DOT__local_map;
    {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_access(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_access\n"); );
    // Locals
    IData/*31:0*/ __Vfunc_get_n_maps__72__Vfuncout;
    __Vfunc_get_n_maps__72__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__73__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__95__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__96__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__100__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__101__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__115__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__116__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__119__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__120__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__125__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__126__Vfuncout;
    // Body
    {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_rights(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_rights__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_rights\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__128__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_mem_map_info__129__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> info;
    {
        ...
        VL_NULL_CHECK(map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 793)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, 1U, __Vtask_get_mem_map_info__129__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_offset(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_offset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_offset\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__130__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_mem_map_info__131__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> orig_map;
    {
        ...
        VL_NULL_CHECK(map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 812)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, 1U, __Vtask_get_mem_map_info__131__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_registers(Vdma__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg>> &regs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_registers\n"); );
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> unnamedblk436__DOT__vreg;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_fields(Vdma__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg_field>> &fields) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_fields\n"); );
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> unnamedblk437__DOT__l;
    CData/*0:0*/ unnamedblk437__DOT__l__Vfirst;
    unnamedblk437__DOT__l__Vfirst = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> unnamedblk437__DOT__unnamedblk438__DOT__vreg;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vfield_by_name(Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg_field> &get_vfield_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vfield_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__147__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__148__Vfuncout;
    ...
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg_field>> vfields;
    {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_name(Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_name\n"); );
    // Locals
    ...
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> unnamedblk440__DOT__l;
    CData/*0:0*/ unnamedblk440__DOT__l__Vfirst;
    unnamedblk440__DOT__l__Vfirst = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> unnamedblk440__DOT__unnamedblk441__DOT__vreg;
    {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_offset(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_offset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_offset\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__166__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__167__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__170__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__171__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0U != ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_addresses(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlQueue<QData/*63:0*/> &addr, IData/*31:0*/ &get_addresses__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_addresses\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__173__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_mem_map_info__174__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__183__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__184__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> orig_map;
    {
        ...
        VL_NULL_CHECK(map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 908)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, 1U, __Vtask_get_mem_map_info__174__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_address(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_address\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_size(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ &get_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_size\n"); );
    // Body
    get_size__Vfuncrtn = this->__PVT__m_size;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bits(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bits__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bits\n"); );
    // Body
    get_n_bits__Vfuncrtn = this->__PVT__m_n_bits;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bytes(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bytes__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bytes\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_build_coverage(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ models, IData/*31:0*/ &build_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_build_coverage\n"); );
    // Locals
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz163__Vclpkg.__VnoInFunc_read_by_name(vlSymsp, 
                        ...
                        this->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __Vfunc_get_full_name__189__Vfuncout);
                                                                                ...
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, __Vtask_read_by_name__188__Vfuncout);
    build_coverage__Vfuncrtn = __Vtask_read_by_name__188__val;
    build_coverage__Vfuncrtn = (build_coverage__Vfuncrtn 
                                & models);
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_coverage(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ models) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_coverage\n"); );
    // Body
    this->__PVT__m_has_cover = (this->__PVT__m_has_cover 
                                | models);
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_coverage(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ models, CData/*0:0*/ &has_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_coverage\n"); );
    // Body
    has_coverage__Vfuncrtn = ((this->__PVT__m_has_cover 
                               & models) == models);
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_coverage(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, IData/*31:0*/ &set_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_coverage\n"); );
    // Body
    {
        if ((0U == is_on)) {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_coverage(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, CData/*0:0*/ &get_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_coverage\n"); );
    // Locals
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_read(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_read\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__194__Vfuncout;
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_write(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, VlQueue<QData/*63:0*/> value, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_write\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__197__Vfuncout;
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_read(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, VlQueue<QData/*63:0*/> &value, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_read\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__200__Vfuncout;
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_write(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_write\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_Xcheck_accessX__204__Vfuncout;
    __Vfunc_Xcheck_accessX__204__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__204__map_info;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__206__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__208__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__209__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequencer_base> __Vtask_get_sequencer__210__Vfuncout;
    std::string __Vfunc_get_access__215__Vfuncout;
    std::string __Vfunc_get_access__216__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vfunc_get_backdoor__217__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__221__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__223__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vfunc_get_backdoor__229__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__231__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__232__Vfuncout;
    ...
    // Body
    VL_KEEP_THIS;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk443__DOT__cb;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk444__DOT__system_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_frontdoor> unnamedblk444__DOT__unnamedblk445__DOT__fd;
    QData/*63:0*/ unnamedblk444__DOT__unnamedblk446__DOT__idx;
    unnamedblk444__DOT__unnamedblk446__DOT__idx = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk447__DOT__bkdr;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk448__DOT__cb;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback_iter__pi85> cbs;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> map_info;
    {
        cbs = VL_NEW(Vdma_uvm_pkg__03a__03auvm_callback_iter__pi85, vlSymsp, 
                     VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this});
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_read(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_read\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_Xcheck_accessX__240__Vfuncout;
    __Vfunc_Xcheck_accessX__240__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__240__map_info;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__242__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__244__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__245__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequencer_base> __Vtask_get_sequencer__246__Vfuncout;
    std::string __Vfunc_get_access__251__Vfuncout;
    std::string __Vfunc_get_access__252__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vfunc_get_backdoor__253__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__257__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__259__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vfunc_get_backdoor__265__Vfuncout;
    ...
    // Body
    VL_KEEP_THIS;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk451__DOT__cb;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk452__DOT__system_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_frontdoor> unnamedblk452__DOT__unnamedblk453__DOT__fd;
    QData/*63:0*/ unnamedblk452__DOT__unnamedblk454__DOT__idx;
    unnamedblk452__DOT__unnamedblk454__DOT__idx = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk455__DOT__bkdr;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk456__DOT__cb;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xcheck_accessX(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> &map_info, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xcheck_accessX\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__282__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__283__Vfuncout;
    IData/*31:0*/ __Vtask_get_default_door__285__Vfuncout;
    __Vtask_get_default_door__285__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vfunc_get_backdoor__286__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__294__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__295__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_default_map__297__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_default_map__298__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_backdoor__299__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__300__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_mem_map_info__312__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__314__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__315__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__320__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__321__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__326__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__327__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__336__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__337__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__340__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__341__Vfuncout;
    // Body
    {
        ...
        if ((1U != VL_NULL_CHECK(rw, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 1413)
            ...
            VL_NULL_CHECK(VL_NULL_CHECK(rw, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 1425)
                          ->__PVT__local_map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 1425)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, 1U, __Vtask_get_mem_map_info__312__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_poke(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ value, std::string kind, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_poke\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vfunc_get_backdoor__343__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__354__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__359__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__360__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_peek(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ &value, std::string kind, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_peek\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vfunc_get_backdoor__367__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__378__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__388__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__389__Vfuncout;
    std::string __Vtemp_1;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> bkdr;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_frontdoor(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_frontdoor> ftdr, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_frontdoor\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__391__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__393__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__394__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__399__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__400__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_mem_map_info__402__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> map_info;
    {
        ...
        VL_NULL_CHECK(map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 1587)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, 1U, __Vtask_get_mem_map_info__402__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_frontdoor(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_frontdoor> &get_frontdoor__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_frontdoor\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_get_local_map__403__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_mem_map_info__414__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> map_info;
    {
        ...
        VL_NULL_CHECK(map, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 1606)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>{this}, 1U, __Vtask_get_mem_map_info__414__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_backdoor(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> bkdr, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_backdoor\n"); );
    // Body
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_backdoor(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ inherited, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> &get_backdoor__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_backdoor\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> __Vfunc_get_parent__415__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__416__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> __Vtask_get_parent__417__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> unnamedblk459__DOT__blk;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk459__DOT__bkdr;
    if (inherited) {
...
extern const VlWide<32>/*1023:0*/ Vdma__ConstPool__CONST_hd6b7ba52_0;
extern const VlWide<32>/*1023:0*/ Vdma__ConstPool__CONST_h2ae7f32a_0;

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read_func(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw, IData/*31:0*/ &backdoor_read_func__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read_func\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> __Vfunc_uvm_hdl_concat2string__437__concat;
    ...
    Vdma_uvm_hdl_path_slice__struct__0 __Vfunc_uvm_hdl_concat2string__437__unnamedblk266__DOT__unnamedblk267__DOT__slice;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> __Vfunc_uvm_hdl_concat2string__438__concat;
    ...
    Vdma_uvm_hdl_path_slice__struct__0 __Vfunc_uvm_hdl_concat2string__438__unnamedblk266__DOT__unnamedblk267__DOT__slice;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk460__DOT__unnamedblk461__DOT__unnamedblk462__DOT__unnamedblk463__DOT__hdl_concat;
    ...
    ok = 0;
    {
        ...
        while (VL_LTS_III(32, unnamedblk460__DOT__mem_idx, VL_NULL_CHECK(rw, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_mem.svh", 1658)
            ...
            while (VL_LTS_III(32, unnamedblk460__DOT__unnamedblk461__DOT__unnamedblk462__DOT__i, paths.size())) {
                ...
                val[0U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0U];
                val[1U] = Vdma__ConstPool__CONST_hd6b7ba52_0[1U];
                val[2U] = Vdma__ConstPool__CONST_hd6b7ba52_0[2U];
                val[3U] = Vdma__ConstPool__CONST_hd6b7ba52_0[3U];
                val[4U] = Vdma__ConstPool__CONST_hd6b7ba52_0[4U];
                val[5U] = Vdma__ConstPool__CONST_hd6b7ba52_0[5U];
                val[6U] = Vdma__ConstPool__CONST_hd6b7ba52_0[6U];
                val[7U] = Vdma__ConstPool__CONST_hd6b7ba52_0[7U];
                val[8U] = Vdma__ConstPool__CONST_hd6b7ba52_0[8U];
                val[9U] = Vdma__ConstPool__CONST_hd6b7ba52_0[9U];
                val[0x0000000aU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000000aU];
                val[0x0000000bU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000000bU];
                val[0x0000000cU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000000cU];
                val[0x0000000dU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000000dU];
                val[0x0000000eU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000000eU];
                val[0x0000000fU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000000fU];
                val[0x00000010U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000010U];
                val[0x00000011U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000011U];
                val[0x00000012U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000012U];
                val[0x00000013U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000013U];
                val[0x00000014U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000014U];
                val[0x00000015U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000015U];
                val[0x00000016U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000016U];
                val[0x00000017U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000017U];
                val[0x00000018U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000018U];
                val[0x00000019U] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x00000019U];
                val[0x0000001aU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000001aU];
                val[0x0000001bU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000001bU];
                val[0x0000001cU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000001cU];
                val[0x0000001dU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000001dU];
                val[0x0000001eU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000001eU];
                val[0x0000001fU] = Vdma__ConstPool__CONST_hd6b7ba52_0[0x0000001fU];
                ...
                VL_SHIFTL_WWI(1024,1024,32, __Vtemp_2, Vdma__ConstPool__CONST_h2ae7f32a_0, this->__PVT__m_n_bits);
                VL_SUB_W(32, __Vtemp_3, __Vtemp_2, Vdma__ConstPool__CONST_h2ae7f32a_0);
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_write(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_write\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__445__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__446__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__449__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__450__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk467__DOT__unnamedblk468__DOT__unnamedblk469__DOT__unnamedblk470__DOT__hdl_concat;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clear_hdl_path(Vdma__Syms* __restrict vlSymsp, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clear_hdl_path\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__460__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__461__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path(Vdma__Syms* __restrict vlSymsp, VlQueue<Vdma_uvm_hdl_path_slice__struct__0> slices, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz182> __Vtask_get__468__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path_slice(Vdma__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ offset, IData/*31:0*/ size, CData/*0:0*/ first, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path_slice\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz182> __Vtask_get__472__Vfuncout;
    IData/*31:0*/ __Vtask_size__473__Vfuncout;
    __Vtask_size__473__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> __Vtask_get__476__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_hdl_path(Vdma__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &has_hdl_path__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_hdl_path\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path(Vdma__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat>> &paths, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz182> __Vtask_get__491__Vfuncout;
    IData/*31:0*/ __Vtask_size__492__Vfuncout;
    __Vtask_size__492__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> __Vtask_get__493__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    IData/*31:0*/ unnamedblk473__DOT__i;
    unnamedblk473__DOT__i = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk473__DOT__unnamedblk474__DOT__t;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path_kinds(Vdma__Syms* __restrict vlSymsp, VlQueue<std::string> &kinds) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path_kinds\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat>> &paths, std::string kind, std::string separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_hdl_path\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__499__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__500__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz182> __Vtask_get__506__Vfuncout;
    IData/*31:0*/ __Vtask_size__508__Vfuncout;
    __Vtask_size__508__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> __Vtask_get__509__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz182> unnamedblk475__DOT__hdl_paths;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk475__DOT__unnamedblk476__DOT__unnamedblk477__DOT__hdl_concat;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk475__DOT__unnamedblk476__DOT__unnamedblk477__DOT__unnamedblk478__DOT__unnamedblk479__DOT__t;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_parent(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_parent\n"); );
    // Body
    this->__PVT__m_parent = parent;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_parent(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_parent\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> __Vfunc_get_block__513__Vfuncout;
    // Body
    this->__VnoInFunc_get_block(vlSymsp, __Vfunc_get_block__513__Vfuncout);
    get_parent__Vfuncrtn = __Vfunc_get_block__513__Vfuncout;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_convert2string\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_parent_map__517__Vfuncout;
    ...
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk481__DOT__map;
    CData/*0:0*/ unnamedblk481__DOT__map__Vfirst;
    unnamedblk481__DOT__map__Vfirst = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk481__DOT__unnamedblk482__DOT__parent_map;
    IData/*31:0*/ unnamedblk481__DOT__unnamedblk482__DOT__offset;
    unnamedblk481__DOT__unnamedblk482__DOT__offset = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk481__DOT__unnamedblk482__DOT__unnamedblk483__DOT__this_map;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_print(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_print\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clone(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clone\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__531__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__532__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_compare(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vdma_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_compare\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__545__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__546__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0U != ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_pack(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_pack\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__549__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__550__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__553__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__554__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0U != ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_unpack(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_unpack\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__561__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__562__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0U != ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xadd_vregX(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> vreg) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xadd_vregX\n"); );
    // Body
    this->__PVT__m_vregs.at(vreg) = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xdelete_vregX(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_vreg> vreg) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xdelete_vregX\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc___Vbasic_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
    __Vbasic_randomize__Vfuncrtn = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_mem::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::_ctor_var_reset\n"); );
    // Body
...
std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_mem::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_mem::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_mem::to_string_middle\n"); );
    // Body
    std::string out;
