...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ160__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ160__VCLPKG_H_  // guard
...
class Vdma_uvm_pkg__03a__03auvm_object_registry__Tz217;
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160> __PVT__m_global_pool;

    // INTERNAL VARIABLES
    Vdma__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz217> &get_type__Vfuncrtn);
...
class Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160 : public Vdma_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_barrier>> __PVT__pool;
    virtual void __VnoInFunc___Vbasic_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {}
    virtual void __VnoInFunc_add(Vdma__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vdma_uvm_pkg__03a__03auvm_barrier> item);
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz160() {}
};
