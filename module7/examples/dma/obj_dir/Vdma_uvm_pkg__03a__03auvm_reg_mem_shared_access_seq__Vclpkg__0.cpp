...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq> __Vfunc_create__17__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem_shared_access_seq> __Vfunc_create__18__Vfuncout;
    // Body
    VL_KEEP_THIS;
    {
        ...
        VL_NULL_CHECK(Vdma_uvm_pkg__03a__03auvm_reg_sequence__Tz307::__PVT__model, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_shared_access_seq.svh", 407)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc_do_block(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> blk) {
    ...
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz30> __Vfunc_get_by_name__22__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequencer_base> __Vfunc_get_sequencer__38__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz30> __Vfunc_get_by_name__40__Vfuncout;
    std::string __Vtask_get_full_name__41__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz30> __Vfunc_get_by_name__42__Vfuncout;
    std::string __Vtask_get_full_name__43__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_resource__Tz30> __Vfunc_get_by_name__44__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequencer_base> __Vfunc_get_sequencer__49__Vfuncout;
    // Body
    VL_KEEP_THIS;
    ...
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_mem>> mems;
    {
        ...
        this->__VnoInFunc_reset_blk(vlSymsp, Vdma_uvm_pkg__03a__03auvm_reg_sequence__Tz307::__PVT__model);
        VL_NULL_CHECK(Vdma_uvm_pkg__03a__03auvm_reg_sequence__Tz307::__PVT__model, "/mnt/d/proj/designs/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/sequences/uvm_reg_mem_shared_access_seq.svh", 432)->__VnoInFunc_reset(vlSymsp, "HARD"s);
...
void Vdma_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc___Vbasic_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq::__VnoInFunc___Vbasic_randomize\n"); );
    // Body
