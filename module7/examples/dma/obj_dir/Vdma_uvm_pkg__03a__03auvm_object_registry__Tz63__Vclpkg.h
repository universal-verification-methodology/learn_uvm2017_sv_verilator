...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ63__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ63__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vdma__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63__Vclpkg);
    ...
    void __VnoInFunc_get(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63> &get__Vfuncrtn);
...
class Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63 : public Vdma_uvm_pkg__03a__03auvm_object_wrapper {
  public:
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63(Vdma__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_object_registry__Tz63() {}
};
