            ...
            while (VL_LTS_III(32, unnamedblk7__DOT__unnamedblk8__DOT__unnamedblk9__DOT__k, maps.size())) {
                ...
                if ((0U != unnamedblk7__DOT__unnamedblk8__DOT__status)) {
                    if ((0U != ([&]() {
                        ...
                        __Vtemp_8 = Vdma___024unit::__Venumtab_enum_name83
                            [(3U & unnamedblk7__DOT__unnamedblk8__DOT__status)];
                        __Vtemp_9 = ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq::~Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_shared_access_seq::~\n"); );
}
