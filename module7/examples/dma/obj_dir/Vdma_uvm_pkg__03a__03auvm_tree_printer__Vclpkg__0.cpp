...
void Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__pi8> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__pi8> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_type_name(Vdma__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_tree_printer"s;
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_set_default(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tree_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    this->__PVT__m_default_tree_printer = printer;
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_get_default(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_tree_printer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_tree_printer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((VlNull{} == this->__PVT__m_default_tree_printer)) {
        this->__PVT__m_default_tree_printer = VL_NEW(Vdma_uvm_pkg__03a__03auvm_tree_printer, vlProcess, vlSymsp, "uvm_default_tree_printer"s);
    }
    get_default__Vfuncrtn = this->__PVT__m_default_tree_printer;
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_object_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__pi8> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_create(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_tree_printer> tmp;
    tmp = ((""s == name) ? VL_NEW(Vdma_uvm_pkg__03a__03auvm_tree_printer, vlProcess, vlSymsp, ""s)
            : VL_NEW(Vdma_uvm_pkg__03a__03auvm_tree_printer, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_type_name(Vdma__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_tree_printer"s;
}

Vdma_uvm_pkg__03a__03auvm_tree_printer::Vdma_uvm_pkg__03a__03auvm_tree_printer(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name)
    : Vdma_uvm_pkg__03a__03auvm_printer(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::new\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_set_indent(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ indent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_set_indent\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__6__Vfuncout;
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_indent(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_indent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_indent\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__7__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_printer_knobs> _knobs;
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_set_separators(Vdma__Syms* __restrict vlSymsp, std::string separators) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_set_separators\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__8__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_printer_knobs> _knobs;
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_separators(Vdma__Syms* __restrict vlSymsp, std::string &get_separators__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_get_separators\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_printer_knobs> __Vfunc_get_knobs__9__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03am_uvm_printer_knobs> _knobs;
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_flush(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_flush\n"); );
    // Body
    Vdma_uvm_pkg__03a__03auvm_printer::__VnoInFunc_flush(vlProcess, vlSymsp);
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_emit(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_emit\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer_element> __Vfunc_get_bottom_element__22__Vfuncout;
    // Body
    std::string s;
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_m_emit_element(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer_element> element, IData/*31:0*/ level, std::string &m_emit_element__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_m_emit_element\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_tree_printer::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vdma_uvm_pkg__03a__03auvm_tree_printer::~Vdma_uvm_pkg__03a__03auvm_tree_printer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_tree_printer>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_tree_printer::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_tree_printer::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_tree_printer::to_string_middle\n"); );
    // Body
    std::string out;
