...
void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168, vlProcess, vlSymsp);
...
void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_m_cb_find(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz48> q, VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ &m_cb_find__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_m_cb_find\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_m_cb_find_name(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz48> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_display(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field> me;
    ...
    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_am_i_a(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_am_i_a\n"); );
        // Body
        VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field> this_type;
        {
            if ((VlNull{} == obj)) {
    ...
    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_get_tw_cb_q(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vdma_uvm_pkg__03a__03auvm_queue__Tz48> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Locals
            ...
            if (([&]() {
                ...
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Vdma_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    ...
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168>{this}))) {
    ...
    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_add_tw_cbs(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Vdma_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            ...
            if ((cb_pair != VlClassRef<Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168>{this})) {
    ...
    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_delete_tw_cbs(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
    ...
    Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp)
      : Vdma_uvm_pkg__03a__03auvm_callbacks_base(vlProcess, vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::new\n"); );
        // Body
        _ctor_var_reset(vlSymsp);
        ;
    }

    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc_randomize\n"); );
        // Locals
    ...
    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc___Vbasic_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__Vbasic_randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::__VnoInFunc___Vbasic_randomize\n"); );
        // Body
        __Vbasic_randomize__Vfuncrtn = 1U;
    }

    void Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::_ctor_var_reset\n"); );
        // Body
        (void)vlSymsp;  // Prevent unused variable warning
    }

    std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168>& obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::VL_TO_STRING\n"); );
        // Body
        return (obj ? obj->to_string() : "null");
    }

    std::string Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::to_string() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::to_string\n"); );
        // Body
        return ("'{"s + to_string_middle() + "}");
    }

    std::string Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::to_string_middle() const {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vdma_uvm_pkg__03a__03auvm_typed_callbacks__Tz168::to_string_middle\n"); );
        // Body
        std::string out;
