...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI67__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE__PI67__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vdma___024unit__03a__03aDmaTxn;
class Vdma_uvm_pkg__03a__03auvm_analysis_export__Tz126;
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_sequencer_param_base__pi67__Vclpkg);
...
class Vdma_uvm_pkg__03a__03auvm_sequencer_param_base__pi67 : public Vdma_uvm_pkg__03a__03auvm_sequencer_base {
  public:
    ...
    VlQueue<VlClassRef<Vdma___024unit__03a__03aDmaTxn>> __PVT__m_last_req_buffer;
    VlQueue<VlClassRef<Vdma___024unit__03a__03aDmaTxn>> __PVT__m_last_rsp_buffer;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequencer_analysis_fifo__pi75> __PVT__sqr_rsp_analysis_fifo;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_analysis_export__Tz126> __PVT__rsp_export;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_tlm_fifo__Tz126> __PVT__m_req_fifo;
    ...
    void __VnoInFunc_last_req(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vdma___024unit__03a__03aDmaTxn> &last_req__Vfuncrtn);
    void __VnoInFunc_last_rsp(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vdma___024unit__03a__03aDmaTxn> &last_rsp__Vfuncrtn);
    void __VnoInFunc_m_last_req_push_front(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma___024unit__03a__03aDmaTxn> item);
    void __VnoInFunc_m_last_rsp_push_front(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma___024unit__03a__03aDmaTxn> item);
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_sequencer_param_base__pi67(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vdma_uvm_pkg__03a__03auvm_sequencer_param_base__pi67() {}
};
