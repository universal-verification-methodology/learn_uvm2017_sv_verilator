...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI39__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI39__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_registry_common__pi39__Vclpkg final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_registry_common__pi39> __PVT__get__Vstatic__m_inst;

    // INTERNAL VARIABLES
    Vdma__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vdma_uvm_pkg__03a__03auvm_registry_common__pi39__Vclpkg(Vdma__Syms* symsp, const char* v__name);
    ~Vdma_uvm_pkg__03a__03auvm_registry_common__pi39__Vclpkg();
    VL_UNCOPYABLE(Vdma_uvm_pkg__03a__03auvm_registry_common__pi39__Vclpkg);
    ...
    void __VnoInFunc_get(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_registry_common__pi39> &get__Vfuncrtn);
...
class Vdma_uvm_pkg__03a__03auvm_registry_common__pi39 : public virtual VlClass {
  public:
  ...
  public:
    Vdma_uvm_pkg__03a__03auvm_registry_common__pi39(Vdma__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vdma_uvm_pkg__03a__03auvm_registry_common__pi39() {}
};
