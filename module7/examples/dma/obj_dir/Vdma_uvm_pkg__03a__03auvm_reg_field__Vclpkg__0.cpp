...
void Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__pi95> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__pi95> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi95__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_type_name(Vdma__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_reg_field"s;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_max_size(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_get_max_size\n"); );
    // Body
    get_max_size__Vfuncrtn = this->__PVT__m_max_size;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_define_access(Vdma__Syms* __restrict vlSymsp, std::string name, CData/*0:0*/ &define_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_define_access\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_m_predefine_policies(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &m_predefine_policies__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vdma_uvm_pkg__03a__03auvm_reg_field__Vclpkg::__VnoInFunc_m_predefine_policies\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_object_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__pi95> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi95__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_create(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field> tmp;
    tmp = ((""s == name) ? VL_NEW(Vdma_uvm_pkg__03a__03auvm_reg_field, vlProcess, vlSymsp, "uvm_reg_field"s)
            : VL_NEW(Vdma_uvm_pkg__03a__03auvm_reg_field, vlProcess, vlSymsp, name));
    create__Vfuncrtn = tmp;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_type_name(Vdma__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_field"s;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_write(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_write\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_write(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_write\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_read(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_read\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_read(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_read\n"); );
}

Vdma_uvm_pkg__03a__03auvm_reg_field::Vdma_uvm_pkg__03a__03auvm_reg_field(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name)
    : Vdma_uvm_pkg__03a__03auvm_object(vlProcess, vlSymsp, name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    IData/*31:0*/ unnamedblk2_1__DOT__i;
    unnamedblk2_1__DOT__i = 0;
    ;
    Vdma_uvm_pkg__03a__03auvm_void::__Vrandmode.resize(1U);
    unnamedblk2_1__DOT__i = 0U;
    while ((unnamedblk2_1__DOT__i < Vdma_uvm_pkg__03a__03auvm_void::__Vrandmode.size())) {
        Vdma_uvm_pkg__03a__03auvm_void::__Vrandmode.atWrite(unnamedblk2_1__DOT__i) = 1U;
        unnamedblk2_1__DOT__i = ((IData)(1U) + unnamedblk2_1__DOT__i);
    }
    Vdma_uvm_pkg__03a__03auvm_void::__PVT__constraint.write_var(this->__PVT__value, 0x0000000000000040ULL, 
                                                                "value", 0ULL, 0ULL);
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_configure(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg> parent, IData/*31:0*/ size, IData/*31:0*/ lsb_pos, std::string access, CData/*0:0*/ __SYM__volatile, QData/*63:0*/ reset, CData/*0:0*/ has_reset, CData/*0:0*/ is_rand, CData/*0:0*/ individually_accessible) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_configure\n"); );
    // Locals
    ...
    VL_NULL_CHECK(this->__PVT__m_parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 432)->__VnoInFunc_add_field(vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>{this});
    ...
    if ((1U & (~ (IData)(is_rand)))) {
        Vdma_uvm_pkg__03a__03auvm_void::__Vrandmode.atWrite(0U) = 0U;
    }
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_parent(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_parent\n"); );
    // Body
    get_parent__Vfuncrtn = this->__PVT__m_parent;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_full_name\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_register(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg> &get_register__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_register\n"); );
    // Body
    get_register__Vfuncrtn = this->__PVT__m_parent;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_lsb_pos(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_lsb_pos__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_lsb_pos\n"); );
    // Body
    get_lsb_pos__Vfuncrtn = this->__PVT__m_lsb;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_n_bits(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bits__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_n_bits\n"); );
    // Body
    get_n_bits__Vfuncrtn = this->__PVT__m_size;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_known_access(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, CData/*0:0*/ &is_known_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_known_access\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_access(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_access\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_backdoor__27__Vfuncout;
    ...
    // Body
    std::string __VCase_h963d5047__0;
    std::string field_access;
    {
        ...
        if (([&]() {
             ...
             ->__VnoInFunc_get_rights(vlProcess, vlSymsp, map, __Vtask_get_rights__28__Vfuncout);
                    __VCase_h963d5047__0 = __Vtask_get_rights__28__Vfuncout;
                }(), 1U)) {
            if (("RW"s == __VCase_h963d5047__0)) {
                get_access__Vfuncrtn = field_access;
                goto __Vlabel0;
            } else if (("RO"s == __VCase_h963d5047__0)) {
            ...
            } else if (("WO"s == __VCase_h963d5047__0)) {
                if ((((((((((("RW"s == field_access) 
                             || ("WRC"s == field_access)) 
                            || ("WRS"s == field_access)) 
                           | ("W1SRC"s == field_access)) 
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_access(Vdma__Syms* __restrict vlSymsp, std::string mode, std::string &set_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_access\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_volatility(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ __SYM__volatile) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_volatility\n"); );
    // Body
    this->__PVT__m_volatile = __SYM__volatile;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_volatile(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_volatile__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_volatile\n"); );
    // Body
    is_volatile__Vfuncrtn = this->__PVT__m_volatile;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XpredictX(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ cur_val, QData/*63:0*/ wr_val, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &XpredictX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XpredictX\n"); );
    // Locals
    ...
    // Body
    std::string __VCase_hf71776fd__0;
    QData/*63:0*/ mask;
    mask = 0;
    {
        ...
        if (([&]() {
                    ...
                    __VCase_hf71776fd__0 = __Vfunc_get_access__49__Vfuncout;
                }(), (((((((("RO"s == __VCase_hf71776fd__0) 
                            | ("RW"s == __VCase_hf71776fd__0)) 
                           | ("RC"s == __VCase_hf71776fd__0)) 
                          | ("RS"s == __VCase_hf71776fd__0)) 
                         | ("WC"s == __VCase_hf71776fd__0)) 
                        | ("WS"s == __VCase_hf71776fd__0)) 
                       | ("WRC"s == __VCase_hf71776fd__0)) 
                      | ("WRS"s == __VCase_hf71776fd__0)))) {
            if (("RO"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = cur_val;
                goto __Vlabel0;
            } else if (("RW"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = wr_val;
                goto __Vlabel0;
            } else if (("RC"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = cur_val;
                goto __Vlabel0;
            } else if (("RS"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = cur_val;
                goto __Vlabel0;
            } else if (("WC"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = 0ULL;
                goto __Vlabel0;
            } else if (("WS"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = mask;
                goto __Vlabel0;
            } else if (("WRC"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = wr_val;
                goto __Vlabel0;
            } else {
                XpredictX__Vfuncrtn = wr_val;
        ...
        } else if ((((((((("WSRC"s == __VCase_hf71776fd__0) 
                          | ("WCRS"s == __VCase_hf71776fd__0)) 
                         | ("W1C"s == __VCase_hf71776fd__0)) 
                        | ("W1S"s == __VCase_hf71776fd__0)) 
                       | ("W1T"s == __VCase_hf71776fd__0)) 
                      | ("W0C"s == __VCase_hf71776fd__0)) 
                     | ("W0S"s == __VCase_hf71776fd__0)) 
                    | ("W0T"s == __VCase_hf71776fd__0))) {
            if (("WSRC"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = mask;
                goto __Vlabel0;
            } else if (("WCRS"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = 0ULL;
                goto __Vlabel0;
            } else if (("W1C"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val & (~ wr_val));
                goto __Vlabel0;
            } else if (("W1S"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val | wr_val);
                goto __Vlabel0;
            } else if (("W1T"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val ^ wr_val);
                goto __Vlabel0;
            } else if (("W0C"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val & wr_val);
                goto __Vlabel0;
            } else if (("W0S"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val | ((~ wr_val) 
                                                  & mask));
                goto __Vlabel0;
            } else {
        ...
        } else if ((((((((("W1SRC"s == __VCase_hf71776fd__0) 
                          | ("W1CRS"s == __VCase_hf71776fd__0)) 
                         | ("W0SRC"s == __VCase_hf71776fd__0)) 
                        | ("W0CRS"s == __VCase_hf71776fd__0)) 
                       | ("WO"s == __VCase_hf71776fd__0)) 
                      | ("WOC"s == __VCase_hf71776fd__0)) 
                     | ("WOS"s == __VCase_hf71776fd__0)) 
                    | ("W1"s == __VCase_hf71776fd__0))) {
            if (("W1SRC"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val | wr_val);
                goto __Vlabel0;
            } else if (("W1CRS"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val & (~ wr_val));
                goto __Vlabel0;
            } else if (("W0SRC"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val | ((~ wr_val) 
                                                  & mask));
                goto __Vlabel0;
            } else if (("W0CRS"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = (cur_val & wr_val);
                goto __Vlabel0;
            } else if (("WO"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = wr_val;
                goto __Vlabel0;
            } else if (("WOC"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = 0ULL;
                goto __Vlabel0;
            } else if (("WOS"s == __VCase_hf71776fd__0)) {
                XpredictX__Vfuncrtn = mask;
                goto __Vlabel0;
            } else {
        ...
        } else if (("WO1"s == __VCase_hf71776fd__0)) {
            XpredictX__Vfuncrtn = ((IData)(this->__PVT__m_written)
                                    ? cur_val : wr_val);
            goto __Vlabel0;
        } else if (("NOACCESS"s == __VCase_hf71776fd__0)) {
            XpredictX__Vfuncrtn = cur_val;
            goto __Vlabel0;
        } else {
            XpredictX__Vfuncrtn = wr_val;
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_predict(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ value, CData/*7:0*/ be, IData/*31:0*/ kind, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, std::string fname, IData/*31:0*/ lineno, CData/*0:0*/ &predict__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_predict\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_predict(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw, IData/*31:0*/ kind, CData/*7:0*/ be) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_predict\n"); );
    // Locals
    QData/*63:0*/ __Vfunc_XpredictX__58__Vfuncout;
    __Vfunc_XpredictX__58__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__59__Vfuncout;
    QData/*63:0*/ __Vtask_post_predict__60__value;
    __Vtask_post_predict__60__value = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__61__Vfuncout;
    std::string __Vfunc_get_access__63__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__64__Vfuncout;
    QData/*63:0*/ __Vtask_post_predict__65__value;
    __Vtask_post_predict__65__value = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__66__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__69__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__70__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__76__Vfuncout;
    // Body
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86> unnamedblk278__DOT__cbs;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk278__DOT__unnamedblk279__DOT__cb;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86> unnamedblk280__DOT__cbs;
    std::string unnamedblk280__DOT__unnamedblk281__DOT__acc;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk280__DOT__unnamedblk282__DOT__cb;
    ...
    field_val = 0;
    {
        ...
        this->__PVT__m_lineno = VL_NULL_CHECK(rw, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 733)
            ->__PVT__lineno;
        if ((2U == kind)) {
            unnamedblk278__DOT__cbs = VL_NEW(Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86, vlSymsp, 
                                             VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>{this});
            ...
            while ((VlNull{} != unnamedblk278__DOT__unnamedblk279__DOT__cb)) {
                ...
                VL_NULL_CHECK(unnamedblk278__DOT__unnamedblk279__DOT__cb, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 747)->__VnoInFunc_post_predict(vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>{this}, this->__PVT__m_mirrored, __Vtask_post_predict__60__value, 2U, VL_NULL_CHECK(rw, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 748)
            ...
            unnamedblk280__DOT__cbs = VL_NEW(Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86, vlSymsp, 
                                             VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>{this});
            ...
            while ((VlNull{} != unnamedblk280__DOT__unnamedblk282__DOT__cb)) {
                ...
                VL_NULL_CHECK(unnamedblk280__DOT__unnamedblk282__DOT__cb, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 785)->__VnoInFunc_post_predict(vlSymsp, 
                                                                                VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>{this}, this->__PVT__m_mirrored, __Vtask_post_predict__65__value, 1U, VL_NULL_CHECK(rw, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 786)
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XupdateX(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ &XupdateX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_XupdateX\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ value, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__80__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__89__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__90__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get(Vdma__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, QData/*63:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get\n"); );
    // Body
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_mirrored_value(Vdma__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, QData/*63:0*/ &get_mirrored_value__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_mirrored_value\n"); );
    // Body
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_reset(Vdma__Syms* __restrict vlSymsp, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_reset\n"); );
    // Body
    {
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_has_reset(Vdma__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ __SYM__delete, CData/*0:0*/ &has_reset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_has_reset\n"); );
    // Body
    {
        if ((! this->__PVT__m_reset.exists(kind))) {
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_reset(Vdma__Syms* __restrict vlSymsp, std::string kind, QData/*63:0*/ &get_reset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_reset\n"); );
    // Body
    {
        if ((! this->__PVT__m_reset.exists(kind))) {
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_reset(Vdma__Syms* __restrict vlSymsp, QData/*63:0*/ value, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_reset\n"); );
    // Body
    this->__PVT__m_reset.at(kind) = (value & (VL_SHIFTL_QQI(64,64,32, 1ULL, this->__PVT__m_size) 
                                              - 1ULL));
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_needs_update(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &needs_update__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_needs_update\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_Xcheck_accessX(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> &map_info, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_Xcheck_accessX\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> __Vtask_get_block__98__Vfuncout;
    IData/*31:0*/ __Vtask_get_default_door__99__Vfuncout;
    __Vtask_get_default_door__99__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_backdoor> __Vtask_get_backdoor__100__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__103__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__104__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__108__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__109__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vfunc_backdoor__111__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_local_map__112__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__121__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__122__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_get_reg_map_info__124__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__132__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__133__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_block> unnamedblk283__DOT__blk;
    {
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_write(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__135__Vfuncout;
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_write(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_write\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_Xcheck_accessX__139__Vfuncout;
    __Vfunc_Xcheck_accessX__139__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__139__map_info;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__155__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__159__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__161__Vfuncout;
    CData/*0:0*/ __Vtask_get_auto_predict__165__Vfuncout;
    __Vtask_get_auto_predict__165__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__168__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__170__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk285__DOT__system_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86> unnamedblk285__DOT__cbs;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk285__DOT__unnamedblk286__DOT__cb;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk285__DOT__unnamedblk287__DOT__cb;
    std::string __VCase_h594f39c6__0;
    QData/*63:0*/ value_adjust;
    value_adjust = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> map_info;
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>> fields;
    ...
    bad_side_effect = 0;
    {
        ...
        while (VL_LTS_III(32, unnamedblk284__DOT__i, fields.size())) {
            {
                ...
                if (([&]() {
                     ...
                     ->__VnoInFunc_get_access(vlProcess, vlSymsp, VL_NULL_CHECK(rw, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 1106)
                            ...
                            __VCase_h594f39c6__0 = __Vtask_get_access__150__Vfuncout;
                        }(), 1U)) {
                    if ((1U & (~ (((((((("RO"s == __VCase_h594f39c6__0) 
                                        || ("RC"s == __VCase_h594f39c6__0)) 
                                       || ("RS"s == __VCase_h594f39c6__0)) 
                                      || ("W1C"s == __VCase_h594f39c6__0)) 
                                     || ("W1S"s == __VCase_h594f39c6__0)) 
                                    || ("W1T"s == __VCase_h594f39c6__0)) 
                                   || ("W1SRC"s == __VCase_h594f39c6__0)) 
                                  || ("W1CRC"s == __VCase_h594f39c6__0))))) {
                        if (((((("W0C"s == __VCase_h594f39c6__0) 
                                || ("W0S"s == __VCase_h594f39c6__0)) 
                               || ("W0T"s == __VCase_h594f39c6__0)) 
                              || ("W0SRC"s == __VCase_h594f39c6__0)) 
                             || ("W0CRS"s == __VCase_h594f39c6__0))) {
                            value_adjust = (value_adjust 
                        ...
                        } else if ((((((("WC"s == __VCase_h594f39c6__0) 
                                        || ("WS"s == __VCase_h594f39c6__0)) 
                                       || ("WCRS"s 
                                           == __VCase_h594f39c6__0)) 
                                      || ("WSRC"s == __VCase_h594f39c6__0)) 
                                     || ("WOC"s == __VCase_h594f39c6__0)) 
                                    || ("WOS"s == __VCase_h594f39c6__0))) {
                            bad_side_effect = 1U;
                        } else {
                            value_adjust = (value_adjust 
        ...
        if (([&]() {
            ...
            unnamedblk285__DOT__cbs = VL_NEW(Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86, vlSymsp, 
                                             VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>{this});
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_read(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_read\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> __Vfunc_create__183__Vfuncout;
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_read(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_read\n"); );
    // Locals
    CData/*0:0*/ __Vfunc_Xcheck_accessX__187__Vfuncout;
    __Vfunc_Xcheck_accessX__187__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__187__map_info;
    CData/*0:0*/ __Vfunc_is_indv_accessible__188__Vfuncout;
    __Vfunc_is_indv_accessible__188__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__189__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__193__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__195__Vfuncout;
    CData/*0:0*/ __Vtask_get_auto_predict__199__Vfuncout;
    __Vtask_get_auto_predict__199__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_first__202__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> __Vtask_next__204__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__211__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__212__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__216__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__217__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VL_KEEP_THIS;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk288__DOT__system_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86> unnamedblk288__DOT__cbs;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk288__DOT__unnamedblk289__DOT__cb;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk288__DOT__unnamedblk290__DOT__cb;
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>> unnamedblk291__DOT__fields;
    ...
    bad_side_effect = 0;
    {
        ...
        if (([&]() {
            ...
            unnamedblk288__DOT__cbs = VL_NEW(Vdma_uvm_pkg__03a__03auvm_callback_iter__pi86, vlSymsp, 
                                             VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>{this});
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_indv_accessible(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> local_map, CData/*0:0*/ &is_indv_accessible__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_is_indv_accessible\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__220__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__221__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__229__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__230__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__234__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__235__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_frontdoor> __Vtask_get_frontdoor__237__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__239__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__240__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__245__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__246__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> __Vtask_get_root_map__248__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_adapter> __Vtask_get_adapter__249__Vfuncout;
    ...
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> unnamedblk294__DOT__system_map;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_adapter> unnamedblk294__DOT__adapter;
    ...
    VlQueue<VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>> unnamedblk295__DOT__fields;
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_poke(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ value, std::string kind, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_poke\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__273__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__274__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__279__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__280__Vfuncout;
                ...
                __Vtask_uvm_report_error__282__message 
                    = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(
                                        ...
                                        VL_NULL_CHECK(this->__PVT__m_parent, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/reg/uvm_reg_field.svh", 1461)
                                                        ...
                                                        Vdma___024unit::__Venumtab_enum_name83
                                                        [
                                                        (3U 
                                                         & status)]));
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_peek(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ &value, std::string kind, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_peek\n"); );
    // Locals
...
VlCoroutine Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_mirror(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ check, IData/*31:0*/ path, VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vdma_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_mirror\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_compare(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ check) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_set_compare\n"); );
    // Body
    this->__PVT__m_check = check;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_compare(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &get_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_get_compare\n"); );
    // Body
    get_compare__Vfuncrtn = this->__PVT__m_check;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_randomize(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_pre_randomize\n"); );
    // Body
    this->__PVT__value = this->__PVT__m_desired;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_randomize(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_post_randomize\n"); );
    // Body
    this->__PVT__m_desired = this->__PVT__value;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_print(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_print\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_convert2string\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg> __Vfunc_get_register__296__Vfuncout;
    ...
    with_debug_info = 0;
    std::string prefix;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg> reg_;
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_clone(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_clone\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__305__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__306__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_copy\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__310__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__311__Vfuncout;
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_compare(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vdma_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_compare\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_pack(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_pack\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__330__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__331__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0U != ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_unpack(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_do_unpack\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__334__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__335__Vfuncout;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__338__Vfuncout;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_root> __Vtask_get_root__339__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((0U != ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_randomize(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_randomize\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_uvm_reg_field_valid_setup_constraint(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc_uvm_reg_field_valid_setup_constraint\n"); );
    // Locals
    std::string __Vtemp_1;
    std::string __Vtemp_2;
    std::string __Vtemp_3;
    std::string __Vtemp_4;
    // Body
    __Vtemp_1 = (Vdma_uvm_pkg__03a__03auvm_void::__Vrandmode.at(0U)
    ...
    __Vtemp_4 = VL_SFORMATF_N_NX("(__Vbv (bvult %@ %@))",0,
                                 -1,&(__Vtemp_1),-1,
                                 &(__Vtemp_2)) ;
    Vdma_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard(VL_SFORMATF_N_NX("(__Vbv (=> (__Vbool %@) (__Vbool %@)))",0,
                                                                            -1,
                                                                            &(__Vtemp_3),
                                                                            -1,
...
void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___Vsetup_constraints\n"); );
    // Body
    this->__VnoInFunc_uvm_reg_field_valid_setup_constraint(vlSymsp);
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vdma_uvm_pkg__03a__03auvm_reg_field::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::_ctor_var_reset\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_reg_field::~Vdma_uvm_pkg__03a__03auvm_reg_field() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_reg_field>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_reg_field::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_reg_field::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_reg_field::to_string_middle\n"); );
    // Body
    std::string out;
