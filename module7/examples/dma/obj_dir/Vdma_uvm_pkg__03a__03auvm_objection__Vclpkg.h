...
class Vdma_uvm_pkg__03a__03a__VDynScope_37;
class Vdma_uvm_pkg__03a__03a__VDynScope_39;
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_objection__Vclpkg final {
  public:
  ...
  private:
    VlCoroutine __VnoInFunc_m_init_objections____Vfork_2__0(VlProcessRef vlProcess, VlClassRef<Vdma_std__03a__03aprocess> unnamedblk7__DOT____VforkParent);
};
