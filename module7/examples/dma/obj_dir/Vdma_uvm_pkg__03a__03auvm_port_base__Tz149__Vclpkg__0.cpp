...
Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::Vdma_uvm_pkg__03a__03auvm_port_base__Tz149(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ port_type, IData/*31:0*/ min_size, IData/*31:0*/ max_size)
    : Vdma_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126(vlProcess, vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::new\n"); );
    // Locals
    ...
    this->__PVT__m_comp = VL_NEW(Vdma_uvm_pkg__03a__03auvm_port_component__Tz156, vlProcess, vlSymsp, name, parent, 
                                 VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149>{this});
    if ((1U & (~ ([&]() {
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_name(Vdma__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_name\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_full_name\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_parent(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_parent\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_comp(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_component_base> &get_comp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_comp\n"); );
    // Body
    get_comp__Vfuncrtn = this->__PVT__m_comp;
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_type_name(Vdma__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_type_name\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_max_size(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &max_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_max_size\n"); );
    // Body
    max_size__Vfuncrtn = this->__PVT__m_max_size;
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_min_size(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &min_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_min_size\n"); );
    // Body
    min_size__Vfuncrtn = this->__PVT__m_min_size;
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_unbounded(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_unbounded__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_unbounded\n"); );
    // Body
    is_unbounded__Vfuncrtn = (0xffffffffU == this->__PVT__m_max_size);
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_port(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_port__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_port\n"); );
    // Body
    is_port__Vfuncrtn = (0U == this->__PVT__m_port_type);
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_export(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_export__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_export\n"); );
    // Body
    is_export__Vfuncrtn = (1U == this->__PVT__m_port_type);
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_imp(Vdma__Syms* __restrict vlSymsp, CData/*0:0*/ &is_imp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_is_imp\n"); );
    // Body
    is_imp__Vfuncrtn = (2U == this->__PVT__m_port_type);
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_size(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_size\n"); );
    // Body
    size__Vfuncrtn = this->__PVT__m_imp_list.size();
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_set_if(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_set_if\n"); );
    // Locals
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> __Vfunc_get_if__7__Vfuncout;
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_m_get_if_mask(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &m_get_if_mask__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_m_get_if_mask\n"); );
    // Body
    m_get_if_mask__Vfuncrtn = this->__PVT__m_if_mask;
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_set_default_index(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_set_default_index\n"); );
    // Body
    this->__PVT__m_def_index = index;
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_connect(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> provider) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_connect\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        if ((provider == VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149>{this})) {
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_debug_connected_to(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ level, IData/*31:0*/ max_level) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_debug_connected_to\n"); );
    // Locals
    ...
    curr_num = 0;
    std::string s_sz;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> port;
    {
        ...
        if ((0U == level)) {
            ...
            VL_NULL_CHECK(this->__PVT__m_comp, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_port_base.svh", 591)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, "debug_connected_to"s, vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz149__Vclpkg.__PVT__debug_connected_to__Vstatic__save, 0x000000c8U, ""s, 0U, ""s, 0U);
        }
        __Vlabel0: ;
    }
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_debug_provided_to(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ level, IData/*31:0*/ max_level) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_debug_provided_to\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> port;
    {
        ...
        if ((0U == level)) {
            ...
            VL_NULL_CHECK(this->__PVT__m_comp, "/home/yongfu/proj/learn_uvm2017_sv_verilator/tools/uvm-2017/1800.2-2017-1.0/src/base/uvm_port_base.svh", 639)->__VnoInFunc_uvm_report_info(vlProcess, vlSymsp, "debug_provided_to"s, vlSymsp->TOP__uvm_pkg__03a__03auvm_port_base__Tz149__Vclpkg.__PVT__debug_provided_to__Vstatic__save, 0x000000c8U, ""s, 0U, ""s, 0U);
        }
        __Vlabel0: ;
    }
}

void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_connected_to(Vdma__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149>> &list) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_connected_to\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_provided_to(Vdma__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149>> &list) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_provided_to\n"); );
    // Body
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_m_check_relationship(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_m_check_relationship\n"); );
    // Locals
    ...
    // Body
    std::string s;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> from;
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_component> to_gparent;
    {
        ...
        from = VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149>{this};
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_m_add_list(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> provider) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_m_add_list\n"); );
    // Locals
    IData/*31:0*/ __Vtask_size__68__Vfuncout;
    __Vtask_size__68__Vfuncout = 0;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> __Vtask_get_if__69__Vfuncout;
    ...
    std::string sz;
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> imp;
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_resolve_bindings(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_resolve_bindings\n"); );
    // Locals
    ...
    VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> unnamedblk8__DOT__unnamedblk9__DOT__port;
    {
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_if(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149> &get_if__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::__VnoInFunc_get_if\n"); );
    // Locals
...
void Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::_ctor_var_reset(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::_ctor_var_reset\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::~Vdma_uvm_pkg__03a__03auvm_port_base__Tz149() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vdma_uvm_pkg__03a__03auvm_port_base__Tz149>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vdma_uvm_pkg__03a__03auvm_port_base__Tz149::to_string_middle\n"); );
    // Body
    std::string out;
    ...
    out += ", "+ Vdma_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126::to_string_middle();
    return (out);
}
