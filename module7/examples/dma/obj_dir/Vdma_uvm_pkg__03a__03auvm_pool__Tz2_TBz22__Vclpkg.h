...
#ifndef VERILATED_VDMA_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ22__VCLPKG_H_
#define VERILATED_VDMA_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ22__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz22__Vclpkg final : public VerilatedModule {
  public:
    ...
    void __VnoInFunc_get_global(Vdma__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz22> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_object_registry__Tz75> &get_type__Vfuncrtn);
...
class Vdma_uvm_pkg__03a__03auvm_pool__Tz2_TBz22 : public Vdma_uvm_pkg__03a__03auvm_object {
  public:
    ...
    virtual void __VnoInFunc_get(Vdma__Syms* __restrict vlSymsp, std::string key, IData/*31:0*/ &get__Vfuncrtn);
