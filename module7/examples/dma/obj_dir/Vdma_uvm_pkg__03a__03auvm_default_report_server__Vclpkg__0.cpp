...
void Vdma_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_severity_counts(Vdma__Syms* __restrict vlSymsp) {
    ...
    s = 0U;
    {
        while (true) {
            ...
            s = Vdma___024unit::__Venumtab_enum_next21
                [s];
        }
        __Vlabel0: ;
    }
...
void Vdma_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_report_message(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, VlClassRef<Vdma_uvm_pkg__03a__03auvm_report_message> report_message, std::string report_object_name, std::string &compose_report_message__Vfuncrtn) {
    ...
    sev_string = Vdma___024unit::__Venumtab_enum_name21
        [l_severity];
    if ((""s != ([&]() {
    ...
    if (this->__PVT__show_verbosity) {
        if ((0U != (Vdma___024unit::__Venumtab_enum_valid25
            ...
            verbosity_str = Vdma___024unit::__Venumtab_enum_name25
                .at(l_verbosity);
        } else {
...
void Vdma_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_report_summarize(VlProcessRef vlProcess, Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    ...
    if ((0U != this->__PVT__m_severity_count.first(unnamedblk11__DOT__s))) {
        ...
        while (((IData)(unnamedblk11__DOT__s__Vfirst) 
            ...
            __Vtemp_1 = Vdma___024unit::__Venumtab_enum_name21
...
void Vdma_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vsetup_constraints(Vdma__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vdma_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___VBasicRand(Vdma__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___VBasicRand\n"); );
    // Body
...
Vdma_uvm_pkg__03a__03auvm_default_report_server::~Vdma_uvm_pkg__03a__03auvm_default_report_server() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdma_uvm_pkg__03a__03auvm_default_report_server::~\n"); );
}
