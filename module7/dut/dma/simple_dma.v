    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (dma_start && !dma_done) begin
                ...
                // 
                // PARAMETER LATCHING:
                //   - All parameters latched simultaneously on clock edge
                //   - Ensures consistent parameter set
                //   - Parameters remain stable during transfer
                //   - Counter reset to 0 for new transfer
